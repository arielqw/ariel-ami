...
8010003a:	c7 44 24 04 48 92 10 	movl   $0x80109248,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 e0 dc 10 80 	movl   $0x8010dce0,(%esp)
80100049:	e8 84 54 00 00       	call   801054d2 <initlock>
...
801000bd:	e8 31 54 00 00       	call   801054f3 <acquire>
...
8010011f:	e8 aa 50 00 00       	call   801051ce <sleep>
      goto loop;
...
80100198:	c7 04 24 4f 92 10 80 	movl   $0x8010924f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 60 92 10 80 	movl   $0x80109260,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 67 92 10 80 	movl   $0x80109267,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 e0 dc 10 80 	movl   $0x8010dce0,(%esp)
8010023c:	e8 b2 52 00 00       	call   801054f3 <acquire>
...
8010029d:	e8 28 50 00 00       	call   801052ca <wakeup>
...
801003bc:	e8 32 51 00 00       	call   801054f3 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 6e 92 10 80 	movl   $0x8010926e,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 77 92 10 80 	movl   $0x80109277,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 1a 50 00 00       	call   80105555 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 7e 92 10 80 	movl   $0x8010927e,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 8d 92 10 80 	movl   $0x8010928d,(%esp)
...
80100592:	e8 0d 50 00 00       	call   801055a4 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 8f 92 10 80 	movl   $0x8010928f,(%esp)
...
801006b2:	e8 5e 51 00 00       	call   80105815 <memmove>
    pos -= 80;
...
801006e1:	e8 5c 50 00 00       	call   80105742 <memset>
  }
...
80100776:	e8 be 6c 00 00       	call   80107439 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 b2 6c 00 00       	call   80107439 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 a6 6c 00 00       	call   80107439 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 99 6c 00 00       	call   80107439 <uartputc>
  cgaputc(c);
...
801007ba:	e8 34 4d 00 00       	call   801054f3 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 a1 4b 00 00       	call   80105390 <procdump>
      break;
...
801008f7:	e8 ce 49 00 00       	call   801052ca <wakeup>
        }
      }
      break;
...
8010091e:	e8 32 4c 00 00       	call   80105555 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 ab 4b 00 00       	call   801054f3 <acquire>
  while(n > 0){
...
80100961:	e8 ef 4b 00 00       	call   80105555 <release>
        ilock(ip);
...
8010098a:	e8 3f 48 00 00       	call   801051ce <sleep>
...
80100a08:	e8 48 4b 00 00       	call   80105555 <release>
  ilock(ip);
...
80100a3e:	e8 b0 4a 00 00       	call   801054f3 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 d8 4a 00 00       	call   80105555 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 93 92 10 	movl   $0x80109293,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 2b 4a 00 00       	call   801054d2 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 9b 92 10 	movl   $0x8010929b,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 00 1e 11 80 	movl   $0x80111e00,(%esp)
80100ab6:	e8 17 4a 00 00       	call   801054d2 <initlock>
...
80100b78:	0f 85 9a 03 00 00    	jne    80100f18 <exec+0x41c>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 fa 79 00 00       	call   8010857d <setupkvm>
...
80100c17:	e8 33 7d 00 00       	call   8010894f <allocuvm>
...
80100c54:	e8 07 7c 00 00       	call   80108860 <loaduvm>
...
80100c9b:	ba f2 8d 10 80       	mov    $0x80108df2,%edx
80100ca0:	b8 e8 8d 10 80       	mov    $0x80108de8,%eax
...
80100cda:	e8 70 7c 00 00       	call   8010894f <allocuvm>
...
80100d07:	e8 67 7e 00 00       	call   80108b73 <clearpteu>
...
80100d22:	c7 44 24 08 e8 8d 10 	movl   $0x80108de8,0x8(%esp)
80100d29:	80 
...
80100d37:	e8 fc 7f 00 00       	call   80108d38 <copyout>
...
80100d6e:	e8 4d 4c 00 00       	call   801059c0 <strlen>
...
80100d8c:	e8 2f 4c 00 00       	call   801059c0 <strlen>
...
80100db6:	e8 7d 7f 00 00       	call   80108d38 <copyout>
...
80100e55:	e8 de 7e 00 00       	call   80108d38 <copyout>
...
80100eac:	e8 c1 4a 00 00       	call   80105972 <safestrcpy>
//  cprintf("\n[debug] [%s] executing '%s' \n", TAG, last);
...
80100efe:	e8 6b 77 00 00       	call   8010866e <switchuvm>
  freevm(oldpgdir);
80100f03:	8b 45 c8             	mov    -0x38(%ebp),%eax
80100f06:	89 04 24             	mov    %eax,(%esp)
80100f09:	e8 d7 7b 00 00       	call   80108ae5 <freevm>
  return 0;
...
80100f43:	e8 9d 7b 00 00       	call   80108ae5 <freevm>
  if(ip){
...
80100f6e:	c7 44 24 04 a1 92 10 	movl   $0x801092a1,0x4(%esp)
80100f75:	80 
80100f76:	c7 04 24 c0 1e 11 80 	movl   $0x80111ec0,(%esp)
80100f7d:	e8 50 45 00 00       	call   801054d2 <initlock>
}
80100f82:	c9                   	leave  
80100f83:	c3                   	ret    
...
80100f91:	e8 5d 45 00 00       	call   801054f3 <acquire>
...
80100fba:	e8 96 45 00 00       	call   80105555 <release>
      return f;
...
80100fd8:	e8 78 45 00 00       	call   80105555 <release>
  return 0;
...
80100ff1:	e8 fd 44 00 00       	call   801054f3 <acquire>
  if(f->ref < 1)
...
80100ffe:	7f 0c                	jg     8010100c <filedup+0x28>
    panic("filedup");
80101000:	c7 04 24 a8 92 10 80 	movl   $0x801092a8,(%esp)
...
80101022:	e8 2e 45 00 00       	call   80105555 <release>
  return f;
...
80101039:	e8 b5 44 00 00       	call   801054f3 <acquire>
  if(f->ref < 1)
...
80101046:	7f 0c                	jg     80101054 <fileclose+0x28>
    panic("fileclose");
80101048:	c7 04 24 b0 92 10 80 	movl   $0x801092b0,(%esp)
...
80101074:	e8 dc 44 00 00       	call   80105555 <release>
    return;
...
801010be:	e8 92 44 00 00       	call   80105555 <release>
...
801011fd:	eb 0c                	jmp    8010120b <fileread+0xba>
  ...
  panic("fileread");
801011ff:	c7 04 24 ba 92 10 80 	movl   $0x801092ba,(%esp)
...
8010130b:	c7 04 24 c3 92 10 80 	movl   $0x801092c3,(%esp)
...
8010133e:	eb 0c                	jmp    8010134c <filewrite+0x13f>
  ...
  panic("filewrite");
80101340:	c7 04 24 d3 92 10 80 	movl   $0x801092d3,(%esp)
...
80101388:	e8 88 44 00 00       	call   80105815 <memmove>
  brelse(bp);
...
801013ce:	e8 6f 43 00 00       	call   80105742 <memset>
  log_write(bp);
...
80101530:	0f 82 e1 fe ff ff    	jb     80101417 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
80101536:	c7 04 24 dd 92 10 80 	movl   $0x801092dd,(%esp)
...
801015cd:	c7 04 24 f3 92 10 80 	movl   $0x801092f3,(%esp)
...
80101621:	c7 44 24 04 06 93 10 	movl   $0x80109306,0x4(%esp)
80101628:	80 
80101629:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101630:	e8 9d 3e 00 00       	call   801054d2 <initlock>
}
80101635:	c9                   	leave  
80101636:	c3                   	ret    
...
801016b2:	e8 8b 40 00 00       	call   80105742 <memset>
      dip->type = type;
...
80101702:	0f 82 5a ff ff ff    	jb     80101662 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101708:	c7 04 24 0d 93 10 80 	movl   $0x8010930d,(%esp)
...
801017af:	e8 61 40 00 00       	call   80105815 <memmove>
  log_write(bp);
...
801017d9:	e8 15 3d 00 00       	call   801054f3 <acquire>
...
80101823:	e8 2d 3d 00 00       	call   80105555 <release>
      return ip;
...
80101856:	c7 04 24 1f 93 10 80 	movl   $0x8010931f,(%esp)
...
80101894:	e8 bc 3c 00 00       	call   80105555 <release>
...
801018ab:	e8 43 3c 00 00       	call   801054f3 <acquire>
  ip->ref++;
...
801018c6:	e8 8a 3c 00 00       	call   80105555 <release>
  return ip;
...
801018e4:	7f 0c                	jg     801018f2 <ilock+0x22>
    panic("ilock");
801018e6:	c7 04 24 2f 93 10 80 	movl   $0x8010932f,(%esp)
801018ed:	e8 4b ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801018f2:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
801018f9:	e8 f5 3b 00 00       	call   801054f3 <acquire>
...
8010190e:	e8 bb 38 00 00       	call   801051ce <sleep>
...
80101938:	e8 18 3c 00 00       	call   80105555 <release>
...
801019e3:	e8 2d 3e 00 00       	call   80105815 <memmove>
    brelse(bp);
...
80101a0e:	75 0c                	jne    80101a1c <ilock+0x14c>
      panic("ilock: no type");
80101a10:	c7 04 24 35 93 10 80 	movl   $0x80109335,(%esp)
...
80101a3f:	7f 0c                	jg     80101a4d <iunlock+0x2f>
    panic("iunlock");
80101a41:	c7 04 24 44 93 10 80 	movl   $0x80109344,(%esp)
80101a48:	e8 f0 ea ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101a4d:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101a54:	e8 9a 3a 00 00       	call   801054f3 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a70:	e8 55 38 00 00       	call   801052ca <wakeup>
  release(&icache.lock);
80101a75:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101a7c:	e8 d4 3a 00 00       	call   80105555 <release>
}
80101a81:	c9                   	leave  
80101a82:	c3                   	ret    
...
80101a90:	e8 5e 3a 00 00       	call   801054f3 <acquire>
...
80101acc:	74 0c                	je     80101ada <iput+0x57>
      panic("iput busy");
80101ace:	c7 04 24 4c 93 10 80 	movl   $0x8010934c,(%esp)
...
80101af2:	e8 5e 3a 00 00       	call   80105555 <release>
    itrunc(ip);
...
80101b1d:	e8 d1 39 00 00       	call   801054f3 <acquire>
    ip->flags = 0;
...
80101b32:	e8 93 37 00 00       	call   801052ca <wakeup>
  }
  ip->ref--;
...
80101b4d:	e8 03 3a 00 00       	call   80105555 <release>
}
80101b52:	c9                   	leave  
80101b53:	c3                   	ret    
...
80101c62:	c7 04 24 56 93 10 80 	movl   $0x80109356,(%esp)
...
80101efa:	e8 16 39 00 00       	call   80105815 <memmove>
    brelse(bp);
...
80102060:	e8 b0 37 00 00       	call   80105815 <memmove>
    log_write(bp);
...
801020e2:	e8 d2 37 00 00       	call   801058b9 <strncmp>
}
801020e7:	c9                   	leave  
801020e8:	c3                   	ret    
...
801020fc:	c7 04 24 69 93 10 80 	movl   $0x80109369,(%esp)
...
80102138:	74 0c                	je     80102146 <dirlookup+0x5d>
      panic("dirlink read");
8010213a:	c7 04 24 7b 93 10 80 	movl   $0x8010937b,(%esp)
...
8010221c:	74 0c                	je     8010222a <dirlink+0x79>
      panic("dirlink read");
8010221e:	c7 04 24 7b 93 10 80 	movl   $0x8010937b,(%esp)
...
80102264:	e8 a8 36 00 00       	call   80105911 <strncpy>
  de.inum = inum;
...
80102294:	74 0c                	je     801022a2 <dirlink+0xf1>
    panic("dirlink");
80102296:	c7 04 24 88 93 10 80 	movl   $0x80109388,(%esp)
...
8010231d:	e8 f3 34 00 00       	call   80105815 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102338:	e8 d8 34 00 00       	call   80105815 <memmove>
    name[len] = 0;
...
80102594:	c7 44 24 04 90 93 10 	movl   $0x80109390,0x4(%esp)
8010259b:	80 
8010259c:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
801025a3:	e8 2a 2f 00 00       	call   801054d2 <initlock>
  picenable(IRQ_IDE);
...
8010263e:	75 0c                	jne    8010264c <idestart+0x18>
    panic("idestart");
80102640:	c7 04 24 94 93 10 80 	movl   $0x80109394,(%esp)
...
80102766:	e8 88 2d 00 00       	call   801054f3 <acquire>
  if((b = idequeue) == 0){
...
80102780:	e8 d0 2d 00 00       	call   80105555 <release>
...
801027f3:	e8 d2 2a 00 00       	call   801052ca <wakeup>
...
80102815:	e8 3b 2d 00 00       	call   80105555 <release>
}
8010281a:	c9                   	leave  
8010281b:	c3                   	ret    
...
8010282e:	c7 04 24 9d 93 10 80 	movl   $0x8010939d,(%esp)
...
80102847:	c7 04 24 b1 93 10 80 	movl   $0x801093b1,(%esp)
...
801028d2:	e8 f7 28 00 00       	call   801051ce <sleep>
...
801028ee:	e8 62 2c 00 00       	call   80105555 <release>
}
801028f3:	c9                   	leave  
801028f4:	c3                   	ret    
...
8010297e:	c7 04 24 e4 93 10 80 	movl   $0x801093e4,(%esp)
...
80102a3f:	c7 44 24 04 16 94 10 	movl   $0x80109416,0x4(%esp)
80102a46:	80 
80102a47:	c7 04 24 a0 38 11 80 	movl   $0x801138a0,(%esp)
80102a4e:	e8 7f 2a 00 00       	call   801054d2 <initlock>
  kmem.use_lock = 0;
...
80102af9:	76 0c                	jbe    80102b07 <kfree+0x39>
    panic("kfree");
80102afb:	c7 04 24 1b 94 10 80 	movl   $0x8010941b,(%esp)
...
80102b1d:	e8 20 2c 00 00       	call   80105742 <memset>
...
80102b32:	e8 bc 29 00 00       	call   801054f3 <acquire>
  r = (struct run*)v;
...
80102b60:	e8 f0 29 00 00       	call   80105555 <release>
}
80102b65:	c9                   	leave  
80102b66:	c3                   	ret    
...
80102b7d:	e8 71 29 00 00       	call   801054f3 <acquire>
  r = kmem.freelist;
...
80102baa:	e8 a6 29 00 00       	call   80105555 <release>
  return (char*)r;
...
80102f50:	c7 04 24 24 94 10 80 	movl   $0x80109424,(%esp)
...
801031b4:	e8 00 26 00 00       	call   801057b9 <memcmp>
...
801032b6:	c7 44 24 04 50 94 10 	movl   $0x80109450,0x4(%esp)
801032bd:	80 
801032be:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
801032c5:	e8 08 22 00 00       	call   801054d2 <initlock>
  readsb(ROOTDEV, &sb);
...
80103378:	e8 98 24 00 00       	call   80105815 <memmove>
...
801034ca:	e8 24 20 00 00       	call   801054f3 <acquire>
  while(1){
    if(log.committing){
...
801034e7:	e8 e2 1c 00 00       	call   801051ce <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
8010351b:	e8 ae 1c 00 00       	call   801051ce <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
80103536:	e8 1a 20 00 00       	call   80105555 <release>
      break;
8010353b:	90                   	nop
    }
  }
...
80103552:	e8 9c 1f 00 00       	call   801054f3 <acquire>
  log.outstanding -= 1;
...
8010356d:	c7 04 24 54 94 10 80 	movl   $0x80109454,(%esp)
...
8010359c:	e8 29 1d 00 00       	call   801052ca <wakeup>
  }
  release(&log.lock);
801035a1:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
801035a8:	e8 a8 1f 00 00       	call   80105555 <release>
...
80103659:	e8 b7 21 00 00       	call   80105815 <memmove>
...
801036e4:	c7 04 24 63 94 10 80 	movl   $0x80109463,(%esp)
...
801036f9:	c7 04 24 79 94 10 80 	movl   $0x80109479,(%esp)
80103700:	e8 38 ce ff ff       	call   8010053d <panic>

  acquire(&log.lock);
80103705:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
8010370c:	e8 e2 1d 00 00       	call   801054f3 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103784:	e8 cc 1d 00 00       	call   80105555 <release>
}
80103789:	c9                   	leave  
8010378a:	c3                   	ret    
	...
...
8010380c:	c7 04 24 94 94 10 80 	movl   $0x80109494,(%esp)
...
80103827:	e8 fc 3a 00 00       	call   80107328 <uartinit>
  pinit();         // process table
8010382c:	e8 8e 0b 00 00       	call   801043bf <pinit>
  tvinit();        // trap vectors
80103831:	e8 b5 35 00 00       	call   80106deb <tvinit>
  binit();         // buffer cache
...
80103853:	e8 d6 34 00 00       	call   80106d2e <timerinit>
...
8010387e:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103881:	e8 cb 4d 00 00       	call   80108651 <switchkvm>
  seginit();
80103886:	e8 52 47 00 00       	call   80107fdd <seginit>
  lapicinit();
...
801038ab:	c7 04 24 ab 94 10 80 	movl   $0x801094ab,(%esp)
801038b2:	e8 ea ca ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801038b7:	e8 a3 36 00 00       	call   80106f5f <idtinit>
...
801038d7:	e8 94 17 00 00       	call   80105070 <scheduler>
...
80103909:	e8 07 1f 00 00       	call   80105815 <memmove>
...
80103a97:	00 
80103a98:	c7 44 24 04 bc 94 10 	movl   $0x801094bc,0x4(%esp)
80103a9f:	80 
80103aa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103aa3:	89 04 24             	mov    %eax,(%esp)
80103aa6:	e8 0e 1d 00 00       	call   801057b9 <memcmp>
...
80103bd8:	00 
80103bd9:	c7 44 24 04 c1 94 10 	movl   $0x801094c1,0x4(%esp)
80103be0:	80 
80103be1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103be4:	89 04 24             	mov    %eax,(%esp)
80103be7:	e8 cd 1b 00 00       	call   801057b9 <memcmp>
...
80103cb2:	8b 04 85 04 95 10 80 	mov    -0x7fef6afc(,%eax,4),%eax
...
80103ceb:	c7 04 24 c6 94 10 80 	movl   $0x801094c6,(%esp)
...
80103d7e:	c7 04 24 e4 94 10 80 	movl   $0x801094e4,(%esp)
...
80104083:	c7 44 24 04 18 95 10 	movl   $0x80109518,0x4(%esp)
8010408a:	80 
8010408b:	89 04 24             	mov    %eax,(%esp)
8010408e:	e8 3f 14 00 00       	call   801054d2 <initlock>
  (*f0)->type = FD_PIPE;
...
8010413b:	e8 b3 13 00 00       	call   801054f3 <acquire>
  if(writable){
...
8010415e:	e8 67 11 00 00       	call   801052ca <wakeup>
...
8010417d:	e8 48 11 00 00       	call   801052ca <wakeup>
  }
...
801041a2:	e8 ae 13 00 00       	call   80105555 <release>
    kfree((char*)p);
...
801041ba:	e8 96 13 00 00       	call   80105555 <release>
}
801041bf:	c9                   	leave  
801041c0:	c3                   	ret    
...
801041ce:	e8 20 13 00 00       	call   801054f3 <acquire>
  for(i = 0; i < n; i++){
...
801041ff:	e8 51 13 00 00       	call   80105555 <release>
        return -1;
...
80104219:	e8 ac 10 00 00       	call   801052ca <wakeup>
...
80104231:	e8 98 0f 00 00       	call   801051ce <sleep>
...
80104298:	e8 2d 10 00 00       	call   801052ca <wakeup>
  release(&p->lock);
8010429d:	8b 45 08             	mov    0x8(%ebp),%eax
801042a0:	89 04 24             	mov    %eax,(%esp)
801042a3:	e8 ad 12 00 00       	call   80105555 <release>
  return n;
...
801042be:	e8 30 12 00 00       	call   801054f3 <acquire>
...
801042d8:	e8 78 12 00 00       	call   80105555 <release>
      return -1;
...
801042fa:	e8 cf 0e 00 00       	call   801051ce <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
8010438a:	e8 3b 0f 00 00       	call   801052ca <wakeup>
  release(&p->lock);
8010438f:	8b 45 08             	mov    0x8(%ebp),%eax
80104392:	89 04 24             	mov    %eax,(%esp)
80104395:	e8 bb 11 00 00       	call   80105555 <release>
  return i;
...
801043c5:	c7 44 24 04 20 95 10 	movl   $0x80109520,0x4(%esp)
801043cc:	80 
801043cd:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801043d4:	e8 f9 10 00 00       	call   801054d2 <initlock>
...
801043e8:	e8 c9 4b 00 00       	call   80108fb6 <init_linkedList>
	#endif
}
801043ed:	c9                   	leave  
801043ee:	c3                   	ret    
...
801043fc:	e8 f2 10 00 00       	call   801054f3 <acquire>
...
8010442b:	e8 25 11 00 00       	call   80105555 <release>
  return 0;
...
8010447c:	e8 d4 10 00 00       	call   80105555 <release>
...
801044c6:	ba a0 6d 10 80       	mov    $0x80106da0,%edx
...
801044f6:	e8 47 12 00 00       	call   80105742 <memset>
  p->context->eip = (uint)forkret;
801044fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044fe:	8b 40 20             	mov    0x20(%eax),%eax
80104501:	ba a2 51 10 80       	mov    $0x801051a2,%edx
...
80104524:	e8 54 40 00 00       	call   8010857d <setupkvm>
...
80104539:	c7 04 24 27 95 10 80 	movl   $0x80109527,(%esp)
...
8010455f:	e8 71 42 00 00       	call   801087d5 <inituvm>
  p->sz = PGSIZE;
...
80104586:	e8 b7 11 00 00       	call   80105742 <memset>
...
801045ff:	00 
80104600:	c7 44 24 04 40 95 10 	movl   $0x80109540,0x4(%esp)
80104607:	80 
80104608:	89 04 24             	mov    %eax,(%esp)
8010460b:	e8 62 13 00 00       	call   80105972 <safestrcpy>
  p->cwd = namei("/");
80104610:	c7 04 24 49 95 10 80 	movl   $0x80109549,(%esp)
...
80104633:	e8 bb 0e 00 00       	call   801054f3 <acquire>
...
8010465f:	e8 f1 0e 00 00       	call   80105555 <release>
  #endif
...
8010469c:	e8 ae 42 00 00       	call   8010894f <allocuvm>
...
801046d6:	e8 4e 43 00 00       	call   80108a29 <deallocuvm>
...
801046ff:	e8 6a 3f 00 00       	call   8010866e <switchuvm>
  return 0;
...
80104744:	e8 70 44 00 00       	call   80108bb9 <copyuvm>
...
8010484b:	e8 22 11 00 00       	call   80105972 <safestrcpy>
...
8010488b:	e8 63 0c 00 00       	call   801054f3 <acquire>
  np->state = RUNNABLE;
...
801048be:	e8 92 0c 00 00       	call   80105555 <release>
...
801048e2:	75 0c                	jne    801048f0 <exit+0x22>
    panic("init exiting");
801048e4:	c7 04 24 4b 95 10 80 	movl   $0x8010954b,(%esp)
...
80104972:	e8 7c 0b 00 00       	call   801054f3 <acquire>
...
801049a4:	e8 c0 08 00 00       	call   80105269 <wakeup1>
...
801049e1:	e8 83 08 00 00       	call   80105269 <wakeup1>
  wakeup1(proc->parent);
//  cprintf("\n This is your captin speaking, here is : %s \n", ptable.proc[SHELL_PID].name);
...
801049fc:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104a03:	e8 81 06 00 00       	call   80105089 <sched>
  panic("zombie exit");
80104a08:	c7 04 24 58 95 10 80 	movl   $0x80109558,(%esp)
...
80104a44:	e8 9c 40 00 00       	call   80108ae5 <freevm>
    p->state = UNUSED;
...
80104ae5:	e8 09 0a 00 00       	call   801054f3 <acquire>
  for(;;){
...
80104b45:	e8 0b 0a 00 00       	call   80105555 <release>
...
80104b7a:	e8 d6 09 00 00       	call   80105555 <release>
      return -1;
...
80104b97:	e8 32 06 00 00       	call   801051ce <sleep>
  }
...
80104bed:	e8 63 09 00 00       	call   80105555 <release>
...
80104c19:	e8 b0 05 00 00       	call   801051ce <sleep>
  }
...
80104c2d:	e8 c1 08 00 00       	call   801054f3 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
...
80104ca6:	e8 aa 08 00 00       	call   80105555 <release>
...
80104ce4:	e8 6c 08 00 00       	call   80105555 <release>
      return -1;
...
80104d0f:	e8 ba 04 00 00       	call   801051ce <sleep>
			break;
80104d14:	90                   	nop
			release(&ptable.lock);
			return -1;
...
80104d21:	e8 2f 08 00 00       	call   80105555 <release>
			return -1;
...
80104d34:	e8 1c 08 00 00       	call   80105555 <release>
			return -1;
...
80104d4d:	e8 a1 07 00 00       	call   801054f3 <acquire>
	  for(;;){
	    // Scan through table looking for zombie children.
	    havekids = 0;
...
80104d60:	eb 73                	jmp    80104dd5 <wait_stat+0x95>
	      if(p->parent != proc)
80104d62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d65:	8b 50 18             	mov    0x18(%eax),%edx
80104d68:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d6e:	39 c2                	cmp    %eax,%edx
80104d70:	75 5b                	jne    80104dcd <wait_stat+0x8d>
	        continue;
	      havekids = 1;
80104d72:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
	      if(p->state == ZOMBIE){
80104d79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d7c:	8b 40 0c             	mov    0xc(%eax),%eax
80104d7f:	83 f8 05             	cmp    $0x5,%eax
80104d82:	75 4a                	jne    80104dce <wait_stat+0x8e>
	        // Found one.
	    	*wtime = p->retime;
80104d84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d87:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
80104d8d:	8b 45 08             	mov    0x8(%ebp),%eax
80104d90:	89 10                	mov    %edx,(%eax)
	    	*rtime = p->rutime;
80104d92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d95:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
80104d9b:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d9e:	89 10                	mov    %edx,(%eax)
	    	*iotime = p->stime;
80104da0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da3:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
80104da9:	8b 45 10             	mov    0x10(%ebp),%eax
80104dac:	89 10                	mov    %edx,(%eax)

	        pid = clean_proc_entry(p);
80104dae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104db1:	89 04 24             	mov    %eax,(%esp)
80104db4:	e8 5b fc ff ff       	call   80104a14 <clean_proc_entry>
80104db9:	89 45 ec             	mov    %eax,-0x14(%ebp)
	     ...
	     //   }
	        ...
	        release(&ptable.lock);
80104dbc:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104dc3:	e8 8d 07 00 00       	call   80105555 <release>

	        return pid;
80104dc8:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104dcb:	eb 52                	jmp    80104e1f <wait_stat+0xdf>
	  for(;;){
	    // Scan through table looking for zombie children.
	    havekids = 0;
	    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104dcd:	90                   	nop
	  ...
	  for(;;){
	    ...
	    havekids = 0;
	    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104dce:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
80104dd5:	81 7d f4 14 68 11 80 	cmpl   $0x80116814,-0xc(%ebp)
80104ddc:	72 84                	jb     80104d62 <wait_stat+0x22>
	        return pid;
	      }
	    }
	    ...
	    // No point waiting if we don't have any children.
	    if(!havekids || proc->killed){
80104dde:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104de2:	74 0d                	je     80104df1 <wait_stat+0xb1>
80104de4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104dea:	8b 40 28             	mov    0x28(%eax),%eax
80104ded:	85 c0                	test   %eax,%eax
80104def:	74 13                	je     80104e04 <wait_stat+0xc4>
	      release(&ptable.lock);
80104df1:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104df8:	e8 58 07 00 00       	call   80105555 <release>
	      return -1;
80104dfd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e02:	eb 1b                	jmp    80104e1f <wait_stat+0xdf>
	    }

	    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
	    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104e04:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e0a:	c7 44 24 04 e0 3f 11 	movl   $0x80113fe0,0x4(%esp)
80104e11:	80 
80104e12:	89 04 24             	mov    %eax,(%esp)
80104e15:	e8 b4 03 00 00       	call   801051ce <sleep>
	  }
80104e1a:	e9 33 ff ff ff       	jmp    80104d52 <wait_stat+0x12>
}
80104e1f:	c9                   	leave  
80104e20:	c3                   	ret    
...
80104e24:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct proc* p;
	int pids[64];
	int counter = 0;
...
//	int i, status;
	int i;
	int retVal = -1;
80104e31:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)

	//cprintf("called fg with gid: %d \n", gid);
	acquire(&ptable.lock);
80104e38:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104e3f:	e8 af 06 00 00       	call   801054f3 <acquire>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e44:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104e4b:	eb 60                	jmp    80104ead <foreground+0x8c>
			if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104e4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e50:	8b 40 0c             	mov    0xc(%eax),%eax
80104e53:	83 f8 04             	cmp    $0x4,%eax
80104e56:	74 16                	je     80104e6e <foreground+0x4d>
80104e58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e5b:	8b 40 0c             	mov    0xc(%eax),%eax
80104e5e:	83 f8 03             	cmp    $0x3,%eax
80104e61:	74 0b                	je     80104e6e <foreground+0x4d>
80104e63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e66:	8b 40 0c             	mov    0xc(%eax),%eax
80104e69:	83 f8 02             	cmp    $0x2,%eax
80104e6c:	75 38                	jne    80104ea6 <foreground+0x85>
				(p->parent == initproc) &&
80104e6e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e71:	8b 50 18             	mov    0x18(%eax),%edx
80104e74:	a1 80 c6 10 80       	mov    0x8010c680,%eax
	int retVal = -1;
...
80104e7b:	75 29                	jne    80104ea6 <foreground+0x85>
				(p->parent == initproc) &&
				(p->gid == gid) )
...
80104e86:	75 1e                	jne    80104ea6 <foreground+0x85>
				(p->gid == gid) )
			{
				p->parent = &ptable.proc[1]; //parent = shell
80104e88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e8b:	c7 40 18 b4 40 11 80 	movl   $0x801140b4,0x18(%eax)
				pids[counter] = p->pid;
80104e92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e95:	8b 50 10             	mov    0x10(%eax),%edx
80104e98:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e9b:	89 94 85 e8 fe ff ff 	mov    %edx,-0x118(%ebp,%eax,4)
				counter++;
80104ea2:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
	int i;
	int retVal = -1;
	...
	acquire(&ptable.lock);
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ea6:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
80104ead:	81 7d f4 14 68 11 80 	cmpl   $0x80116814,-0xc(%ebp)
80104eb4:	72 97                	jb     80104e4d <foreground+0x2c>
				p->parent = &ptable.proc[1]; //parent = shell
				pids[counter] = p->pid;
				counter++;
			}
...
80104ebd:	eb 22                	jmp    80104ee1 <foreground+0xc0>
		//cprintf("**waiting for: %d \n ",pids[i]);
		if (shellWait(pids[i]) != -1)	retVal = 1;
80104ebf:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ec2:	8b 84 85 e8 fe ff ff 	mov    -0x118(%ebp,%eax,4),%eax
80104ec9:	89 04 24             	mov    %eax,(%esp)
80104ecc:	e8 d2 fc ff ff       	call   80104ba3 <shellWait>
80104ed1:	83 f8 ff             	cmp    $0xffffffff,%eax
80104ed4:	74 07                	je     80104edd <foreground+0xbc>
80104ed6:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
	...
	for(i=0; i < counter; i++){
80104edd:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
80104ee1:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ee4:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80104ee7:	7c d6                	jl     80104ebf <foreground+0x9e>
		//cprintf("**waiting for: %d \n ",pids[i]);
		if (shellWait(pids[i]) != -1)	retVal = 1;
	}
	release(&ptable.lock);
80104ee9:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104ef0:	e8 60 06 00 00       	call   80105555 <release>
		cprintf("**waiting for: %d \n ",pids[i]);
	...
	*/
	...
	return retVal;
80104ef5:	8b 45 e8             	mov    -0x18(%ebp),%eax
}
80104ef8:	c9                   	leave  
80104ef9:	c3                   	ret    

80104efa <set_priority>:
...
80104f07:	83 ec 28             	sub    $0x28,%esp
	struct proc* p;
	int i = 0;
80104f0a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
//	  head->id = 18;
//	  head->data = 0;
//
//	  add_last(&plist,head);
//	plist.print(&plist);
	acquire(&ptable.lock);
80104f11:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104f18:	e8 d6 05 00 00       	call   801054f3 <acquire>
//		j++;
//	}
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f1d:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104f24:	eb 7c                	jmp    80104fa2 <list_pgroup+0x9e>
		if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104f26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f29:	8b 40 0c             	mov    0xc(%eax),%eax
80104f2c:	83 f8 04             	cmp    $0x4,%eax
80104f2f:	74 16                	je     80104f47 <list_pgroup+0x43>
80104f31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f34:	8b 40 0c             	mov    0xc(%eax),%eax
80104f37:	83 f8 03             	cmp    $0x3,%eax
80104f3a:	74 0b                	je     80104f47 <list_pgroup+0x43>
80104f3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f3f:	8b 40 0c             	mov    0xc(%eax),%eax
80104f42:	83 f8 02             	cmp    $0x2,%eax
80104f45:	75 54                	jne    80104f9b <list_pgroup+0x97>
			p->gid == gid ){
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
		if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104f4d:	3b 45 08             	cmp    0x8(%ebp),%eax
80104f50:	75 49                	jne    80104f9b <list_pgroup+0x97>
			p->gid == gid ){

			arr[i].pid = p->pid;
80104f52:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104f55:	89 d0                	mov    %edx,%eax
80104f57:	c1 e0 02             	shl    $0x2,%eax
80104f5a:	01 d0                	add    %edx,%eax
80104f5c:	c1 e0 02             	shl    $0x2,%eax
80104f5f:	03 45 0c             	add    0xc(%ebp),%eax
80104f62:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104f65:	8b 52 10             	mov    0x10(%edx),%edx
80104f68:	89 10                	mov    %edx,(%eax)
			safestrcpy(arr[i].name, p->name, sizeof(arr[i].name));
80104f6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f6d:	8d 48 70             	lea    0x70(%eax),%ecx
80104f70:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104f73:	89 d0                	mov    %edx,%eax
80104f75:	c1 e0 02             	shl    $0x2,%eax
80104f78:	01 d0                	add    %edx,%eax
80104f7a:	c1 e0 02             	shl    $0x2,%eax
80104f7d:	03 45 0c             	add    0xc(%ebp),%eax
80104f80:	83 c0 04             	add    $0x4,%eax
80104f83:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104f8a:	00 
80104f8b:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104f8f:	89 04 24             	mov    %eax,(%esp)
80104f92:	e8 db 09 00 00       	call   80105972 <safestrcpy>
			i++;
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f9b:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
80104fa2:	81 7d f4 14 68 11 80 	cmpl   $0x80116814,-0xc(%ebp)
80104fa9:	0f 82 77 ff ff ff    	jb     80104f26 <list_pgroup+0x22>
		}
	}
...
80104fb5:	89 10                	mov    %edx,(%eax)
	release(&ptable.lock);
80104fb7:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104fbe:	e8 92 05 00 00       	call   80105555 <release>
...
80104fcd:	83 ec 28             	sub    $0x28,%esp
	  struct proc *p;

	  for(;;){
	    // Enable interrupts on this processor.
	    sti();
80104fd0:	e8 e4 f3 ff ff       	call   801043b9 <sti>

	    acquire(&ptable.lock);
80104fd5:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104fdc:	e8 12 05 00 00       	call   801054f3 <acquire>
	    if (plist.size)
80104fe1:	a1 a8 c6 10 80       	mov    0x8010c6a8,%eax
80104fe6:	85 c0                	test   %eax,%eax
80104fe8:	74 75                	je     8010505f <scheduler_frr_fcfs+0x95>
	    {
			  p = plist.remove_first(&plist);
80104fea:	a1 b8 cc 10 80       	mov    0x8010ccb8,%eax
80104fef:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80104ff6:	ff d0                	call   *%eax
80104ff8:	89 45 f4             	mov    %eax,-0xc(%ebp)
			  if(p->state != RUNNABLE){
80104ffb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ffe:	8b 40 0c             	mov    0xc(%eax),%eax
80105001:	83 f8 03             	cmp    $0x3,%eax
80105004:	74 0c                	je     80105012 <scheduler_frr_fcfs+0x48>
				  cprintf("ERROR: linkedlist contains a proc which is not RUNNABLE");
80105006:	c7 04 24 64 95 10 80 	movl   $0x80109564,(%esp)
8010500d:	e8 8f b3 ff ff       	call   801003a1 <cprintf>
			  }
...
80105015:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
			  switchuvm(p);
8010501b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010501e:	89 04 24             	mov    %eax,(%esp)
80105021:	e8 48 36 00 00       	call   8010866e <switchuvm>
			  p->state = RUNNING;
80105026:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105029:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
			  swtch(&cpu->scheduler, proc->context);
80105030:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105036:	8b 40 20             	mov    0x20(%eax),%eax
80105039:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105040:	83 c2 04             	add    $0x4,%edx
80105043:	89 44 24 04          	mov    %eax,0x4(%esp)
80105047:	89 14 24             	mov    %edx,(%esp)
8010504a:	e8 99 09 00 00       	call   801059e8 <swtch>
			  switchkvm();
8010504f:	e8 fd 35 00 00       	call   80108651 <switchkvm>

			  // Process is done running for now.
			  // It should have changed its p->state before coming back.
			  proc = 0;
80105054:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
8010505b:	00 00 00 00 
	    }
	    release(&ptable.lock);
8010505f:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105066:	e8 ea 04 00 00       	call   80105555 <release>

	  }
8010506b:	e9 60 ff ff ff       	jmp    80104fd0 <scheduler_frr_fcfs+0x6>
...
80105076:	c7 04 24 9c 95 10 80 	movl   $0x8010959c,(%esp)
8010507d:	e8 1f b3 ff ff       	call   801003a1 <cprintf>
		scheduler_frr_fcfs();
80105082:	e8 43 ff ff ff       	call   80104fca <scheduler_frr_fcfs>
	#else
...
80105087:	eb fe                	jmp    80105087 <scheduler+0x17>
...
8010508f:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105096:	e8 76 05 00 00       	call   80105611 <holding>
8010509b:	85 c0                	test   %eax,%eax
8010509d:	75 0c                	jne    801050ab <sched+0x22>
    panic("sched ptable.lock");
8010509f:	c7 04 24 ad 95 10 80 	movl   $0x801095ad,(%esp)
801050a6:	e8 92 b4 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
801050ab:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050b1:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050b7:	83 f8 01             	cmp    $0x1,%eax
801050ba:	74 0c                	je     801050c8 <sched+0x3f>
    panic("sched locks");
801050bc:	c7 04 24 bf 95 10 80 	movl   $0x801095bf,(%esp)
801050c3:	e8 75 b4 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
801050c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050ce:	8b 40 0c             	mov    0xc(%eax),%eax
801050d1:	83 f8 04             	cmp    $0x4,%eax
801050d4:	75 0c                	jne    801050e2 <sched+0x59>
    panic("sched running");
801050d6:	c7 04 24 cb 95 10 80 	movl   $0x801095cb,(%esp)
801050dd:	e8 5b b4 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
801050e2:	e8 bd f2 ff ff       	call   801043a4 <readeflags>
801050e7:	25 00 02 00 00       	and    $0x200,%eax
801050ec:	85 c0                	test   %eax,%eax
801050ee:	74 0c                	je     801050fc <sched+0x73>
    panic("sched interruptible");
801050f0:	c7 04 24 d9 95 10 80 	movl   $0x801095d9,(%esp)
801050f7:	e8 41 b4 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
801050fc:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105102:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105108:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
8010510b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105111:	8b 40 04             	mov    0x4(%eax),%eax
80105114:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010511b:	83 c2 20             	add    $0x20,%edx
8010511e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105122:	89 14 24             	mov    %edx,(%esp)
80105125:	e8 be 08 00 00       	call   801059e8 <swtch>
  cpu->intena = intena;
8010512a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105130:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105133:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105139:	c9                   	leave  
8010513a:	c3                   	ret    
...
80105141:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105148:	e8 a6 03 00 00       	call   801054f3 <acquire>
#if defined(FRR) || defined(FCFS)
  if(proc->state != RUNNABLE) plist.add(&plist, proc->pid, proc); //todo ifdef
8010514d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105153:	8b 40 0c             	mov    0xc(%eax),%eax
80105156:	83 f8 03             	cmp    $0x3,%eax
80105159:	74 27                	je     80105182 <yield+0x47>
8010515b:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
80105161:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105168:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010516e:	8b 40 10             	mov    0x10(%eax),%eax
80105171:	89 54 24 08          	mov    %edx,0x8(%esp)
80105175:	89 44 24 04          	mov    %eax,0x4(%esp)
80105179:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80105180:	ff d1                	call   *%ecx
#endif
  proc->state = RUNNABLE;
...
80105188:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  sched();
8010518f:	e8 f5 fe ff ff       	call   80105089 <sched>
  release(&ptable.lock);
80105194:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
8010519b:	e8 b5 03 00 00       	call   80105555 <release>
}
801051a0:	c9                   	leave  
801051a1:	c3                   	ret    
...
801051a5:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801051a8:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801051af:	e8 a1 03 00 00       	call   80105555 <release>

  if (first) {
801051b4:	a1 20 c0 10 80       	mov    0x8010c020,%eax
801051b9:	85 c0                	test   %eax,%eax
801051bb:	74 0f                	je     801051cc <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801051bd:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
801051c4:	00 00 00 
    initlog();
801051c7:	e8 e4 e0 ff ff       	call   801032b0 <initlog>
  }
...
801051d1:	83 ec 18             	sub    $0x18,%esp
  if(proc == 0)
801051d4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051da:	85 c0                	test   %eax,%eax
801051dc:	75 0c                	jne    801051ea <sleep+0x1c>
    panic("sleep");
801051de:	c7 04 24 ed 95 10 80 	movl   $0x801095ed,(%esp)
801051e5:	e8 53 b3 ff ff       	call   8010053d <panic>

  if(lk == 0)
801051ea:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801051ee:	75 0c                	jne    801051fc <sleep+0x2e>
    panic("sleep without lk");
801051f0:	c7 04 24 f3 95 10 80 	movl   $0x801095f3,(%esp)
801051f7:	e8 41 b3 ff ff       	call   8010053d <panic>
...
801051fc:	81 7d 0c e0 3f 11 80 	cmpl   $0x80113fe0,0xc(%ebp)
80105203:	74 17                	je     8010521c <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105205:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
8010520c:	e8 e2 02 00 00       	call   801054f3 <acquire>
    release(lk);
80105211:	8b 45 0c             	mov    0xc(%ebp),%eax
80105214:	89 04 24             	mov    %eax,(%esp)
80105217:	e8 39 03 00 00       	call   80105555 <release>
  }

  // Go to sleep.
  proc->chan = chan;
8010521c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105222:	8b 55 08             	mov    0x8(%ebp),%edx
80105225:	89 50 24             	mov    %edx,0x24(%eax)
  proc->state = SLEEPING;
80105228:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010522e:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80105235:	e8 4f fe ff ff       	call   80105089 <sched>

  // Tidy up.
  proc->chan = 0;
8010523a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105240:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80105247:	81 7d 0c e0 3f 11 80 	cmpl   $0x80113fe0,0xc(%ebp)
8010524e:	74 17                	je     80105267 <sleep+0x99>
    release(&ptable.lock);
80105250:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105257:	e8 f9 02 00 00       	call   80105555 <release>
    acquire(lk);
8010525c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010525f:	89 04 24             	mov    %eax,(%esp)
80105262:	e8 8c 02 00 00       	call   801054f3 <acquire>
  }
}
80105267:	c9                   	leave  
80105268:	c3                   	ret    
...
8010526c:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010526f:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80105276:	eb 47                	jmp    801052bf <wakeup1+0x56>
    if(p->state == SLEEPING && p->chan == chan){
80105278:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010527b:	8b 40 0c             	mov    0xc(%eax),%eax
8010527e:	83 f8 02             	cmp    $0x2,%eax
80105281:	75 35                	jne    801052b8 <wakeup1+0x4f>
80105283:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105286:	8b 40 24             	mov    0x24(%eax),%eax
80105289:	3b 45 08             	cmp    0x8(%ebp),%eax
8010528c:	75 2a                	jne    801052b8 <wakeup1+0x4f>
        p->state = RUNNABLE;
8010528e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105291:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
		#if defined(FRR) || defined(FCFS)
        	plist.add(&plist,p->pid, p); //todo ifdef
80105298:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
8010529e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052a1:	8b 40 10             	mov    0x10(%eax),%eax
801052a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052a7:	89 54 24 08          	mov    %edx,0x8(%esp)
801052ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801052af:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801052b6:	ff d1                	call   *%ecx
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801052b8:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
801052bf:	81 7d f4 14 68 11 80 	cmpl   $0x80116814,-0xc(%ebp)
801052c6:	72 b0                	jb     80105278 <wakeup1+0xf>
        p->state = RUNNABLE;
		#if defined(FRR) || defined(FCFS)
        	plist.add(&plist,p->pid, p); //todo ifdef
		#endif
...
801052cd:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
801052d0:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801052d7:	e8 17 02 00 00       	call   801054f3 <acquire>
  wakeup1(chan);
801052dc:	8b 45 08             	mov    0x8(%ebp),%eax
801052df:	89 04 24             	mov    %eax,(%esp)
801052e2:	e8 82 ff ff ff       	call   80105269 <wakeup1>
  release(&ptable.lock);
801052e7:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801052ee:	e8 62 02 00 00       	call   80105555 <release>
}
801052f3:	c9                   	leave  
801052f4:	c3                   	ret    
...
801052f8:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801052fb:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105302:	e8 ec 01 00 00       	call   801054f3 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105307:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
8010530e:	eb 64                	jmp    80105374 <kill+0x7f>
    if(p->pid == pid){
80105310:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105313:	8b 40 10             	mov    0x10(%eax),%eax
80105316:	3b 45 08             	cmp    0x8(%ebp),%eax
80105319:	75 52                	jne    8010536d <kill+0x78>
      p->killed = 1;
8010531b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010531e:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING){
80105325:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105328:	8b 40 0c             	mov    0xc(%eax),%eax
8010532b:	83 f8 02             	cmp    $0x2,%eax
8010532e:	75 2a                	jne    8010535a <kill+0x65>
        p->state = RUNNABLE;
80105330:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105333:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
		#if defined(FRR) || defined(FCFS)
        	plist.add(&plist,p->pid,p); //todo ifdef
8010533a:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
80105340:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105343:	8b 40 10             	mov    0x10(%eax),%eax
80105346:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105349:	89 54 24 08          	mov    %edx,0x8(%esp)
8010534d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105351:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80105358:	ff d1                	call   *%ecx
		#endif
      }
      release(&ptable.lock);
8010535a:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105361:	e8 ef 01 00 00       	call   80105555 <release>
      return 0;
80105366:	b8 00 00 00 00       	mov    $0x0,%eax
8010536b:	eb 21                	jmp    8010538e <kill+0x99>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010536d:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
80105374:	81 7d f4 14 68 11 80 	cmpl   $0x80116814,-0xc(%ebp)
8010537b:	72 93                	jb     80105310 <kill+0x1b>
      }
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
8010537d:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105384:	e8 cc 01 00 00       	call   80105555 <release>
  return -1;
...
80105393:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105396:	c7 45 f0 14 40 11 80 	movl   $0x80114014,-0x10(%ebp)
8010539d:	e9 db 00 00 00       	jmp    8010547d <procdump+0xed>
    if(p->state == UNUSED)
801053a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053a5:	8b 40 0c             	mov    0xc(%eax),%eax
801053a8:	85 c0                	test   %eax,%eax
801053aa:	0f 84 c5 00 00 00    	je     80105475 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801053b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053b3:	8b 40 0c             	mov    0xc(%eax),%eax
801053b6:	83 f8 05             	cmp    $0x5,%eax
801053b9:	77 23                	ja     801053de <procdump+0x4e>
801053bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053be:	8b 40 0c             	mov    0xc(%eax),%eax
801053c1:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801053c8:	85 c0                	test   %eax,%eax
801053ca:	74 12                	je     801053de <procdump+0x4e>
      state = states[p->state];
801053cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053cf:	8b 40 0c             	mov    0xc(%eax),%eax
801053d2:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801053d9:	89 45 ec             	mov    %eax,-0x14(%ebp)
801053dc:	eb 07                	jmp    801053e5 <procdump+0x55>
    else
      state = "???";
801053de:	c7 45 ec 04 96 10 80 	movl   $0x80109604,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
801053e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053e8:	8d 50 70             	lea    0x70(%eax),%edx
801053eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053ee:	8b 40 10             	mov    0x10(%eax),%eax
801053f1:	89 54 24 0c          	mov    %edx,0xc(%esp)
801053f5:	8b 55 ec             	mov    -0x14(%ebp),%edx
801053f8:	89 54 24 08          	mov    %edx,0x8(%esp)
801053fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105400:	c7 04 24 08 96 10 80 	movl   $0x80109608,(%esp)
80105407:	e8 95 af ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
8010540c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010540f:	8b 40 0c             	mov    0xc(%eax),%eax
80105412:	83 f8 02             	cmp    $0x2,%eax
80105415:	75 50                	jne    80105467 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105417:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010541a:	8b 40 20             	mov    0x20(%eax),%eax
8010541d:	8b 40 0c             	mov    0xc(%eax),%eax
80105420:	83 c0 08             	add    $0x8,%eax
80105423:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80105426:	89 54 24 04          	mov    %edx,0x4(%esp)
8010542a:	89 04 24             	mov    %eax,(%esp)
8010542d:	e8 72 01 00 00       	call   801055a4 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105432:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105439:	eb 1b                	jmp    80105456 <procdump+0xc6>
        cprintf(" %p", pc[i]);
8010543b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010543e:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105442:	89 44 24 04          	mov    %eax,0x4(%esp)
80105446:	c7 04 24 11 96 10 80 	movl   $0x80109611,(%esp)
8010544d:	e8 4f af ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80105452:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105456:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
8010545a:	7f 0b                	jg     80105467 <procdump+0xd7>
8010545c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010545f:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105463:	85 c0                	test   %eax,%eax
80105465:	75 d4                	jne    8010543b <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105467:	c7 04 24 15 96 10 80 	movl   $0x80109615,(%esp)
8010546e:	e8 2e af ff ff       	call   801003a1 <cprintf>
80105473:	eb 01                	jmp    80105476 <procdump+0xe6>
  char *state;
  uint pc[10];
...
8010547d:	81 7d f0 14 68 11 80 	cmpl   $0x80116814,-0x10(%ebp)
80105484:	0f 82 18 ff ff ff    	jb     801053a2 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80105493:	9c                   	pushf  
80105494:	5b                   	pop    %ebx
80105495:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
801054b7:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
801054ba:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
801054c1:	f0 87 02             	lock xchg %eax,(%edx)
...
801054c6:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               ...
               "cc");
  return result;
801054c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
801054db:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801054de:	8b 45 08             	mov    0x8(%ebp),%eax
801054e1:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801054e7:	8b 45 08             	mov    0x8(%ebp),%eax
801054ea:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801054f1:	5d                   	pop    %ebp
801054f2:	c3                   	ret    
...
801054f9:	e8 3d 01 00 00       	call   8010563b <pushcli>
  if(holding(lk))
801054fe:	8b 45 08             	mov    0x8(%ebp),%eax
80105501:	89 04 24             	mov    %eax,(%esp)
80105504:	e8 08 01 00 00       	call   80105611 <holding>
80105509:	85 c0                	test   %eax,%eax
8010550b:	74 0c                	je     80105519 <acquire+0x26>
    panic("acquire");
8010550d:	c7 04 24 41 96 10 80 	movl   $0x80109641,(%esp)
80105514:	e8 24 b0 ff ff       	call   8010053d <panic>
...
80105528:	e8 80 ff ff ff       	call   801054ad <xchg>
8010552d:	85 c0                	test   %eax,%eax
8010552f:	75 e9                	jne    8010551a <acquire+0x27>
    ;
...
80105561:	e8 ab 00 00 00       	call   80105611 <holding>
80105566:	85 c0                	test   %eax,%eax
80105568:	75 0c                	jne    80105576 <release+0x21>
    panic("release");
8010556a:	c7 04 24 49 96 10 80 	movl   $0x80109649,(%esp)
...
80105598:	e8 10 ff ff ff       	call   801054ad <xchg>

  popcli();
8010559d:	e8 e1 00 00 00       	call   80105683 <popcli>
}
801055a2:	c9                   	leave  
801055a3:	c3                   	ret    
...
801055ba:	eb 32                	jmp    801055ee <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801055bc:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801055c0:	74 47                	je     80105609 <getcallerpcs+0x65>
801055c2:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801055c9:	76 3e                	jbe    80105609 <getcallerpcs+0x65>
801055cb:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801055cf:	74 38                	je     80105609 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801055d1:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055d4:	c1 e0 02             	shl    $0x2,%eax
801055d7:	03 45 0c             	add    0xc(%ebp),%eax
801055da:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055dd:	8b 52 04             	mov    0x4(%edx),%edx
...
801055e7:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801055ea:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801055ee:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801055f2:	7e c8                	jle    801055bc <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801055f4:	eb 13                	jmp    80105609 <getcallerpcs+0x65>
    pcs[i] = 0;
801055f6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055f9:	c1 e0 02             	shl    $0x2,%eax
801055fc:	03 45 0c             	add    0xc(%ebp),%eax
801055ff:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80105609:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010560d:	7e e7                	jle    801055f6 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010560f:	c9                   	leave  
80105610:	c3                   	ret    
...
8010561b:	74 17                	je     80105634 <holding+0x23>
8010561d:	8b 45 08             	mov    0x8(%ebp),%eax
80105620:	8b 50 08             	mov    0x8(%eax),%edx
80105623:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105629:	39 c2                	cmp    %eax,%edx
8010562b:	75 07                	jne    80105634 <holding+0x23>
8010562d:	b8 01 00 00 00       	mov    $0x1,%eax
80105632:	eb 05                	jmp    80105639 <holding+0x28>
...
8010563e:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105641:	e8 46 fe ff ff       	call   8010548c <readeflags>
80105646:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105649:	e8 53 fe ff ff       	call   801054a1 <cli>
  if(cpu->ncli++ == 0)
8010564e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105654:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010565a:	85 d2                	test   %edx,%edx
8010565c:	0f 94 c1             	sete   %cl
8010565f:	83 c2 01             	add    $0x1,%edx
80105662:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105668:	84 c9                	test   %cl,%cl
8010566a:	74 15                	je     80105681 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
8010566c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105672:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105675:	81 e2 00 02 00 00    	and    $0x200,%edx
8010567b:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105681:	c9                   	leave  
80105682:	c3                   	ret    
...
80105686:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105689:	e8 fe fd ff ff       	call   8010548c <readeflags>
8010568e:	25 00 02 00 00       	and    $0x200,%eax
80105693:	85 c0                	test   %eax,%eax
80105695:	74 0c                	je     801056a3 <popcli+0x20>
    panic("popcli - interruptible");
80105697:	c7 04 24 51 96 10 80 	movl   $0x80109651,(%esp)
8010569e:	e8 9a ae ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
801056a3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056a9:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801056af:	83 ea 01             	sub    $0x1,%edx
801056b2:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801056b8:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801056be:	85 c0                	test   %eax,%eax
801056c0:	79 0c                	jns    801056ce <popcli+0x4b>
    panic("popcli");
801056c2:	c7 04 24 68 96 10 80 	movl   $0x80109668,(%esp)
801056c9:	e8 6f ae ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
801056ce:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056d4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801056da:	85 c0                	test   %eax,%eax
801056dc:	75 15                	jne    801056f3 <popcli+0x70>
801056de:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801056e4:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801056ea:	85 c0                	test   %eax,%eax
801056ec:	74 05                	je     801056f3 <popcli+0x70>
    sti();
801056ee:	e8 b4 fd ff ff       	call   801054a7 <sti>
}
801056f3:	c9                   	leave  
801056f4:	c3                   	ret    
...
801056fd:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105700:	8b 55 10             	mov    0x10(%ebp),%edx
80105703:	8b 45 0c             	mov    0xc(%ebp),%eax
80105706:	89 cb                	mov    %ecx,%ebx
80105708:	89 df                	mov    %ebx,%edi
8010570a:	89 d1                	mov    %edx,%ecx
8010570c:	fc                   	cld    
8010570d:	f3 aa                	rep stos %al,%es:(%edi)
8010570f:	89 ca                	mov    %ecx,%edx
80105711:	89 fb                	mov    %edi,%ebx
80105713:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105716:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105722:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105725:	8b 55 10             	mov    0x10(%ebp),%edx
80105728:	8b 45 0c             	mov    0xc(%ebp),%eax
8010572b:	89 cb                	mov    %ecx,%ebx
8010572d:	89 df                	mov    %ebx,%edi
8010572f:	89 d1                	mov    %edx,%ecx
80105731:	fc                   	cld    
80105732:	f3 ab                	rep stos %eax,%es:(%edi)
80105734:	89 ca                	mov    %ecx,%edx
80105736:	89 fb                	mov    %edi,%ebx
80105738:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010573b:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
8010574b:	83 e0 03             	and    $0x3,%eax
8010574e:	85 c0                	test   %eax,%eax
80105750:	75 49                	jne    8010579b <memset+0x59>
80105752:	8b 45 10             	mov    0x10(%ebp),%eax
80105755:	83 e0 03             	and    $0x3,%eax
80105758:	85 c0                	test   %eax,%eax
8010575a:	75 3f                	jne    8010579b <memset+0x59>
    c &= 0xFF;
8010575c:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105763:	8b 45 10             	mov    0x10(%ebp),%eax
80105766:	c1 e8 02             	shr    $0x2,%eax
80105769:	89 c2                	mov    %eax,%edx
8010576b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010576e:	89 c1                	mov    %eax,%ecx
80105770:	c1 e1 18             	shl    $0x18,%ecx
80105773:	8b 45 0c             	mov    0xc(%ebp),%eax
80105776:	c1 e0 10             	shl    $0x10,%eax
80105779:	09 c1                	or     %eax,%ecx
8010577b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010577e:	c1 e0 08             	shl    $0x8,%eax
80105781:	09 c8                	or     %ecx,%eax
80105783:	0b 45 0c             	or     0xc(%ebp),%eax
80105786:	89 54 24 08          	mov    %edx,0x8(%esp)
8010578a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010578e:	8b 45 08             	mov    0x8(%ebp),%eax
80105791:	89 04 24             	mov    %eax,(%esp)
80105794:	e8 84 ff ff ff       	call   8010571d <stosl>
80105799:	eb 19                	jmp    801057b4 <memset+0x72>
  } else
    stosb(dst, c, n);
...
801057af:	e8 44 ff ff ff       	call   801056f8 <stosb>
  return dst;
...
801057c8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801057cb:	eb 32                	jmp    801057ff <memcmp+0x46>
    if(*s1 != *s2)
801057cd:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057d0:	0f b6 10             	movzbl (%eax),%edx
801057d3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057d6:	0f b6 00             	movzbl (%eax),%eax
801057d9:	38 c2                	cmp    %al,%dl
801057db:	74 1a                	je     801057f7 <memcmp+0x3e>
      return *s1 - *s2;
801057dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057e0:	0f b6 00             	movzbl (%eax),%eax
801057e3:	0f b6 d0             	movzbl %al,%edx
801057e6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057e9:	0f b6 00             	movzbl (%eax),%eax
801057ec:	0f b6 c0             	movzbl %al,%eax
801057ef:	89 d1                	mov    %edx,%ecx
801057f1:	29 c1                	sub    %eax,%ecx
801057f3:	89 c8                	mov    %ecx,%eax
801057f5:	eb 1c                	jmp    80105813 <memcmp+0x5a>
    s1++, s2++;
801057f7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057fb:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105803:	0f 95 c0             	setne  %al
80105806:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010580a:	84 c0                	test   %al,%al
8010580c:	75 bf                	jne    801057cd <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
8010582a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010582d:	73 54                	jae    80105883 <memmove+0x6e>
8010582f:	8b 45 10             	mov    0x10(%ebp),%eax
80105832:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105835:	01 d0                	add    %edx,%eax
80105837:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010583a:	76 47                	jbe    80105883 <memmove+0x6e>
    s += n;
8010583c:	8b 45 10             	mov    0x10(%ebp),%eax
8010583f:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105842:	8b 45 10             	mov    0x10(%ebp),%eax
80105845:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105848:	eb 13                	jmp    8010585d <memmove+0x48>
      *--d = *--s;
8010584a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010584e:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105852:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105855:	0f b6 10             	movzbl (%eax),%edx
80105858:	8b 45 f8             	mov    -0x8(%ebp),%eax
...
80105861:	0f 95 c0             	setne  %al
80105864:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105868:	84 c0                	test   %al,%al
8010586a:	75 de                	jne    8010584a <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010586c:	eb 25                	jmp    80105893 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105879:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010587d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105881:	eb 01                	jmp    80105884 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105883:	90                   	nop
80105884:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105888:	0f 95 c0             	setne  %al
8010588b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010588f:	84 c0                	test   %al,%al
80105891:	75 db                	jne    8010586e <memmove+0x59>
      *d++ = *s++;
...
801058b2:	e8 5e ff ff ff       	call   80105815 <memmove>
}
801058b7:	c9                   	leave  
801058b8:	c3                   	ret    
...
801058f5:	eb 18                	jmp    8010590f <strncmp+0x56>
...
80105909:	89 d1                	mov    %edx,%ecx
8010590b:	29 c1                	sub    %eax,%ecx
8010590d:	89 c8                	mov    %ecx,%eax
}
8010590f:	5d                   	pop    %ebp
80105910:	c3                   	ret    
...
8010591a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
8010591d:	90                   	nop
8010591e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105922:	0f 9f c0             	setg   %al
80105925:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105929:	84 c0                	test   %al,%al
8010592b:	74 30                	je     8010595d <strncpy+0x4c>
8010592d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105930:	0f b6 10             	movzbl (%eax),%edx
80105933:	8b 45 08             	mov    0x8(%ebp),%eax
80105936:	88 10                	mov    %dl,(%eax)
80105938:	8b 45 08             	mov    0x8(%ebp),%eax
8010593b:	0f b6 00             	movzbl (%eax),%eax
8010593e:	84 c0                	test   %al,%al
80105940:	0f 95 c0             	setne  %al
80105943:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105947:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010594b:	84 c0                	test   %al,%al
8010594d:	75 cf                	jne    8010591e <strncpy+0xd>
    ;
  while(n-- > 0)
8010594f:	eb 0c                	jmp    8010595d <strncpy+0x4c>
    *s++ = 0;
80105951:	8b 45 08             	mov    0x8(%ebp),%eax
80105954:	c6 00 00             	movb   $0x0,(%eax)
80105957:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010595b:	eb 01                	jmp    8010595e <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
8010595d:	90                   	nop
8010595e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105962:	0f 9f c0             	setg   %al
80105965:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105969:	84 c0                	test   %al,%al
8010596b:	75 e4                	jne    80105951 <strncpy+0x40>
    *s++ = 0;
  return os;
...
8010597b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
8010597e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105982:	7f 05                	jg     80105989 <safestrcpy+0x17>
    return os;
80105984:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105987:	eb 35                	jmp    801059be <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105989:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010598d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105991:	7e 22                	jle    801059b5 <safestrcpy+0x43>
80105993:	8b 45 0c             	mov    0xc(%ebp),%eax
80105996:	0f b6 10             	movzbl (%eax),%edx
80105999:	8b 45 08             	mov    0x8(%ebp),%eax
8010599c:	88 10                	mov    %dl,(%eax)
8010599e:	8b 45 08             	mov    0x8(%ebp),%eax
801059a1:	0f b6 00             	movzbl (%eax),%eax
801059a4:	84 c0                	test   %al,%al
801059a6:	0f 95 c0             	setne  %al
801059a9:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801059ad:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801059b1:	84 c0                	test   %al,%al
801059b3:	75 d4                	jne    80105989 <safestrcpy+0x17>
    ;
  *s = 0;
...
801059cd:	eb 04                	jmp    801059d3 <strlen+0x13>
801059cf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801059d3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059d6:	03 45 08             	add    0x8(%ebp),%eax
801059d9:	0f b6 00             	movzbl (%eax),%eax
801059dc:	84 c0                	test   %al,%al
801059de:	75 ef                	jne    801059cf <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801059e8:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801059ec:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801059f3:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801059f4:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801059f6:	89 d4                	mov    %edx,%esp
...
80105a0b:	3b 45 08             	cmp    0x8(%ebp),%eax
80105a0e:	76 12                	jbe    80105a22 <fetchint+0x22>
80105a10:	8b 45 08             	mov    0x8(%ebp),%eax
80105a13:	8d 50 04             	lea    0x4(%eax),%edx
80105a16:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a1c:	8b 00                	mov    (%eax),%eax
80105a1e:	39 c2                	cmp    %eax,%edx
80105a20:	76 07                	jbe    80105a29 <fetchint+0x29>
    return -1;
80105a22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a27:	eb 0f                	jmp    80105a38 <fetchint+0x38>
  *ip = *(int*)(addr);
...
80105a4b:	77 07                	ja     80105a54 <fetchstr+0x1a>
    return -1;
80105a4d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a52:	eb 48                	jmp    80105a9c <fetchstr+0x62>
  *pp = (char*)addr;
...
80105a64:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105a67:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a6a:	8b 00                	mov    (%eax),%eax
80105a6c:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105a6f:	eb 1e                	jmp    80105a8f <fetchstr+0x55>
    if(*s == 0)
80105a71:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a74:	0f b6 00             	movzbl (%eax),%eax
80105a77:	84 c0                	test   %al,%al
80105a79:	75 10                	jne    80105a8b <fetchstr+0x51>
      return s - *pp;
80105a7b:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a7e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a81:	8b 00                	mov    (%eax),%eax
80105a83:	89 d1                	mov    %edx,%ecx
80105a85:	29 c1                	sub    %eax,%ecx
80105a87:	89 c8                	mov    %ecx,%eax
80105a89:	eb 11                	jmp    80105a9c <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105a8b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105a8f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a92:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105a95:	72 da                	jb     80105a71 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105aaa:	8b 40 1c             	mov    0x1c(%eax),%eax
80105aad:	8b 50 44             	mov    0x44(%eax),%edx
80105ab0:	8b 45 08             	mov    0x8(%ebp),%eax
80105ab3:	c1 e0 02             	shl    $0x2,%eax
80105ab6:	01 d0                	add    %edx,%eax
80105ab8:	8d 50 04             	lea    0x4(%eax),%edx
80105abb:	8b 45 0c             	mov    0xc(%ebp),%eax
80105abe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ac2:	89 14 24             	mov    %edx,(%esp)
80105ac5:	e8 36 ff ff ff       	call   80105a00 <fetchint>
}
80105aca:	c9                   	leave  
80105acb:	c3                   	ret    
...
80105b31:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105b34:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105b37:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b3b:	8b 45 08             	mov    0x8(%ebp),%eax
80105b3e:	89 04 24             	mov    %eax,(%esp)
80105b41:	e8 58 ff ff ff       	call   80105a9e <argint>
80105b46:	85 c0                	test   %eax,%eax
80105b48:	79 07                	jns    80105b51 <argstr+0x23>
    return -1;
80105b4a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b4f:	eb 12                	jmp    80105b63 <argstr+0x35>
...
80105b5e:	e8 d7 fe ff ff       	call   80105a3a <fetchstr>
}
80105b63:	c9                   	leave  
80105b64:	c3                   	ret    
...
80105b75:	8b 40 1c             	mov    0x1c(%eax),%eax
80105b78:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105b7b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b7f:	7e 30                	jle    80105bb1 <syscall+0x4c>
80105b81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b84:	83 f8 1a             	cmp    $0x1a,%eax
80105b87:	77 28                	ja     80105bb1 <syscall+0x4c>
80105b89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b8c:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105b93:	85 c0                	test   %eax,%eax
80105b95:	74 1a                	je     80105bb1 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105b97:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b9d:	8b 58 1c             	mov    0x1c(%eax),%ebx
80105ba0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ba3:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105baa:	ff d0                	call   *%eax
80105bac:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105baf:	eb 3d                	jmp    80105bee <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105bb1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105bb7:	8d 48 70             	lea    0x70(%eax),%ecx
80105bba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105bc0:	8b 40 10             	mov    0x10(%eax),%eax
80105bc3:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105bc6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105bca:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105bce:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bd2:	c7 04 24 6f 96 10 80 	movl   $0x8010966f,(%esp)
80105bd9:	e8 c3 a7 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105bde:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105be4:	8b 40 1c             	mov    0x1c(%eax),%eax
80105be7:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105bee:	83 c4 24             	add    $0x24,%esp
80105bf1:	5b                   	pop    %ebx
80105bf2:	5d                   	pop    %ebp
80105bf3:	c3                   	ret    
...
80105bf7:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105c07:	e8 92 fe ff ff       	call   80105a9e <argint>
80105c0c:	85 c0                	test   %eax,%eax
80105c0e:	79 07                	jns    80105c17 <argfd+0x23>
    return -1;
80105c10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c15:	eb 50                	jmp    80105c67 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105c17:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c1a:	85 c0                	test   %eax,%eax
80105c1c:	78 21                	js     80105c3f <argfd+0x4b>
80105c1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c21:	83 f8 0f             	cmp    $0xf,%eax
80105c24:	7f 19                	jg     80105c3f <argfd+0x4b>
80105c26:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c2c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c2f:	83 c2 08             	add    $0x8,%edx
80105c32:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80105c36:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c39:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c3d:	75 07                	jne    80105c46 <argfd+0x52>
    return -1;
80105c3f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c44:	eb 21                	jmp    80105c67 <argfd+0x73>
  if(pfd)
80105c46:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105c4a:	74 08                	je     80105c54 <argfd+0x60>
    *pfd = fd;
80105c4c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c4f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105c52:	89 10                	mov    %edx,(%eax)
  if(pf)
80105c54:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105c58:	74 08                	je     80105c62 <argfd+0x6e>
    *pf = f;
80105c5a:	8b 45 10             	mov    0x10(%ebp),%eax
80105c5d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c60:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105c6c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105c6f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105c76:	eb 30                	jmp    80105ca8 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105c78:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c7e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c81:	83 c2 08             	add    $0x8,%edx
80105c84:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80105c88:	85 c0                	test   %eax,%eax
80105c8a:	75 18                	jne    80105ca4 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105c8c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c92:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c95:	8d 4a 08             	lea    0x8(%edx),%ecx
80105c98:	8b 55 08             	mov    0x8(%ebp),%edx
80105c9b:	89 54 88 0c          	mov    %edx,0xc(%eax,%ecx,4)
      return fd;
80105c9f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ca2:	eb 0f                	jmp    80105cb3 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105ca4:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ca8:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105cac:	7e ca                	jle    80105c78 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105cc9:	00 
80105cca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105cd1:	e8 1e ff ff ff       	call   80105bf4 <argfd>
80105cd6:	85 c0                	test   %eax,%eax
80105cd8:	79 07                	jns    80105ce1 <sys_dup+0x2c>
    return -1;
80105cda:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cdf:	eb 29                	jmp    80105d0a <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105ce1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce4:	89 04 24             	mov    %eax,(%esp)
80105ce7:	e8 7d ff ff ff       	call   80105c69 <fdalloc>
80105cec:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105cef:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105cf3:	79 07                	jns    80105cfc <sys_dup+0x47>
    return -1;
80105cf5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cfa:	eb 0e                	jmp    80105d0a <sys_dup+0x55>
  filedup(f);
80105cfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cff:	89 04 24             	mov    %eax,(%esp)
80105d02:	e8 dd b2 ff ff       	call   80100fe4 <filedup>
  return fd;
...
80105d15:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d19:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d20:	00 
80105d21:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d28:	e8 c7 fe ff ff       	call   80105bf4 <argfd>
80105d2d:	85 c0                	test   %eax,%eax
80105d2f:	78 35                	js     80105d66 <sys_read+0x5a>
80105d31:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d34:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d38:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105d3f:	e8 5a fd ff ff       	call   80105a9e <argint>
80105d44:	85 c0                	test   %eax,%eax
80105d46:	78 1e                	js     80105d66 <sys_read+0x5a>
80105d48:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d4f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105d52:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d5d:	e8 6a fd ff ff       	call   80105acc <argptr>
80105d62:	85 c0                	test   %eax,%eax
80105d64:	79 07                	jns    80105d6d <sys_read+0x61>
    return -1;
80105d66:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d6b:	eb 19                	jmp    80105d86 <sys_read+0x7a>
  return fileread(f, p, n);
80105d6d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105d70:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105d73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d76:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105d7a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d7e:	89 04 24             	mov    %eax,(%esp)
80105d81:	e8 cb b3 ff ff       	call   80101151 <fileread>
}
80105d86:	c9                   	leave  
80105d87:	c3                   	ret    
...
80105da4:	e8 4b fe ff ff       	call   80105bf4 <argfd>
80105da9:	85 c0                	test   %eax,%eax
80105dab:	78 35                	js     80105de2 <sys_write+0x5a>
80105dad:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105db0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105db4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105dbb:	e8 de fc ff ff       	call   80105a9e <argint>
80105dc0:	85 c0                	test   %eax,%eax
80105dc2:	78 1e                	js     80105de2 <sys_write+0x5a>
...
80105dd9:	e8 ee fc ff ff       	call   80105acc <argptr>
80105dde:	85 c0                	test   %eax,%eax
80105de0:	79 07                	jns    80105de9 <sys_write+0x61>
    return -1;
80105de2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105de7:	eb 19                	jmp    80105e02 <sys_write+0x7a>
...
80105dfd:	e8 0b b4 ff ff       	call   8010120d <filewrite>
}
80105e02:	c9                   	leave  
80105e03:	c3                   	ret    
...
80105e07:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argfd(0, &fd, &f) < 0)
80105e0a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e0d:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e11:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105e14:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e18:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e1f:	e8 d0 fd ff ff       	call   80105bf4 <argfd>
80105e24:	85 c0                	test   %eax,%eax
80105e26:	79 07                	jns    80105e2f <sys_close+0x2b>
    return -1;
80105e28:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e2d:	eb 24                	jmp    80105e53 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105e2f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e35:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e38:	83 c2 08             	add    $0x8,%edx
80105e3b:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80105e42:	00 
  fileclose(f);
80105e43:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e46:	89 04 24             	mov    %eax,(%esp)
80105e49:	e8 de b1 ff ff       	call   8010102c <fileclose>
  return 0;
...
80105e5b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105e5e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e62:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105e69:	00 
80105e6a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e71:	e8 7e fd ff ff       	call   80105bf4 <argfd>
80105e76:	85 c0                	test   %eax,%eax
80105e78:	78 1f                	js     80105e99 <sys_fstat+0x44>
80105e7a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105e81:	00 
80105e82:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105e85:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e89:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e90:	e8 37 fc ff ff       	call   80105acc <argptr>
80105e95:	85 c0                	test   %eax,%eax
80105e97:	79 07                	jns    80105ea0 <sys_fstat+0x4b>
    return -1;
80105e99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e9e:	eb 12                	jmp    80105eb2 <sys_fstat+0x5d>
...
80105ead:	e8 50 b2 ff ff       	call   80101102 <filestat>
}
80105eb2:	c9                   	leave  
80105eb3:	c3                   	ret    
...
80105eba:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105ebd:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ec1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ec8:	e8 61 fc ff ff       	call   80105b2e <argstr>
80105ecd:	85 c0                	test   %eax,%eax
80105ecf:	78 17                	js     80105ee8 <sys_link+0x34>
80105ed1:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105ed4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ed8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105edf:	e8 4a fc ff ff       	call   80105b2e <argstr>
80105ee4:	85 c0                	test   %eax,%eax
80105ee6:	79 0a                	jns    80105ef2 <sys_link+0x3e>
    return -1;
80105ee8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eed:	e9 41 01 00 00       	jmp    80106033 <sys_link+0x17f>

  begin_op();
80105ef2:	e8 c6 d5 ff ff       	call   801034bd <begin_op>
  if((ip = namei(old)) == 0){
80105ef7:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105efa:	89 04 24             	mov    %eax,(%esp)
80105efd:	e8 70 c5 ff ff       	call   80102472 <namei>
80105f02:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f05:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f09:	75 0f                	jne    80105f1a <sys_link+0x66>
    end_op();
80105f0b:	e8 2e d6 ff ff       	call   8010353e <end_op>
    return -1;
80105f10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f15:	e9 19 01 00 00       	jmp    80106033 <sys_link+0x17f>
  }

  ilock(ip);
80105f1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f1d:	89 04 24             	mov    %eax,(%esp)
80105f20:	e8 ab b9 ff ff       	call   801018d0 <ilock>
  if(ip->type == T_DIR){
80105f25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f28:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f2c:	66 83 f8 01          	cmp    $0x1,%ax
80105f30:	75 1a                	jne    80105f4c <sys_link+0x98>
    iunlockput(ip);
80105f32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f35:	89 04 24             	mov    %eax,(%esp)
80105f38:	e8 17 bc ff ff       	call   80101b54 <iunlockput>
    end_op();
80105f3d:	e8 fc d5 ff ff       	call   8010353e <end_op>
    return -1;
80105f42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f47:	e9 e7 00 00 00       	jmp    80106033 <sys_link+0x17f>
  }

  ip->nlink++;
80105f4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f53:	8d 50 01             	lea    0x1(%eax),%edx
...
80105f6e:	e8 ab ba ff ff       	call   80101a1e <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105f73:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105f76:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105f79:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f7d:	89 04 24             	mov    %eax,(%esp)
80105f80:	e8 0f c5 ff ff       	call   80102494 <nameiparent>
80105f85:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f88:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f8c:	74 68                	je     80105ff6 <sys_link+0x142>
    goto bad;
  ilock(dp);
80105f8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f91:	89 04 24             	mov    %eax,(%esp)
80105f94:	e8 37 b9 ff ff       	call   801018d0 <ilock>
...
80105fa5:	75 20                	jne    80105fc7 <sys_link+0x113>
80105fa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105faa:	8b 40 04             	mov    0x4(%eax),%eax
80105fad:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105fbe:	e8 ee c1 ff ff       	call   801021b1 <dirlink>
80105fc3:	85 c0                	test   %eax,%eax
80105fc5:	79 0d                	jns    80105fd4 <sys_link+0x120>
    iunlockput(dp);
80105fc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fca:	89 04 24             	mov    %eax,(%esp)
80105fcd:	e8 82 bb ff ff       	call   80101b54 <iunlockput>
    goto bad;
80105fd2:	eb 23                	jmp    80105ff7 <sys_link+0x143>
  }
  iunlockput(dp);
80105fd4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fd7:	89 04 24             	mov    %eax,(%esp)
80105fda:	e8 75 bb ff ff       	call   80101b54 <iunlockput>
  iput(ip);
80105fdf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe2:	89 04 24             	mov    %eax,(%esp)
80105fe5:	e8 99 ba ff ff       	call   80101a83 <iput>

  end_op();
80105fea:	e8 4f d5 ff ff       	call   8010353e <end_op>

  return 0;
80105fef:	b8 00 00 00 00       	mov    $0x0,%eax
80105ff4:	eb 3d                	jmp    80106033 <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105ffd:	e8 ce b8 ff ff       	call   801018d0 <ilock>
  ip->nlink--;
...
80106019:	e8 f6 b6 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
8010601e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106021:	89 04 24             	mov    %eax,(%esp)
80106024:	e8 2b bb ff ff       	call   80101b54 <iunlockput>
  end_op();
80106029:	e8 10 d5 ff ff       	call   8010353e <end_op>
  return -1;
...
8010603b:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80106042:	eb 4b                	jmp    8010608f <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106044:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106047:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010604e:	00 
8010604f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106053:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106056:	89 44 24 04          	mov    %eax,0x4(%esp)
8010605a:	8b 45 08             	mov    0x8(%ebp),%eax
8010605d:	89 04 24             	mov    %eax,(%esp)
80106060:	e8 61 bd ff ff       	call   80101dc6 <readi>
80106065:	83 f8 10             	cmp    $0x10,%eax
80106068:	74 0c                	je     80106076 <isdirempty+0x41>
      panic("isdirempty: readi");
8010606a:	c7 04 24 8b 96 10 80 	movl   $0x8010968b,(%esp)
80106071:	e8 c7 a4 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80106076:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
8010607a:	66 85 c0             	test   %ax,%ax
8010607d:	74 07                	je     80106086 <isdirempty+0x51>
      return 0;
8010607f:	b8 00 00 00 00       	mov    $0x0,%eax
80106084:	eb 1b                	jmp    801060a1 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80106089:	83 c0 10             	add    $0x10,%eax
...
8010609a:	72 a8                	jb     80106044 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
801060a6:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801060a9:	8d 45 cc             	lea    -0x34(%ebp),%eax
801060ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801060b0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060b7:	e8 72 fa ff ff       	call   80105b2e <argstr>
801060bc:	85 c0                	test   %eax,%eax
801060be:	79 0a                	jns    801060ca <sys_unlink+0x27>
    return -1;
801060c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060c5:	e9 af 01 00 00       	jmp    80106279 <sys_unlink+0x1d6>

  begin_op();
801060ca:	e8 ee d3 ff ff       	call   801034bd <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801060cf:	8b 45 cc             	mov    -0x34(%ebp),%eax
801060d2:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801060d5:	89 54 24 04          	mov    %edx,0x4(%esp)
801060d9:	89 04 24             	mov    %eax,(%esp)
801060dc:	e8 b3 c3 ff ff       	call   80102494 <nameiparent>
801060e1:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060e4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060e8:	75 0f                	jne    801060f9 <sys_unlink+0x56>
    end_op();
801060ea:	e8 4f d4 ff ff       	call   8010353e <end_op>
    return -1;
801060ef:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f4:	e9 80 01 00 00       	jmp    80106279 <sys_unlink+0x1d6>
  }

  ilock(dp);
801060f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060fc:	89 04 24             	mov    %eax,(%esp)
801060ff:	e8 cc b7 ff ff       	call   801018d0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106104:	c7 44 24 04 9d 96 10 	movl   $0x8010969d,0x4(%esp)
8010610b:	80 
8010610c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010610f:	89 04 24             	mov    %eax,(%esp)
80106112:	e8 b0 bf ff ff       	call   801020c7 <namecmp>
80106117:	85 c0                	test   %eax,%eax
80106119:	0f 84 45 01 00 00    	je     80106264 <sys_unlink+0x1c1>
8010611f:	c7 44 24 04 9f 96 10 	movl   $0x8010969f,0x4(%esp)
80106126:	80 
80106127:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010612a:	89 04 24             	mov    %eax,(%esp)
8010612d:	e8 95 bf ff ff       	call   801020c7 <namecmp>
80106132:	85 c0                	test   %eax,%eax
80106134:	0f 84 2a 01 00 00    	je     80106264 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
8010613a:	8d 45 c8             	lea    -0x38(%ebp),%eax
8010613d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106141:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106144:	89 44 24 04          	mov    %eax,0x4(%esp)
80106148:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010614b:	89 04 24             	mov    %eax,(%esp)
8010614e:	e8 96 bf ff ff       	call   801020e9 <dirlookup>
80106153:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106156:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010615a:	0f 84 03 01 00 00    	je     80106263 <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80106160:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106163:	89 04 24             	mov    %eax,(%esp)
80106166:	e8 65 b7 ff ff       	call   801018d0 <ilock>

  if(ip->nlink < 1)
8010616b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010616e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106172:	66 85 c0             	test   %ax,%ax
80106175:	7f 0c                	jg     80106183 <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
80106177:	c7 04 24 a2 96 10 80 	movl   $0x801096a2,(%esp)
8010617e:	e8 ba a3 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106183:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106186:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010618a:	66 83 f8 01          	cmp    $0x1,%ax
8010618e:	75 1f                	jne    801061af <sys_unlink+0x10c>
80106190:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106193:	89 04 24             	mov    %eax,(%esp)
80106196:	e8 9a fe ff ff       	call   80106035 <isdirempty>
8010619b:	85 c0                	test   %eax,%eax
8010619d:	75 10                	jne    801061af <sys_unlink+0x10c>
    iunlockput(ip);
8010619f:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a2:	89 04 24             	mov    %eax,(%esp)
801061a5:	e8 aa b9 ff ff       	call   80101b54 <iunlockput>
    goto bad;
801061aa:	e9 b5 00 00 00       	jmp    80106264 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
801061af:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801061b6:	00 
801061b7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061be:	00 
801061bf:	8d 45 e0             	lea    -0x20(%ebp),%eax
801061c2:	89 04 24             	mov    %eax,(%esp)
801061c5:	e8 78 f5 ff ff       	call   80105742 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801061ca:	8b 45 c8             	mov    -0x38(%ebp),%eax
801061cd:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801061d4:	00 
...
801061e6:	e8 46 bd ff ff       	call   80101f31 <writei>
801061eb:	83 f8 10             	cmp    $0x10,%eax
801061ee:	74 0c                	je     801061fc <sys_unlink+0x159>
    panic("unlink: writei");
801061f0:	c7 04 24 b4 96 10 80 	movl   $0x801096b4,(%esp)
801061f7:	e8 41 a3 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801061fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061ff:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106203:	66 83 f8 01          	cmp    $0x1,%ax
80106207:	75 1c                	jne    80106225 <sys_unlink+0x182>
    dp->nlink--;
80106209:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010620c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106210:	8d 50 ff             	lea    -0x1(%eax),%edx
80106213:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106216:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010621a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010621d:	89 04 24             	mov    %eax,(%esp)
80106220:	e8 ef b4 ff ff       	call   80101714 <iupdate>
  }
  iunlockput(dp);
80106225:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106228:	89 04 24             	mov    %eax,(%esp)
8010622b:	e8 24 b9 ff ff       	call   80101b54 <iunlockput>

  ip->nlink--;
80106230:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106233:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106237:	8d 50 ff             	lea    -0x1(%eax),%edx
8010623a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010623d:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106241:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106244:	89 04 24             	mov    %eax,(%esp)
80106247:	e8 c8 b4 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
8010624c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010624f:	89 04 24             	mov    %eax,(%esp)
80106252:	e8 fd b8 ff ff       	call   80101b54 <iunlockput>

  end_op();
80106257:	e8 e2 d2 ff ff       	call   8010353e <end_op>

  return 0;
8010625c:	b8 00 00 00 00       	mov    $0x0,%eax
80106261:	eb 16                	jmp    80106279 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
8010626a:	e8 e5 b8 ff ff       	call   80101b54 <iunlockput>
  end_op();
8010626f:	e8 ca d2 ff ff       	call   8010353e <end_op>
  return -1;
...
80106281:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106284:	8b 55 10             	mov    0x10(%ebp),%edx
80106287:	8b 45 14             	mov    0x14(%ebp),%eax
8010628a:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
8010628e:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106292:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80106296:	8d 45 de             	lea    -0x22(%ebp),%eax
80106299:	89 44 24 04          	mov    %eax,0x4(%esp)
8010629d:	8b 45 08             	mov    0x8(%ebp),%eax
801062a0:	89 04 24             	mov    %eax,(%esp)
801062a3:	e8 ec c1 ff ff       	call   80102494 <nameiparent>
801062a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062ab:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062af:	75 0a                	jne    801062bb <create+0x40>
    return 0;
801062b1:	b8 00 00 00 00       	mov    $0x0,%eax
801062b6:	e9 7e 01 00 00       	jmp    80106439 <create+0x1be>
  ilock(dp);
801062bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062be:	89 04 24             	mov    %eax,(%esp)
801062c1:	e8 0a b6 ff ff       	call   801018d0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801062c6:	8d 45 ec             	lea    -0x14(%ebp),%eax
801062c9:	89 44 24 08          	mov    %eax,0x8(%esp)
801062cd:	8d 45 de             	lea    -0x22(%ebp),%eax
801062d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801062d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062d7:	89 04 24             	mov    %eax,(%esp)
801062da:	e8 0a be ff ff       	call   801020e9 <dirlookup>
801062df:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062e2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062e6:	74 47                	je     8010632f <create+0xb4>
    iunlockput(dp);
801062e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062eb:	89 04 24             	mov    %eax,(%esp)
801062ee:	e8 61 b8 ff ff       	call   80101b54 <iunlockput>
    ilock(ip);
801062f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062f6:	89 04 24             	mov    %eax,(%esp)
801062f9:	e8 d2 b5 ff ff       	call   801018d0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801062fe:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106303:	75 15                	jne    8010631a <create+0x9f>
80106305:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106308:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010630c:	66 83 f8 02          	cmp    $0x2,%ax
80106310:	75 08                	jne    8010631a <create+0x9f>
      return ip;
80106312:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106315:	e9 1f 01 00 00       	jmp    80106439 <create+0x1be>
    iunlockput(ip);
8010631a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010631d:	89 04 24             	mov    %eax,(%esp)
80106320:	e8 2f b8 ff ff       	call   80101b54 <iunlockput>
    return 0;
80106325:	b8 00 00 00 00       	mov    $0x0,%eax
8010632a:	e9 0a 01 00 00       	jmp    80106439 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
8010632f:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106336:	8b 00                	mov    (%eax),%eax
80106338:	89 54 24 04          	mov    %edx,0x4(%esp)
8010633c:	89 04 24             	mov    %eax,(%esp)
8010633f:	e8 f3 b2 ff ff       	call   80101637 <ialloc>
80106344:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106347:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010634b:	75 0c                	jne    80106359 <create+0xde>
    panic("create: ialloc");
8010634d:	c7 04 24 c3 96 10 80 	movl   $0x801096c3,(%esp)
80106354:	e8 e4 a1 ff ff       	call   8010053d <panic>

  ilock(ip);
80106359:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635c:	89 04 24             	mov    %eax,(%esp)
8010635f:	e8 6c b5 ff ff       	call   801018d0 <ilock>
  ip->major = major;
80106364:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106367:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
8010636b:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
8010636f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106372:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106376:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
8010637a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010637d:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106383:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106386:	89 04 24             	mov    %eax,(%esp)
80106389:	e8 86 b3 ff ff       	call   80101714 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
8010638e:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106393:	75 6a                	jne    801063ff <create+0x184>
    dp->nlink++;  // for ".."
80106395:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106398:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010639c:	8d 50 01             	lea    0x1(%eax),%edx
8010639f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063a2:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
801063a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063a9:	89 04 24             	mov    %eax,(%esp)
801063ac:	e8 63 b3 ff ff       	call   80101714 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801063b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b4:	8b 40 04             	mov    0x4(%eax),%eax
801063b7:	89 44 24 08          	mov    %eax,0x8(%esp)
801063bb:	c7 44 24 04 9d 96 10 	movl   $0x8010969d,0x4(%esp)
801063c2:	80 
801063c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c6:	89 04 24             	mov    %eax,(%esp)
801063c9:	e8 e3 bd ff ff       	call   801021b1 <dirlink>
801063ce:	85 c0                	test   %eax,%eax
801063d0:	78 21                	js     801063f3 <create+0x178>
801063d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063d5:	8b 40 04             	mov    0x4(%eax),%eax
801063d8:	89 44 24 08          	mov    %eax,0x8(%esp)
801063dc:	c7 44 24 04 9f 96 10 	movl   $0x8010969f,0x4(%esp)
801063e3:	80 
801063e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e7:	89 04 24             	mov    %eax,(%esp)
801063ea:	e8 c2 bd ff ff       	call   801021b1 <dirlink>
801063ef:	85 c0                	test   %eax,%eax
801063f1:	79 0c                	jns    801063ff <create+0x184>
      panic("create dots");
801063f3:	c7 04 24 d2 96 10 80 	movl   $0x801096d2,(%esp)
801063fa:	e8 3e a1 ff ff       	call   8010053d <panic>
  }
...
80106416:	e8 96 bd ff ff       	call   801021b1 <dirlink>
8010641b:	85 c0                	test   %eax,%eax
8010641d:	79 0c                	jns    8010642b <create+0x1b0>
    panic("create: dirlink");
8010641f:	c7 04 24 de 96 10 80 	movl   $0x801096de,(%esp)
80106426:	e8 12 a1 ff ff       	call   8010053d <panic>

  iunlockput(dp);
8010642b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010642e:	89 04 24             	mov    %eax,(%esp)
80106431:	e8 1e b7 ff ff       	call   80101b54 <iunlockput>
...
8010643e:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010644f:	e8 da f6 ff ff       	call   80105b2e <argstr>
80106454:	85 c0                	test   %eax,%eax
80106456:	78 17                	js     8010646f <sys_open+0x34>
80106458:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010645b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010645f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106466:	e8 33 f6 ff ff       	call   80105a9e <argint>
8010646b:	85 c0                	test   %eax,%eax
8010646d:	79 0a                	jns    80106479 <sys_open+0x3e>
    return -1;
8010646f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106474:	e9 5a 01 00 00       	jmp    801065d3 <sys_open+0x198>

  begin_op();
80106479:	e8 3f d0 ff ff       	call   801034bd <begin_op>

  if(omode & O_CREATE){
8010647e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106481:	25 00 02 00 00       	and    $0x200,%eax
80106486:	85 c0                	test   %eax,%eax
80106488:	74 3b                	je     801064c5 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
8010648a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010648d:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106494:	00 
80106495:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010649c:	00 
8010649d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801064a4:	00 
801064a5:	89 04 24             	mov    %eax,(%esp)
801064a8:	e8 ce fd ff ff       	call   8010627b <create>
801064ad:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801064b0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064b4:	75 6b                	jne    80106521 <sys_open+0xe6>
      end_op();
801064b6:	e8 83 d0 ff ff       	call   8010353e <end_op>
      return -1;
801064bb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064c0:	e9 0e 01 00 00       	jmp    801065d3 <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
801064c5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064c8:	89 04 24             	mov    %eax,(%esp)
801064cb:	e8 a2 bf ff ff       	call   80102472 <namei>
801064d0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801064d3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801064d7:	75 0f                	jne    801064e8 <sys_open+0xad>
      end_op();
801064d9:	e8 60 d0 ff ff       	call   8010353e <end_op>
      return -1;
801064de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064e3:	e9 eb 00 00 00       	jmp    801065d3 <sys_open+0x198>
    }
    ilock(ip);
801064e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064eb:	89 04 24             	mov    %eax,(%esp)
801064ee:	e8 dd b3 ff ff       	call   801018d0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801064f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f6:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801064fa:	66 83 f8 01          	cmp    $0x1,%ax
801064fe:	75 21                	jne    80106521 <sys_open+0xe6>
80106500:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106503:	85 c0                	test   %eax,%eax
80106505:	74 1a                	je     80106521 <sys_open+0xe6>
      iunlockput(ip);
80106507:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650a:	89 04 24             	mov    %eax,(%esp)
8010650d:	e8 42 b6 ff ff       	call   80101b54 <iunlockput>
      end_op();
80106512:	e8 27 d0 ff ff       	call   8010353e <end_op>
      return -1;
80106517:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010651c:	e9 b2 00 00 00       	jmp    801065d3 <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106521:	e8 5e aa ff ff       	call   80100f84 <filealloc>
80106526:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106529:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010652d:	74 14                	je     80106543 <sys_open+0x108>
8010652f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106532:	89 04 24             	mov    %eax,(%esp)
80106535:	e8 2f f7 ff ff       	call   80105c69 <fdalloc>
8010653a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010653d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106541:	79 28                	jns    8010656b <sys_open+0x130>
    if(f)
80106543:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106547:	74 0b                	je     80106554 <sys_open+0x119>
      fileclose(f);
80106549:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010654c:	89 04 24             	mov    %eax,(%esp)
8010654f:	e8 d8 aa ff ff       	call   8010102c <fileclose>
    iunlockput(ip);
80106554:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106557:	89 04 24             	mov    %eax,(%esp)
8010655a:	e8 f5 b5 ff ff       	call   80101b54 <iunlockput>
    end_op();
8010655f:	e8 da cf ff ff       	call   8010353e <end_op>
    return -1;
80106564:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106569:	eb 68                	jmp    801065d3 <sys_open+0x198>
  }
  iunlock(ip);
8010656b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010656e:	89 04 24             	mov    %eax,(%esp)
80106571:	e8 a8 b4 ff ff       	call   80101a1e <iunlock>
  end_op();
80106576:	e8 c3 cf ff ff       	call   8010353e <end_op>

  f->type = FD_INODE;
8010657b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010657e:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106584:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106587:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010658a:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010658d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106590:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106597:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010659a:	83 e0 01             	and    $0x1,%eax
8010659d:	85 c0                	test   %eax,%eax
8010659f:	0f 94 c2             	sete   %dl
...
801065b0:	75 0a                	jne    801065bc <sys_open+0x181>
801065b2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065b5:	83 e0 02             	and    $0x2,%eax
801065b8:	85 c0                	test   %eax,%eax
801065ba:	74 07                	je     801065c3 <sys_open+0x188>
801065bc:	b8 01 00 00 00       	mov    $0x1,%eax
801065c1:	eb 05                	jmp    801065c8 <sys_open+0x18d>
...
801065d8:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801065db:	e8 dd ce ff ff       	call   801034bd <begin_op>
...
801065ee:	e8 3b f5 ff ff       	call   80105b2e <argstr>
...
80106635:	e8 1a b5 ff ff       	call   80101b54 <iunlockput>
  end_op();
8010663a:	e8 ff ce ff ff       	call   8010353e <end_op>
  return 0;
...
8010667b:	e8 1e f4 ff ff       	call   80105a9e <argint>
  char *path;
  int len;
  int major, minor;
...
80106692:	e8 07 f4 ff ff       	call   80105a9e <argint>
  int len;
  int major, minor;
...
801066dd:	e8 72 b4 ff ff       	call   80101b54 <iunlockput>
  end_op();
801066e2:	e8 57 ce ff ff       	call   8010353e <end_op>
  return 0;
...
80106736:	e8 95 b1 ff ff       	call   801018d0 <ilock>
  if(ip->type != T_DIR){
...
8010674e:	e8 01 b4 ff ff       	call   80101b54 <iunlockput>
    end_op();
80106753:	e8 e6 cd ff ff       	call   8010353e <end_op>
    return -1;
...
80106765:	e8 b4 b2 ff ff       	call   80101a1e <iunlock>
  iput(proc->cwd);
8010676a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106770:	8b 40 6c             	mov    0x6c(%eax),%eax
80106773:	89 04 24             	mov    %eax,(%esp)
80106776:	e8 08 b3 ff ff       	call   80101a83 <iput>
  end_op();
8010677b:	e8 be cd ff ff       	call   8010353e <end_op>
  proc->cwd = ip;
80106780:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106786:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106789:	89 50 6c             	mov    %edx,0x6c(%eax)
  return 0;
...
801067aa:	e8 7f f3 ff ff       	call   80105b2e <argstr>
...
801067f0:	e8 4d ef ff ff       	call   80105742 <memset>
  for(i=0;; i++){
...
80106809:	e9 95 00 00 00       	jmp    801068a3 <sys_exec+0x110>
...
80106864:	e8 93 a2 ff ff       	call   80100afc <exec>
80106869:	eb 38                	jmp    801068a3 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010686e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106875:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010687b:	01 c2                	add    %eax,%edx
8010687d:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106883:	89 54 24 04          	mov    %edx,0x4(%esp)
80106887:	89 04 24             	mov    %eax,(%esp)
8010688a:	e8 ab f1 ff ff       	call   80105a3a <fetchstr>
8010688f:	85 c0                	test   %eax,%eax
80106891:	79 07                	jns    8010689a <sys_exec+0x107>
      return -1;
80106893:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106898:	eb 09                	jmp    801068a3 <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010689a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010689e:	e9 59 ff ff ff       	jmp    801067fc <sys_exec+0x69>
  return exec(path, argv);
}
801068a3:	c9                   	leave  
801068a4:	c3                   	ret    
...
801068a8:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801068ab:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801068b2:	00 
801068b3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801068b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801068ba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068c1:	e8 06 f2 ff ff       	call   80105acc <argptr>
801068c6:	85 c0                	test   %eax,%eax
801068c8:	79 0a                	jns    801068d4 <sys_pipe+0x2f>
    return -1;
801068ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068cf:	e9 9b 00 00 00       	jmp    8010696f <sys_pipe+0xca>
...
801068e1:	e8 06 d7 ff ff       	call   80103fec <pipealloc>
801068e6:	85 c0                	test   %eax,%eax
801068e8:	79 07                	jns    801068f1 <sys_pipe+0x4c>
    return -1;
801068ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068ef:	eb 7e                	jmp    8010696f <sys_pipe+0xca>
  fd0 = -1;
801068f1:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801068f8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801068fb:	89 04 24             	mov    %eax,(%esp)
801068fe:	e8 66 f3 ff ff       	call   80105c69 <fdalloc>
80106903:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106906:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010690a:	78 14                	js     80106920 <sys_pipe+0x7b>
8010690c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010690f:	89 04 24             	mov    %eax,(%esp)
80106912:	e8 52 f3 ff ff       	call   80105c69 <fdalloc>
80106917:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010691a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010691e:	79 37                	jns    80106957 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106920:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106924:	78 14                	js     8010693a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106926:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010692c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010692f:	83 c2 08             	add    $0x8,%edx
80106932:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80106939:	00 
    fileclose(rf);
8010693a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010693d:	89 04 24             	mov    %eax,(%esp)
80106940:	e8 e7 a6 ff ff       	call   8010102c <fileclose>
    fileclose(wf);
80106945:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106948:	89 04 24             	mov    %eax,(%esp)
8010694b:	e8 dc a6 ff ff       	call   8010102c <fileclose>
    return -1;
80106950:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106955:	eb 18                	jmp    8010696f <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106957:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010695a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010695d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010695f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106962:	8d 50 04             	lea    0x4(%eax),%edx
80106965:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106968:	89 02                	mov    %eax,(%edx)
  return 0;
8010696a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010696f:	c9                   	leave  
80106970:	c3                   	ret    
80106971:	00 00                	add    %al,(%eax)
	...
...
80106977:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010697a:	e8 8c dd ff ff       	call   8010470b <fork>
}
8010697f:	c9                   	leave  
80106980:	c3                   	ret    
...
80106a04:	e8 95 f0 ff ff       	call   80105a9e <argint>
80106a09:	85 c0                	test   %eax,%eax
80106a0b:	78 36                	js     80106a43 <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
80106a0d:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a14:	00 
80106a15:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a18:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a23:	e8 a4 f0 ff ff       	call   80105acc <argptr>
{
	int pid;
	int *status;
	int options;
...
80106a2a:	78 17                	js     80106a43 <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
			(argint(2, &options) < 0) ){
80106a2c:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a33:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106a3a:	e8 5f f0 ff ff       	call   80105a9e <argint>
	int pid;
	int *status;
	int options;
...
80106a41:	79 07                	jns    80106a4a <sys_waitpid+0x5a>
			(argint(2, &options) < 0) ){

		return -1;
80106a43:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a48:	eb 19                	jmp    80106a63 <sys_waitpid+0x73>
	}

	return waitpid(pid, status, options);
80106a4a:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106a4d:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80106a5e:	e8 bd e1 ff ff       	call   80104c20 <waitpid>
}
80106a63:	c9                   	leave  
80106a64:	c3                   	ret    

80106a65 <sys_wait_stat>:
...
80106a6b:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a72:	00 
80106a73:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106a76:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a7a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a81:	e8 46 f0 ff ff       	call   80105acc <argptr>
80106a86:	85 c0                	test   %eax,%eax
80106a88:	78 3e                	js     80106ac8 <sys_wait_stat+0x63>
			(argptr(1,(char**)&rtime, sizeof(int)) < 0) ||
80106a8a:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a91:	00 
80106a92:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a95:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106aa0:	e8 27 f0 ff ff       	call   80105acc <argptr>
int
sys_wait_stat(void)
{
	int *wtime, *rtime, *iotime;
...
80106aa7:	78 1f                	js     80106ac8 <sys_wait_stat+0x63>
			(argptr(1,(char**)&rtime, sizeof(int)) < 0) ||
			(argptr(2,(char**)&iotime, sizeof(int)) < 0) ){
80106aa9:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106ab0:	00 
80106ab1:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106ab4:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ab8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106abf:	e8 08 f0 ff ff       	call   80105acc <argptr>
sys_wait_stat(void)
{
	int *wtime, *rtime, *iotime;
...
80106ac6:	79 07                	jns    80106acf <sys_wait_stat+0x6a>
			(argptr(2,(char**)&iotime, sizeof(int)) < 0) ){

		return -1;
80106ac8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106acd:	eb 19                	jmp    80106ae8 <sys_wait_stat+0x83>
	}

	return wait_stat(wtime, rtime, iotime);
80106acf:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106ad2:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106ad5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106adc:	89 54 24 04          	mov    %edx,0x4(%esp)
80106ae0:	89 04 24             	mov    %eax,(%esp)
80106ae3:	e8 58 e2 ff ff       	call   80104d40 <wait_stat>
}
80106ae8:	c9                   	leave  
80106ae9:	c3                   	ret    

80106aea <sys_list_pgroup>:
...
80106b24:	78 1f                	js     80106b45 <sys_list_pgroup+0x5b>
			(argptr(1,(char**)&arr, sizeof(process_info_entry)) < 0) ||
			(argptr(2,(char**)&size, sizeof(int)) < 0)){
80106b26:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b2d:	00 
80106b2e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106b31:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b35:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106b3c:	e8 8b ef ff ff       	call   80105acc <argptr>
	int gid;
	process_info_entry* arr;
	int* size;
...
80106b43:	79 07                	jns    80106b4c <sys_list_pgroup+0x62>
			(argptr(2,(char**)&size, sizeof(int)) < 0)){

		return -1;
80106b45:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b4a:	eb 19                	jmp    80106b65 <sys_list_pgroup+0x7b>
	}

	return list_pgroup(gid, arr, size);
80106b4c:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106b4f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106b52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b55:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b59:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b5d:	89 04 24             	mov    %eax,(%esp)
80106b60:	e8 9f e3 ff ff       	call   80104f04 <list_pgroup>
}
80106b65:	c9                   	leave  
80106b66:	c3                   	ret    

80106b67 <sys_foreground>:
...
80106b7b:	e8 1e ef ff ff       	call   80105a9e <argint>
80106b80:	85 c0                	test   %eax,%eax
80106b82:	79 07                	jns    80106b8b <sys_foreground+0x24>
		return -1;
80106b84:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b89:	eb 0b                	jmp    80106b96 <sys_foreground+0x2f>
	}

	return foreground(gid);
80106b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b8e:	89 04 24             	mov    %eax,(%esp)
80106b91:	e8 8b e2 ff ff       	call   80104e21 <foreground>
}
80106b96:	c9                   	leave  
80106b97:	c3                   	ret    

80106b98 <sys_set_priority>:
...
80106bac:	e8 ed ee ff ff       	call   80105a9e <argint>
80106bb1:	85 c0                	test   %eax,%eax
80106bb3:	79 07                	jns    80106bbc <sys_set_priority+0x24>
	return -1;
80106bb5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bba:	eb 0b                	jmp    80106bc7 <sys_set_priority+0x2f>
	return set_priority(priority);
80106bbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bbf:	89 04 24             	mov    %eax,(%esp)
80106bc2:	e8 33 e3 ff ff       	call   80104efa <set_priority>
}
80106bc7:	c9                   	leave  
80106bc8:	c3                   	ret    
...
80106bdd:	e8 bc ee ff ff       	call   80105a9e <argint>
80106be2:	85 c0                	test   %eax,%eax
80106be4:	79 07                	jns    80106bed <sys_kill+0x24>
    return -1;
80106be6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106beb:	eb 0b                	jmp    80106bf8 <sys_kill+0x2f>
  return kill(pid);
80106bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bf0:	89 04 24             	mov    %eax,(%esp)
80106bf3:	e8 fd e6 ff ff       	call   801052f5 <kill>
}
80106bf8:	c9                   	leave  
80106bf9:	c3                   	ret    
...
80106c03:	8b 40 10             	mov    0x10(%eax),%eax
}
80106c06:	5d                   	pop    %ebp
80106c07:	c3                   	ret    
...
80106c0b:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106c0e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c11:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c15:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c1c:	e8 7d ee ff ff       	call   80105a9e <argint>
80106c21:	85 c0                	test   %eax,%eax
80106c23:	79 07                	jns    80106c2c <sys_sbrk+0x24>
    return -1;
80106c25:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c2a:	eb 24                	jmp    80106c50 <sys_sbrk+0x48>
  addr = proc->sz;
80106c2c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c32:	8b 00                	mov    (%eax),%eax
80106c34:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106c37:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c3a:	89 04 24             	mov    %eax,(%esp)
80106c3d:	e8 24 da ff ff       	call   80104666 <growproc>
80106c42:	85 c0                	test   %eax,%eax
80106c44:	79 07                	jns    80106c4d <sys_sbrk+0x45>
    return -1;
80106c46:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c4b:	eb 03                	jmp    80106c50 <sys_sbrk+0x48>
  return addr;
...
80106c55:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106c58:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c5b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c5f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c66:	e8 33 ee ff ff       	call   80105a9e <argint>
80106c6b:	85 c0                	test   %eax,%eax
80106c6d:	79 07                	jns    80106c76 <sys_sleep+0x24>
    return -1;
80106c6f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c74:	eb 6c                	jmp    80106ce2 <sys_sleep+0x90>
  acquire(&tickslock);
80106c76:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106c7d:	e8 71 e8 ff ff       	call   801054f3 <acquire>
  ticks0 = ticks;
80106c82:	a1 60 70 11 80       	mov    0x80117060,%eax
80106c87:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106c8a:	eb 34                	jmp    80106cc0 <sys_sleep+0x6e>
    if(proc->killed){
80106c8c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c92:	8b 40 28             	mov    0x28(%eax),%eax
80106c95:	85 c0                	test   %eax,%eax
80106c97:	74 13                	je     80106cac <sys_sleep+0x5a>
      release(&tickslock);
80106c99:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106ca0:	e8 b0 e8 ff ff       	call   80105555 <release>
      return -1;
80106ca5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106caa:	eb 36                	jmp    80106ce2 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106cac:	c7 44 24 04 20 68 11 	movl   $0x80116820,0x4(%esp)
80106cb3:	80 
80106cb4:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
80106cbb:	e8 0e e5 ff ff       	call   801051ce <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106cc0:	a1 60 70 11 80       	mov    0x80117060,%eax
80106cc5:	89 c2                	mov    %eax,%edx
80106cc7:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106cca:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ccd:	39 c2                	cmp    %eax,%edx
80106ccf:	72 bb                	jb     80106c8c <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106cd1:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106cd8:	e8 78 e8 ff ff       	call   80105555 <release>
  return 0;
...
80106ce7:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80106cea:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106cf1:	e8 fd e7 ff ff       	call   801054f3 <acquire>
  xticks = ticks;
80106cf6:	a1 60 70 11 80       	mov    0x80117060,%eax
80106cfb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106cfe:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106d05:	e8 4b e8 ff ff       	call   80105555 <release>
  return xticks;
...
80106d77:	e8 f9 d0 ff ff       	call   80103e75 <picenable>
}
80106d7c:	c9                   	leave  
80106d7d:	c3                   	ret    
	...
...
80106d97:	54                   	push   %esp
  call trap
80106d98:	e8 7b 02 00 00       	call   80107018 <trap>
  addl $4, %esp
...
80106e00:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106e07:	89 c2                	mov    %eax,%edx
80106e09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e0c:	66 89 14 c5 60 68 11 	mov    %dx,-0x7fee97a0(,%eax,8)
80106e13:	80 
80106e14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e17:	66 c7 04 c5 62 68 11 	movw   $0x8,-0x7fee979e(,%eax,8)
80106e1e:	80 08 00 
80106e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e24:	0f b6 14 c5 64 68 11 	movzbl -0x7fee979c(,%eax,8),%edx
80106e2b:	80 
80106e2c:	83 e2 e0             	and    $0xffffffe0,%edx
80106e2f:	88 14 c5 64 68 11 80 	mov    %dl,-0x7fee979c(,%eax,8)
80106e36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e39:	0f b6 14 c5 64 68 11 	movzbl -0x7fee979c(,%eax,8),%edx
80106e40:	80 
80106e41:	83 e2 1f             	and    $0x1f,%edx
80106e44:	88 14 c5 64 68 11 80 	mov    %dl,-0x7fee979c(,%eax,8)
80106e4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e4e:	0f b6 14 c5 65 68 11 	movzbl -0x7fee979b(,%eax,8),%edx
80106e55:	80 
80106e56:	83 e2 f0             	and    $0xfffffff0,%edx
80106e59:	83 ca 0e             	or     $0xe,%edx
80106e5c:	88 14 c5 65 68 11 80 	mov    %dl,-0x7fee979b(,%eax,8)
80106e63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e66:	0f b6 14 c5 65 68 11 	movzbl -0x7fee979b(,%eax,8),%edx
80106e6d:	80 
80106e6e:	83 e2 ef             	and    $0xffffffef,%edx
80106e71:	88 14 c5 65 68 11 80 	mov    %dl,-0x7fee979b(,%eax,8)
80106e78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e7b:	0f b6 14 c5 65 68 11 	movzbl -0x7fee979b(,%eax,8),%edx
80106e82:	80 
80106e83:	83 e2 9f             	and    $0xffffff9f,%edx
80106e86:	88 14 c5 65 68 11 80 	mov    %dl,-0x7fee979b(,%eax,8)
80106e8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e90:	0f b6 14 c5 65 68 11 	movzbl -0x7fee979b(,%eax,8),%edx
80106e97:	80 
80106e98:	83 ca 80             	or     $0xffffff80,%edx
80106e9b:	88 14 c5 65 68 11 80 	mov    %dl,-0x7fee979b(,%eax,8)
80106ea2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ea5:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106eac:	c1 e8 10             	shr    $0x10,%eax
80106eaf:	89 c2                	mov    %eax,%edx
80106eb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eb4:	66 89 14 c5 66 68 11 	mov    %dx,-0x7fee979a(,%eax,8)
80106ebb:	80 
void
tvinit(void)
{
...
80106ecd:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106ed2:	66 a3 60 6a 11 80    	mov    %ax,0x80116a60
80106ed8:	66 c7 05 62 6a 11 80 	movw   $0x8,0x80116a62
80106edf:	08 00 
80106ee1:	0f b6 05 64 6a 11 80 	movzbl 0x80116a64,%eax
80106ee8:	83 e0 e0             	and    $0xffffffe0,%eax
80106eeb:	a2 64 6a 11 80       	mov    %al,0x80116a64
80106ef0:	0f b6 05 64 6a 11 80 	movzbl 0x80116a64,%eax
80106ef7:	83 e0 1f             	and    $0x1f,%eax
80106efa:	a2 64 6a 11 80       	mov    %al,0x80116a64
80106eff:	0f b6 05 65 6a 11 80 	movzbl 0x80116a65,%eax
80106f06:	83 c8 0f             	or     $0xf,%eax
80106f09:	a2 65 6a 11 80       	mov    %al,0x80116a65
80106f0e:	0f b6 05 65 6a 11 80 	movzbl 0x80116a65,%eax
80106f15:	83 e0 ef             	and    $0xffffffef,%eax
80106f18:	a2 65 6a 11 80       	mov    %al,0x80116a65
80106f1d:	0f b6 05 65 6a 11 80 	movzbl 0x80116a65,%eax
80106f24:	83 c8 60             	or     $0x60,%eax
80106f27:	a2 65 6a 11 80       	mov    %al,0x80116a65
80106f2c:	0f b6 05 65 6a 11 80 	movzbl 0x80116a65,%eax
80106f33:	83 c8 80             	or     $0xffffff80,%eax
80106f36:	a2 65 6a 11 80       	mov    %al,0x80116a65
80106f3b:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106f40:	c1 e8 10             	shr    $0x10,%eax
80106f43:	66 a3 66 6a 11 80    	mov    %ax,0x80116a66
  
  initlock(&tickslock, "time");
80106f49:	c7 44 24 04 f0 96 10 	movl   $0x801096f0,0x4(%esp)
80106f50:	80 
80106f51:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
80106f58:	e8 75 e5 ff ff       	call   801054d2 <initlock>
}
80106f5d:	c9                   	leave  
80106f5e:	c3                   	ret    
...
80106f6c:	00 
80106f6d:	c7 04 24 60 68 11 80 	movl   $0x80116860,(%esp)
80106f74:	e8 33 fe ff ff       	call   80106dac <lidt>
}
80106f79:	c9                   	leave  
80106f7a:	c3                   	ret    

80106f7b <updateStats>:
...
80106f7e:	83 ec 10             	sub    $0x10,%esp
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80106f81:	c7 45 fc 14 40 11 80 	movl   $0x80114014,-0x4(%ebp)
80106f88:	eb 7f                	jmp    80107009 <updateStats+0x8e>
		switch (p->state) {
80106f8a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106f8d:	8b 40 0c             	mov    0xc(%eax),%eax
80106f90:	83 f8 03             	cmp    $0x3,%eax
80106f93:	74 21                	je     80106fb6 <updateStats+0x3b>
80106f95:	83 f8 04             	cmp    $0x4,%eax
80106f98:	74 33                	je     80106fcd <updateStats+0x52>
80106f9a:	83 f8 02             	cmp    $0x2,%eax
80106f9d:	75 62                	jne    80107001 <updateStats+0x86>
			case SLEEPING:
				p->stime++;
80106f9f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fa2:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80106fa8:	8d 50 01             	lea    0x1(%eax),%edx
80106fab:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fae:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
				break;
80106fb4:	eb 4c                	jmp    80107002 <updateStats+0x87>
			case RUNNABLE:
				p->retime++;
80106fb6:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fb9:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
80106fbf:	8d 50 01             	lea    0x1(%eax),%edx
80106fc2:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fc5:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
				break;
80106fcb:	eb 35                	jmp    80107002 <updateStats+0x87>
			case RUNNING:
				p->rutime++;
80106fcd:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fd0:	8b 80 94 00 00 00    	mov    0x94(%eax),%eax
80106fd6:	8d 50 01             	lea    0x1(%eax),%edx
80106fd9:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fdc:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
				p->vruntime += p->priority;
80106fe2:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fe5:	8b 90 9c 00 00 00    	mov    0x9c(%eax),%edx
80106feb:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106fee:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
80106ff4:	01 c2                	add    %eax,%edx
80106ff6:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106ff9:	89 90 9c 00 00 00    	mov    %edx,0x9c(%eax)
				break;
80106fff:	eb 01                	jmp    80107002 <updateStats+0x87>
			default:
				break;
80107001:	90                   	nop
} ptable;
...
void updateStats()
{
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80107002:	81 45 fc a0 00 00 00 	addl   $0xa0,-0x4(%ebp)
80107009:	81 7d fc 14 68 11 80 	cmpl   $0x80116814,-0x4(%ebp)
80107010:	0f 82 74 ff ff ff    	jb     80106f8a <updateStats+0xf>
				break;
			default:
				break;
		}
...
8010701e:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80107021:	8b 45 08             	mov    0x8(%ebp),%eax
80107024:	8b 40 30             	mov    0x30(%eax),%eax
80107027:	83 f8 40             	cmp    $0x40,%eax
8010702a:	75 4c                	jne    80107078 <trap+0x60>
    if(proc->killed)
8010702c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107032:	8b 40 28             	mov    0x28(%eax),%eax
80107035:	85 c0                	test   %eax,%eax
80107037:	74 0c                	je     80107045 <trap+0x2d>
      exit(EXIT_STATUS_DEFAULT);
80107039:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80107040:	e8 89 d8 ff ff       	call   801048ce <exit>
    proc->tf = tf;
80107045:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010704b:	8b 55 08             	mov    0x8(%ebp),%edx
8010704e:	89 50 1c             	mov    %edx,0x1c(%eax)
    syscall();
80107051:	e8 0f eb ff ff       	call   80105b65 <syscall>
    if(proc->killed)
80107056:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010705c:	8b 40 28             	mov    0x28(%eax),%eax
8010705f:	85 c0                	test   %eax,%eax
80107061:	0f 84 6f 02 00 00    	je     801072d6 <trap+0x2be>
      exit(EXIT_STATUS_DEFAULT);
80107067:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010706e:	e8 5b d8 ff ff       	call   801048ce <exit>
    return;
80107073:	e9 5e 02 00 00       	jmp    801072d6 <trap+0x2be>
  }

  switch(tf->trapno){
80107078:	8b 45 08             	mov    0x8(%ebp),%eax
8010707b:	8b 40 30             	mov    0x30(%eax),%eax
8010707e:	83 e8 20             	sub    $0x20,%eax
80107081:	83 f8 1f             	cmp    $0x1f,%eax
80107084:	0f 87 c1 00 00 00    	ja     8010714b <trap+0x133>
8010708a:	8b 04 85 98 97 10 80 	mov    -0x7fef6868(,%eax,4),%eax
80107091:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107093:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107099:	0f b6 00             	movzbl (%eax),%eax
8010709c:	84 c0                	test   %al,%al
8010709e:	75 36                	jne    801070d6 <trap+0xbe>
      acquire(&tickslock);
801070a0:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
801070a7:	e8 47 e4 ff ff       	call   801054f3 <acquire>
      ticks++;
801070ac:	a1 60 70 11 80       	mov    0x80117060,%eax
801070b1:	83 c0 01             	add    $0x1,%eax
801070b4:	a3 60 70 11 80       	mov    %eax,0x80117060
      wakeup(&ticks);
801070b9:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
801070c0:	e8 05 e2 ff ff       	call   801052ca <wakeup>
      release(&tickslock);
801070c5:	c7 04 24 20 68 11 80 	movl   $0x80116820,(%esp)
801070cc:	e8 84 e4 ff ff       	call   80105555 <release>

      updateStats();
801070d1:	e8 a5 fe ff ff       	call   80106f7b <updateStats>
    }
    lapiceoi();
801070d6:	e8 a0 be ff ff       	call   80102f7b <lapiceoi>
    break;
801070db:	e9 41 01 00 00       	jmp    80107221 <trap+0x209>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801070e0:	e8 74 b6 ff ff       	call   80102759 <ideintr>
    lapiceoi();
801070e5:	e8 91 be ff ff       	call   80102f7b <lapiceoi>
    break;
801070ea:	e9 32 01 00 00       	jmp    80107221 <trap+0x209>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801070ef:	e8 3b bc ff ff       	call   80102d2f <kbdintr>
    lapiceoi();
801070f4:	e8 82 be ff ff       	call   80102f7b <lapiceoi>
    break;
801070f9:	e9 23 01 00 00       	jmp    80107221 <trap+0x209>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801070fe:	e8 d9 03 00 00       	call   801074dc <uartintr>
    lapiceoi();
80107103:	e8 73 be ff ff       	call   80102f7b <lapiceoi>
    break;
80107108:	e9 14 01 00 00       	jmp    80107221 <trap+0x209>
  case T_IRQ0 + 7:
...
8010710d:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107110:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80107116:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010711a:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
8010711d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107123:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80107129:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010712d:	89 54 24 08          	mov    %edx,0x8(%esp)
80107131:	89 44 24 04          	mov    %eax,0x4(%esp)
80107135:	c7 04 24 f8 96 10 80 	movl   $0x801096f8,(%esp)
8010713c:	e8 60 92 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107141:	e8 35 be ff ff       	call   80102f7b <lapiceoi>
    break;
80107146:	e9 d6 00 00 00       	jmp    80107221 <trap+0x209>
...
80107153:	74 11                	je     80107166 <trap+0x14e>
...
80107164:	75 46                	jne    801071ac <trap+0x194>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107166:	e8 6a fc ff ff       	call   80106dd5 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
8010716b:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010716e:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107171:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107178:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010717b:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010717e:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107181:	8b 52 30             	mov    0x30(%edx),%edx
80107184:	89 44 24 10          	mov    %eax,0x10(%esp)
80107188:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010718c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107190:	89 54 24 04          	mov    %edx,0x4(%esp)
80107194:	c7 04 24 1c 97 10 80 	movl   $0x8010971c,(%esp)
8010719b:	e8 01 92 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801071a0:	c7 04 24 4e 97 10 80 	movl   $0x8010974e,(%esp)
801071a7:	e8 91 93 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071ac:	e8 24 fc ff ff       	call   80106dd5 <rcr2>
801071b1:	89 c2                	mov    %eax,%edx
...
801071b3:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071b6:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071b9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801071bf:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c2:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071c5:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c8:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071cb:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071ce:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801071d1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071d7:	83 c0 70             	add    $0x70,%eax
801071da:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801071dd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071e3:	8b 40 10             	mov    0x10(%eax),%eax
801071e6:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801071ea:	89 7c 24 18          	mov    %edi,0x18(%esp)
801071ee:	89 74 24 14          	mov    %esi,0x14(%esp)
801071f2:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801071f6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801071fa:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801071fd:	89 54 24 08          	mov    %edx,0x8(%esp)
80107201:	89 44 24 04          	mov    %eax,0x4(%esp)
80107205:	c7 04 24 54 97 10 80 	movl   $0x80109754,(%esp)
8010720c:	e8 90 91 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107211:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107217:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
8010721e:	eb 01                	jmp    80107221 <trap+0x209>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107221:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107227:	85 c0                	test   %eax,%eax
80107229:	74 2b                	je     80107256 <trap+0x23e>
8010722b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107231:	8b 40 28             	mov    0x28(%eax),%eax
80107234:	85 c0                	test   %eax,%eax
80107236:	74 1e                	je     80107256 <trap+0x23e>
80107238:	8b 45 08             	mov    0x8(%ebp),%eax
8010723b:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010723f:	0f b7 c0             	movzwl %ax,%eax
80107242:	83 e0 03             	and    $0x3,%eax
80107245:	83 f8 03             	cmp    $0x3,%eax
80107248:	75 0c                	jne    80107256 <trap+0x23e>
    exit(EXIT_STATUS_DEFAULT);
8010724a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80107251:	e8 78 d6 ff ff       	call   801048ce <exit>
...
8010725e:	74 3f                	je     8010729f <trap+0x287>
80107260:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107266:	8b 40 0c             	mov    0xc(%eax),%eax
80107269:	83 f8 04             	cmp    $0x4,%eax
8010726c:	75 31                	jne    8010729f <trap+0x287>
8010726e:	8b 45 08             	mov    0x8(%ebp),%eax
80107271:	8b 40 30             	mov    0x30(%eax),%eax
80107274:	83 f8 20             	cmp    $0x20,%eax
80107277:	75 26                	jne    8010729f <trap+0x287>
	    if( !(ticks % QUANTA) ) yield();
80107279:	8b 0d 60 70 11 80    	mov    0x80117060,%ecx
8010727f:	ba cd cc cc cc       	mov    $0xcccccccd,%edx
80107284:	89 c8                	mov    %ecx,%eax
80107286:	f7 e2                	mul    %edx
80107288:	c1 ea 02             	shr    $0x2,%edx
8010728b:	89 d0                	mov    %edx,%eax
8010728d:	c1 e0 02             	shl    $0x2,%eax
80107290:	01 d0                	add    %edx,%eax
80107292:	89 ca                	mov    %ecx,%edx
80107294:	29 c2                	sub    %eax,%edx
80107296:	85 d2                	test   %edx,%edx
80107298:	75 05                	jne    8010729f <trap+0x287>
8010729a:	e8 9c de ff ff       	call   8010513b <yield>
  }
#endif
...
801072a7:	74 2e                	je     801072d7 <trap+0x2bf>
801072a9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801072af:	8b 40 28             	mov    0x28(%eax),%eax
801072b2:	85 c0                	test   %eax,%eax
801072b4:	74 21                	je     801072d7 <trap+0x2bf>
...
801072c6:	75 0f                	jne    801072d7 <trap+0x2bf>
    exit(EXIT_STATUS_DEFAULT);
801072c8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801072cf:	e8 fa d5 ff ff       	call   801048ce <exit>
801072d4:	eb 01                	jmp    801072d7 <trap+0x2bf>
      exit(EXIT_STATUS_DEFAULT);
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
801072d7:	83 c4 3c             	add    $0x3c,%esp
801072da:	5b                   	pop    %ebx
801072db:	5e                   	pop    %esi
801072dc:	5f                   	pop    %edi
801072dd:	5d                   	pop    %ebp
...
801072ea:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801072ee:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
801072f2:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801072f6:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
801072fa:	ec                   	in     (%dx),%al
801072fb:	89 c3                	mov    %eax,%ebx
801072fd:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107300:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107304:	83 c4 14             	add    $0x14,%esp
80107307:	5b                   	pop    %ebx
80107308:	5d                   	pop    %ebp
80107309:	c3                   	ret    
...
80107310:	8b 55 08             	mov    0x8(%ebp),%edx
80107313:	8b 45 0c             	mov    0xc(%ebp),%eax
80107316:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010731a:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010731d:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107321:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010732b:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010732e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107335:	00 
80107336:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010733d:	e8 c8 ff ff ff       	call   8010730a <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107342:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107349:	00 
8010734a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107351:	e8 b4 ff ff ff       	call   8010730a <outb>
  outb(COM1+0, 115200/9600);
80107356:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
8010735d:	00 
8010735e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107365:	e8 a0 ff ff ff       	call   8010730a <outb>
  outb(COM1+1, 0);
8010736a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107371:	00 
80107372:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107379:	e8 8c ff ff ff       	call   8010730a <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
8010737e:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107385:	00 
80107386:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
8010738d:	e8 78 ff ff ff       	call   8010730a <outb>
  outb(COM1+4, 0);
80107392:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107399:	00 
8010739a:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801073a1:	e8 64 ff ff ff       	call   8010730a <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801073a6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801073ad:	00 
801073ae:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801073b5:	e8 50 ff ff ff       	call   8010730a <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801073ba:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801073c1:	e8 1a ff ff ff       	call   801072e0 <inb>
801073c6:	3c ff                	cmp    $0xff,%al
801073c8:	74 6c                	je     80107436 <uartinit+0x10e>
    return;
  uart = 1;
801073ca:	c7 05 cc cc 10 80 01 	movl   $0x1,0x8010cccc
801073d1:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801073d4:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801073db:	e8 00 ff ff ff       	call   801072e0 <inb>
  inb(COM1+0);
801073e0:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801073e7:	e8 f4 fe ff ff       	call   801072e0 <inb>
  picenable(IRQ_COM1);
801073ec:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801073f3:	e8 7d ca ff ff       	call   80103e75 <picenable>
  ioapicenable(IRQ_COM1, 0);
801073f8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801073ff:	00 
80107400:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107407:	e8 d2 b5 ff ff       	call   801029de <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010740c:	c7 45 f4 18 98 10 80 	movl   $0x80109818,-0xc(%ebp)
80107413:	eb 15                	jmp    8010742a <uartinit+0x102>
    uartputc(*p);
80107415:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107418:	0f b6 00             	movzbl (%eax),%eax
8010741b:	0f be c0             	movsbl %al,%eax
8010741e:	89 04 24             	mov    %eax,(%esp)
80107421:	e8 13 00 00 00       	call   80107439 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107426:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010742a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010742d:	0f b6 00             	movzbl (%eax),%eax
80107430:	84 c0                	test   %al,%al
80107432:	75 e1                	jne    80107415 <uartinit+0xed>
80107434:	eb 01                	jmp    80107437 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
8010743c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
8010743f:	a1 cc cc 10 80       	mov    0x8010cccc,%eax
80107444:	85 c0                	test   %eax,%eax
80107446:	74 4d                	je     80107495 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107448:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010744f:	eb 10                	jmp    80107461 <uartputc+0x28>
    microdelay(10);
80107451:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107458:	e8 43 bb ff ff       	call   80102fa0 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010745d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107461:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107465:	7f 16                	jg     8010747d <uartputc+0x44>
80107467:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010746e:	e8 6d fe ff ff       	call   801072e0 <inb>
80107473:	0f b6 c0             	movzbl %al,%eax
80107476:	83 e0 20             	and    $0x20,%eax
80107479:	85 c0                	test   %eax,%eax
8010747b:	74 d4                	je     80107451 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
8010747d:	8b 45 08             	mov    0x8(%ebp),%eax
80107480:	0f b6 c0             	movzbl %al,%eax
80107483:	89 44 24 04          	mov    %eax,0x4(%esp)
80107487:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010748e:	e8 77 fe ff ff       	call   8010730a <outb>
80107493:	eb 01                	jmp    80107496 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010749b:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010749e:	a1 cc cc 10 80       	mov    0x8010cccc,%eax
801074a3:	85 c0                	test   %eax,%eax
801074a5:	75 07                	jne    801074ae <uartgetc+0x16>
    return -1;
801074a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801074ac:	eb 2c                	jmp    801074da <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801074ae:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801074b5:	e8 26 fe ff ff       	call   801072e0 <inb>
801074ba:	0f b6 c0             	movzbl %al,%eax
801074bd:	83 e0 01             	and    $0x1,%eax
801074c0:	85 c0                	test   %eax,%eax
801074c2:	75 07                	jne    801074cb <uartgetc+0x33>
    return -1;
801074c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801074c9:	eb 0f                	jmp    801074da <uartgetc+0x42>
  return inb(COM1+0);
801074cb:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801074d2:	e8 09 fe ff ff       	call   801072e0 <inb>
801074d7:	0f b6 c0             	movzbl %al,%eax
}
801074da:	c9                   	leave  
801074db:	c3                   	ret    
...
801074df:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801074e2:	c7 04 24 98 74 10 80 	movl   $0x80107498,(%esp)
801074e9:	e8 bf 92 ff ff       	call   801007ad <consoleintr>
}
801074ee:	c9                   	leave  
801074ef:	c3                   	ret    
...
801074f2:	6a 00                	push   $0x0
  jmp alltraps
801074f4:	e9 87 f8 ff ff       	jmp    80106d80 <alltraps>
...
801074f9:	6a 00                	push   $0x0
  pushl $1
801074fb:	6a 01                	push   $0x1
  jmp alltraps
801074fd:	e9 7e f8 ff ff       	jmp    80106d80 <alltraps>
...
80107504:	6a 02                	push   $0x2
  jmp alltraps
80107506:	e9 75 f8 ff ff       	jmp    80106d80 <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $3
8010750d:	6a 03                	push   $0x3
  jmp alltraps
8010750f:	e9 6c f8 ff ff       	jmp    80106d80 <alltraps>
...
80107514:	6a 00                	push   $0x0
  pushl $4
80107516:	6a 04                	push   $0x4
  jmp alltraps
80107518:	e9 63 f8 ff ff       	jmp    80106d80 <alltraps>
...
8010751d:	6a 00                	push   $0x0
  pushl $5
8010751f:	6a 05                	push   $0x5
  jmp alltraps
80107521:	e9 5a f8 ff ff       	jmp    80106d80 <alltraps>
...
80107528:	6a 06                	push   $0x6
  jmp alltraps
8010752a:	e9 51 f8 ff ff       	jmp    80106d80 <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $7
80107531:	6a 07                	push   $0x7
  jmp alltraps
80107533:	e9 48 f8 ff ff       	jmp    80106d80 <alltraps>

80107538 <vector8>:
.globl vector8
vector8:
  pushl $8
80107538:	6a 08                	push   $0x8
  jmp alltraps
8010753a:	e9 41 f8 ff ff       	jmp    80106d80 <alltraps>
...
8010753f:	6a 00                	push   $0x0
  pushl $9
80107541:	6a 09                	push   $0x9
  jmp alltraps
80107543:	e9 38 f8 ff ff       	jmp    80106d80 <alltraps>

80107548 <vector10>:
.globl vector10
vector10:
  pushl $10
80107548:	6a 0a                	push   $0xa
  jmp alltraps
...
vector11:
  pushl $11
8010754f:	6a 0b                	push   $0xb
  jmp alltraps
80107551:	e9 2a f8 ff ff       	jmp    80106d80 <alltraps>

80107556 <vector12>:
.globl vector12
vector12:
  pushl $12
80107556:	6a 0c                	push   $0xc
  jmp alltraps
80107558:	e9 23 f8 ff ff       	jmp    80106d80 <alltraps>

8010755d <vector13>:
.globl vector13
vector13:
  pushl $13
8010755d:	6a 0d                	push   $0xd
  jmp alltraps
8010755f:	e9 1c f8 ff ff       	jmp    80106d80 <alltraps>

80107564 <vector14>:
.globl vector14
vector14:
  pushl $14
80107564:	6a 0e                	push   $0xe
  jmp alltraps
80107566:	e9 15 f8 ff ff       	jmp    80106d80 <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $15
8010756d:	6a 0f                	push   $0xf
  jmp alltraps
8010756f:	e9 0c f8 ff ff       	jmp    80106d80 <alltraps>
...
80107574:	6a 00                	push   $0x0
  pushl $16
80107576:	6a 10                	push   $0x10
  jmp alltraps
80107578:	e9 03 f8 ff ff       	jmp    80106d80 <alltraps>

8010757d <vector17>:
.globl vector17
vector17:
  pushl $17
8010757d:	6a 11                	push   $0x11
  jmp alltraps
8010757f:	e9 fc f7 ff ff       	jmp    80106d80 <alltraps>
...
80107584:	6a 00                	push   $0x0
  pushl $18
80107586:	6a 12                	push   $0x12
  jmp alltraps
80107588:	e9 f3 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010758d:	6a 00                	push   $0x0
  pushl $19
8010758f:	6a 13                	push   $0x13
  jmp alltraps
80107591:	e9 ea f7 ff ff       	jmp    80106d80 <alltraps>
...
80107596:	6a 00                	push   $0x0
  pushl $20
80107598:	6a 14                	push   $0x14
  jmp alltraps
8010759a:	e9 e1 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010759f:	6a 00                	push   $0x0
  pushl $21
801075a1:	6a 15                	push   $0x15
  jmp alltraps
801075a3:	e9 d8 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075a8:	6a 00                	push   $0x0
  pushl $22
801075aa:	6a 16                	push   $0x16
  jmp alltraps
801075ac:	e9 cf f7 ff ff       	jmp    80106d80 <alltraps>
...
801075b1:	6a 00                	push   $0x0
  pushl $23
801075b3:	6a 17                	push   $0x17
  jmp alltraps
801075b5:	e9 c6 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075ba:	6a 00                	push   $0x0
  pushl $24
801075bc:	6a 18                	push   $0x18
  jmp alltraps
801075be:	e9 bd f7 ff ff       	jmp    80106d80 <alltraps>
...
801075c3:	6a 00                	push   $0x0
  pushl $25
801075c5:	6a 19                	push   $0x19
  jmp alltraps
801075c7:	e9 b4 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075cc:	6a 00                	push   $0x0
  pushl $26
801075ce:	6a 1a                	push   $0x1a
  jmp alltraps
801075d0:	e9 ab f7 ff ff       	jmp    80106d80 <alltraps>
...
801075d5:	6a 00                	push   $0x0
  pushl $27
801075d7:	6a 1b                	push   $0x1b
  jmp alltraps
801075d9:	e9 a2 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075de:	6a 00                	push   $0x0
  pushl $28
801075e0:	6a 1c                	push   $0x1c
  jmp alltraps
801075e2:	e9 99 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075e7:	6a 00                	push   $0x0
  pushl $29
801075e9:	6a 1d                	push   $0x1d
  jmp alltraps
801075eb:	e9 90 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075f0:	6a 00                	push   $0x0
  pushl $30
801075f2:	6a 1e                	push   $0x1e
  jmp alltraps
801075f4:	e9 87 f7 ff ff       	jmp    80106d80 <alltraps>
...
801075f9:	6a 00                	push   $0x0
  pushl $31
801075fb:	6a 1f                	push   $0x1f
  jmp alltraps
801075fd:	e9 7e f7 ff ff       	jmp    80106d80 <alltraps>
...
80107602:	6a 00                	push   $0x0
  pushl $32
80107604:	6a 20                	push   $0x20
  jmp alltraps
80107606:	e9 75 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010760b:	6a 00                	push   $0x0
  pushl $33
8010760d:	6a 21                	push   $0x21
  jmp alltraps
8010760f:	e9 6c f7 ff ff       	jmp    80106d80 <alltraps>
...
80107614:	6a 00                	push   $0x0
  pushl $34
80107616:	6a 22                	push   $0x22
  jmp alltraps
80107618:	e9 63 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010761d:	6a 00                	push   $0x0
  pushl $35
8010761f:	6a 23                	push   $0x23
  jmp alltraps
80107621:	e9 5a f7 ff ff       	jmp    80106d80 <alltraps>
...
80107626:	6a 00                	push   $0x0
  pushl $36
80107628:	6a 24                	push   $0x24
  jmp alltraps
8010762a:	e9 51 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010762f:	6a 00                	push   $0x0
  pushl $37
80107631:	6a 25                	push   $0x25
  jmp alltraps
80107633:	e9 48 f7 ff ff       	jmp    80106d80 <alltraps>
...
80107638:	6a 00                	push   $0x0
  pushl $38
8010763a:	6a 26                	push   $0x26
  jmp alltraps
8010763c:	e9 3f f7 ff ff       	jmp    80106d80 <alltraps>
...
80107641:	6a 00                	push   $0x0
  pushl $39
80107643:	6a 27                	push   $0x27
  jmp alltraps
80107645:	e9 36 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010764a:	6a 00                	push   $0x0
  pushl $40
8010764c:	6a 28                	push   $0x28
  jmp alltraps
8010764e:	e9 2d f7 ff ff       	jmp    80106d80 <alltraps>
...
80107653:	6a 00                	push   $0x0
  pushl $41
80107655:	6a 29                	push   $0x29
  jmp alltraps
80107657:	e9 24 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010765c:	6a 00                	push   $0x0
  pushl $42
8010765e:	6a 2a                	push   $0x2a
  jmp alltraps
80107660:	e9 1b f7 ff ff       	jmp    80106d80 <alltraps>
...
80107665:	6a 00                	push   $0x0
  pushl $43
80107667:	6a 2b                	push   $0x2b
  jmp alltraps
80107669:	e9 12 f7 ff ff       	jmp    80106d80 <alltraps>
...
8010766e:	6a 00                	push   $0x0
  pushl $44
80107670:	6a 2c                	push   $0x2c
  jmp alltraps
80107672:	e9 09 f7 ff ff       	jmp    80106d80 <alltraps>
...
80107677:	6a 00                	push   $0x0
  pushl $45
80107679:	6a 2d                	push   $0x2d
  jmp alltraps
8010767b:	e9 00 f7 ff ff       	jmp    80106d80 <alltraps>
...
80107680:	6a 00                	push   $0x0
  pushl $46
80107682:	6a 2e                	push   $0x2e
  jmp alltraps
80107684:	e9 f7 f6 ff ff       	jmp    80106d80 <alltraps>
...
80107689:	6a 00                	push   $0x0
  pushl $47
8010768b:	6a 2f                	push   $0x2f
  jmp alltraps
8010768d:	e9 ee f6 ff ff       	jmp    80106d80 <alltraps>
...
80107692:	6a 00                	push   $0x0
  pushl $48
80107694:	6a 30                	push   $0x30
  jmp alltraps
80107696:	e9 e5 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010769b:	6a 00                	push   $0x0
  pushl $49
8010769d:	6a 31                	push   $0x31
  jmp alltraps
8010769f:	e9 dc f6 ff ff       	jmp    80106d80 <alltraps>
...
801076a4:	6a 00                	push   $0x0
  pushl $50
801076a6:	6a 32                	push   $0x32
  jmp alltraps
801076a8:	e9 d3 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076ad:	6a 00                	push   $0x0
  pushl $51
801076af:	6a 33                	push   $0x33
  jmp alltraps
801076b1:	e9 ca f6 ff ff       	jmp    80106d80 <alltraps>
...
801076b6:	6a 00                	push   $0x0
  pushl $52
801076b8:	6a 34                	push   $0x34
  jmp alltraps
801076ba:	e9 c1 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076bf:	6a 00                	push   $0x0
  pushl $53
801076c1:	6a 35                	push   $0x35
  jmp alltraps
801076c3:	e9 b8 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076c8:	6a 00                	push   $0x0
  pushl $54
801076ca:	6a 36                	push   $0x36
  jmp alltraps
801076cc:	e9 af f6 ff ff       	jmp    80106d80 <alltraps>
...
801076d1:	6a 00                	push   $0x0
  pushl $55
801076d3:	6a 37                	push   $0x37
  jmp alltraps
801076d5:	e9 a6 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076da:	6a 00                	push   $0x0
  pushl $56
801076dc:	6a 38                	push   $0x38
  jmp alltraps
801076de:	e9 9d f6 ff ff       	jmp    80106d80 <alltraps>
...
801076e3:	6a 00                	push   $0x0
  pushl $57
801076e5:	6a 39                	push   $0x39
  jmp alltraps
801076e7:	e9 94 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076ec:	6a 00                	push   $0x0
  pushl $58
801076ee:	6a 3a                	push   $0x3a
  jmp alltraps
801076f0:	e9 8b f6 ff ff       	jmp    80106d80 <alltraps>
...
801076f5:	6a 00                	push   $0x0
  pushl $59
801076f7:	6a 3b                	push   $0x3b
  jmp alltraps
801076f9:	e9 82 f6 ff ff       	jmp    80106d80 <alltraps>
...
801076fe:	6a 00                	push   $0x0
  pushl $60
80107700:	6a 3c                	push   $0x3c
  jmp alltraps
80107702:	e9 79 f6 ff ff       	jmp    80106d80 <alltraps>
...
80107707:	6a 00                	push   $0x0
  pushl $61
80107709:	6a 3d                	push   $0x3d
  jmp alltraps
8010770b:	e9 70 f6 ff ff       	jmp    80106d80 <alltraps>
...
80107710:	6a 00                	push   $0x0
  pushl $62
80107712:	6a 3e                	push   $0x3e
  jmp alltraps
80107714:	e9 67 f6 ff ff       	jmp    80106d80 <alltraps>
...
80107719:	6a 00                	push   $0x0
  pushl $63
8010771b:	6a 3f                	push   $0x3f
  jmp alltraps
8010771d:	e9 5e f6 ff ff       	jmp    80106d80 <alltraps>
...
80107722:	6a 00                	push   $0x0
  pushl $64
80107724:	6a 40                	push   $0x40
  jmp alltraps
80107726:	e9 55 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010772b:	6a 00                	push   $0x0
  pushl $65
8010772d:	6a 41                	push   $0x41
  jmp alltraps
8010772f:	e9 4c f6 ff ff       	jmp    80106d80 <alltraps>
...
80107734:	6a 00                	push   $0x0
  pushl $66
80107736:	6a 42                	push   $0x42
  jmp alltraps
80107738:	e9 43 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010773d:	6a 00                	push   $0x0
  pushl $67
8010773f:	6a 43                	push   $0x43
  jmp alltraps
80107741:	e9 3a f6 ff ff       	jmp    80106d80 <alltraps>
...
80107746:	6a 00                	push   $0x0
  pushl $68
80107748:	6a 44                	push   $0x44
  jmp alltraps
8010774a:	e9 31 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010774f:	6a 00                	push   $0x0
  pushl $69
80107751:	6a 45                	push   $0x45
  jmp alltraps
80107753:	e9 28 f6 ff ff       	jmp    80106d80 <alltraps>
...
80107758:	6a 00                	push   $0x0
  pushl $70
8010775a:	6a 46                	push   $0x46
  jmp alltraps
8010775c:	e9 1f f6 ff ff       	jmp    80106d80 <alltraps>
...
80107761:	6a 00                	push   $0x0
  pushl $71
80107763:	6a 47                	push   $0x47
  jmp alltraps
80107765:	e9 16 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010776a:	6a 00                	push   $0x0
  pushl $72
8010776c:	6a 48                	push   $0x48
  jmp alltraps
8010776e:	e9 0d f6 ff ff       	jmp    80106d80 <alltraps>
...
80107773:	6a 00                	push   $0x0
  pushl $73
80107775:	6a 49                	push   $0x49
  jmp alltraps
80107777:	e9 04 f6 ff ff       	jmp    80106d80 <alltraps>
...
8010777c:	6a 00                	push   $0x0
  pushl $74
8010777e:	6a 4a                	push   $0x4a
  jmp alltraps
80107780:	e9 fb f5 ff ff       	jmp    80106d80 <alltraps>
...
80107785:	6a 00                	push   $0x0
  pushl $75
80107787:	6a 4b                	push   $0x4b
  jmp alltraps
80107789:	e9 f2 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010778e:	6a 00                	push   $0x0
  pushl $76
80107790:	6a 4c                	push   $0x4c
  jmp alltraps
80107792:	e9 e9 f5 ff ff       	jmp    80106d80 <alltraps>
...
80107797:	6a 00                	push   $0x0
  pushl $77
80107799:	6a 4d                	push   $0x4d
  jmp alltraps
8010779b:	e9 e0 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077a0:	6a 00                	push   $0x0
  pushl $78
801077a2:	6a 4e                	push   $0x4e
  jmp alltraps
801077a4:	e9 d7 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077a9:	6a 00                	push   $0x0
  pushl $79
801077ab:	6a 4f                	push   $0x4f
  jmp alltraps
801077ad:	e9 ce f5 ff ff       	jmp    80106d80 <alltraps>
...
801077b2:	6a 00                	push   $0x0
  pushl $80
801077b4:	6a 50                	push   $0x50
  jmp alltraps
801077b6:	e9 c5 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077bb:	6a 00                	push   $0x0
  pushl $81
801077bd:	6a 51                	push   $0x51
  jmp alltraps
801077bf:	e9 bc f5 ff ff       	jmp    80106d80 <alltraps>
...
801077c4:	6a 00                	push   $0x0
  pushl $82
801077c6:	6a 52                	push   $0x52
  jmp alltraps
801077c8:	e9 b3 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077cd:	6a 00                	push   $0x0
  pushl $83
801077cf:	6a 53                	push   $0x53
  jmp alltraps
801077d1:	e9 aa f5 ff ff       	jmp    80106d80 <alltraps>
...
801077d6:	6a 00                	push   $0x0
  pushl $84
801077d8:	6a 54                	push   $0x54
  jmp alltraps
801077da:	e9 a1 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077df:	6a 00                	push   $0x0
  pushl $85
801077e1:	6a 55                	push   $0x55
  jmp alltraps
801077e3:	e9 98 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077e8:	6a 00                	push   $0x0
  pushl $86
801077ea:	6a 56                	push   $0x56
  jmp alltraps
801077ec:	e9 8f f5 ff ff       	jmp    80106d80 <alltraps>
...
801077f1:	6a 00                	push   $0x0
  pushl $87
801077f3:	6a 57                	push   $0x57
  jmp alltraps
801077f5:	e9 86 f5 ff ff       	jmp    80106d80 <alltraps>
...
801077fa:	6a 00                	push   $0x0
  pushl $88
801077fc:	6a 58                	push   $0x58
  jmp alltraps
801077fe:	e9 7d f5 ff ff       	jmp    80106d80 <alltraps>
...
80107803:	6a 00                	push   $0x0
  pushl $89
80107805:	6a 59                	push   $0x59
  jmp alltraps
80107807:	e9 74 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010780c:	6a 00                	push   $0x0
  pushl $90
8010780e:	6a 5a                	push   $0x5a
  jmp alltraps
80107810:	e9 6b f5 ff ff       	jmp    80106d80 <alltraps>
...
80107815:	6a 00                	push   $0x0
  pushl $91
80107817:	6a 5b                	push   $0x5b
  jmp alltraps
80107819:	e9 62 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010781e:	6a 00                	push   $0x0
  pushl $92
80107820:	6a 5c                	push   $0x5c
  jmp alltraps
80107822:	e9 59 f5 ff ff       	jmp    80106d80 <alltraps>
...
80107827:	6a 00                	push   $0x0
  pushl $93
80107829:	6a 5d                	push   $0x5d
  jmp alltraps
8010782b:	e9 50 f5 ff ff       	jmp    80106d80 <alltraps>
...
80107830:	6a 00                	push   $0x0
  pushl $94
80107832:	6a 5e                	push   $0x5e
  jmp alltraps
80107834:	e9 47 f5 ff ff       	jmp    80106d80 <alltraps>
...
80107839:	6a 00                	push   $0x0
  pushl $95
8010783b:	6a 5f                	push   $0x5f
  jmp alltraps
8010783d:	e9 3e f5 ff ff       	jmp    80106d80 <alltraps>
...
80107842:	6a 00                	push   $0x0
  pushl $96
80107844:	6a 60                	push   $0x60
  jmp alltraps
80107846:	e9 35 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010784b:	6a 00                	push   $0x0
  pushl $97
8010784d:	6a 61                	push   $0x61
  jmp alltraps
8010784f:	e9 2c f5 ff ff       	jmp    80106d80 <alltraps>
...
80107854:	6a 00                	push   $0x0
  pushl $98
80107856:	6a 62                	push   $0x62
  jmp alltraps
80107858:	e9 23 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010785d:	6a 00                	push   $0x0
  pushl $99
8010785f:	6a 63                	push   $0x63
  jmp alltraps
80107861:	e9 1a f5 ff ff       	jmp    80106d80 <alltraps>
...
80107866:	6a 00                	push   $0x0
  pushl $100
80107868:	6a 64                	push   $0x64
  jmp alltraps
8010786a:	e9 11 f5 ff ff       	jmp    80106d80 <alltraps>
...
8010786f:	6a 00                	push   $0x0
  pushl $101
80107871:	6a 65                	push   $0x65
  jmp alltraps
80107873:	e9 08 f5 ff ff       	jmp    80106d80 <alltraps>
...
80107878:	6a 00                	push   $0x0
  pushl $102
8010787a:	6a 66                	push   $0x66
  jmp alltraps
8010787c:	e9 ff f4 ff ff       	jmp    80106d80 <alltraps>
...
80107881:	6a 00                	push   $0x0
  pushl $103
80107883:	6a 67                	push   $0x67
  jmp alltraps
80107885:	e9 f6 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010788a:	6a 00                	push   $0x0
  pushl $104
8010788c:	6a 68                	push   $0x68
  jmp alltraps
8010788e:	e9 ed f4 ff ff       	jmp    80106d80 <alltraps>
...
80107893:	6a 00                	push   $0x0
  pushl $105
80107895:	6a 69                	push   $0x69
  jmp alltraps
80107897:	e9 e4 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010789c:	6a 00                	push   $0x0
  pushl $106
8010789e:	6a 6a                	push   $0x6a
  jmp alltraps
801078a0:	e9 db f4 ff ff       	jmp    80106d80 <alltraps>
...
801078a5:	6a 00                	push   $0x0
  pushl $107
801078a7:	6a 6b                	push   $0x6b
  jmp alltraps
801078a9:	e9 d2 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078ae:	6a 00                	push   $0x0
  pushl $108
801078b0:	6a 6c                	push   $0x6c
  jmp alltraps
801078b2:	e9 c9 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078b7:	6a 00                	push   $0x0
  pushl $109
801078b9:	6a 6d                	push   $0x6d
  jmp alltraps
801078bb:	e9 c0 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078c0:	6a 00                	push   $0x0
  pushl $110
801078c2:	6a 6e                	push   $0x6e
  jmp alltraps
801078c4:	e9 b7 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078c9:	6a 00                	push   $0x0
  pushl $111
801078cb:	6a 6f                	push   $0x6f
  jmp alltraps
801078cd:	e9 ae f4 ff ff       	jmp    80106d80 <alltraps>
...
801078d2:	6a 00                	push   $0x0
  pushl $112
801078d4:	6a 70                	push   $0x70
  jmp alltraps
801078d6:	e9 a5 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078db:	6a 00                	push   $0x0
  pushl $113
801078dd:	6a 71                	push   $0x71
  jmp alltraps
801078df:	e9 9c f4 ff ff       	jmp    80106d80 <alltraps>
...
801078e4:	6a 00                	push   $0x0
  pushl $114
801078e6:	6a 72                	push   $0x72
  jmp alltraps
801078e8:	e9 93 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078ed:	6a 00                	push   $0x0
  pushl $115
801078ef:	6a 73                	push   $0x73
  jmp alltraps
801078f1:	e9 8a f4 ff ff       	jmp    80106d80 <alltraps>
...
801078f6:	6a 00                	push   $0x0
  pushl $116
801078f8:	6a 74                	push   $0x74
  jmp alltraps
801078fa:	e9 81 f4 ff ff       	jmp    80106d80 <alltraps>
...
801078ff:	6a 00                	push   $0x0
  pushl $117
80107901:	6a 75                	push   $0x75
  jmp alltraps
80107903:	e9 78 f4 ff ff       	jmp    80106d80 <alltraps>
...
80107908:	6a 00                	push   $0x0
  pushl $118
8010790a:	6a 76                	push   $0x76
  jmp alltraps
8010790c:	e9 6f f4 ff ff       	jmp    80106d80 <alltraps>
...
80107911:	6a 00                	push   $0x0
  pushl $119
80107913:	6a 77                	push   $0x77
  jmp alltraps
80107915:	e9 66 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010791a:	6a 00                	push   $0x0
  pushl $120
8010791c:	6a 78                	push   $0x78
  jmp alltraps
8010791e:	e9 5d f4 ff ff       	jmp    80106d80 <alltraps>
...
80107923:	6a 00                	push   $0x0
  pushl $121
80107925:	6a 79                	push   $0x79
  jmp alltraps
80107927:	e9 54 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010792c:	6a 00                	push   $0x0
  pushl $122
8010792e:	6a 7a                	push   $0x7a
  jmp alltraps
80107930:	e9 4b f4 ff ff       	jmp    80106d80 <alltraps>
...
80107935:	6a 00                	push   $0x0
  pushl $123
80107937:	6a 7b                	push   $0x7b
  jmp alltraps
80107939:	e9 42 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010793e:	6a 00                	push   $0x0
  pushl $124
80107940:	6a 7c                	push   $0x7c
  jmp alltraps
80107942:	e9 39 f4 ff ff       	jmp    80106d80 <alltraps>
...
80107947:	6a 00                	push   $0x0
  pushl $125
80107949:	6a 7d                	push   $0x7d
  jmp alltraps
8010794b:	e9 30 f4 ff ff       	jmp    80106d80 <alltraps>
...
80107950:	6a 00                	push   $0x0
  pushl $126
80107952:	6a 7e                	push   $0x7e
  jmp alltraps
80107954:	e9 27 f4 ff ff       	jmp    80106d80 <alltraps>
...
80107959:	6a 00                	push   $0x0
  pushl $127
8010795b:	6a 7f                	push   $0x7f
  jmp alltraps
8010795d:	e9 1e f4 ff ff       	jmp    80106d80 <alltraps>
...
80107962:	6a 00                	push   $0x0
  pushl $128
80107964:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107969:	e9 12 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010796e:	6a 00                	push   $0x0
  pushl $129
80107970:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107975:	e9 06 f4 ff ff       	jmp    80106d80 <alltraps>
...
8010797a:	6a 00                	push   $0x0
  pushl $130
8010797c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107981:	e9 fa f3 ff ff       	jmp    80106d80 <alltraps>
...
80107986:	6a 00                	push   $0x0
  pushl $131
80107988:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010798d:	e9 ee f3 ff ff       	jmp    80106d80 <alltraps>
...
80107992:	6a 00                	push   $0x0
  pushl $132
80107994:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107999:	e9 e2 f3 ff ff       	jmp    80106d80 <alltraps>
...
8010799e:	6a 00                	push   $0x0
  pushl $133
801079a0:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801079a5:	e9 d6 f3 ff ff       	jmp    80106d80 <alltraps>
...
801079aa:	6a 00                	push   $0x0
  pushl $134
801079ac:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801079b1:	e9 ca f3 ff ff       	jmp    80106d80 <alltraps>
...
801079b6:	6a 00                	push   $0x0
  pushl $135
801079b8:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801079bd:	e9 be f3 ff ff       	jmp    80106d80 <alltraps>
...
801079c2:	6a 00                	push   $0x0
  pushl $136
801079c4:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801079c9:	e9 b2 f3 ff ff       	jmp    80106d80 <alltraps>
...
801079ce:	6a 00                	push   $0x0
  pushl $137
801079d0:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801079d5:	e9 a6 f3 ff ff       	jmp    80106d80 <alltraps>
...
801079da:	6a 00                	push   $0x0
  pushl $138
801079dc:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801079e1:	e9 9a f3 ff ff       	jmp    80106d80 <alltraps>
...
801079e6:	6a 00                	push   $0x0
  pushl $139
801079e8:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801079ed:	e9 8e f3 ff ff       	jmp    80106d80 <alltraps>
...
801079f2:	6a 00                	push   $0x0
  pushl $140
801079f4:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801079f9:	e9 82 f3 ff ff       	jmp    80106d80 <alltraps>
...
801079fe:	6a 00                	push   $0x0
  pushl $141
80107a00:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107a05:	e9 76 f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a0a:	6a 00                	push   $0x0
  pushl $142
80107a0c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107a11:	e9 6a f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a16:	6a 00                	push   $0x0
  pushl $143
80107a18:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107a1d:	e9 5e f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a22:	6a 00                	push   $0x0
  pushl $144
80107a24:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107a29:	e9 52 f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a2e:	6a 00                	push   $0x0
  pushl $145
80107a30:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107a35:	e9 46 f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a3a:	6a 00                	push   $0x0
  pushl $146
80107a3c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107a41:	e9 3a f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a46:	6a 00                	push   $0x0
  pushl $147
80107a48:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107a4d:	e9 2e f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a52:	6a 00                	push   $0x0
  pushl $148
80107a54:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107a59:	e9 22 f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a5e:	6a 00                	push   $0x0
  pushl $149
80107a60:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107a65:	e9 16 f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a6a:	6a 00                	push   $0x0
  pushl $150
80107a6c:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107a71:	e9 0a f3 ff ff       	jmp    80106d80 <alltraps>
...
80107a76:	6a 00                	push   $0x0
  pushl $151
80107a78:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107a7d:	e9 fe f2 ff ff       	jmp    80106d80 <alltraps>
...
80107a82:	6a 00                	push   $0x0
  pushl $152
80107a84:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107a89:	e9 f2 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107a8e:	6a 00                	push   $0x0
  pushl $153
80107a90:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107a95:	e9 e6 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107a9a:	6a 00                	push   $0x0
  pushl $154
80107a9c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107aa1:	e9 da f2 ff ff       	jmp    80106d80 <alltraps>
...
80107aa6:	6a 00                	push   $0x0
  pushl $155
80107aa8:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107aad:	e9 ce f2 ff ff       	jmp    80106d80 <alltraps>
...
80107ab2:	6a 00                	push   $0x0
  pushl $156
80107ab4:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107ab9:	e9 c2 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107abe:	6a 00                	push   $0x0
  pushl $157
80107ac0:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107ac5:	e9 b6 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107aca:	6a 00                	push   $0x0
  pushl $158
80107acc:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107ad1:	e9 aa f2 ff ff       	jmp    80106d80 <alltraps>
...
80107ad6:	6a 00                	push   $0x0
  pushl $159
80107ad8:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107add:	e9 9e f2 ff ff       	jmp    80106d80 <alltraps>
...
80107ae2:	6a 00                	push   $0x0
  pushl $160
80107ae4:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107ae9:	e9 92 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107aee:	6a 00                	push   $0x0
  pushl $161
80107af0:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107af5:	e9 86 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107afa:	6a 00                	push   $0x0
  pushl $162
80107afc:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107b01:	e9 7a f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b06:	6a 00                	push   $0x0
  pushl $163
80107b08:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107b0d:	e9 6e f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b12:	6a 00                	push   $0x0
  pushl $164
80107b14:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107b19:	e9 62 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b1e:	6a 00                	push   $0x0
  pushl $165
80107b20:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107b25:	e9 56 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b2a:	6a 00                	push   $0x0
  pushl $166
80107b2c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107b31:	e9 4a f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b36:	6a 00                	push   $0x0
  pushl $167
80107b38:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107b3d:	e9 3e f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b42:	6a 00                	push   $0x0
  pushl $168
80107b44:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107b49:	e9 32 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b4e:	6a 00                	push   $0x0
  pushl $169
80107b50:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107b55:	e9 26 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b5a:	6a 00                	push   $0x0
  pushl $170
80107b5c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107b61:	e9 1a f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b66:	6a 00                	push   $0x0
  pushl $171
80107b68:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107b6d:	e9 0e f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b72:	6a 00                	push   $0x0
  pushl $172
80107b74:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107b79:	e9 02 f2 ff ff       	jmp    80106d80 <alltraps>
...
80107b7e:	6a 00                	push   $0x0
  pushl $173
80107b80:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107b85:	e9 f6 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107b8a:	6a 00                	push   $0x0
  pushl $174
80107b8c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107b91:	e9 ea f1 ff ff       	jmp    80106d80 <alltraps>
...
80107b96:	6a 00                	push   $0x0
  pushl $175
80107b98:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107b9d:	e9 de f1 ff ff       	jmp    80106d80 <alltraps>
...
80107ba2:	6a 00                	push   $0x0
  pushl $176
80107ba4:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107ba9:	e9 d2 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bae:	6a 00                	push   $0x0
  pushl $177
80107bb0:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107bb5:	e9 c6 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bba:	6a 00                	push   $0x0
  pushl $178
80107bbc:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107bc1:	e9 ba f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bc6:	6a 00                	push   $0x0
  pushl $179
80107bc8:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107bcd:	e9 ae f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bd2:	6a 00                	push   $0x0
  pushl $180
80107bd4:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107bd9:	e9 a2 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bde:	6a 00                	push   $0x0
  pushl $181
80107be0:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107be5:	e9 96 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bea:	6a 00                	push   $0x0
  pushl $182
80107bec:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107bf1:	e9 8a f1 ff ff       	jmp    80106d80 <alltraps>
...
80107bf6:	6a 00                	push   $0x0
  pushl $183
80107bf8:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107bfd:	e9 7e f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c02:	6a 00                	push   $0x0
  pushl $184
80107c04:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107c09:	e9 72 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c0e:	6a 00                	push   $0x0
  pushl $185
80107c10:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107c15:	e9 66 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c1a:	6a 00                	push   $0x0
  pushl $186
80107c1c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107c21:	e9 5a f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c26:	6a 00                	push   $0x0
  pushl $187
80107c28:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107c2d:	e9 4e f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c32:	6a 00                	push   $0x0
  pushl $188
80107c34:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107c39:	e9 42 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c3e:	6a 00                	push   $0x0
  pushl $189
80107c40:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107c45:	e9 36 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c4a:	6a 00                	push   $0x0
  pushl $190
80107c4c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107c51:	e9 2a f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c56:	6a 00                	push   $0x0
  pushl $191
80107c58:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107c5d:	e9 1e f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c62:	6a 00                	push   $0x0
  pushl $192
80107c64:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107c69:	e9 12 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c6e:	6a 00                	push   $0x0
  pushl $193
80107c70:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107c75:	e9 06 f1 ff ff       	jmp    80106d80 <alltraps>
...
80107c7a:	6a 00                	push   $0x0
  pushl $194
80107c7c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107c81:	e9 fa f0 ff ff       	jmp    80106d80 <alltraps>
...
80107c86:	6a 00                	push   $0x0
  pushl $195
80107c88:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107c8d:	e9 ee f0 ff ff       	jmp    80106d80 <alltraps>
...
80107c92:	6a 00                	push   $0x0
  pushl $196
80107c94:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107c99:	e9 e2 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107c9e:	6a 00                	push   $0x0
  pushl $197
80107ca0:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107ca5:	e9 d6 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107caa:	6a 00                	push   $0x0
  pushl $198
80107cac:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107cb1:	e9 ca f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cb6:	6a 00                	push   $0x0
  pushl $199
80107cb8:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107cbd:	e9 be f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cc2:	6a 00                	push   $0x0
  pushl $200
80107cc4:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107cc9:	e9 b2 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cce:	6a 00                	push   $0x0
  pushl $201
80107cd0:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107cd5:	e9 a6 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cda:	6a 00                	push   $0x0
  pushl $202
80107cdc:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107ce1:	e9 9a f0 ff ff       	jmp    80106d80 <alltraps>
...
80107ce6:	6a 00                	push   $0x0
  pushl $203
80107ce8:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107ced:	e9 8e f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cf2:	6a 00                	push   $0x0
  pushl $204
80107cf4:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107cf9:	e9 82 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107cfe:	6a 00                	push   $0x0
  pushl $205
80107d00:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107d05:	e9 76 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d0a:	6a 00                	push   $0x0
  pushl $206
80107d0c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107d11:	e9 6a f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d16:	6a 00                	push   $0x0
  pushl $207
80107d18:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107d1d:	e9 5e f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d22:	6a 00                	push   $0x0
  pushl $208
80107d24:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107d29:	e9 52 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d2e:	6a 00                	push   $0x0
  pushl $209
80107d30:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107d35:	e9 46 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d3a:	6a 00                	push   $0x0
  pushl $210
80107d3c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107d41:	e9 3a f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d46:	6a 00                	push   $0x0
  pushl $211
80107d48:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107d4d:	e9 2e f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d52:	6a 00                	push   $0x0
  pushl $212
80107d54:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107d59:	e9 22 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d5e:	6a 00                	push   $0x0
  pushl $213
80107d60:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107d65:	e9 16 f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d6a:	6a 00                	push   $0x0
  pushl $214
80107d6c:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107d71:	e9 0a f0 ff ff       	jmp    80106d80 <alltraps>
...
80107d76:	6a 00                	push   $0x0
  pushl $215
80107d78:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107d7d:	e9 fe ef ff ff       	jmp    80106d80 <alltraps>
...
80107d82:	6a 00                	push   $0x0
  pushl $216
80107d84:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107d89:	e9 f2 ef ff ff       	jmp    80106d80 <alltraps>
...
80107d8e:	6a 00                	push   $0x0
  pushl $217
80107d90:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107d95:	e9 e6 ef ff ff       	jmp    80106d80 <alltraps>
...
80107d9a:	6a 00                	push   $0x0
  pushl $218
80107d9c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107da1:	e9 da ef ff ff       	jmp    80106d80 <alltraps>
...
80107da6:	6a 00                	push   $0x0
  pushl $219
80107da8:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107dad:	e9 ce ef ff ff       	jmp    80106d80 <alltraps>
...
80107db2:	6a 00                	push   $0x0
  pushl $220
80107db4:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107db9:	e9 c2 ef ff ff       	jmp    80106d80 <alltraps>
...
80107dbe:	6a 00                	push   $0x0
  pushl $221
80107dc0:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107dc5:	e9 b6 ef ff ff       	jmp    80106d80 <alltraps>
...
80107dca:	6a 00                	push   $0x0
  pushl $222
80107dcc:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107dd1:	e9 aa ef ff ff       	jmp    80106d80 <alltraps>
...
80107dd6:	6a 00                	push   $0x0
  pushl $223
80107dd8:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107ddd:	e9 9e ef ff ff       	jmp    80106d80 <alltraps>
...
80107de2:	6a 00                	push   $0x0
  pushl $224
80107de4:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107de9:	e9 92 ef ff ff       	jmp    80106d80 <alltraps>
...
80107dee:	6a 00                	push   $0x0
  pushl $225
80107df0:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107df5:	e9 86 ef ff ff       	jmp    80106d80 <alltraps>
...
80107dfa:	6a 00                	push   $0x0
  pushl $226
80107dfc:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107e01:	e9 7a ef ff ff       	jmp    80106d80 <alltraps>
...
80107e06:	6a 00                	push   $0x0
  pushl $227
80107e08:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107e0d:	e9 6e ef ff ff       	jmp    80106d80 <alltraps>
...
80107e12:	6a 00                	push   $0x0
  pushl $228
80107e14:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107e19:	e9 62 ef ff ff       	jmp    80106d80 <alltraps>
...
80107e1e:	6a 00                	push   $0x0
  pushl $229
80107e20:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107e25:	e9 56 ef ff ff       	jmp    80106d80 <alltraps>
...
80107e2a:	6a 00                	push   $0x0
  pushl $230
80107e2c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107e31:	e9 4a ef ff ff       	jmp    80106d80 <alltraps>
...
80107e36:	6a 00                	push   $0x0
  pushl $231
80107e38:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107e3d:	e9 3e ef ff ff       	jmp    80106d80 <alltraps>
...
80107e42:	6a 00                	push   $0x0
  pushl $232
80107e44:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107e49:	e9 32 ef ff ff       	jmp    80106d80 <alltraps>
...
80107e4e:	6a 00                	push   $0x0
  pushl $233
80107e50:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107e55:	e9 26 ef ff ff       	jmp    80106d80 <alltraps>
...
80107e5a:	6a 00                	push   $0x0
  pushl $234
80107e5c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107e61:	e9 1a ef ff ff       	jmp    80106d80 <alltraps>
...
80107e66:	6a 00                	push   $0x0
  pushl $235
80107e68:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107e6d:	e9 0e ef ff ff       	jmp    80106d80 <alltraps>
...
80107e72:	6a 00                	push   $0x0
  pushl $236
80107e74:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107e79:	e9 02 ef ff ff       	jmp    80106d80 <alltraps>
...
80107e7e:	6a 00                	push   $0x0
  pushl $237
80107e80:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107e85:	e9 f6 ee ff ff       	jmp    80106d80 <alltraps>
...
80107e8a:	6a 00                	push   $0x0
  pushl $238
80107e8c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107e91:	e9 ea ee ff ff       	jmp    80106d80 <alltraps>
...
80107e96:	6a 00                	push   $0x0
  pushl $239
80107e98:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107e9d:	e9 de ee ff ff       	jmp    80106d80 <alltraps>
...
80107ea2:	6a 00                	push   $0x0
  pushl $240
80107ea4:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107ea9:	e9 d2 ee ff ff       	jmp    80106d80 <alltraps>
...
80107eae:	6a 00                	push   $0x0
  pushl $241
80107eb0:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107eb5:	e9 c6 ee ff ff       	jmp    80106d80 <alltraps>
...
80107eba:	6a 00                	push   $0x0
  pushl $242
80107ebc:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107ec1:	e9 ba ee ff ff       	jmp    80106d80 <alltraps>
...
80107ec6:	6a 00                	push   $0x0
  pushl $243
80107ec8:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107ecd:	e9 ae ee ff ff       	jmp    80106d80 <alltraps>
...
80107ed2:	6a 00                	push   $0x0
  pushl $244
80107ed4:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107ed9:	e9 a2 ee ff ff       	jmp    80106d80 <alltraps>
...
80107ede:	6a 00                	push   $0x0
  pushl $245
80107ee0:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107ee5:	e9 96 ee ff ff       	jmp    80106d80 <alltraps>
...
80107eea:	6a 00                	push   $0x0
  pushl $246
80107eec:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107ef1:	e9 8a ee ff ff       	jmp    80106d80 <alltraps>
...
80107ef6:	6a 00                	push   $0x0
  pushl $247
80107ef8:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107efd:	e9 7e ee ff ff       	jmp    80106d80 <alltraps>
...
80107f02:	6a 00                	push   $0x0
  pushl $248
80107f04:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107f09:	e9 72 ee ff ff       	jmp    80106d80 <alltraps>
...
80107f0e:	6a 00                	push   $0x0
  pushl $249
80107f10:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107f15:	e9 66 ee ff ff       	jmp    80106d80 <alltraps>
...
80107f1a:	6a 00                	push   $0x0
  pushl $250
80107f1c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107f21:	e9 5a ee ff ff       	jmp    80106d80 <alltraps>
...
80107f26:	6a 00                	push   $0x0
  pushl $251
80107f28:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107f2d:	e9 4e ee ff ff       	jmp    80106d80 <alltraps>
...
80107f32:	6a 00                	push   $0x0
  pushl $252
80107f34:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107f39:	e9 42 ee ff ff       	jmp    80106d80 <alltraps>
...
80107f3e:	6a 00                	push   $0x0
  pushl $253
80107f40:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107f45:	e9 36 ee ff ff       	jmp    80106d80 <alltraps>
...
80107f4a:	6a 00                	push   $0x0
  pushl $254
80107f4c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107f51:	e9 2a ee ff ff       	jmp    80106d80 <alltraps>
...
80107f56:	6a 00                	push   $0x0
  pushl $255
80107f58:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107f5d:	e9 1e ee ff ff       	jmp    80106d80 <alltraps>
	...
...
80107f67:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107f6a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f6d:	83 e8 01             	sub    $0x1,%eax
80107f70:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107f74:	8b 45 08             	mov    0x8(%ebp),%eax
80107f77:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107f7b:	8b 45 08             	mov    0x8(%ebp),%eax
80107f7e:	c1 e8 10             	shr    $0x10,%eax
80107f81:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107f85:	8d 45 fa             	lea    -0x6(%ebp),%eax
...
80107fe0:	53                   	push   %ebx
80107fe1:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107fe4:	e8 36 af ff ff       	call   80102f1f <cpunum>
80107fe9:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107fef:	05 e0 39 11 80       	add    $0x801139e0,%eax
80107ff4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107ff7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ffa:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80108000:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108003:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80108009:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800c:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80108010:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108013:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108017:	83 e2 f0             	and    $0xfffffff0,%edx
8010801a:	83 ca 0a             	or     $0xa,%edx
8010801d:	88 50 7d             	mov    %dl,0x7d(%eax)
80108020:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108023:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108027:	83 ca 10             	or     $0x10,%edx
8010802a:	88 50 7d             	mov    %dl,0x7d(%eax)
8010802d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108030:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108034:	83 e2 9f             	and    $0xffffff9f,%edx
80108037:	88 50 7d             	mov    %dl,0x7d(%eax)
8010803a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80108041:	83 ca 80             	or     $0xffffff80,%edx
80108044:	88 50 7d             	mov    %dl,0x7d(%eax)
80108047:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804a:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010804e:	83 ca 0f             	or     $0xf,%edx
80108051:	88 50 7e             	mov    %dl,0x7e(%eax)
80108054:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108057:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010805b:	83 e2 ef             	and    $0xffffffef,%edx
8010805e:	88 50 7e             	mov    %dl,0x7e(%eax)
80108061:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108064:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108068:	83 e2 df             	and    $0xffffffdf,%edx
8010806b:	88 50 7e             	mov    %dl,0x7e(%eax)
8010806e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108071:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108075:	83 ca 40             	or     $0x40,%edx
80108078:	88 50 7e             	mov    %dl,0x7e(%eax)
8010807b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010807e:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108082:	83 ca 80             	or     $0xffffff80,%edx
80108085:	88 50 7e             	mov    %dl,0x7e(%eax)
80108088:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010808b:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010808f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108092:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80108099:	ff ff 
8010809b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010809e:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801080a5:	00 00 
801080a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080aa:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
...
801080ca:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801080d1:	83 ca 10             	or     $0x10,%edx
801080d4:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080dd:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801080e4:	83 e2 9f             	and    $0xffffff9f,%edx
801080e7:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
801080ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080f0:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801080f7:	83 ca 80             	or     $0xffffff80,%edx
801080fa:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108100:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108103:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010810a:	83 ca 0f             	or     $0xf,%edx
8010810d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108113:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108116:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010811d:	83 e2 ef             	and    $0xffffffef,%edx
80108120:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108126:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108129:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108130:	83 e2 df             	and    $0xffffffdf,%edx
80108133:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108139:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813c:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108143:	83 ca 40             	or     $0x40,%edx
80108146:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010814c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010814f:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108156:	83 ca 80             	or     $0xffffff80,%edx
80108159:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010815f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108162:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108169:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010816c:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80108173:	ff ff 
80108175:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108178:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010817f:	00 00 
80108181:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108184:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010818b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108195:	83 e2 f0             	and    $0xfffffff0,%edx
80108198:	83 ca 0a             	or     $0xa,%edx
8010819b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801081a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a4:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801081ab:	83 ca 10             	or     $0x10,%edx
801081ae:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801081b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b7:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801081be:	83 ca 60             	or     $0x60,%edx
801081c1:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801081c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ca:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801081d1:	83 ca 80             	or     $0xffffff80,%edx
801081d4:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801081da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081dd:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801081e4:	83 ca 0f             	or     $0xf,%edx
801081e7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801081ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f0:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801081f7:	83 e2 ef             	and    $0xffffffef,%edx
801081fa:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108200:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108203:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010820a:	83 e2 df             	and    $0xffffffdf,%edx
8010820d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108213:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108216:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010821d:	83 ca 40             	or     $0x40,%edx
80108220:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108226:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108229:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108230:	83 ca 80             	or     $0xffffff80,%edx
80108233:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108239:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010823c:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108243:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108246:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
8010824d:	ff ff 
8010824f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108252:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108259:	00 00 
8010825b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010825e:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80108265:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108268:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010826f:	83 e2 f0             	and    $0xfffffff0,%edx
80108272:	83 ca 02             	or     $0x2,%edx
80108275:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010827b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010827e:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108285:	83 ca 10             	or     $0x10,%edx
80108288:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010828e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108291:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108298:	83 ca 60             	or     $0x60,%edx
8010829b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801082a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a4:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801082ab:	83 ca 80             	or     $0xffffff80,%edx
801082ae:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801082b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082b7:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801082be:	83 ca 0f             	or     $0xf,%edx
801082c1:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801082c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ca:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801082d1:	83 e2 ef             	and    $0xffffffef,%edx
801082d4:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801082da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082dd:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801082e4:	83 e2 df             	and    $0xffffffdf,%edx
801082e7:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801082ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082f0:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801082f7:	83 ca 40             	or     $0x40,%edx
801082fa:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108300:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108303:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010830a:	83 ca 80             	or     $0xffffff80,%edx
8010830d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108313:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108316:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010831d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108320:	05 b4 00 00 00       	add    $0xb4,%eax
80108325:	89 c3                	mov    %eax,%ebx
80108327:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010832a:	05 b4 00 00 00       	add    $0xb4,%eax
8010832f:	c1 e8 10             	shr    $0x10,%eax
80108332:	89 c1                	mov    %eax,%ecx
...
80108344:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
8010834b:	00 00 
8010834d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108350:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80108357:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010835a:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108360:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108363:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010836a:	83 e1 f0             	and    $0xfffffff0,%ecx
8010836d:	83 c9 02             	or     $0x2,%ecx
80108370:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108376:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108379:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108380:	83 c9 10             	or     $0x10,%ecx
80108383:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108389:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010838c:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108393:	83 e1 9f             	and    $0xffffff9f,%ecx
80108396:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010839c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010839f:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801083a6:	83 c9 80             	or     $0xffffff80,%ecx
801083a9:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801083af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b2:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801083b9:	83 e1 f0             	and    $0xfffffff0,%ecx
801083bc:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083c5:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801083cc:	83 e1 ef             	and    $0xffffffef,%ecx
801083cf:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083d8:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801083df:	83 e1 df             	and    $0xffffffdf,%ecx
801083e2:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083eb:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801083f2:	83 c9 40             	or     $0x40,%ecx
801083f5:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801083fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083fe:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108405:	83 c9 80             	or     $0xffffff80,%ecx
80108408:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010840e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108411:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108417:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010841a:	83 c0 70             	add    $0x70,%eax
8010841d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108424:	00 
80108425:	89 04 24             	mov    %eax,(%esp)
80108428:	e8 37 fb ff ff       	call   80107f64 <lgdt>
  loadgs(SEG_KCPU << 3);
8010842d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108434:	e8 6a fb ff ff       	call   80107fa3 <loadgs>
...
8010844d:	83 c4 24             	add    $0x24,%esp
80108450:	5b                   	pop    %ebx
80108451:	5d                   	pop    %ebp
80108452:	c3                   	ret    
...
8010845f:	c1 e0 02             	shl    $0x2,%eax
80108462:	03 45 08             	add    0x8(%ebp),%eax
80108465:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80108468:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010846b:	8b 00                	mov    (%eax),%eax
8010846d:	83 e0 01             	and    $0x1,%eax
80108470:	84 c0                	test   %al,%al
80108472:	74 17                	je     8010848b <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80108474:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108477:	8b 00                	mov    (%eax),%eax
80108479:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010847e:	89 04 24             	mov    %eax,(%esp)
80108481:	e8 4a fb ff ff       	call   80107fd0 <p2v>
80108486:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108489:	eb 4b                	jmp    801084d6 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010848b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010848f:	74 0e                	je     8010849f <walkpgdir+0x4c>
80108491:	e8 d1 a6 ff ff       	call   80102b67 <kalloc>
80108496:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108499:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010849d:	75 07                	jne    801084a6 <walkpgdir+0x53>
      return 0;
8010849f:	b8 00 00 00 00       	mov    $0x0,%eax
801084a4:	eb 41                	jmp    801084e7 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801084a6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801084ad:	00 
801084ae:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801084b5:	00 
801084b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084b9:	89 04 24             	mov    %eax,(%esp)
801084bc:	e8 81 d2 ff ff       	call   80105742 <memset>
...
801084c7:	e8 f7 fa ff ff       	call   80107fc3 <v2p>
801084cc:	89 c2                	mov    %eax,%edx
801084ce:	83 ca 07             	or     $0x7,%edx
801084d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084d4:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801084d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801084d9:	c1 e8 0c             	shr    $0xc,%eax
801084dc:	25 ff 03 00 00       	and    $0x3ff,%eax
801084e1:	c1 e0 02             	shl    $0x2,%eax
801084e4:	03 45 f4             	add    -0xc(%ebp),%eax
}
801084e7:	c9                   	leave  
801084e8:	c3                   	ret    
...
80108520:	e8 2e ff ff ff       	call   80108453 <walkpgdir>
80108525:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108528:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010852c:	75 07                	jne    80108535 <mappages+0x4c>
      return -1;
8010852e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108533:	eb 46                	jmp    8010857b <mappages+0x92>
    if(*pte & PTE_P)
80108535:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108538:	8b 00                	mov    (%eax),%eax
8010853a:	83 e0 01             	and    $0x1,%eax
8010853d:	84 c0                	test   %al,%al
8010853f:	74 0c                	je     8010854d <mappages+0x64>
      panic("remap");
80108541:	c7 04 24 20 98 10 80 	movl   $0x80109820,(%esp)
80108548:	e8 f0 7f ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
8010854d:	8b 45 18             	mov    0x18(%ebp),%eax
80108550:	0b 45 14             	or     0x14(%ebp),%eax
80108553:	89 c2                	mov    %eax,%edx
80108555:	83 ca 01             	or     $0x1,%edx
80108558:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010855b:	89 10                	mov    %edx,(%eax)
    if(a == last)
8010855d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108560:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108563:	74 10                	je     80108575 <mappages+0x8c>
      break;
    a += PGSIZE;
...
80108573:	eb 96                	jmp    8010850b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108581:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108584:	e8 de a5 ff ff       	call   80102b67 <kalloc>
80108589:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010858c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108590:	75 0a                	jne    8010859c <setupkvm+0x1f>
    return 0;
80108592:	b8 00 00 00 00       	mov    $0x0,%eax
80108597:	e9 98 00 00 00       	jmp    80108634 <setupkvm+0xb7>
...
801085b2:	e8 8b d1 ff ff       	call   80105742 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
801085b7:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
801085be:	e8 0d fa ff ff       	call   80107fd0 <p2v>
801085c3:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
801085c8:	76 0c                	jbe    801085d6 <setupkvm+0x59>
    panic("PHYSTOP too high");
801085ca:	c7 04 24 26 98 10 80 	movl   $0x80109826,(%esp)
801085d1:	e8 67 7f ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801085d6:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
801085dd:	eb 49                	jmp    80108628 <setupkvm+0xab>
...
801085df:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801085e2:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
801085e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
801085e8:	8b 50 04             	mov    0x4(%eax),%edx
801085eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085ee:	8b 58 08             	mov    0x8(%eax),%ebx
801085f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085f4:	8b 40 04             	mov    0x4(%eax),%eax
801085f7:	29 c3                	sub    %eax,%ebx
801085f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085fc:	8b 00                	mov    (%eax),%eax
801085fe:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108602:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108606:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010860a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010860e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108611:	89 04 24             	mov    %eax,(%esp)
80108614:	e8 d0 fe ff ff       	call   801084e9 <mappages>
80108619:	85 c0                	test   %eax,%eax
8010861b:	79 07                	jns    80108624 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010861d:	b8 00 00 00 00       	mov    $0x0,%eax
80108622:	eb 10                	jmp    80108634 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108624:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108628:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
8010862f:	72 ae                	jb     801085df <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80108634:	83 c4 34             	add    $0x34,%esp
80108637:	5b                   	pop    %ebx
80108638:	5d                   	pop    %ebp
80108639:	c3                   	ret    
...
8010863d:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108640:	e8 38 ff ff ff       	call   8010857d <setupkvm>
80108645:	a3 b8 70 11 80       	mov    %eax,0x801170b8
  switchkvm();
8010864a:	e8 02 00 00 00       	call   80108651 <switchkvm>
}
8010864f:	c9                   	leave  
80108650:	c3                   	ret    
...
80108657:	a1 b8 70 11 80       	mov    0x801170b8,%eax
8010865c:	89 04 24             	mov    %eax,(%esp)
8010865f:	e8 5f f9 ff ff       	call   80107fc3 <v2p>
80108664:	89 04 24             	mov    %eax,(%esp)
80108667:	e8 4c f9 ff ff       	call   80107fb8 <lcr3>
}
8010866c:	c9                   	leave  
8010866d:	c3                   	ret    
...
80108672:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108675:	e8 c1 cf ff ff       	call   8010563b <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010867a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108680:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108687:	83 c2 08             	add    $0x8,%edx
8010868a:	89 d3                	mov    %edx,%ebx
8010868c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108693:	83 c2 08             	add    $0x8,%edx
80108696:	c1 ea 10             	shr    $0x10,%edx
80108699:	89 d1                	mov    %edx,%ecx
8010869b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801086a2:	83 c2 08             	add    $0x8,%edx
801086a5:	c1 ea 18             	shr    $0x18,%edx
801086a8:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
801086af:	67 00 
801086b1:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
801086b8:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
801086be:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801086c5:	83 e1 f0             	and    $0xfffffff0,%ecx
801086c8:	83 c9 09             	or     $0x9,%ecx
801086cb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801086d1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801086d8:	83 c9 10             	or     $0x10,%ecx
801086db:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801086e1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801086e8:	83 e1 9f             	and    $0xffffff9f,%ecx
801086eb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801086f1:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801086f8:	83 c9 80             	or     $0xffffff80,%ecx
801086fb:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108701:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108708:	83 e1 f0             	and    $0xfffffff0,%ecx
8010870b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108711:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108718:	83 e1 ef             	and    $0xffffffef,%ecx
8010871b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108721:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108728:	83 e1 df             	and    $0xffffffdf,%ecx
8010872b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108731:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108738:	83 c9 40             	or     $0x40,%ecx
8010873b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108741:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108748:	83 e1 7f             	and    $0x7f,%ecx
8010874b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108751:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80108757:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010875d:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80108764:	83 e2 ef             	and    $0xffffffef,%edx
80108767:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
8010876d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108773:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80108779:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010877f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80108786:	8b 52 08             	mov    0x8(%edx),%edx
80108789:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010878f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108792:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108799:	e8 ef f7 ff ff       	call   80107f8d <ltr>
  if(p->pgdir == 0)
8010879e:	8b 45 08             	mov    0x8(%ebp),%eax
801087a1:	8b 40 04             	mov    0x4(%eax),%eax
801087a4:	85 c0                	test   %eax,%eax
801087a6:	75 0c                	jne    801087b4 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801087a8:	c7 04 24 37 98 10 80 	movl   $0x80109837,(%esp)
801087af:	e8 89 7d ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
801087b4:	8b 45 08             	mov    0x8(%ebp),%eax
801087b7:	8b 40 04             	mov    0x4(%eax),%eax
801087ba:	89 04 24             	mov    %eax,(%esp)
801087bd:	e8 01 f8 ff ff       	call   80107fc3 <v2p>
801087c2:	89 04 24             	mov    %eax,(%esp)
801087c5:	e8 ee f7 ff ff       	call   80107fb8 <lcr3>
  popcli();
801087ca:	e8 b4 ce ff ff       	call   80105683 <popcli>
}
801087cf:	83 c4 14             	add    $0x14,%esp
801087d2:	5b                   	pop    %ebx
801087d3:	5d                   	pop    %ebp
801087d4:	c3                   	ret    
...
801087d8:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801087db:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801087e2:	76 0c                	jbe    801087f0 <inituvm+0x1b>
    panic("inituvm: more than a page");
801087e4:	c7 04 24 4b 98 10 80 	movl   $0x8010984b,(%esp)
801087eb:	e8 4d 7d ff ff       	call   8010053d <panic>
  mem = kalloc();
801087f0:	e8 72 a3 ff ff       	call   80102b67 <kalloc>
801087f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
801087f8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801087ff:	00 
80108800:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108807:	00 
80108808:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010880b:	89 04 24             	mov    %eax,(%esp)
8010880e:	e8 2f cf ff ff       	call   80105742 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108813:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108816:	89 04 24             	mov    %eax,(%esp)
80108819:	e8 a5 f7 ff ff       	call   80107fc3 <v2p>
8010881e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108825:	00 
80108826:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80108840:	e8 a4 fc ff ff       	call   801084e9 <mappages>
  memmove(mem, init, sz);
80108845:	8b 45 10             	mov    0x10(%ebp),%eax
...
80108859:	e8 b7 cf ff ff       	call   80105815 <memmove>
}
8010885e:	c9                   	leave  
8010885f:	c3                   	ret    
...
80108864:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80108871:	74 0c                	je     8010887f <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108873:	c7 04 24 68 98 10 80 	movl   $0x80109868,(%esp)
8010887a:	e8 be 7c ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
8010887f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108886:	e9 ad 00 00 00       	jmp    80108938 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010888b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010888e:	8b 55 0c             	mov    0xc(%ebp),%edx
80108891:	01 d0                	add    %edx,%eax
80108893:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010889a:	00 
8010889b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010889f:	8b 45 08             	mov    0x8(%ebp),%eax
801088a2:	89 04 24             	mov    %eax,(%esp)
801088a5:	e8 a9 fb ff ff       	call   80108453 <walkpgdir>
801088aa:	89 45 ec             	mov    %eax,-0x14(%ebp)
801088ad:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801088b1:	75 0c                	jne    801088bf <loaduvm+0x5f>
      panic("loaduvm: address should exist");
801088b3:	c7 04 24 8b 98 10 80 	movl   $0x8010988b,(%esp)
801088ba:	e8 7e 7c ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
801088cf:	8b 55 18             	mov    0x18(%ebp),%edx
801088d2:	89 d1                	mov    %edx,%ecx
801088d4:	29 c1                	sub    %eax,%ecx
801088d6:	89 c8                	mov    %ecx,%eax
801088d8:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801088dd:	77 11                	ja     801088f0 <loaduvm+0x90>
      n = sz - i;
801088df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088e2:	8b 55 18             	mov    0x18(%ebp),%edx
801088e5:	89 d1                	mov    %edx,%ecx
801088e7:	29 c1                	sub    %eax,%ecx
801088e9:	89 c8                	mov    %ecx,%eax
801088eb:	89 45 f0             	mov    %eax,-0x10(%ebp)
801088ee:	eb 07                	jmp    801088f7 <loaduvm+0x97>
    else
      n = PGSIZE;
801088f0:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801088f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088fa:	8b 55 14             	mov    0x14(%ebp),%edx
801088fd:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108900:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108903:	89 04 24             	mov    %eax,(%esp)
80108906:	e8 c5 f6 ff ff       	call   80107fd0 <p2v>
8010890b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010890e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108912:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108916:	89 44 24 04          	mov    %eax,0x4(%esp)
8010891a:	8b 45 10             	mov    0x10(%ebp),%eax
8010891d:	89 04 24             	mov    %eax,(%esp)
80108920:	e8 a1 94 ff ff       	call   80101dc6 <readi>
80108925:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108928:	74 07                	je     80108931 <loaduvm+0xd1>
      return -1;
8010892a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010892f:	eb 18                	jmp    80108949 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
8010893b:	3b 45 18             	cmp    0x18(%ebp),%eax
8010893e:	0f 82 47 ff ff ff    	jb     8010888b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108949:	83 c4 24             	add    $0x24,%esp
8010894c:	5b                   	pop    %ebx
8010894d:	5d                   	pop    %ebp
8010894e:	c3                   	ret    
...
80108952:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
8010895a:	79 0a                	jns    80108966 <allocuvm+0x17>
    return 0;
8010895c:	b8 00 00 00 00       	mov    $0x0,%eax
80108961:	e9 c1 00 00 00       	jmp    80108a27 <allocuvm+0xd8>
  if(newsz < oldsz)
80108966:	8b 45 10             	mov    0x10(%ebp),%eax
80108969:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010896c:	73 08                	jae    80108976 <allocuvm+0x27>
    return oldsz;
8010896e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108971:	e9 b1 00 00 00       	jmp    80108a27 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108976:	8b 45 0c             	mov    0xc(%ebp),%eax
80108979:	05 ff 0f 00 00       	add    $0xfff,%eax
8010897e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108983:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108986:	e9 8d 00 00 00       	jmp    80108a18 <allocuvm+0xc9>
    mem = kalloc();
8010898b:	e8 d7 a1 ff ff       	call   80102b67 <kalloc>
80108990:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108993:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108997:	75 2c                	jne    801089c5 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108999:	c7 04 24 a9 98 10 80 	movl   $0x801098a9,(%esp)
801089a0:	e8 fc 79 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801089a5:	8b 45 0c             	mov    0xc(%ebp),%eax
801089a8:	89 44 24 08          	mov    %eax,0x8(%esp)
801089ac:	8b 45 10             	mov    0x10(%ebp),%eax
801089af:	89 44 24 04          	mov    %eax,0x4(%esp)
801089b3:	8b 45 08             	mov    0x8(%ebp),%eax
801089b6:	89 04 24             	mov    %eax,(%esp)
801089b9:	e8 6b 00 00 00       	call   80108a29 <deallocuvm>
      return 0;
801089be:	b8 00 00 00 00       	mov    $0x0,%eax
801089c3:	eb 62                	jmp    80108a27 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
801089c5:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801089cc:	00 
801089cd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801089d4:	00 
801089d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089d8:	89 04 24             	mov    %eax,(%esp)
801089db:	e8 62 cd ff ff       	call   80105742 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801089e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089e3:	89 04 24             	mov    %eax,(%esp)
801089e6:	e8 d8 f5 ff ff       	call   80107fc3 <v2p>
801089eb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801089ee:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801089f5:	00 
801089f6:	89 44 24 0c          	mov    %eax,0xc(%esp)
801089fa:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a01:	00 
80108a02:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a06:	8b 45 08             	mov    0x8(%ebp),%eax
80108a09:	89 04 24             	mov    %eax,(%esp)
80108a0c:	e8 d8 fa ff ff       	call   801084e9 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108a1b:	3b 45 10             	cmp    0x10(%ebp),%eax
80108a1e:	0f 82 67 ff ff ff    	jb     8010898b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108a2c:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80108a2f:	8b 45 10             	mov    0x10(%ebp),%eax
80108a32:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108a35:	72 08                	jb     80108a3f <deallocuvm+0x16>
    return oldsz;
80108a37:	8b 45 0c             	mov    0xc(%ebp),%eax
80108a3a:	e9 a4 00 00 00       	jmp    80108ae3 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108a3f:	8b 45 10             	mov    0x10(%ebp),%eax
80108a42:	05 ff 0f 00 00       	add    $0xfff,%eax
80108a47:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a4c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108a4f:	e9 80 00 00 00       	jmp    80108ad4 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108a54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a57:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a5e:	00 
80108a5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a63:	8b 45 08             	mov    0x8(%ebp),%eax
80108a66:	89 04 24             	mov    %eax,(%esp)
80108a69:	e8 e5 f9 ff ff       	call   80108453 <walkpgdir>
80108a6e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108a71:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108a75:	75 09                	jne    80108a80 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108a77:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108a7e:	eb 4d                	jmp    80108acd <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108a80:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a83:	8b 00                	mov    (%eax),%eax
80108a85:	83 e0 01             	and    $0x1,%eax
80108a88:	84 c0                	test   %al,%al
80108a8a:	74 41                	je     80108acd <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108a8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a8f:	8b 00                	mov    (%eax),%eax
80108a91:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a96:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108a99:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a9d:	75 0c                	jne    80108aab <deallocuvm+0x82>
        panic("kfree");
80108a9f:	c7 04 24 c1 98 10 80 	movl   $0x801098c1,(%esp)
80108aa6:	e8 92 7a ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108aab:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108aae:	89 04 24             	mov    %eax,(%esp)
80108ab1:	e8 1a f5 ff ff       	call   80107fd0 <p2v>
80108ab6:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108ab9:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108abc:	89 04 24             	mov    %eax,(%esp)
80108abf:	e8 0a a0 ff ff       	call   80102ace <kfree>
      *pte = 0;
80108ac4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108ac7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108acd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108ad4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ad7:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108ada:	0f 82 74 ff ff ff    	jb     80108a54 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
freevm(pde_t *pgdir)
{
80108ae5:	55                   	push   %ebp
80108ae6:	89 e5                	mov    %esp,%ebp
80108ae8:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108aeb:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108aef:	75 0c                	jne    80108afd <freevm+0x18>
    panic("freevm: no pgdir");
80108af1:	c7 04 24 c7 98 10 80 	movl   $0x801098c7,(%esp)
80108af8:	e8 40 7a ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108afd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108b04:	00 
80108b05:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108b0c:	80 
80108b0d:	8b 45 08             	mov    0x8(%ebp),%eax
80108b10:	89 04 24             	mov    %eax,(%esp)
80108b13:	e8 11 ff ff ff       	call   80108a29 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108b18:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108b1f:	eb 3c                	jmp    80108b5d <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108b21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b24:	c1 e0 02             	shl    $0x2,%eax
80108b27:	03 45 08             	add    0x8(%ebp),%eax
80108b2a:	8b 00                	mov    (%eax),%eax
80108b2c:	83 e0 01             	and    $0x1,%eax
80108b2f:	84 c0                	test   %al,%al
80108b31:	74 26                	je     80108b59 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108b33:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b36:	c1 e0 02             	shl    $0x2,%eax
80108b39:	03 45 08             	add    0x8(%ebp),%eax
80108b3c:	8b 00                	mov    (%eax),%eax
80108b3e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b43:	89 04 24             	mov    %eax,(%esp)
80108b46:	e8 85 f4 ff ff       	call   80107fd0 <p2v>
80108b4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108b4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b51:	89 04 24             	mov    %eax,(%esp)
80108b54:	e8 75 9f ff ff       	call   80102ace <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108b59:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108b5d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108b64:	76 bb                	jbe    80108b21 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108b69:	89 04 24             	mov    %eax,(%esp)
80108b6c:	e8 5d 9f ff ff       	call   80102ace <kfree>
}
80108b71:	c9                   	leave  
80108b72:	c3                   	ret    
...
80108b76:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80108b84:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b88:	8b 45 08             	mov    0x8(%ebp),%eax
80108b8b:	89 04 24             	mov    %eax,(%esp)
80108b8e:	e8 c0 f8 ff ff       	call   80108453 <walkpgdir>
80108b93:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108b96:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108b9a:	75 0c                	jne    80108ba8 <clearpteu+0x35>
    panic("clearpteu");
80108b9c:	c7 04 24 d8 98 10 80 	movl   $0x801098d8,(%esp)
80108ba3:	e8 95 79 ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108ba8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bab:	8b 00                	mov    (%eax),%eax
80108bad:	89 c2                	mov    %eax,%edx
80108baf:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108bbc:	53                   	push   %ebx
80108bbd:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108bc0:	e8 b8 f9 ff ff       	call   8010857d <setupkvm>
80108bc5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108bc8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108bcc:	75 0a                	jne    80108bd8 <copyuvm+0x1f>
    return 0;
80108bce:	b8 00 00 00 00       	mov    $0x0,%eax
80108bd3:	e9 fd 00 00 00       	jmp    80108cd5 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108bd8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108bdf:	e9 cc 00 00 00       	jmp    80108cb0 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108be4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108be7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108bee:	00 
80108bef:	89 44 24 04          	mov    %eax,0x4(%esp)
80108bf3:	8b 45 08             	mov    0x8(%ebp),%eax
80108bf6:	89 04 24             	mov    %eax,(%esp)
80108bf9:	e8 55 f8 ff ff       	call   80108453 <walkpgdir>
80108bfe:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108c01:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108c05:	75 0c                	jne    80108c13 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108c07:	c7 04 24 e2 98 10 80 	movl   $0x801098e2,(%esp)
80108c0e:	e8 2a 79 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108c13:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108c16:	8b 00                	mov    (%eax),%eax
80108c18:	83 e0 01             	and    $0x1,%eax
80108c1b:	85 c0                	test   %eax,%eax
80108c1d:	75 0c                	jne    80108c2b <copyuvm+0x72>
      panic("copyuvm: page not present");
80108c1f:	c7 04 24 fc 98 10 80 	movl   $0x801098fc,(%esp)
80108c26:	e8 12 79 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80108c2b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108c2e:	8b 00                	mov    (%eax),%eax
...
80108c3d:	25 ff 0f 00 00       	and    $0xfff,%eax
80108c42:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108c45:	e8 1d 9f ff ff       	call   80102b67 <kalloc>
80108c4a:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108c4d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108c51:	74 6e                	je     80108cc1 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108c53:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108c56:	89 04 24             	mov    %eax,(%esp)
80108c59:	e8 72 f3 ff ff       	call   80107fd0 <p2v>
80108c5e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c65:	00 
80108c66:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c6a:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108c6d:	89 04 24             	mov    %eax,(%esp)
80108c70:	e8 a0 cb ff ff       	call   80105815 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108c75:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108c78:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108c7b:	89 04 24             	mov    %eax,(%esp)
80108c7e:	e8 40 f3 ff ff       	call   80107fc3 <v2p>
80108c83:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c86:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108c8a:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108c8e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108c95:	00 
80108c96:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c9a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c9d:	89 04 24             	mov    %eax,(%esp)
80108ca0:	e8 44 f8 ff ff       	call   801084e9 <mappages>
80108ca5:	85 c0                	test   %eax,%eax
80108ca7:	78 1b                	js     80108cc4 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108ca9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108cb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cb3:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108cb6:	0f 82 28 ff ff ff    	jb     80108be4 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108cbf:	eb 14                	jmp    80108cd5 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108cc1:	90                   	nop
80108cc2:	eb 01                	jmp    80108cc5 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108cc4:	90                   	nop
...
80108ccb:	e8 15 fe ff ff       	call   80108ae5 <freevm>
  return 0;
80108cd0:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108cd5:	83 c4 44             	add    $0x44,%esp
80108cd8:	5b                   	pop    %ebx
80108cd9:	5d                   	pop    %ebp
80108cda:	c3                   	ret    
...
80108cec:	89 44 24 04          	mov    %eax,0x4(%esp)
80108cf0:	8b 45 08             	mov    0x8(%ebp),%eax
80108cf3:	89 04 24             	mov    %eax,(%esp)
80108cf6:	e8 58 f7 ff ff       	call   80108453 <walkpgdir>
80108cfb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108cfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d01:	8b 00                	mov    (%eax),%eax
80108d03:	83 e0 01             	and    $0x1,%eax
80108d06:	85 c0                	test   %eax,%eax
80108d08:	75 07                	jne    80108d11 <uva2ka+0x36>
    return 0;
80108d0a:	b8 00 00 00 00       	mov    $0x0,%eax
80108d0f:	eb 25                	jmp    80108d36 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d14:	8b 00                	mov    (%eax),%eax
80108d16:	83 e0 04             	and    $0x4,%eax
80108d19:	85 c0                	test   %eax,%eax
80108d1b:	75 07                	jne    80108d24 <uva2ka+0x49>
    return 0;
80108d1d:	b8 00 00 00 00       	mov    $0x0,%eax
80108d22:	eb 12                	jmp    80108d36 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108d24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d27:	8b 00                	mov    (%eax),%eax
80108d29:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d2e:	89 04 24             	mov    %eax,(%esp)
80108d31:	e8 9a f2 ff ff       	call   80107fd0 <p2v>
}
80108d36:	c9                   	leave  
80108d37:	c3                   	ret    
...
80108d41:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108d44:	e9 8b 00 00 00       	jmp    80108dd4 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108d49:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d4c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108d51:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108d54:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d57:	89 44 24 04          	mov    %eax,0x4(%esp)
80108d5b:	8b 45 08             	mov    0x8(%ebp),%eax
80108d5e:	89 04 24             	mov    %eax,(%esp)
80108d61:	e8 75 ff ff ff       	call   80108cdb <uva2ka>
80108d66:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108d69:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108d6d:	75 07                	jne    80108d76 <copyout+0x3e>
      return -1;
80108d6f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108d74:	eb 6d                	jmp    80108de3 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108d76:	8b 45 0c             	mov    0xc(%ebp),%eax
80108d79:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108d7c:	89 d1                	mov    %edx,%ecx
80108d7e:	29 c1                	sub    %eax,%ecx
80108d80:	89 c8                	mov    %ecx,%eax
80108d82:	05 00 10 00 00       	add    $0x1000,%eax
80108d87:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108d8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108d8d:	3b 45 14             	cmp    0x14(%ebp),%eax
80108d90:	76 06                	jbe    80108d98 <copyout+0x60>
      n = len;
80108d92:	8b 45 14             	mov    0x14(%ebp),%eax
80108d95:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108d98:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108d9b:	8b 55 0c             	mov    0xc(%ebp),%edx
80108d9e:	89 d1                	mov    %edx,%ecx
80108da0:	29 c1                	sub    %eax,%ecx
80108da2:	89 c8                	mov    %ecx,%eax
80108da4:	03 45 e8             	add    -0x18(%ebp),%eax
80108da7:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108daa:	89 54 24 08          	mov    %edx,0x8(%esp)
80108dae:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108db1:	89 54 24 04          	mov    %edx,0x4(%esp)
80108db5:	89 04 24             	mov    %eax,(%esp)
80108db8:	e8 58 ca ff ff       	call   80105815 <memmove>
    len -= n;
...
80108dd8:	0f 85 6b ff ff ff    	jne    80108d49 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
...
80108de3:	c9                   	leave  
80108de4:	c3                   	ret    
80108de5:	00 00                	add    %al,(%eax)
	...

80108de8 <implicit_exit>:
.code32
.globl implicit_exit
...
80108de9:	6a ff                	push   $0xffffffff

	movl $2, %eax;
80108deb:	b8 02 00 00 00       	mov    $0x2,%eax
	int $64;
80108df0:	cd 40                	int    $0x40

80108df2 <implicit_exit_end>:
	...

80108df4 <create_link>:
...
80108df7:	83 ec 28             	sub    $0x28,%esp
	int i;
	for (i = 0; i < LINKED_LIST_SIZE; i++) {
80108dfa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108e01:	eb 4e                	jmp    80108e51 <create_link+0x5d>
		if(!list->nodes[i].used){
80108e03:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108e06:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e09:	89 d0                	mov    %edx,%eax
80108e0b:	01 c0                	add    %eax,%eax
80108e0d:	01 d0                	add    %edx,%eax
80108e0f:	c1 e0 03             	shl    $0x3,%eax
80108e12:	01 c8                	add    %ecx,%eax
80108e14:	83 c0 20             	add    $0x20,%eax
80108e17:	8b 00                	mov    (%eax),%eax
80108e19:	85 c0                	test   %eax,%eax
80108e1b:	75 30                	jne    80108e4d <create_link+0x59>
			list->nodes[i].used = 1;
80108e1d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108e20:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e23:	89 d0                	mov    %edx,%eax
80108e25:	01 c0                	add    %eax,%eax
80108e27:	01 d0                	add    %edx,%eax
80108e29:	c1 e0 03             	shl    $0x3,%eax
80108e2c:	01 c8                	add    %ecx,%eax
80108e2e:	83 c0 20             	add    $0x20,%eax
80108e31:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
			return &list->nodes[i];
80108e37:	8b 45 08             	mov    0x8(%ebp),%eax
80108e3a:	8d 48 10             	lea    0x10(%eax),%ecx
80108e3d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108e40:	89 d0                	mov    %edx,%eax
80108e42:	01 c0                	add    %eax,%eax
80108e44:	01 d0                	add    %edx,%eax
80108e46:	c1 e0 03             	shl    $0x3,%eax
80108e49:	01 c8                	add    %ecx,%eax
80108e4b:	eb 1b                	jmp    80108e68 <create_link+0x74>
#include "types.h"
#include "defs.h"
...
struct node* create_link(linkedList* list){
	int i;
	for (i = 0; i < LINKED_LIST_SIZE; i++) {
80108e4d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108e51:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
80108e55:	7e ac                	jle    80108e03 <create_link+0xf>
			return &list->nodes[i];
		}
	}
...
80108e57:	c7 04 24 18 99 10 80 	movl   $0x80109918,(%esp)
80108e5e:	e8 3e 75 ff ff       	call   801003a1 <cprintf>
	return 0;
80108e63:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108e68:	c9                   	leave  
80108e69:	c3                   	ret    
...
80108e6a:	55                   	push   %ebp
80108e6b:	89 e5                	mov    %esp,%ebp
	link->id = 0;
80108e6d:	8b 45 08             	mov    0x8(%ebp),%eax
80108e70:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	link->data = 0;
80108e76:	8b 45 08             	mov    0x8(%ebp),%eax
80108e79:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	link->next = 0;
80108e80:	8b 45 08             	mov    0x8(%ebp),%eax
80108e83:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	link->prev = 0;
80108e8a:	8b 45 08             	mov    0x8(%ebp),%eax
80108e8d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	link->used = 0;
80108e94:	8b 45 08             	mov    0x8(%ebp),%eax
80108e97:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
}
80108e9e:	5d                   	pop    %ebp
80108e9f:	c3                   	ret    
...
80108ea8:	85 c0                	test   %eax,%eax
80108eaa:	75 22                	jne    80108ece <add_last+0x2e>
		list->head = link;
80108eac:	8b 45 08             	mov    0x8(%ebp),%eax
80108eaf:	8b 55 0c             	mov    0xc(%ebp),%edx
80108eb2:	89 10                	mov    %edx,(%eax)
		list->tail = link;
80108eb4:	8b 45 08             	mov    0x8(%ebp),%eax
80108eb7:	8b 55 0c             	mov    0xc(%ebp),%edx
80108eba:	89 50 04             	mov    %edx,0x4(%eax)
		list->size++;
80108ebd:	8b 45 08             	mov    0x8(%ebp),%eax
80108ec0:	8b 40 08             	mov    0x8(%eax),%eax
80108ec3:	8d 50 01             	lea    0x1(%eax),%edx
80108ec6:	8b 45 08             	mov    0x8(%ebp),%eax
80108ec9:	89 50 08             	mov    %edx,0x8(%eax)
80108ecc:	eb 30                	jmp    80108efe <add_last+0x5e>
	}
	else{
		link->prev = list->tail;
80108ece:	8b 45 08             	mov    0x8(%ebp),%eax
80108ed1:	8b 50 04             	mov    0x4(%eax),%edx
80108ed4:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ed7:	89 50 0c             	mov    %edx,0xc(%eax)
		list->tail->next = link;
80108eda:	8b 45 08             	mov    0x8(%ebp),%eax
80108edd:	8b 40 04             	mov    0x4(%eax),%eax
80108ee0:	8b 55 0c             	mov    0xc(%ebp),%edx
80108ee3:	89 50 08             	mov    %edx,0x8(%eax)
		list->tail = link;
80108ee6:	8b 45 08             	mov    0x8(%ebp),%eax
80108ee9:	8b 55 0c             	mov    0xc(%ebp),%edx
80108eec:	89 50 04             	mov    %edx,0x4(%eax)
		list->size++;
80108eef:	8b 45 08             	mov    0x8(%ebp),%eax
80108ef2:	8b 40 08             	mov    0x8(%eax),%eax
80108ef5:	8d 50 01             	lea    0x1(%eax),%edx
80108ef8:	8b 45 08             	mov    0x8(%ebp),%eax
80108efb:	89 50 08             	mov    %edx,0x8(%eax)
	}
}
80108efe:	5d                   	pop    %ebp
80108eff:	c3                   	ret    
...
80108f09:	89 04 24             	mov    %eax,(%esp)
80108f0c:	e8 e3 fe ff ff       	call   80108df4 <create_link>
80108f11:	89 45 f4             	mov    %eax,-0xc(%ebp)
	node->id = id;
80108f14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f17:	8b 55 0c             	mov    0xc(%ebp),%edx
80108f1a:	89 10                	mov    %edx,(%eax)
	node->data = p;
80108f1c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f1f:	8b 55 10             	mov    0x10(%ebp),%edx
80108f22:	89 50 04             	mov    %edx,0x4(%eax)
	list->add_last(list,node);
80108f25:	8b 45 08             	mov    0x8(%ebp),%eax
80108f28:	8b 90 10 06 00 00    	mov    0x610(%eax),%edx
80108f2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f31:	89 44 24 04          	mov    %eax,0x4(%esp)
80108f35:	8b 45 08             	mov    0x8(%ebp),%eax
80108f38:	89 04 24             	mov    %eax,(%esp)
80108f3b:	ff d2                	call   *%edx
	//print(list);
}
80108f3d:	c9                   	leave  
80108f3e:	c3                   	ret    

80108f3f <remove_first>:


struct proc* remove_first(linkedList* list){
80108f3f:	55                   	push   %ebp
80108f40:	89 e5                	mov    %esp,%ebp
80108f42:	83 ec 28             	sub    $0x28,%esp
	struct proc* p;
	node* tmp;
	if( list->head == 0 ){
...
80108fb6 <init_linkedList>:
void init_linkedList(linkedList* list,int fixed_size){
80108fb6:	55                   	push   %ebp
80108fb7:	89 e5                	mov    %esp,%ebp
80108fb9:	53                   	push   %ebx
80108fba:	83 ec 24             	sub    $0x24,%esp
	int i;
	list->head = 0;
80108fbd:	8b 45 08             	mov    0x8(%ebp),%eax
80108fc0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	list->tail = 0;
80108fc6:	8b 45 08             	mov    0x8(%ebp),%eax
80108fc9:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	list->size = 0;
80108fd0:	8b 45 08             	mov    0x8(%ebp),%eax
80108fd3:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	list->max_size = fixed_size;
80108fda:	8b 45 08             	mov    0x8(%ebp),%eax
80108fdd:	8b 55 0c             	mov    0xc(%ebp),%edx
80108fe0:	89 50 0c             	mov    %edx,0xc(%eax)
	list->add_last = add_last;
80108fe3:	8b 45 08             	mov    0x8(%ebp),%eax
80108fe6:	c7 80 10 06 00 00 a0 	movl   $0x80108ea0,0x610(%eax)
80108fed:	8e 10 80 
	list->add = add;
80108ff0:	8b 45 08             	mov    0x8(%ebp),%eax
80108ff3:	c7 80 14 06 00 00 00 	movl   $0x80108f00,0x614(%eax)
80108ffa:	8f 10 80 
	list->remove_first = remove_first;
80108ffd:	8b 45 08             	mov    0x8(%ebp),%eax
80109000:	c7 80 18 06 00 00 3f 	movl   $0x80108f3f,0x618(%eax)
80109007:	8f 10 80 
	list->print = print;
8010900a:	8b 45 08             	mov    0x8(%ebp),%eax
8010900d:	c7 80 1c 06 00 00 c7 	movl   $0x801090c7,0x61c(%eax)
80109014:	90 10 80 
	list->get_link = get_link;
80109017:	8b 45 08             	mov    0x8(%ebp),%eax
8010901a:	c7 80 20 06 00 00 2b 	movl   $0x8010912b,0x620(%eax)
80109021:	91 10 80 
	list->remove_link = remove_link;
80109024:	8b 45 08             	mov    0x8(%ebp),%eax
80109027:	c7 80 24 06 00 00 9b 	movl   $0x8010919b,0x624(%eax)
8010902e:	91 10 80 
	list->search = search;
80109031:	8b 45 08             	mov    0x8(%ebp),%eax
80109034:	c7 80 28 06 00 00 66 	movl   $0x80109166,0x628(%eax)
8010903b:	91 10 80 

	for(i=0; i < fixed_size; i++){
8010903e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80109045:	eb 4d                	jmp    80109094 <init_linkedList+0xde>
		list->nodes[i].clean_up = clean_up;
80109047:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010904a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010904d:	89 d0                	mov    %edx,%eax
8010904f:	01 c0                	add    %eax,%eax
80109051:	01 d0                	add    %edx,%eax
80109053:	c1 e0 03             	shl    $0x3,%eax
80109056:	01 c8                	add    %ecx,%eax
80109058:	83 c0 24             	add    $0x24,%eax
8010905b:	c7 00 6a 8e 10 80    	movl   $0x80108e6a,(%eax)
		list->nodes[i].clean_up(&list->nodes[i]);
80109061:	8b 4d 08             	mov    0x8(%ebp),%ecx
80109064:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109067:	89 d0                	mov    %edx,%eax
80109069:	01 c0                	add    %eax,%eax
8010906b:	01 d0                	add    %edx,%eax
8010906d:	c1 e0 03             	shl    $0x3,%eax
80109070:	01 c8                	add    %ecx,%eax
80109072:	83 c0 24             	add    $0x24,%eax
80109075:	8b 08                	mov    (%eax),%ecx
80109077:	8b 45 08             	mov    0x8(%ebp),%eax
8010907a:	8d 58 10             	lea    0x10(%eax),%ebx
8010907d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109080:	89 d0                	mov    %edx,%eax
80109082:	01 c0                	add    %eax,%eax
80109084:	01 d0                	add    %edx,%eax
80109086:	c1 e0 03             	shl    $0x3,%eax
80109089:	01 d8                	add    %ebx,%eax
8010908b:	89 04 24             	mov    %eax,(%esp)
8010908e:	ff d1                	call   *%ecx
	list->print = print;
	list->get_link = get_link;
	list->remove_link = remove_link;
	list->search = search;
...
80109097:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010909a:	7c ab                	jl     80109047 <init_linkedList+0x91>
		list->nodes[i].clean_up = clean_up;
		list->nodes[i].clean_up(&list->nodes[i]);
	}

}
8010909c:	83 c4 24             	add    $0x24,%esp
8010909f:	5b                   	pop    %ebx
801090a0:	5d                   	pop    %ebp
801090a1:	c3                   	ret    
...
801090a5:	83 ec 18             	sub    $0x18,%esp
	while(list->size > 0){
801090a8:	eb 11                	jmp    801090bb <clean_list+0x19>
		list->remove_first(list);
801090aa:	8b 45 08             	mov    0x8(%ebp),%eax
801090ad:	8b 90 18 06 00 00    	mov    0x618(%eax),%edx
801090b3:	8b 45 08             	mov    0x8(%ebp),%eax
801090b6:	89 04 24             	mov    %eax,(%esp)
801090b9:	ff d2                	call   *%edx
	}
...
801090be:	8b 40 08             	mov    0x8(%eax),%eax
801090c1:	85 c0                	test   %eax,%eax
801090c3:	7f e5                	jg     801090aa <clean_list+0x8>
		list->remove_first(list);
	}
}
801090c5:	c9                   	leave  
...
801090ca:	83 ec 28             	sub    $0x28,%esp
	node* link = list->head;
801090cd:	8b 45 08             	mov    0x8(%ebp),%eax
801090d0:	8b 00                	mov    (%eax),%eax
801090d2:	89 45 f4             	mov    %eax,-0xc(%ebp)

	cprintf("LinkedList content:\n");
801090d5:	c7 04 24 87 99 10 80 	movl   $0x80109987,(%esp)
801090dc:	e8 c0 72 ff ff       	call   801003a1 <cprintf>

	cprintf("HEAD");
801090e1:	c7 04 24 9c 99 10 80 	movl   $0x8010999c,(%esp)
801090e8:	e8 b4 72 ff ff       	call   801003a1 <cprintf>
	while(link != 0){
801090ed:	eb 28                	jmp    80109117 <print+0x50>
		cprintf(" => [%d ,0x%x] ",link->id,link->data);
801090ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090f2:	8b 50 04             	mov    0x4(%eax),%edx
801090f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090f8:	8b 00                	mov    (%eax),%eax
801090fa:	89 54 24 08          	mov    %edx,0x8(%esp)
801090fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80109102:	c7 04 24 a1 99 10 80 	movl   $0x801099a1,(%esp)
80109109:	e8 93 72 ff ff       	call   801003a1 <cprintf>
		link = link->next;
8010910e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109111:	8b 40 08             	mov    0x8(%eax),%eax
80109114:	89 45 f4             	mov    %eax,-0xc(%ebp)
	node* link = list->head;
	...
	cprintf("HEAD");
	while(link != 0){
80109117:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010911b:	75 d2                	jne    801090ef <print+0x28>
		cprintf(" => [%d ,0x%x] ",link->id,link->data);
		link = link->next;
	}
	cprintf("<= TAIL \n");
8010911d:	c7 04 24 b1 99 10 80 	movl   $0x801099b1,(%esp)
...
8010912e:	83 ec 10             	sub    $0x10,%esp
	node* link = list->head;
80109131:	8b 45 08             	mov    0x8(%ebp),%eax
80109134:	8b 00                	mov    (%eax),%eax
80109136:	89 45 fc             	mov    %eax,-0x4(%ebp)
	while(position > 0 && link != 0){
80109139:	eb 0d                	jmp    80109148 <get_link+0x1d>
		link = link->next;
8010913b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010913e:	8b 40 08             	mov    0x8(%eax),%eax
80109141:	89 45 fc             	mov    %eax,-0x4(%ebp)
		position--;
80109144:	83 6d 0c 01          	subl   $0x1,0xc(%ebp)
...
node* get_link(linkedList* list,int position){
	node* link = list->head;
	while(position > 0 && link != 0){
80109148:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010914c:	7e 06                	jle    80109154 <get_link+0x29>
8010914e:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80109152:	75 e7                	jne    8010913b <get_link+0x10>
		link = link->next;
		position--;
	}
	if(position == 0) return link;
80109154:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80109158:	75 05                	jne    8010915f <get_link+0x34>
8010915a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010915d:	eb 05                	jmp    80109164 <get_link+0x39>
...
80109169:	83 ec 10             	sub    $0x10,%esp
	node* p = list->head;
8010916c:	8b 45 08             	mov    0x8(%ebp),%eax
8010916f:	8b 00                	mov    (%eax),%eax
80109171:	89 45 fc             	mov    %eax,-0x4(%ebp)

	while(p != 0){
80109174:	eb 18                	jmp    8010918e <search+0x28>
		if(p->id == id){
80109176:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109179:	8b 00                	mov    (%eax),%eax
8010917b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010917e:	75 05                	jne    80109185 <search+0x1f>
			return p;
80109180:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109183:	eb 14                	jmp    80109199 <search+0x33>
		}
		p=p->next;
80109185:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109188:	8b 40 08             	mov    0x8(%eax),%eax
8010918b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	return 0;
}
node* search(linkedList* list, int id){
	node* p = list->head;
	...
	while(p != 0){
8010918e:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80109192:	75 e2                	jne    80109176 <search+0x10>
		if(p->id == id){
			return p;
		}
		p=p->next;
...
8010919b <remove_link>:


int remove_link(linkedList* list,int id){
8010919b:	55                   	push   %ebp
8010919c:	89 e5                	mov    %esp,%ebp
8010919e:	83 ec 28             	sub    $0x28,%esp
	node* tmp = search(list,id);
801091a1:	8b 45 0c             	mov    0xc(%ebp),%eax
801091a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801091a8:	8b 45 08             	mov    0x8(%ebp),%eax
801091ab:	89 04 24             	mov    %eax,(%esp)
801091ae:	e8 b3 ff ff ff       	call   80109166 <search>
801091b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
	cprintf("requested: %d, deleting, found:(%d) %d\n", id, tmp, tmp->id);
801091b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091b9:	8b 00                	mov    (%eax),%eax
801091bb:	89 44 24 0c          	mov    %eax,0xc(%esp)
801091bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091c2:	89 44 24 08          	mov    %eax,0x8(%esp)
801091c6:	8b 45 0c             	mov    0xc(%ebp),%eax
801091c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801091cd:	c7 04 24 bc 99 10 80 	movl   $0x801099bc,(%esp)
801091d4:	e8 c8 71 ff ff       	call   801003a1 <cprintf>
	if(tmp != 0){
801091d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801091dd:	74 62                	je     80109241 <remove_link+0xa6>
		if(tmp->prev == 0){ /* was head*/
801091df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091e2:	8b 40 0c             	mov    0xc(%eax),%eax
801091e5:	85 c0                	test   %eax,%eax
801091e7:	75 0d                	jne    801091f6 <remove_link+0x5b>
			list->head = tmp->next;
801091e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091ec:	8b 50 08             	mov    0x8(%eax),%edx
801091ef:	8b 45 08             	mov    0x8(%ebp),%eax
801091f2:	89 10                	mov    %edx,(%eax)
801091f4:	eb 36                	jmp    8010922c <remove_link+0x91>
		}
		else{
			tmp->prev->next = tmp->next;
801091f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091f9:	8b 40 0c             	mov    0xc(%eax),%eax
801091fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801091ff:	8b 52 08             	mov    0x8(%edx),%edx
80109202:	89 50 08             	mov    %edx,0x8(%eax)
			if(tmp->next != 0){
80109205:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109208:	8b 40 08             	mov    0x8(%eax),%eax
8010920b:	85 c0                	test   %eax,%eax
8010920d:	74 11                	je     80109220 <remove_link+0x85>
				tmp->next->prev = tmp->prev;
8010920f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109212:	8b 40 08             	mov    0x8(%eax),%eax
80109215:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109218:	8b 52 0c             	mov    0xc(%edx),%edx
8010921b:	89 50 0c             	mov    %edx,0xc(%eax)
8010921e:	eb 0c                	jmp    8010922c <remove_link+0x91>
			}
			else{
				list->tail = tmp->prev;
80109220:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109223:	8b 50 0c             	mov    0xc(%eax),%edx
80109226:	8b 45 08             	mov    0x8(%ebp),%eax
80109229:	89 50 04             	mov    %edx,0x4(%eax)
			}
...
8010922f:	8b 50 14             	mov    0x14(%eax),%edx
80109232:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109235:	89 04 24             	mov    %eax,(%esp)
80109238:	ff d2                	call   *%edx
		//list->print(list);

		return 1;
8010923a:	b8 01 00 00 00       	mov    $0x1,%eax
8010923f:	eb 05                	jmp    80109246 <remove_link+0xab>
	}
	return 0;
80109241:	b8 00 00 00 00       	mov    $0x0,%eax
}
80109246:	c9                   	leave  
80109247:	c3                   	ret    
