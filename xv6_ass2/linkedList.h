...
typedef struct linkedList
{
	...
	void (*add)(struct linkedList* list, int id, struct thread* p);
	struct thread* (*remove_first)(struct linkedList* list);
	...
	void (*clean_list)(struct linkedList* list);
} linkedList;
...
struct thread* remove_first(linkedList* list);
