...
801000bd:	e8 29 51 00 00       	call   801051eb <acquire>
...
80100104:	e8 44 51 00 00       	call   8010524d <release>
        return b;
...
8010011f:	e8 e0 4d 00 00       	call   80104f04 <sleep>
      goto loop;
...
8010017c:	e8 cc 50 00 00       	call   8010524d <release>
      return b;
...
8010023c:	e8 aa 4f 00 00       	call   801051eb <acquire>
...
8010029d:	e8 3e 4d 00 00       	call   80104fe0 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 9f 4f 00 00       	call   8010524d <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 2a 4e 00 00       	call   801051eb <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 72 8a 10 80 	movl   $0x80108a72,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 7b 8a 10 80 	movl   $0x80108a7b,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 12 4d 00 00       	call   8010524d <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 82 8a 10 80 	movl   $0x80108a82,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 91 8a 10 80 	movl   $0x80108a91,(%esp)
...
80100592:	e8 05 4d 00 00       	call   8010529c <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 93 8a 10 80 	movl   $0x80108a93,(%esp)
...
801006b2:	e8 56 4e 00 00       	call   8010550d <memmove>
    pos -= 80;
...
801006e1:	e8 54 4d 00 00       	call   8010543a <memset>
  }
...
801007ba:	e8 2c 4a 00 00       	call   801051eb <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 97 48 00 00       	call   80105086 <procdump>
      break;
...
801008f7:	e8 e4 46 00 00       	call   80104fe0 <wakeup>
        }
      }
      break;
...
8010091e:	e8 2a 49 00 00       	call   8010524d <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 a3 48 00 00       	call   801051eb <acquire>
  while(n > 0){
...
80100961:	e8 e7 48 00 00       	call   8010524d <release>
        ilock(ip);
...
8010098a:	e8 75 45 00 00       	call   80104f04 <sleep>
...
80100a08:	e8 40 48 00 00       	call   8010524d <release>
  ilock(ip);
...
80100a3e:	e8 a8 47 00 00       	call   801051eb <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 d0 47 00 00       	call   8010524d <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 97 8a 10 	movl   $0x80108a97,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 23 47 00 00       	call   801051ca <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 9f 8a 10 	movl   $0x80108a9f,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
80100ab6:	e8 0f 47 00 00       	call   801051ca <initlock>
...
80100b78:	0f 85 9a 03 00 00    	jne    80100f18 <exec+0x41c>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 52 76 00 00       	call   801081d5 <setupkvm>
...
80100c17:	e8 8b 79 00 00       	call   801085a7 <allocuvm>
...
80100c54:	e8 5f 78 00 00       	call   801084b8 <loaduvm>
...
80100c9b:	ba 4a 8a 10 80       	mov    $0x80108a4a,%edx
80100ca0:	b8 40 8a 10 80       	mov    $0x80108a40,%eax
...
80100cda:	e8 c8 78 00 00       	call   801085a7 <allocuvm>
...
80100d07:	e8 bf 7a 00 00       	call   801087cb <clearpteu>
...
80100d22:	c7 44 24 08 40 8a 10 	movl   $0x80108a40,0x8(%esp)
80100d29:	80 
...
80100d37:	e8 54 7c 00 00       	call   80108990 <copyout>
...
80100d6e:	e8 45 49 00 00       	call   801056b8 <strlen>
...
80100d8c:	e8 27 49 00 00       	call   801056b8 <strlen>
...
80100db6:	e8 d5 7b 00 00       	call   80108990 <copyout>
...
80100e55:	e8 36 7b 00 00       	call   80108990 <copyout>
...
80100eac:	e8 b9 47 00 00       	call   8010566a <safestrcpy>
//  cprintf("\n[debug] [%s] executing '%s' \n", TAG, last);
...
80100efe:	e8 c3 73 00 00       	call   801082c6 <switchuvm>
  freevm(oldpgdir);
80100f03:	8b 45 c8             	mov    -0x38(%ebp),%eax
80100f06:	89 04 24             	mov    %eax,(%esp)
80100f09:	e8 2f 78 00 00       	call   8010873d <freevm>
  return 0;
...
80100f43:	e8 f5 77 00 00       	call   8010873d <freevm>
  if(ip){
...
80100f6e:	c7 44 24 04 a5 8a 10 	movl   $0x80108aa5,0x4(%esp)
80100f75:	80 
80100f76:	c7 04 24 60 18 11 80 	movl   $0x80111860,(%esp)
80100f7d:	e8 48 42 00 00       	call   801051ca <initlock>
}
80100f82:	c9                   	leave  
80100f83:	c3                   	ret    
...
80100f91:	e8 55 42 00 00       	call   801051eb <acquire>
...
80100fba:	e8 8e 42 00 00       	call   8010524d <release>
      return f;
...
80100fd8:	e8 70 42 00 00       	call   8010524d <release>
  return 0;
...
80100ff1:	e8 f5 41 00 00       	call   801051eb <acquire>
  if(f->ref < 1)
...
80100ffe:	7f 0c                	jg     8010100c <filedup+0x28>
    panic("filedup");
80101000:	c7 04 24 ac 8a 10 80 	movl   $0x80108aac,(%esp)
...
80101022:	e8 26 42 00 00       	call   8010524d <release>
  return f;
...
80101039:	e8 ad 41 00 00       	call   801051eb <acquire>
  if(f->ref < 1)
...
80101046:	7f 0c                	jg     80101054 <fileclose+0x28>
    panic("fileclose");
80101048:	c7 04 24 b4 8a 10 80 	movl   $0x80108ab4,(%esp)
...
80101074:	e8 d4 41 00 00       	call   8010524d <release>
    return;
...
801010be:	e8 8a 41 00 00       	call   8010524d <release>
...
801011fd:	eb 0c                	jmp    8010120b <fileread+0xba>
  ...
  panic("fileread");
801011ff:	c7 04 24 be 8a 10 80 	movl   $0x80108abe,(%esp)
...
8010130b:	c7 04 24 c7 8a 10 80 	movl   $0x80108ac7,(%esp)
...
8010133e:	eb 0c                	jmp    8010134c <filewrite+0x13f>
  ...
  panic("filewrite");
80101340:	c7 04 24 d7 8a 10 80 	movl   $0x80108ad7,(%esp)
...
80101388:	e8 80 41 00 00       	call   8010550d <memmove>
  brelse(bp);
...
801013ce:	e8 67 40 00 00       	call   8010543a <memset>
  log_write(bp);
...
80101530:	0f 82 e1 fe ff ff    	jb     80101417 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
80101536:	c7 04 24 e1 8a 10 80 	movl   $0x80108ae1,(%esp)
...
801015cd:	c7 04 24 f7 8a 10 80 	movl   $0x80108af7,(%esp)
...
80101621:	c7 44 24 04 0a 8b 10 	movl   $0x80108b0a,0x4(%esp)
80101628:	80 
80101629:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101630:	e8 95 3b 00 00       	call   801051ca <initlock>
}
80101635:	c9                   	leave  
80101636:	c3                   	ret    
...
801016b2:	e8 83 3d 00 00       	call   8010543a <memset>
      dip->type = type;
...
80101702:	0f 82 5a ff ff ff    	jb     80101662 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101708:	c7 04 24 11 8b 10 80 	movl   $0x80108b11,(%esp)
...
801017af:	e8 59 3d 00 00       	call   8010550d <memmove>
  log_write(bp);
...
801017d9:	e8 0d 3a 00 00       	call   801051eb <acquire>
...
80101823:	e8 25 3a 00 00       	call   8010524d <release>
      return ip;
...
80101856:	c7 04 24 23 8b 10 80 	movl   $0x80108b23,(%esp)
...
80101894:	e8 b4 39 00 00       	call   8010524d <release>
...
801018ab:	e8 3b 39 00 00       	call   801051eb <acquire>
  ip->ref++;
...
801018c6:	e8 82 39 00 00       	call   8010524d <release>
  return ip;
...
801018e4:	7f 0c                	jg     801018f2 <ilock+0x22>
    panic("ilock");
801018e6:	c7 04 24 33 8b 10 80 	movl   $0x80108b33,(%esp)
801018ed:	e8 4b ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801018f2:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801018f9:	e8 ed 38 00 00       	call   801051eb <acquire>
...
8010190e:	e8 f1 35 00 00       	call   80104f04 <sleep>
...
80101938:	e8 10 39 00 00       	call   8010524d <release>
...
801019e3:	e8 25 3b 00 00       	call   8010550d <memmove>
    brelse(bp);
...
80101a0e:	75 0c                	jne    80101a1c <ilock+0x14c>
      panic("ilock: no type");
80101a10:	c7 04 24 39 8b 10 80 	movl   $0x80108b39,(%esp)
...
80101a3f:	7f 0c                	jg     80101a4d <iunlock+0x2f>
    panic("iunlock");
80101a41:	c7 04 24 48 8b 10 80 	movl   $0x80108b48,(%esp)
80101a48:	e8 f0 ea ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101a4d:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a54:	e8 92 37 00 00       	call   801051eb <acquire>
  ip->flags &= ~I_BUSY;
...
80101a70:	e8 6b 35 00 00       	call   80104fe0 <wakeup>
  release(&icache.lock);
80101a75:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a7c:	e8 cc 37 00 00       	call   8010524d <release>
}
80101a81:	c9                   	leave  
80101a82:	c3                   	ret    
...
80101a90:	e8 56 37 00 00       	call   801051eb <acquire>
...
80101acc:	74 0c                	je     80101ada <iput+0x57>
      panic("iput busy");
80101ace:	c7 04 24 50 8b 10 80 	movl   $0x80108b50,(%esp)
...
80101af2:	e8 56 37 00 00       	call   8010524d <release>
    itrunc(ip);
...
80101b1d:	e8 c9 36 00 00       	call   801051eb <acquire>
    ip->flags = 0;
...
80101b32:	e8 a9 34 00 00       	call   80104fe0 <wakeup>
  }
  ip->ref--;
...
80101b4d:	e8 fb 36 00 00       	call   8010524d <release>
}
80101b52:	c9                   	leave  
80101b53:	c3                   	ret    
...
80101c62:	c7 04 24 5a 8b 10 80 	movl   $0x80108b5a,(%esp)
...
80101efa:	e8 0e 36 00 00       	call   8010550d <memmove>
    brelse(bp);
...
80102060:	e8 a8 34 00 00       	call   8010550d <memmove>
    log_write(bp);
...
801020e2:	e8 ca 34 00 00       	call   801055b1 <strncmp>
}
801020e7:	c9                   	leave  
801020e8:	c3                   	ret    
...
801020fc:	c7 04 24 6d 8b 10 80 	movl   $0x80108b6d,(%esp)
...
80102138:	74 0c                	je     80102146 <dirlookup+0x5d>
      panic("dirlink read");
8010213a:	c7 04 24 7f 8b 10 80 	movl   $0x80108b7f,(%esp)
...
8010221c:	74 0c                	je     8010222a <dirlink+0x79>
      panic("dirlink read");
8010221e:	c7 04 24 7f 8b 10 80 	movl   $0x80108b7f,(%esp)
...
80102264:	e8 a0 33 00 00       	call   80105609 <strncpy>
  de.inum = inum;
...
80102294:	74 0c                	je     801022a2 <dirlink+0xf1>
    panic("dirlink");
80102296:	c7 04 24 8c 8b 10 80 	movl   $0x80108b8c,(%esp)
...
8010231d:	e8 eb 31 00 00       	call   8010550d <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102338:	e8 d0 31 00 00       	call   8010550d <memmove>
    name[len] = 0;
...
80102594:	c7 44 24 04 94 8b 10 	movl   $0x80108b94,0x4(%esp)
8010259b:	80 
8010259c:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
801025a3:	e8 22 2c 00 00       	call   801051ca <initlock>
  picenable(IRQ_IDE);
...
8010263e:	75 0c                	jne    8010264c <idestart+0x18>
    panic("idestart");
80102640:	c7 04 24 98 8b 10 80 	movl   $0x80108b98,(%esp)
...
80102766:	e8 80 2a 00 00       	call   801051eb <acquire>
  if((b = idequeue) == 0){
...
80102780:	e8 c8 2a 00 00       	call   8010524d <release>
...
801027f3:	e8 e8 27 00 00       	call   80104fe0 <wakeup>
...
80102815:	e8 33 2a 00 00       	call   8010524d <release>
}
8010281a:	c9                   	leave  
8010281b:	c3                   	ret    
...
8010282e:	c7 04 24 a1 8b 10 80 	movl   $0x80108ba1,(%esp)
...
80102847:	c7 04 24 b5 8b 10 80 	movl   $0x80108bb5,(%esp)
...
801028d2:	e8 2d 26 00 00       	call   80104f04 <sleep>
...
801028ee:	e8 5a 29 00 00       	call   8010524d <release>
}
801028f3:	c9                   	leave  
801028f4:	c3                   	ret    
...
8010297e:	c7 04 24 e8 8b 10 80 	movl   $0x80108be8,(%esp)
...
80102a3f:	c7 44 24 04 1a 8c 10 	movl   $0x80108c1a,0x4(%esp)
80102a46:	80 
80102a47:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
80102a4e:	e8 77 27 00 00       	call   801051ca <initlock>
  kmem.use_lock = 0;
...
80102af9:	76 0c                	jbe    80102b07 <kfree+0x39>
    panic("kfree");
80102afb:	c7 04 24 1f 8c 10 80 	movl   $0x80108c1f,(%esp)
...
80102b1d:	e8 18 29 00 00       	call   8010543a <memset>
...
80102b32:	e8 b4 26 00 00       	call   801051eb <acquire>
  r = (struct run*)v;
...
80102b60:	e8 e8 26 00 00       	call   8010524d <release>
}
80102b65:	c9                   	leave  
80102b66:	c3                   	ret    
...
80102b7d:	e8 69 26 00 00       	call   801051eb <acquire>
  r = kmem.freelist;
...
80102baa:	e8 9e 26 00 00       	call   8010524d <release>
  return (char*)r;
...
80102f50:	c7 04 24 28 8c 10 80 	movl   $0x80108c28,(%esp)
...
801031b4:	e8 f8 22 00 00       	call   801054b1 <memcmp>
...
801032b6:	c7 44 24 04 54 8c 10 	movl   $0x80108c54,0x4(%esp)
801032bd:	80 
801032be:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801032c5:	e8 00 1f 00 00       	call   801051ca <initlock>
  readsb(ROOTDEV, &sb);
...
80103378:	e8 90 21 00 00       	call   8010550d <memmove>
...
801034ca:	e8 1c 1d 00 00       	call   801051eb <acquire>
  while(1){
    if(log.committing){
...
801034e7:	e8 18 1a 00 00       	call   80104f04 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
8010351b:	e8 e4 19 00 00       	call   80104f04 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
80103536:	e8 12 1d 00 00       	call   8010524d <release>
      break;
8010353b:	90                   	nop
    }
  }
...
80103552:	e8 94 1c 00 00       	call   801051eb <acquire>
  log.outstanding -= 1;
...
8010356d:	c7 04 24 58 8c 10 80 	movl   $0x80108c58,(%esp)
...
8010359c:	e8 3f 1a 00 00       	call   80104fe0 <wakeup>
  }
  release(&log.lock);
801035a1:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801035a8:	e8 a0 1c 00 00       	call   8010524d <release>
...
80103659:	e8 af 1e 00 00       	call   8010550d <memmove>
...
801036e4:	c7 04 24 67 8c 10 80 	movl   $0x80108c67,(%esp)
...
801036f9:	c7 04 24 7d 8c 10 80 	movl   $0x80108c7d,(%esp)
80103700:	e8 38 ce ff ff       	call   8010053d <panic>

  acquire(&log.lock);
80103705:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
8010370c:	e8 da 1a 00 00       	call   801051eb <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103784:	e8 c4 1a 00 00       	call   8010524d <release>
}
80103789:	c9                   	leave  
8010378a:	c3                   	ret    
	...
...
8010380c:	c7 04 24 98 8c 10 80 	movl   $0x80108c98,(%esp)
...
80103827:	e8 54 37 00 00       	call   80106f80 <uartinit>
  pinit();         // process table
8010382c:	e8 8e 0b 00 00       	call   801043bf <pinit>
  tvinit();        // trap vectors
80103831:	e8 4d 32 00 00       	call   80106a83 <tvinit>
  binit();         // buffer cache
...
80103853:	e8 6e 31 00 00       	call   801069c6 <timerinit>
...
8010387e:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103881:	e8 23 4a 00 00       	call   801082a9 <switchkvm>
  seginit();
80103886:	e8 aa 43 00 00       	call   80107c35 <seginit>
  lapicinit();
...
801038ab:	c7 04 24 af 8c 10 80 	movl   $0x80108caf,(%esp)
801038b2:	e8 ea ca ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801038b7:	e8 3b 33 00 00       	call   80106bf7 <idtinit>
...
801038d7:	e8 7c 14 00 00       	call   80104d58 <scheduler>
...
80103909:	e8 ff 1b 00 00       	call   8010550d <memmove>
...
80103a97:	00 
80103a98:	c7 44 24 04 c0 8c 10 	movl   $0x80108cc0,0x4(%esp)
80103a9f:	80 
80103aa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103aa3:	89 04 24             	mov    %eax,(%esp)
80103aa6:	e8 06 1a 00 00       	call   801054b1 <memcmp>
...
80103bd8:	00 
80103bd9:	c7 44 24 04 c5 8c 10 	movl   $0x80108cc5,0x4(%esp)
80103be0:	80 
80103be1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103be4:	89 04 24             	mov    %eax,(%esp)
80103be7:	e8 c5 18 00 00       	call   801054b1 <memcmp>
...
80103cb2:	8b 04 85 08 8d 10 80 	mov    -0x7fef72f8(,%eax,4),%eax
...
80103ceb:	c7 04 24 ca 8c 10 80 	movl   $0x80108cca,(%esp)
...
80103d7e:	c7 04 24 e8 8c 10 80 	movl   $0x80108ce8,(%esp)
...
80104083:	c7 44 24 04 1c 8d 10 	movl   $0x80108d1c,0x4(%esp)
8010408a:	80 
8010408b:	89 04 24             	mov    %eax,(%esp)
8010408e:	e8 37 11 00 00       	call   801051ca <initlock>
  (*f0)->type = FD_PIPE;
...
8010413b:	e8 ab 10 00 00       	call   801051eb <acquire>
  if(writable){
...
8010415e:	e8 7d 0e 00 00       	call   80104fe0 <wakeup>
...
8010417d:	e8 5e 0e 00 00       	call   80104fe0 <wakeup>
  }
...
801041a2:	e8 a6 10 00 00       	call   8010524d <release>
    kfree((char*)p);
...
801041ba:	e8 8e 10 00 00       	call   8010524d <release>
}
801041bf:	c9                   	leave  
801041c0:	c3                   	ret    
...
801041ce:	e8 18 10 00 00       	call   801051eb <acquire>
  for(i = 0; i < n; i++){
...
801041ff:	e8 49 10 00 00       	call   8010524d <release>
        return -1;
...
80104219:	e8 c2 0d 00 00       	call   80104fe0 <wakeup>
...
80104231:	e8 ce 0c 00 00       	call   80104f04 <sleep>
...
80104298:	e8 43 0d 00 00       	call   80104fe0 <wakeup>
  release(&p->lock);
8010429d:	8b 45 08             	mov    0x8(%ebp),%eax
801042a0:	89 04 24             	mov    %eax,(%esp)
801042a3:	e8 a5 0f 00 00       	call   8010524d <release>
  return n;
...
801042be:	e8 28 0f 00 00       	call   801051eb <acquire>
...
801042d8:	e8 70 0f 00 00       	call   8010524d <release>
      return -1;
...
801042fa:	e8 05 0c 00 00       	call   80104f04 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
8010438a:	e8 51 0c 00 00       	call   80104fe0 <wakeup>
  release(&p->lock);
8010438f:	8b 45 08             	mov    0x8(%ebp),%eax
80104392:	89 04 24             	mov    %eax,(%esp)
80104395:	e8 b3 0e 00 00       	call   8010524d <release>
  return i;
...
801043c5:	c7 44 24 04 21 8d 10 	movl   $0x80108d21,0x4(%esp)
801043cc:	80 
801043cd:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801043d4:	e8 f1 0d 00 00       	call   801051ca <initlock>
}
801043d9:	c9                   	leave  
801043da:	c3                   	ret    
...
801043e8:	e8 fe 0d 00 00       	call   801051eb <acquire>
...
80104417:	e8 31 0e 00 00       	call   8010524d <release>
  return 0;
...
8010445b:	e8 ed 0d 00 00       	call   8010524d <release>
...
801044a5:	ba 38 6a 10 80       	mov    $0x80106a38,%edx
...
801044d5:	e8 60 0f 00 00       	call   8010543a <memset>
  p->context->eip = (uint)forkret;
801044da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044dd:	8b 40 20             	mov    0x20(%eax),%eax
801044e0:	ba d8 4e 10 80       	mov    $0x80104ed8,%edx
...
80104503:	e8 cd 3c 00 00       	call   801081d5 <setupkvm>
...
80104518:	c7 04 24 28 8d 10 80 	movl   $0x80108d28,(%esp)
...
8010453e:	e8 ea 3e 00 00       	call   8010842d <inituvm>
  p->sz = PGSIZE;
...
80104565:	e8 d0 0e 00 00       	call   8010543a <memset>
...
801045de:	00 
801045df:	c7 44 24 04 41 8d 10 	movl   $0x80108d41,0x4(%esp)
801045e6:	80 
801045e7:	89 04 24             	mov    %eax,(%esp)
801045ea:	e8 7b 10 00 00       	call   8010566a <safestrcpy>
  p->cwd = namei("/");
801045ef:	c7 04 24 4a 8d 10 80 	movl   $0x80108d4a,(%esp)
...
80104643:	e8 5f 3f 00 00       	call   801085a7 <allocuvm>
...
8010467d:	e8 ff 3f 00 00       	call   80108681 <deallocuvm>
...
801046a6:	e8 1b 3c 00 00       	call   801082c6 <switchuvm>
  return 0;
...
801046eb:	e8 21 41 00 00       	call   80108811 <copyuvm>
...
801047f2:	e8 73 0e 00 00       	call   8010566a <safestrcpy>
...
80104832:	e8 b4 09 00 00       	call   801051eb <acquire>
  np->state = RUNNABLE;
...
80104848:	e8 00 0a 00 00       	call   8010524d <release>
...
8010486c:	75 0c                	jne    8010487a <exit+0x22>
    panic("init exiting");
8010486e:	c7 04 24 4c 8d 10 80 	movl   $0x80108d4c,(%esp)
...
801048fc:	e8 ea 08 00 00       	call   801051eb <acquire>
...
8010492e:	e8 6c 06 00 00       	call   80104f9f <wakeup1>
...
8010496b:	e8 2f 06 00 00       	call   80104f9f <wakeup1>
  proc->ttime = ticks;
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
...
80104986:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010498d:	e8 62 04 00 00       	call   80104df4 <sched>
  panic("zombie exit");
80104992:	c7 04 24 59 8d 10 80 	movl   $0x80108d59,(%esp)
...
801049ab:	e8 3b 08 00 00       	call   801051eb <acquire>
  for(;;){
...
80104a17:	e8 21 3d 00 00       	call   8010873d <freevm>
        p->state = UNUSED;
...
80104a66:	e8 e2 07 00 00       	call   8010524d <release>
...
80104a9f:	e8 a9 07 00 00       	call   8010524d <release>
      return -1;
...
80104abc:	e8 43 04 00 00       	call   80104f04 <sleep>
  }
...
80104acb:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104ace:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ad5:	e8 11 07 00 00       	call   801051eb <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104ada:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    isMyChild = 0;
80104ae1:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ae8:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104aef:	e9 ce 00 00 00       	jmp    80104bc2 <waitpid+0xfa>
      if(p->parent != proc)
80104af4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af7:	8b 50 18             	mov    0x18(%eax),%edx
80104afa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b00:	39 c2                	cmp    %eax,%edx
80104b02:	0f 85 b2 00 00 00    	jne    80104bba <waitpid+0xf2>
        continue;
      havekids = 1;
80104b08:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if( p->pid == childPid ){
80104b0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b12:	8b 40 10             	mov    0x10(%eax),%eax
80104b15:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b18:	0f 85 9d 00 00 00    	jne    80104bbb <waitpid+0xf3>
    	 isMyChild = 1;
80104b1e:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
		 if(p->state == ZOMBIE ){
80104b25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b28:	8b 40 0c             	mov    0xc(%eax),%eax
80104b2b:	83 f8 05             	cmp    $0x5,%eax
80104b2e:	0f 85 87 00 00 00    	jne    80104bbb <waitpid+0xf3>
			// Found one.
			pid = p->pid;
80104b34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b37:	8b 40 10             	mov    0x10(%eax),%eax
80104b3a:	89 45 e8             	mov    %eax,-0x18(%ebp)
			kfree(p->kstack);
80104b3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b40:	8b 40 08             	mov    0x8(%eax),%eax
80104b43:	89 04 24             	mov    %eax,(%esp)
80104b46:	e8 83 df ff ff       	call   80102ace <kfree>
			p->kstack = 0;
80104b4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b4e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
			freevm(p->pgdir);
80104b55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b58:	8b 40 04             	mov    0x4(%eax),%eax
80104b5b:	89 04 24             	mov    %eax,(%esp)
80104b5e:	e8 da 3b 00 00       	call   8010873d <freevm>
			p->state = UNUSED;
80104b63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b66:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
			p->pid = 0;
80104b6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b70:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
			p->parent = 0;
80104b77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b7a:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)
			p->name[0] = 0;
80104b81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b84:	c6 40 70 00          	movb   $0x0,0x70(%eax)
			p->killed = 0;
80104b88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b8b:	c7 40 28 00 00 00 00 	movl   $0x0,0x28(%eax)

			if(status){ // if user did not send status=0 (do not care)
80104b92:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104b96:	74 0e                	je     80104ba6 <waitpid+0xde>
				*status = p->status; //return status to caller
80104b98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b9b:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104ba1:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ba4:	89 10                	mov    %edx,(%eax)
			}

			release(&ptable.lock);
80104ba6:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104bad:	e8 9b 06 00 00       	call   8010524d <release>

			return pid;
80104bb2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104bb5:	e9 8f 00 00 00       	jmp    80104c49 <waitpid+0x181>
    havekids = 0;
    isMyChild = 0;
...
80104bba:	90                   	nop
  for(;;){
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bbb:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104bc2:	81 7d f4 b4 5f 11 80 	cmpl   $0x80115fb4,-0xc(%ebp)
80104bc9:	0f 82 25 ff ff ff    	jb     80104af4 <waitpid+0x2c>
      }
...
80104bcf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104bd3:	74 13                	je     80104be8 <waitpid+0x120>
80104bd5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104bd9:	74 0d                	je     80104be8 <waitpid+0x120>
80104bdb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104be1:	8b 40 28             	mov    0x28(%eax),%eax
80104be4:	85 c0                	test   %eax,%eax
80104be6:	74 13                	je     80104bfb <waitpid+0x133>
      release(&ptable.lock);
80104be8:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104bef:	e8 59 06 00 00       	call   8010524d <release>
      return -1;
80104bf4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bf9:	eb 4e                	jmp    80104c49 <waitpid+0x181>
    }

    switch (options) {
80104bfb:	8b 45 10             	mov    0x10(%ebp),%eax
80104bfe:	85 c0                	test   %eax,%eax
80104c00:	74 07                	je     80104c09 <waitpid+0x141>
80104c02:	83 f8 01             	cmp    $0x1,%eax
80104c05:	74 1e                	je     80104c25 <waitpid+0x15d>
80104c07:	eb 2f                	jmp    80104c38 <waitpid+0x170>
		case BLOCKING:
			sleep(proc, &ptable.lock);
80104c09:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c0f:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80104c16:	80 
80104c17:	89 04 24             	mov    %eax,(%esp)
80104c1a:	e8 e5 02 00 00       	call   80104f04 <sleep>
			break;
80104c1f:	90                   	nop
			release(&ptable.lock);
			return -1;
...
80104c20:	e9 b5 fe ff ff       	jmp    80104ada <waitpid+0x12>
    switch (options) {
		case BLOCKING:
			sleep(proc, &ptable.lock);
			break;
		case NONBLOCKING:
			release(&ptable.lock);
80104c25:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c2c:	e8 1c 06 00 00       	call   8010524d <release>
			return -1;
80104c31:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c36:	eb 11                	jmp    80104c49 <waitpid+0x181>
			break;
		default:
			release(&ptable.lock);
80104c38:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104c3f:	e8 09 06 00 00       	call   8010524d <release>
			return -1;
...
80104c57:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
80104c5d:	8b 45 08             	mov    0x8(%ebp),%eax
80104c60:	89 10                	mov    %edx,(%eax)
	*rtime = proc->rutime;
80104c62:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c68:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
80104c6e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c71:	89 10                	mov    %edx,(%eax)
	*iotime = proc->stime;
80104c73:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c79:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
80104c7f:	8b 45 10             	mov    0x10(%ebp),%eax
80104c82:	89 10                	mov    %edx,(%eax)

	return wait(0);
80104c84:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104c8b:	e8 0e fd ff ff       	call   8010499e <wait>
}
80104c90:	c9                   	leave  
80104c91:	c3                   	ret    

80104c92 <list_pgroup>:
...
80104c95:	83 ec 28             	sub    $0x28,%esp
	struct proc* p;
	int i = 0;
80104c98:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

	acquire(&ptable.lock);
80104c9f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ca6:	e8 40 05 00 00       	call   801051eb <acquire>
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cab:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104cb2:	eb 7c                	jmp    80104d30 <list_pgroup+0x9e>
		if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104cb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cb7:	8b 40 0c             	mov    0xc(%eax),%eax
80104cba:	83 f8 04             	cmp    $0x4,%eax
80104cbd:	74 16                	je     80104cd5 <list_pgroup+0x43>
80104cbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cc2:	8b 40 0c             	mov    0xc(%eax),%eax
80104cc5:	83 f8 03             	cmp    $0x3,%eax
80104cc8:	74 0b                	je     80104cd5 <list_pgroup+0x43>
80104cca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ccd:	8b 40 0c             	mov    0xc(%eax),%eax
80104cd0:	83 f8 02             	cmp    $0x2,%eax
80104cd3:	75 54                	jne    80104d29 <list_pgroup+0x97>
			p->gid == gid ){
80104cd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cd8:	8b 40 14             	mov    0x14(%eax),%eax
//	}
...
80104cde:	75 49                	jne    80104d29 <list_pgroup+0x97>
			p->gid == gid ){
...
80104ced:	03 45 0c             	add    0xc(%ebp),%eax
80104cf0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104cf3:	8b 52 10             	mov    0x10(%edx),%edx
80104cf6:	89 10                	mov    %edx,(%eax)
			safestrcpy(arr[i].name, p->name, sizeof(arr[i].name));
80104cf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cfb:	8d 48 70             	lea    0x70(%eax),%ecx
80104cfe:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d01:	89 d0                	mov    %edx,%eax
80104d03:	c1 e0 02             	shl    $0x2,%eax
80104d06:	01 d0                	add    %edx,%eax
80104d08:	c1 e0 02             	shl    $0x2,%eax
80104d0b:	03 45 0c             	add    0xc(%ebp),%eax
80104d0e:	83 c0 04             	add    $0x4,%eax
80104d11:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104d18:	00 
80104d19:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104d1d:	89 04 24             	mov    %eax,(%esp)
80104d20:	e8 45 09 00 00       	call   8010566a <safestrcpy>
			i++;
80104d25:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
//		cprintf("pid %d - name %s gid (%d) \n", p->pid, p->name, p->gid);
//	}
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d29:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104d30:	81 7d f4 b4 5f 11 80 	cmpl   $0x80115fb4,-0xc(%ebp)
80104d37:	0f 82 77 ff ff ff    	jb     80104cb4 <list_pgroup+0x22>
		}
	}
...
80104d43:	89 10                	mov    %edx,(%eax)
	release(&ptable.lock);
80104d45:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d4c:	e8 fc 04 00 00       	call   8010524d <release>
...
80104d5b:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(;;){
    // Enable interrupts on this processor.
    sti();
80104d5e:	e8 56 f6 ff ff       	call   801043b9 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104d63:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d6a:	e8 7c 04 00 00       	call   801051eb <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d6f:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104d76:	eb 62                	jmp    80104dda <scheduler+0x82>
      if(p->state != RUNNABLE)
80104d78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d7b:	8b 40 0c             	mov    0xc(%eax),%eax
80104d7e:	83 f8 03             	cmp    $0x3,%eax
80104d81:	75 4f                	jne    80104dd2 <scheduler+0x7a>
        continue;
...
80104d86:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104d8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d8f:	89 04 24             	mov    %eax,(%esp)
80104d92:	e8 2f 35 00 00       	call   801082c6 <switchuvm>
      p->state = RUNNING;
80104d97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d9a:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104da1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104da7:	8b 40 20             	mov    0x20(%eax),%eax
80104daa:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104db1:	83 c2 04             	add    $0x4,%edx
80104db4:	89 44 24 04          	mov    %eax,0x4(%esp)
80104db8:	89 14 24             	mov    %edx,(%esp)
80104dbb:	e8 20 09 00 00       	call   801056e0 <swtch>
      switchkvm();
80104dc0:	e8 e4 34 00 00       	call   801082a9 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104dc5:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104dcc:	00 00 00 00 
80104dd0:	eb 01                	jmp    80104dd3 <scheduler+0x7b>
...
80104dd2:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104dd3:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104dda:	81 7d f4 b4 5f 11 80 	cmpl   $0x80115fb4,-0xc(%ebp)
80104de1:	72 95                	jb     80104d78 <scheduler+0x20>
...
80104dea:	e8 5e 04 00 00       	call   8010524d <release>

  }
80104def:	e9 6a ff ff ff       	jmp    80104d5e <scheduler+0x6>
...
80104e01:	e8 03 05 00 00       	call   80105309 <holding>
80104e06:	85 c0                	test   %eax,%eax
80104e08:	75 0c                	jne    80104e16 <sched+0x22>
    panic("sched ptable.lock");
80104e0a:	c7 04 24 65 8d 10 80 	movl   $0x80108d65,(%esp)
...
80104e22:	83 f8 01             	cmp    $0x1,%eax
80104e25:	74 0c                	je     80104e33 <sched+0x3f>
    panic("sched locks");
80104e27:	c7 04 24 77 8d 10 80 	movl   $0x80108d77,(%esp)
80104e2e:	e8 0a b7 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104e33:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e39:	8b 40 0c             	mov    0xc(%eax),%eax
80104e3c:	83 f8 04             	cmp    $0x4,%eax
80104e3f:	75 0c                	jne    80104e4d <sched+0x59>
    panic("sched running");
80104e41:	c7 04 24 83 8d 10 80 	movl   $0x80108d83,(%esp)
80104e48:	e8 f0 b6 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104e4d:	e8 52 f5 ff ff       	call   801043a4 <readeflags>
80104e52:	25 00 02 00 00       	and    $0x200,%eax
80104e57:	85 c0                	test   %eax,%eax
80104e59:	74 0c                	je     80104e67 <sched+0x73>
    panic("sched interruptible");
80104e5b:	c7 04 24 91 8d 10 80 	movl   $0x80108d91,(%esp)
80104e62:	e8 d6 b6 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104e67:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e6d:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104e73:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104e76:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e7c:	8b 40 04             	mov    0x4(%eax),%eax
80104e7f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104e86:	83 c2 20             	add    $0x20,%edx
80104e89:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e8d:	89 14 24             	mov    %edx,(%esp)
80104e90:	e8 4b 08 00 00       	call   801056e0 <swtch>
  cpu->intena = intena;
80104e95:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e9b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e9e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104ea4:	c9                   	leave  
80104ea5:	c3                   	ret    
...
80104eac:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104eb3:	e8 33 03 00 00       	call   801051eb <acquire>
  proc->state = RUNNABLE;
80104eb8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ebe:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104ec5:	e8 2a ff ff ff       	call   80104df4 <sched>
  release(&ptable.lock);
80104eca:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ed1:	e8 77 03 00 00       	call   8010524d <release>
}
80104ed6:	c9                   	leave  
80104ed7:	c3                   	ret    
...
80104edb:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104ede:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ee5:	e8 63 03 00 00       	call   8010524d <release>

  if (first) {
80104eea:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104eef:	85 c0                	test   %eax,%eax
80104ef1:	74 0f                	je     80104f02 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104ef3:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104efa:	00 00 00 
    initlog();
80104efd:	e8 ae e3 ff ff       	call   801032b0 <initlog>
  }
...
80104f12:	75 0c                	jne    80104f20 <sleep+0x1c>
    panic("sleep");
80104f14:	c7 04 24 a5 8d 10 80 	movl   $0x80108da5,(%esp)
80104f1b:	e8 1d b6 ff ff       	call   8010053d <panic>

  if(lk == 0)
80104f20:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104f24:	75 0c                	jne    80104f32 <sleep+0x2e>
    panic("sleep without lk");
80104f26:	c7 04 24 ab 8d 10 80 	movl   $0x80108dab,(%esp)
...
80104f32:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104f39:	74 17                	je     80104f52 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104f3b:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104f42:	e8 a4 02 00 00       	call   801051eb <acquire>
    release(lk);
80104f47:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f4a:	89 04 24             	mov    %eax,(%esp)
80104f4d:	e8 fb 02 00 00       	call   8010524d <release>
  }
...
80104f5b:	89 50 24             	mov    %edx,0x24(%eax)
  proc->state = SLEEPING;
80104f5e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f64:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104f6b:	e8 84 fe ff ff       	call   80104df4 <sched>

  // Tidy up.
  proc->chan = 0;
80104f70:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f76:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104f7d:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104f84:	74 17                	je     80104f9d <sleep+0x99>
    release(&ptable.lock);
80104f86:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104f8d:	e8 bb 02 00 00       	call   8010524d <release>
    acquire(lk);
80104f92:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f95:	89 04 24             	mov    %eax,(%esp)
80104f98:	e8 4e 02 00 00       	call   801051eb <acquire>
  }
}
80104f9d:	c9                   	leave  
80104f9e:	c3                   	ret    
...
80104fa2:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104fa5:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80104fac:	eb 27                	jmp    80104fd5 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104fae:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fb1:	8b 40 0c             	mov    0xc(%eax),%eax
80104fb4:	83 f8 02             	cmp    $0x2,%eax
80104fb7:	75 15                	jne    80104fce <wakeup1+0x2f>
80104fb9:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fbc:	8b 40 24             	mov    0x24(%eax),%eax
80104fbf:	3b 45 08             	cmp    0x8(%ebp),%eax
80104fc2:	75 0a                	jne    80104fce <wakeup1+0x2f>
      p->state = RUNNABLE;
80104fc4:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fc7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104fce:	81 45 fc 98 00 00 00 	addl   $0x98,-0x4(%ebp)
80104fd5:	81 7d fc b4 5f 11 80 	cmpl   $0x80115fb4,-0x4(%ebp)
80104fdc:	72 d0                	jb     80104fae <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104fde:	c9                   	leave  
...
80104fe3:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104fe6:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104fed:	e8 f9 01 00 00       	call   801051eb <acquire>
  wakeup1(chan);
80104ff2:	8b 45 08             	mov    0x8(%ebp),%eax
80104ff5:	89 04 24             	mov    %eax,(%esp)
80104ff8:	e8 a2 ff ff ff       	call   80104f9f <wakeup1>
  release(&ptable.lock);
80104ffd:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105004:	e8 44 02 00 00       	call   8010524d <release>
}
80105009:	c9                   	leave  
8010500a:	c3                   	ret    
...
8010500e:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80105011:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105018:	e8 ce 01 00 00       	call   801051eb <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010501d:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80105024:	eb 44                	jmp    8010506a <kill+0x5f>
    if(p->pid == pid){
80105026:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105029:	8b 40 10             	mov    0x10(%eax),%eax
8010502c:	3b 45 08             	cmp    0x8(%ebp),%eax
8010502f:	75 32                	jne    80105063 <kill+0x58>
      p->killed = 1;
80105031:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105034:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010503b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010503e:	8b 40 0c             	mov    0xc(%eax),%eax
80105041:	83 f8 02             	cmp    $0x2,%eax
80105044:	75 0a                	jne    80105050 <kill+0x45>
        p->state = RUNNABLE;
80105046:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105049:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80105050:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80105057:	e8 f1 01 00 00       	call   8010524d <release>
      return 0;
8010505c:	b8 00 00 00 00       	mov    $0x0,%eax
80105061:	eb 21                	jmp    80105084 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105063:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
8010506a:	81 7d f4 b4 5f 11 80 	cmpl   $0x80115fb4,-0xc(%ebp)
80105071:	72 b3                	jb     80105026 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80105073:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010507a:	e8 ce 01 00 00       	call   8010524d <release>
  return -1;
...
80105089:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010508c:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
80105093:	e9 db 00 00 00       	jmp    80105173 <procdump+0xed>
    if(p->state == UNUSED)
80105098:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010509b:	8b 40 0c             	mov    0xc(%eax),%eax
8010509e:	85 c0                	test   %eax,%eax
801050a0:	0f 84 c5 00 00 00    	je     8010516b <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801050a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050a9:	8b 40 0c             	mov    0xc(%eax),%eax
801050ac:	83 f8 05             	cmp    $0x5,%eax
801050af:	77 23                	ja     801050d4 <procdump+0x4e>
801050b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050b4:	8b 40 0c             	mov    0xc(%eax),%eax
801050b7:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801050be:	85 c0                	test   %eax,%eax
801050c0:	74 12                	je     801050d4 <procdump+0x4e>
      state = states[p->state];
801050c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050c5:	8b 40 0c             	mov    0xc(%eax),%eax
801050c8:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801050cf:	89 45 ec             	mov    %eax,-0x14(%ebp)
801050d2:	eb 07                	jmp    801050db <procdump+0x55>
    else
      state = "???";
801050d4:	c7 45 ec bc 8d 10 80 	movl   $0x80108dbc,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
801050db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050de:	8d 50 70             	lea    0x70(%eax),%edx
801050e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050e4:	8b 40 10             	mov    0x10(%eax),%eax
801050e7:	89 54 24 0c          	mov    %edx,0xc(%esp)
801050eb:	8b 55 ec             	mov    -0x14(%ebp),%edx
801050ee:	89 54 24 08          	mov    %edx,0x8(%esp)
801050f2:	89 44 24 04          	mov    %eax,0x4(%esp)
801050f6:	c7 04 24 c0 8d 10 80 	movl   $0x80108dc0,(%esp)
801050fd:	e8 9f b2 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80105102:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105105:	8b 40 0c             	mov    0xc(%eax),%eax
80105108:	83 f8 02             	cmp    $0x2,%eax
8010510b:	75 50                	jne    8010515d <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010510d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105110:	8b 40 20             	mov    0x20(%eax),%eax
80105113:	8b 40 0c             	mov    0xc(%eax),%eax
80105116:	83 c0 08             	add    $0x8,%eax
80105119:	8d 55 c4             	lea    -0x3c(%ebp),%edx
8010511c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105120:	89 04 24             	mov    %eax,(%esp)
80105123:	e8 74 01 00 00       	call   8010529c <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105128:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010512f:	eb 1b                	jmp    8010514c <procdump+0xc6>
        cprintf(" %p", pc[i]);
80105131:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105134:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105138:	89 44 24 04          	mov    %eax,0x4(%esp)
8010513c:	c7 04 24 c9 8d 10 80 	movl   $0x80108dc9,(%esp)
80105143:	e8 59 b2 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80105148:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010514c:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105150:	7f 0b                	jg     8010515d <procdump+0xd7>
80105152:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105155:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105159:	85 c0                	test   %eax,%eax
8010515b:	75 d4                	jne    80105131 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
8010515d:	c7 04 24 cd 8d 10 80 	movl   $0x80108dcd,(%esp)
80105164:	e8 38 b2 ff ff       	call   801003a1 <cprintf>
80105169:	eb 01                	jmp    8010516c <procdump+0xe6>
  char *state;
  uint pc[10];
...
8010516b:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010516c:	81 45 f0 98 00 00 00 	addl   $0x98,-0x10(%ebp)
80105173:	81 7d f0 b4 5f 11 80 	cmpl   $0x80115fb4,-0x10(%ebp)
8010517a:	0f 82 18 ff ff ff    	jb     80105098 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
8010518b:	9c                   	pushf  
8010518c:	5b                   	pop    %ebx
8010518d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
xchg(volatile uint *addr, uint newval)
{
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
801051b5:	89 c3                	mov    %eax,%ebx
801051b7:	89 d8                	mov    %ebx,%eax
801051b9:	f0 87 02             	lock xchg %eax,(%edx)
801051bc:	89 c3                	mov    %eax,%ebx
801051be:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
801051f1:	e8 3d 01 00 00       	call   80105333 <pushcli>
  if(holding(lk))
801051f6:	8b 45 08             	mov    0x8(%ebp),%eax
801051f9:	89 04 24             	mov    %eax,(%esp)
801051fc:	e8 08 01 00 00       	call   80105309 <holding>
80105201:	85 c0                	test   %eax,%eax
80105203:	74 0c                	je     80105211 <acquire+0x26>
    panic("acquire");
80105205:	c7 04 24 f9 8d 10 80 	movl   $0x80108df9,(%esp)
8010520c:	e8 2c b3 ff ff       	call   8010053d <panic>
...
80105215:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010521c:	00 
8010521d:	89 04 24             	mov    %eax,(%esp)
80105220:	e8 80 ff ff ff       	call   801051a5 <xchg>
80105225:	85 c0                	test   %eax,%eax
80105227:	75 e9                	jne    80105212 <acquire+0x27>
    ;
...
80105233:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105236:	8b 45 08             	mov    0x8(%ebp),%eax
80105239:	83 c0 0c             	add    $0xc,%eax
8010523c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105240:	8d 45 08             	lea    0x8(%ebp),%eax
80105243:	89 04 24             	mov    %eax,(%esp)
80105246:	e8 51 00 00 00       	call   8010529c <getcallerpcs>
}
8010524b:	c9                   	leave  
8010524c:	c3                   	ret    
...
80105259:	e8 ab 00 00 00       	call   80105309 <holding>
8010525e:	85 c0                	test   %eax,%eax
80105260:	75 0c                	jne    8010526e <release+0x21>
    panic("release");
80105262:	c7 04 24 01 8e 10 80 	movl   $0x80108e01,(%esp)
80105269:	e8 cf b2 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
8010526e:	8b 45 08             	mov    0x8(%ebp),%eax
80105271:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105278:	8b 45 08             	mov    0x8(%ebp),%eax
8010527b:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105285:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010528c:	00 
8010528d:	89 04 24             	mov    %eax,(%esp)
80105290:	e8 10 ff ff ff       	call   801051a5 <xchg>

  popcli();
80105295:	e8 e1 00 00 00       	call   8010537b <popcli>
}
8010529a:	c9                   	leave  
8010529b:	c3                   	ret    

8010529c <getcallerpcs>:
...
801052b2:	eb 32                	jmp    801052e6 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801052b4:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801052b8:	74 47                	je     80105301 <getcallerpcs+0x65>
801052ba:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801052c1:	76 3e                	jbe    80105301 <getcallerpcs+0x65>
801052c3:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801052c7:	74 38                	je     80105301 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801052c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
801052cc:	c1 e0 02             	shl    $0x2,%eax
801052cf:	03 45 0c             	add    0xc(%ebp),%eax
801052d2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052d5:	8b 52 04             	mov    0x4(%edx),%edx
...
801052df:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801052e2:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801052e6:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801052ea:	7e c8                	jle    801052b4 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801052ec:	eb 13                	jmp    80105301 <getcallerpcs+0x65>
    pcs[i] = 0;
801052ee:	8b 45 f8             	mov    -0x8(%ebp),%eax
801052f1:	c1 e0 02             	shl    $0x2,%eax
801052f4:	03 45 0c             	add    0xc(%ebp),%eax
...
80105305:	7e e7                	jle    801052ee <getcallerpcs+0x52>
    pcs[i] = 0;
}
80105307:	c9                   	leave  
80105308:	c3                   	ret    
...
80105313:	74 17                	je     8010532c <holding+0x23>
80105315:	8b 45 08             	mov    0x8(%ebp),%eax
80105318:	8b 50 08             	mov    0x8(%eax),%edx
8010531b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105321:	39 c2                	cmp    %eax,%edx
80105323:	75 07                	jne    8010532c <holding+0x23>
80105325:	b8 01 00 00 00       	mov    $0x1,%eax
8010532a:	eb 05                	jmp    80105331 <holding+0x28>
...
80105336:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105339:	e8 46 fe ff ff       	call   80105184 <readeflags>
8010533e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105341:	e8 53 fe ff ff       	call   80105199 <cli>
  if(cpu->ncli++ == 0)
80105346:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010534c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105352:	85 d2                	test   %edx,%edx
80105354:	0f 94 c1             	sete   %cl
80105357:	83 c2 01             	add    $0x1,%edx
8010535a:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105360:	84 c9                	test   %cl,%cl
80105362:	74 15                	je     80105379 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105364:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010536a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010536d:	81 e2 00 02 00 00    	and    $0x200,%edx
80105373:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105379:	c9                   	leave  
8010537a:	c3                   	ret    
...
8010537e:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105381:	e8 fe fd ff ff       	call   80105184 <readeflags>
80105386:	25 00 02 00 00       	and    $0x200,%eax
8010538b:	85 c0                	test   %eax,%eax
8010538d:	74 0c                	je     8010539b <popcli+0x20>
    panic("popcli - interruptible");
8010538f:	c7 04 24 09 8e 10 80 	movl   $0x80108e09,(%esp)
80105396:	e8 a2 b1 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
8010539b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801053a1:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801053a7:	83 ea 01             	sub    $0x1,%edx
801053aa:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801053b0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801053b6:	85 c0                	test   %eax,%eax
801053b8:	79 0c                	jns    801053c6 <popcli+0x4b>
    panic("popcli");
801053ba:	c7 04 24 20 8e 10 80 	movl   $0x80108e20,(%esp)
801053c1:	e8 77 b1 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
801053c6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801053cc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801053d2:	85 c0                	test   %eax,%eax
801053d4:	75 15                	jne    801053eb <popcli+0x70>
801053d6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801053dc:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801053e2:	85 c0                	test   %eax,%eax
801053e4:	74 05                	je     801053eb <popcli+0x70>
    sti();
801053e6:	e8 b4 fd ff ff       	call   8010519f <sti>
}
801053eb:	c9                   	leave  
801053ec:	c3                   	ret    
...
80105419:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
8010541a:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010541d:	8b 55 10             	mov    0x10(%ebp),%edx
80105420:	8b 45 0c             	mov    0xc(%ebp),%eax
80105423:	89 cb                	mov    %ecx,%ebx
80105425:	89 df                	mov    %ebx,%edi
80105427:	89 d1                	mov    %edx,%ecx
80105429:	fc                   	cld    
8010542a:	f3 ab                	rep stos %eax,%es:(%edi)
8010542c:	89 ca                	mov    %ecx,%edx
8010542e:	89 fb                	mov    %edi,%ebx
80105430:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105443:	83 e0 03             	and    $0x3,%eax
80105446:	85 c0                	test   %eax,%eax
80105448:	75 49                	jne    80105493 <memset+0x59>
8010544a:	8b 45 10             	mov    0x10(%ebp),%eax
8010544d:	83 e0 03             	and    $0x3,%eax
80105450:	85 c0                	test   %eax,%eax
80105452:	75 3f                	jne    80105493 <memset+0x59>
    c &= 0xFF;
80105454:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010545b:	8b 45 10             	mov    0x10(%ebp),%eax
8010545e:	c1 e8 02             	shr    $0x2,%eax
80105461:	89 c2                	mov    %eax,%edx
80105463:	8b 45 0c             	mov    0xc(%ebp),%eax
80105466:	89 c1                	mov    %eax,%ecx
80105468:	c1 e1 18             	shl    $0x18,%ecx
8010546b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010546e:	c1 e0 10             	shl    $0x10,%eax
80105471:	09 c1                	or     %eax,%ecx
80105473:	8b 45 0c             	mov    0xc(%ebp),%eax
80105476:	c1 e0 08             	shl    $0x8,%eax
80105479:	09 c8                	or     %ecx,%eax
8010547b:	0b 45 0c             	or     0xc(%ebp),%eax
...
8010548c:	e8 84 ff ff ff       	call   80105415 <stosl>
80105491:	eb 19                	jmp    801054ac <memset+0x72>
  } else
    stosb(dst, c, n);
...
801054a7:	e8 44 ff ff ff       	call   801053f0 <stosb>
  return dst;
...
801054ba:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
801054bd:	8b 45 0c             	mov    0xc(%ebp),%eax
801054c0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801054c3:	eb 32                	jmp    801054f7 <memcmp+0x46>
    if(*s1 != *s2)
...
801054fb:	0f 95 c0             	setne  %al
801054fe:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105502:	84 c0                	test   %al,%al
80105504:	75 bf                	jne    801054c5 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
8010551c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010551f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105522:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105525:	73 54                	jae    8010557b <memmove+0x6e>
80105527:	8b 45 10             	mov    0x10(%ebp),%eax
8010552a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010552d:	01 d0                	add    %edx,%eax
8010552f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105532:	76 47                	jbe    8010557b <memmove+0x6e>
    s += n;
80105534:	8b 45 10             	mov    0x10(%ebp),%eax
80105537:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010553a:	8b 45 10             	mov    0x10(%ebp),%eax
8010553d:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105540:	eb 13                	jmp    80105555 <memmove+0x48>
      *--d = *--s;
80105542:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105546:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010554a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010554d:	0f b6 10             	movzbl (%eax),%edx
...
80105559:	0f 95 c0             	setne  %al
8010555c:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105560:	84 c0                	test   %al,%al
80105562:	75 de                	jne    80105542 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105564:	eb 25                	jmp    8010558b <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105579:	eb 01                	jmp    8010557c <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105580:	0f 95 c0             	setne  %al
80105583:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105587:	84 c0                	test   %al,%al
80105589:	75 db                	jne    80105566 <memmove+0x59>
      *d++ = *s++;
...
801055aa:	e8 5e ff ff ff       	call   8010550d <memmove>
}
801055af:	c9                   	leave  
801055b0:	c3                   	ret    
...
801055b2:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801055b4:	eb 0c                	jmp    801055c2 <strncmp+0x11>
    n--, p++, q++;
801055b6:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801055ba:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801055be:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801055c6:	74 1a                	je     801055e2 <strncmp+0x31>
801055c8:	8b 45 08             	mov    0x8(%ebp),%eax
801055cb:	0f b6 00             	movzbl (%eax),%eax
801055ce:	84 c0                	test   %al,%al
801055d0:	74 10                	je     801055e2 <strncmp+0x31>
...
8010561a:	0f 9f c0             	setg   %al
8010561d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105621:	84 c0                	test   %al,%al
80105623:	74 30                	je     80105655 <strncpy+0x4c>
...
80105638:	0f 95 c0             	setne  %al
8010563b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010563f:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105643:	84 c0                	test   %al,%al
80105645:	75 cf                	jne    80105616 <strncpy+0xd>
    ;
  while(n-- > 0)
80105647:	eb 0c                	jmp    80105655 <strncpy+0x4c>
    *s++ = 0;
80105649:	8b 45 08             	mov    0x8(%ebp),%eax
8010564c:	c6 00 00             	movb   $0x0,(%eax)
8010564f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105653:	eb 01                	jmp    80105656 <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
80105655:	90                   	nop
80105656:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010565a:	0f 9f c0             	setg   %al
8010565d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105661:	84 c0                	test   %al,%al
80105663:	75 e4                	jne    80105649 <strncpy+0x40>
    *s++ = 0;
  return os;
...
8010567a:	7f 05                	jg     80105681 <safestrcpy+0x17>
    return os;
8010567c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010567f:	eb 35                	jmp    801056b6 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105681:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105685:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105689:	7e 22                	jle    801056ad <safestrcpy+0x43>
8010568b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010568e:	0f b6 10             	movzbl (%eax),%edx
...
8010569e:	0f 95 c0             	setne  %al
801056a1:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801056a5:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801056a9:	84 c0                	test   %al,%al
801056ab:	75 d4                	jne    80105681 <safestrcpy+0x17>
    ;
  *s = 0;
801056ad:	8b 45 08             	mov    0x8(%ebp),%eax
801056b0:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801056bb:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801056be:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801056c5:	eb 04                	jmp    801056cb <strlen+0x13>
801056c7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801056cb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801056ce:	03 45 08             	add    0x8(%ebp),%eax
801056d1:	0f b6 00             	movzbl (%eax),%eax
801056d4:	84 c0                	test   %al,%al
801056d6:	75 ef                	jne    801056c7 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801056e0:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801056e4:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801056eb:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801056ec:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801056ee:	89 d4                	mov    %edx,%esp
...
80105703:	3b 45 08             	cmp    0x8(%ebp),%eax
80105706:	76 12                	jbe    8010571a <fetchint+0x22>
80105708:	8b 45 08             	mov    0x8(%ebp),%eax
8010570b:	8d 50 04             	lea    0x4(%eax),%edx
8010570e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105714:	8b 00                	mov    (%eax),%eax
80105716:	39 c2                	cmp    %eax,%edx
80105718:	76 07                	jbe    80105721 <fetchint+0x29>
    return -1;
8010571a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010571f:	eb 0f                	jmp    80105730 <fetchint+0x38>
  *ip = *(int*)(addr);
...
80105740:	3b 45 08             	cmp    0x8(%ebp),%eax
80105743:	77 07                	ja     8010574c <fetchstr+0x1a>
    return -1;
80105745:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010574a:	eb 48                	jmp    80105794 <fetchstr+0x62>
  *pp = (char*)addr;
...
80105764:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105767:	eb 1e                	jmp    80105787 <fetchstr+0x55>
    if(*s == 0)
80105769:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010576c:	0f b6 00             	movzbl (%eax),%eax
8010576f:	84 c0                	test   %al,%al
80105771:	75 10                	jne    80105783 <fetchstr+0x51>
      return s - *pp;
...
80105781:	eb 11                	jmp    80105794 <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105783:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105787:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010578a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010578d:	72 da                	jb     80105769 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801057a2:	8b 40 1c             	mov    0x1c(%eax),%eax
801057a5:	8b 50 44             	mov    0x44(%eax),%edx
801057a8:	8b 45 08             	mov    0x8(%ebp),%eax
801057ab:	c1 e0 02             	shl    $0x2,%eax
801057ae:	01 d0                	add    %edx,%eax
801057b0:	8d 50 04             	lea    0x4(%eax),%edx
801057b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801057b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ba:	89 14 24             	mov    %edx,(%esp)
801057bd:	e8 36 ff ff ff       	call   801056f8 <fetchint>
}
801057c2:	c9                   	leave  
801057c3:	c3                   	ret    
...
801057d7:	e8 ba ff ff ff       	call   80105796 <argint>
801057dc:	85 c0                	test   %eax,%eax
801057de:	79 07                	jns    801057e7 <argptr+0x23>
    return -1;
801057e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057e5:	eb 3d                	jmp    80105824 <argptr+0x60>
...
801057f6:	73 16                	jae    8010580e <argptr+0x4a>
801057f8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801057fb:	89 c2                	mov    %eax,%edx
801057fd:	8b 45 10             	mov    0x10(%ebp),%eax
80105800:	01 c2                	add    %eax,%edx
80105802:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105808:	8b 00                	mov    (%eax),%eax
8010580a:	39 c2                	cmp    %eax,%edx
8010580c:	76 07                	jbe    80105815 <argptr+0x51>
    return -1;
8010580e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105813:	eb 0f                	jmp    80105824 <argptr+0x60>
  *pp = (char*)i;
...
80105861:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105864:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010586a:	8b 40 1c             	mov    0x1c(%eax),%eax
8010586d:	8b 40 1c             	mov    0x1c(%eax),%eax
80105870:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105873:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105877:	7e 30                	jle    801058a9 <syscall+0x4c>
80105879:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587c:	83 f8 18             	cmp    $0x18,%eax
8010587f:	77 28                	ja     801058a9 <syscall+0x4c>
80105881:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105884:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
8010588b:	85 c0                	test   %eax,%eax
8010588d:	74 1a                	je     801058a9 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
8010588f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105895:	8b 58 1c             	mov    0x1c(%eax),%ebx
80105898:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010589b:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801058a2:	ff d0                	call   *%eax
801058a4:	89 43 1c             	mov    %eax,0x1c(%ebx)
801058a7:	eb 3d                	jmp    801058e6 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801058a9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058af:	8d 48 70             	lea    0x70(%eax),%ecx
...
801058bb:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058be:	89 54 24 0c          	mov    %edx,0xc(%esp)
801058c2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801058c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801058ca:	c7 04 24 27 8e 10 80 	movl   $0x80108e27,(%esp)
801058d1:	e8 cb aa ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801058d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058dc:	8b 40 1c             	mov    0x1c(%eax),%eax
801058df:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801058e6:	83 c4 24             	add    $0x24,%esp
801058e9:	5b                   	pop    %ebx
801058ea:	5d                   	pop    %ebp
801058eb:	c3                   	ret    
...
801058ef:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
801058ff:	e8 92 fe ff ff       	call   80105796 <argint>
80105904:	85 c0                	test   %eax,%eax
80105906:	79 07                	jns    8010590f <argfd+0x23>
    return -1;
80105908:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010590d:	eb 50                	jmp    8010595f <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
8010590f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105912:	85 c0                	test   %eax,%eax
80105914:	78 21                	js     80105937 <argfd+0x4b>
80105916:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105919:	83 f8 0f             	cmp    $0xf,%eax
8010591c:	7f 19                	jg     80105937 <argfd+0x4b>
8010591e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105924:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105927:	83 c2 08             	add    $0x8,%edx
8010592a:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
8010592e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105931:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105935:	75 07                	jne    8010593e <argfd+0x52>
    return -1;
80105937:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010593c:	eb 21                	jmp    8010595f <argfd+0x73>
  if(pfd)
8010593e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105942:	74 08                	je     8010594c <argfd+0x60>
    *pfd = fd;
80105944:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105947:	8b 45 0c             	mov    0xc(%ebp),%eax
8010594a:	89 10                	mov    %edx,(%eax)
  if(pf)
8010594c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105950:	74 08                	je     8010595a <argfd+0x6e>
    *pf = f;
80105952:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105964:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105967:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010596e:	eb 30                	jmp    801059a0 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105970:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105976:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105979:	83 c2 08             	add    $0x8,%edx
8010597c:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80105980:	85 c0                	test   %eax,%eax
80105982:	75 18                	jne    8010599c <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105984:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010598a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010598d:	8d 4a 08             	lea    0x8(%edx),%ecx
80105990:	8b 55 08             	mov    0x8(%ebp),%edx
80105993:	89 54 88 0c          	mov    %edx,0xc(%eax,%ecx,4)
      return fd;
80105997:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010599a:	eb 0f                	jmp    801059ab <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
801059a0:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801059a4:	7e ca                	jle    80105970 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801059ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801059c1:	00 
801059c2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059c9:	e8 1e ff ff ff       	call   801058ec <argfd>
801059ce:	85 c0                	test   %eax,%eax
801059d0:	79 07                	jns    801059d9 <sys_dup+0x2c>
    return -1;
801059d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059d7:	eb 29                	jmp    80105a02 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801059d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059dc:	89 04 24             	mov    %eax,(%esp)
801059df:	e8 7d ff ff ff       	call   80105961 <fdalloc>
801059e4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059e7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801059eb:	79 07                	jns    801059f4 <sys_dup+0x47>
    return -1;
801059ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059f2:	eb 0e                	jmp    80105a02 <sys_dup+0x55>
  filedup(f);
801059f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059f7:	89 04 24             	mov    %eax,(%esp)
801059fa:	e8 e5 b5 ff ff       	call   80100fe4 <filedup>
  return fd;
...
80105a07:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105a0d:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a11:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a18:	00 
80105a19:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a20:	e8 c7 fe ff ff       	call   801058ec <argfd>
80105a25:	85 c0                	test   %eax,%eax
80105a27:	78 35                	js     80105a5e <sys_read+0x5a>
80105a29:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105a2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a30:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105a37:	e8 5a fd ff ff       	call   80105796 <argint>
80105a3c:	85 c0                	test   %eax,%eax
80105a3e:	78 1e                	js     80105a5e <sys_read+0x5a>
80105a40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a43:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a47:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105a4a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a4e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a55:	e8 6a fd ff ff       	call   801057c4 <argptr>
80105a5a:	85 c0                	test   %eax,%eax
80105a5c:	79 07                	jns    80105a65 <sys_read+0x61>
    return -1;
80105a5e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a63:	eb 19                	jmp    80105a7e <sys_read+0x7a>
  return fileread(f, p, n);
80105a65:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105a68:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105a6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a6e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105a72:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a76:	89 04 24             	mov    %eax,(%esp)
80105a79:	e8 d3 b6 ff ff       	call   80101151 <fileread>
}
80105a7e:	c9                   	leave  
80105a7f:	c3                   	ret    
...
80105a9c:	e8 4b fe ff ff       	call   801058ec <argfd>
80105aa1:	85 c0                	test   %eax,%eax
80105aa3:	78 35                	js     80105ada <sys_write+0x5a>
80105aa5:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105aa8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aac:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105ab3:	e8 de fc ff ff       	call   80105796 <argint>
80105ab8:	85 c0                	test   %eax,%eax
80105aba:	78 1e                	js     80105ada <sys_write+0x5a>
...
80105ad1:	e8 ee fc ff ff       	call   801057c4 <argptr>
80105ad6:	85 c0                	test   %eax,%eax
80105ad8:	79 07                	jns    80105ae1 <sys_write+0x61>
    return -1;
80105ada:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105adf:	eb 19                	jmp    80105afa <sys_write+0x7a>
  return filewrite(f, p, n);
80105ae1:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105ae4:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105ae7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aea:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105aee:	89 54 24 04          	mov    %edx,0x4(%esp)
80105af2:	89 04 24             	mov    %eax,(%esp)
80105af5:	e8 13 b7 ff ff       	call   8010120d <filewrite>
}
80105afa:	c9                   	leave  
80105afb:	c3                   	ret    
...
80105aff:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105b09:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105b0c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b10:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b17:	e8 d0 fd ff ff       	call   801058ec <argfd>
80105b1c:	85 c0                	test   %eax,%eax
80105b1e:	79 07                	jns    80105b27 <sys_close+0x2b>
    return -1;
80105b20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b25:	eb 24                	jmp    80105b4b <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105b27:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b2d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b30:	83 c2 08             	add    $0x8,%edx
80105b33:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80105b3a:	00 
  fileclose(f);
80105b3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3e:	89 04 24             	mov    %eax,(%esp)
80105b41:	e8 e6 b4 ff ff       	call   8010102c <fileclose>
  return 0;
...
80105b53:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105b56:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b5a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b61:	00 
80105b62:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b69:	e8 7e fd ff ff       	call   801058ec <argfd>
80105b6e:	85 c0                	test   %eax,%eax
80105b70:	78 1f                	js     80105b91 <sys_fstat+0x44>
80105b72:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105b79:	00 
80105b7a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b7d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b81:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b88:	e8 37 fc ff ff       	call   801057c4 <argptr>
80105b8d:	85 c0                	test   %eax,%eax
80105b8f:	79 07                	jns    80105b98 <sys_fstat+0x4b>
    return -1;
80105b91:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b96:	eb 12                	jmp    80105baa <sys_fstat+0x5d>
  return filestat(f, st);
80105b98:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105b9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b9e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ba2:	89 04 24             	mov    %eax,(%esp)
80105ba5:	e8 58 b5 ff ff       	call   80101102 <filestat>
}
80105baa:	c9                   	leave  
80105bab:	c3                   	ret    
...
80105baf:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105bb2:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105bb5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bb9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105bc0:	e8 61 fc ff ff       	call   80105826 <argstr>
80105bc5:	85 c0                	test   %eax,%eax
80105bc7:	78 17                	js     80105be0 <sys_link+0x34>
80105bc9:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105bcc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bd0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105bd7:	e8 4a fc ff ff       	call   80105826 <argstr>
80105bdc:	85 c0                	test   %eax,%eax
80105bde:	79 0a                	jns    80105bea <sys_link+0x3e>
    return -1;
80105be0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105be5:	e9 41 01 00 00       	jmp    80105d2b <sys_link+0x17f>

  begin_op();
80105bea:	e8 ce d8 ff ff       	call   801034bd <begin_op>
  if((ip = namei(old)) == 0){
80105bef:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105bf2:	89 04 24             	mov    %eax,(%esp)
80105bf5:	e8 78 c8 ff ff       	call   80102472 <namei>
80105bfa:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bfd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c01:	75 0f                	jne    80105c12 <sys_link+0x66>
    end_op();
80105c03:	e8 36 d9 ff ff       	call   8010353e <end_op>
    return -1;
80105c08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c0d:	e9 19 01 00 00       	jmp    80105d2b <sys_link+0x17f>
  }

  ilock(ip);
80105c12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c15:	89 04 24             	mov    %eax,(%esp)
80105c18:	e8 b3 bc ff ff       	call   801018d0 <ilock>
  if(ip->type == T_DIR){
80105c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c20:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c24:	66 83 f8 01          	cmp    $0x1,%ax
80105c28:	75 1a                	jne    80105c44 <sys_link+0x98>
    iunlockput(ip);
80105c2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c2d:	89 04 24             	mov    %eax,(%esp)
80105c30:	e8 1f bf ff ff       	call   80101b54 <iunlockput>
    end_op();
80105c35:	e8 04 d9 ff ff       	call   8010353e <end_op>
    return -1;
80105c3a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c3f:	e9 e7 00 00 00       	jmp    80105d2b <sys_link+0x17f>
  }

  ip->nlink++;
80105c44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c47:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c4b:	8d 50 01             	lea    0x1(%eax),%edx
...
80105c5b:	e8 b4 ba ff ff       	call   80101714 <iupdate>
  iunlock(ip);
80105c60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c63:	89 04 24             	mov    %eax,(%esp)
80105c66:	e8 b3 bd ff ff       	call   80101a1e <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105c6b:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105c6e:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105c71:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c75:	89 04 24             	mov    %eax,(%esp)
80105c78:	e8 17 c8 ff ff       	call   80102494 <nameiparent>
80105c7d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c80:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c84:	74 68                	je     80105cee <sys_link+0x142>
    goto bad;
  ilock(dp);
80105c86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c89:	89 04 24             	mov    %eax,(%esp)
80105c8c:	e8 3f bc ff ff       	call   801018d0 <ilock>
...
80105c9d:	75 20                	jne    80105cbf <sys_link+0x113>
80105c9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ca2:	8b 40 04             	mov    0x4(%eax),%eax
80105ca5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ca9:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105cac:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cb0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb3:	89 04 24             	mov    %eax,(%esp)
80105cb6:	e8 f6 c4 ff ff       	call   801021b1 <dirlink>
80105cbb:	85 c0                	test   %eax,%eax
80105cbd:	79 0d                	jns    80105ccc <sys_link+0x120>
    iunlockput(dp);
80105cbf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc2:	89 04 24             	mov    %eax,(%esp)
80105cc5:	e8 8a be ff ff       	call   80101b54 <iunlockput>
    goto bad;
80105cca:	eb 23                	jmp    80105cef <sys_link+0x143>
  }
  iunlockput(dp);
80105ccc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ccf:	89 04 24             	mov    %eax,(%esp)
80105cd2:	e8 7d be ff ff       	call   80101b54 <iunlockput>
  iput(ip);
80105cd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cda:	89 04 24             	mov    %eax,(%esp)
80105cdd:	e8 a1 bd ff ff       	call   80101a83 <iput>

  end_op();
80105ce2:	e8 57 d8 ff ff       	call   8010353e <end_op>

  return 0;
80105ce7:	b8 00 00 00 00       	mov    $0x0,%eax
80105cec:	eb 3d                	jmp    80105d2b <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105cf5:	e8 d6 bb ff ff       	call   801018d0 <ilock>
  ip->nlink--;
...
80105d11:	e8 fe b9 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
80105d16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d19:	89 04 24             	mov    %eax,(%esp)
80105d1c:	e8 33 be ff ff       	call   80101b54 <iunlockput>
  end_op();
80105d21:	e8 18 d8 ff ff       	call   8010353e <end_op>
  return -1;
...
80105d30:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105d33:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105d3a:	eb 4b                	jmp    80105d87 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105d3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d3f:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105d46:	00 
80105d47:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d4b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105d4e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d52:	8b 45 08             	mov    0x8(%ebp),%eax
80105d55:	89 04 24             	mov    %eax,(%esp)
80105d58:	e8 69 c0 ff ff       	call   80101dc6 <readi>
80105d5d:	83 f8 10             	cmp    $0x10,%eax
80105d60:	74 0c                	je     80105d6e <isdirempty+0x41>
      panic("isdirempty: readi");
80105d62:	c7 04 24 43 8e 10 80 	movl   $0x80108e43,(%esp)
80105d69:	e8 cf a7 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105d6e:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105d72:	66 85 c0             	test   %ax,%ax
80105d75:	74 07                	je     80105d7e <isdirempty+0x51>
      return 0;
80105d77:	b8 00 00 00 00       	mov    $0x0,%eax
80105d7c:	eb 1b                	jmp    80105d99 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105d81:	83 c0 10             	add    $0x10,%eax
80105d84:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d87:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105d8a:	8b 45 08             	mov    0x8(%ebp),%eax
80105d8d:	8b 40 18             	mov    0x18(%eax),%eax
80105d90:	39 c2                	cmp    %eax,%edx
80105d92:	72 a8                	jb     80105d3c <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105d94:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105d99:	c9                   	leave  
80105d9a:	c3                   	ret    
...
80105d9e:	83 ec 48             	sub    $0x48,%esp
  ...
  if(argstr(0, &path) < 0)
80105da1:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105da4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105da8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105daf:	e8 72 fa ff ff       	call   80105826 <argstr>
80105db4:	85 c0                	test   %eax,%eax
80105db6:	79 0a                	jns    80105dc2 <sys_unlink+0x27>
    return -1;
80105db8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dbd:	e9 af 01 00 00       	jmp    80105f71 <sys_unlink+0x1d6>

  begin_op();
80105dc2:	e8 f6 d6 ff ff       	call   801034bd <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105dc7:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105dca:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105dcd:	89 54 24 04          	mov    %edx,0x4(%esp)
80105dd1:	89 04 24             	mov    %eax,(%esp)
80105dd4:	e8 bb c6 ff ff       	call   80102494 <nameiparent>
80105dd9:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ddc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105de0:	75 0f                	jne    80105df1 <sys_unlink+0x56>
    end_op();
80105de2:	e8 57 d7 ff ff       	call   8010353e <end_op>
    return -1;
80105de7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dec:	e9 80 01 00 00       	jmp    80105f71 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105df4:	89 04 24             	mov    %eax,(%esp)
80105df7:	e8 d4 ba ff ff       	call   801018d0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105dfc:	c7 44 24 04 55 8e 10 	movl   $0x80108e55,0x4(%esp)
80105e03:	80 
80105e04:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105e07:	89 04 24             	mov    %eax,(%esp)
80105e0a:	e8 b8 c2 ff ff       	call   801020c7 <namecmp>
80105e0f:	85 c0                	test   %eax,%eax
80105e11:	0f 84 45 01 00 00    	je     80105f5c <sys_unlink+0x1c1>
80105e17:	c7 44 24 04 57 8e 10 	movl   $0x80108e57,0x4(%esp)
80105e1e:	80 
80105e1f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105e22:	89 04 24             	mov    %eax,(%esp)
80105e25:	e8 9d c2 ff ff       	call   801020c7 <namecmp>
80105e2a:	85 c0                	test   %eax,%eax
80105e2c:	0f 84 2a 01 00 00    	je     80105f5c <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105e32:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105e35:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105e46:	e8 9e c2 ff ff       	call   801020e9 <dirlookup>
80105e4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e4e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e52:	0f 84 03 01 00 00    	je     80105f5b <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80105e58:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e5b:	89 04 24             	mov    %eax,(%esp)
80105e5e:	e8 6d ba ff ff       	call   801018d0 <ilock>

  if(ip->nlink < 1)
80105e63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e66:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e6a:	66 85 c0             	test   %ax,%ax
80105e6d:	7f 0c                	jg     80105e7b <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
80105e6f:	c7 04 24 5a 8e 10 80 	movl   $0x80108e5a,(%esp)
80105e76:	e8 c2 a6 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105e7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e7e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e82:	66 83 f8 01          	cmp    $0x1,%ax
80105e86:	75 1f                	jne    80105ea7 <sys_unlink+0x10c>
80105e88:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e8b:	89 04 24             	mov    %eax,(%esp)
80105e8e:	e8 9a fe ff ff       	call   80105d2d <isdirempty>
80105e93:	85 c0                	test   %eax,%eax
80105e95:	75 10                	jne    80105ea7 <sys_unlink+0x10c>
    iunlockput(ip);
80105e97:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e9a:	89 04 24             	mov    %eax,(%esp)
80105e9d:	e8 b2 bc ff ff       	call   80101b54 <iunlockput>
    goto bad;
80105ea2:	e9 b5 00 00 00       	jmp    80105f5c <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105ea7:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105eae:	00 
80105eaf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105eb6:	00 
80105eb7:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105eba:	89 04 24             	mov    %eax,(%esp)
80105ebd:	e8 78 f5 ff ff       	call   8010543a <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105ec2:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105ec5:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ecc:	00 
80105ecd:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ed1:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105ed4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ed8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105edb:	89 04 24             	mov    %eax,(%esp)
80105ede:	e8 4e c0 ff ff       	call   80101f31 <writei>
80105ee3:	83 f8 10             	cmp    $0x10,%eax
80105ee6:	74 0c                	je     80105ef4 <sys_unlink+0x159>
    panic("unlink: writei");
80105ee8:	c7 04 24 6c 8e 10 80 	movl   $0x80108e6c,(%esp)
80105eef:	e8 49 a6 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105ef4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ef7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105efb:	66 83 f8 01          	cmp    $0x1,%ax
80105eff:	75 1c                	jne    80105f1d <sys_unlink+0x182>
    dp->nlink--;
80105f01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f04:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f08:	8d 50 ff             	lea    -0x1(%eax),%edx
80105f0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0e:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105f12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f15:	89 04 24             	mov    %eax,(%esp)
80105f18:	e8 f7 b7 ff ff       	call   80101714 <iupdate>
  }
  iunlockput(dp);
80105f1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f20:	89 04 24             	mov    %eax,(%esp)
80105f23:	e8 2c bc ff ff       	call   80101b54 <iunlockput>

  ip->nlink--;
80105f28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2b:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f2f:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105f3f:	e8 d0 b7 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
80105f44:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f47:	89 04 24             	mov    %eax,(%esp)
80105f4a:	e8 05 bc ff ff       	call   80101b54 <iunlockput>

  end_op();
80105f4f:	e8 ea d5 ff ff       	call   8010353e <end_op>

  return 0;
80105f54:	b8 00 00 00 00       	mov    $0x0,%eax
80105f59:	eb 16                	jmp    80105f71 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105f62:	e8 ed bb ff ff       	call   80101b54 <iunlockput>
  end_op();
80105f67:	e8 d2 d5 ff ff       	call   8010353e <end_op>
  return -1;
...
80105f76:	83 ec 48             	sub    $0x48,%esp
80105f79:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105f7c:	8b 55 10             	mov    0x10(%ebp),%edx
80105f7f:	8b 45 14             	mov    0x14(%ebp),%eax
80105f82:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105f86:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105f8a:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105f9b:	e8 f4 c4 ff ff       	call   80102494 <nameiparent>
80105fa0:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fa3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fa7:	75 0a                	jne    80105fb3 <create+0x40>
    return 0;
80105fa9:	b8 00 00 00 00       	mov    $0x0,%eax
80105fae:	e9 7e 01 00 00       	jmp    80106131 <create+0x1be>
  ilock(dp);
80105fb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb6:	89 04 24             	mov    %eax,(%esp)
80105fb9:	e8 12 b9 ff ff       	call   801018d0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105fbe:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
80105fd2:	e8 12 c1 ff ff       	call   801020e9 <dirlookup>
80105fd7:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fda:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105fde:	74 47                	je     80106027 <create+0xb4>
    iunlockput(dp);
80105fe0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe3:	89 04 24             	mov    %eax,(%esp)
80105fe6:	e8 69 bb ff ff       	call   80101b54 <iunlockput>
    ilock(ip);
80105feb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fee:	89 04 24             	mov    %eax,(%esp)
80105ff1:	e8 da b8 ff ff       	call   801018d0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105ff6:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105ffb:	75 15                	jne    80106012 <create+0x9f>
80105ffd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106000:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106004:	66 83 f8 02          	cmp    $0x2,%ax
80106008:	75 08                	jne    80106012 <create+0x9f>
      return ip;
8010600a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010600d:	e9 1f 01 00 00       	jmp    80106131 <create+0x1be>
    iunlockput(ip);
80106012:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106015:	89 04 24             	mov    %eax,(%esp)
80106018:	e8 37 bb ff ff       	call   80101b54 <iunlockput>
    return 0;
8010601d:	b8 00 00 00 00       	mov    $0x0,%eax
80106022:	e9 0a 01 00 00       	jmp    80106131 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106027:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80106037:	e8 fb b5 ff ff       	call   80101637 <ialloc>
8010603c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010603f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106043:	75 0c                	jne    80106051 <create+0xde>
    panic("create: ialloc");
80106045:	c7 04 24 7b 8e 10 80 	movl   $0x80108e7b,(%esp)
8010604c:	e8 ec a4 ff ff       	call   8010053d <panic>

  ilock(ip);
80106051:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106054:	89 04 24             	mov    %eax,(%esp)
80106057:	e8 74 b8 ff ff       	call   801018d0 <ilock>
  ip->major = major;
8010605c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010605f:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106063:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106067:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010606a:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
8010606e:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106072:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106075:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
8010607b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010607e:	89 04 24             	mov    %eax,(%esp)
80106081:	e8 8e b6 ff ff       	call   80101714 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106086:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010608b:	75 6a                	jne    801060f7 <create+0x184>
    dp->nlink++;  // for ".."
8010608d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106090:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106094:	8d 50 01             	lea    0x1(%eax),%edx
...
801060a4:	e8 6b b6 ff ff       	call   80101714 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801060a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ac:	8b 40 04             	mov    0x4(%eax),%eax
801060af:	89 44 24 08          	mov    %eax,0x8(%esp)
801060b3:	c7 44 24 04 55 8e 10 	movl   $0x80108e55,0x4(%esp)
801060ba:	80 
801060bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060be:	89 04 24             	mov    %eax,(%esp)
801060c1:	e8 eb c0 ff ff       	call   801021b1 <dirlink>
801060c6:	85 c0                	test   %eax,%eax
801060c8:	78 21                	js     801060eb <create+0x178>
801060ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060cd:	8b 40 04             	mov    0x4(%eax),%eax
801060d0:	89 44 24 08          	mov    %eax,0x8(%esp)
801060d4:	c7 44 24 04 57 8e 10 	movl   $0x80108e57,0x4(%esp)
801060db:	80 
801060dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060df:	89 04 24             	mov    %eax,(%esp)
801060e2:	e8 ca c0 ff ff       	call   801021b1 <dirlink>
801060e7:	85 c0                	test   %eax,%eax
801060e9:	79 0c                	jns    801060f7 <create+0x184>
      panic("create dots");
801060eb:	c7 04 24 8a 8e 10 80 	movl   $0x80108e8a,(%esp)
801060f2:	e8 46 a4 ff ff       	call   8010053d <panic>
  }
...
8010610e:	e8 9e c0 ff ff       	call   801021b1 <dirlink>
80106113:	85 c0                	test   %eax,%eax
80106115:	79 0c                	jns    80106123 <create+0x1b0>
    panic("create: dirlink");
80106117:	c7 04 24 96 8e 10 80 	movl   $0x80108e96,(%esp)
8010611e:	e8 1a a4 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106123:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106126:	89 04 24             	mov    %eax,(%esp)
80106129:	e8 26 ba ff ff       	call   80101b54 <iunlockput>
...
80106136:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106139:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010613c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106140:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106147:	e8 da f6 ff ff       	call   80105826 <argstr>
8010614c:	85 c0                	test   %eax,%eax
8010614e:	78 17                	js     80106167 <sys_open+0x34>
80106150:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106153:	89 44 24 04          	mov    %eax,0x4(%esp)
80106157:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010615e:	e8 33 f6 ff ff       	call   80105796 <argint>
80106163:	85 c0                	test   %eax,%eax
80106165:	79 0a                	jns    80106171 <sys_open+0x3e>
    return -1;
80106167:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010616c:	e9 5a 01 00 00       	jmp    801062cb <sys_open+0x198>

  begin_op();
80106171:	e8 47 d3 ff ff       	call   801034bd <begin_op>

  if(omode & O_CREATE){
80106176:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106179:	25 00 02 00 00       	and    $0x200,%eax
8010617e:	85 c0                	test   %eax,%eax
80106180:	74 3b                	je     801061bd <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80106182:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106185:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010618c:	00 
8010618d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106194:	00 
80106195:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010619c:	00 
8010619d:	89 04 24             	mov    %eax,(%esp)
801061a0:	e8 ce fd ff ff       	call   80105f73 <create>
801061a5:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801061a8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061ac:	75 6b                	jne    80106219 <sys_open+0xe6>
      end_op();
801061ae:	e8 8b d3 ff ff       	call   8010353e <end_op>
      return -1;
801061b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061b8:	e9 0e 01 00 00       	jmp    801062cb <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
801061bd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801061c0:	89 04 24             	mov    %eax,(%esp)
801061c3:	e8 aa c2 ff ff       	call   80102472 <namei>
801061c8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061cb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061cf:	75 0f                	jne    801061e0 <sys_open+0xad>
      end_op();
801061d1:	e8 68 d3 ff ff       	call   8010353e <end_op>
      return -1;
801061d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061db:	e9 eb 00 00 00       	jmp    801062cb <sys_open+0x198>
    }
    ilock(ip);
801061e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061e3:	89 04 24             	mov    %eax,(%esp)
801061e6:	e8 e5 b6 ff ff       	call   801018d0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801061eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ee:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801061f2:	66 83 f8 01          	cmp    $0x1,%ax
801061f6:	75 21                	jne    80106219 <sys_open+0xe6>
801061f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061fb:	85 c0                	test   %eax,%eax
801061fd:	74 1a                	je     80106219 <sys_open+0xe6>
      iunlockput(ip);
801061ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106202:	89 04 24             	mov    %eax,(%esp)
80106205:	e8 4a b9 ff ff       	call   80101b54 <iunlockput>
      end_op();
8010620a:	e8 2f d3 ff ff       	call   8010353e <end_op>
      return -1;
8010620f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106214:	e9 b2 00 00 00       	jmp    801062cb <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106219:	e8 66 ad ff ff       	call   80100f84 <filealloc>
8010621e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106221:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106225:	74 14                	je     8010623b <sys_open+0x108>
80106227:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010622a:	89 04 24             	mov    %eax,(%esp)
8010622d:	e8 2f f7 ff ff       	call   80105961 <fdalloc>
80106232:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106235:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106239:	79 28                	jns    80106263 <sys_open+0x130>
    if(f)
8010623b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010623f:	74 0b                	je     8010624c <sys_open+0x119>
      fileclose(f);
80106241:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106244:	89 04 24             	mov    %eax,(%esp)
80106247:	e8 e0 ad ff ff       	call   8010102c <fileclose>
    iunlockput(ip);
...
80106261:	eb 68                	jmp    801062cb <sys_open+0x198>
  }
  iunlock(ip);
80106263:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106266:	89 04 24             	mov    %eax,(%esp)
80106269:	e8 b0 b7 ff ff       	call   80101a1e <iunlock>
  end_op();
8010626e:	e8 cb d2 ff ff       	call   8010353e <end_op>
...
80106297:	0f 94 c2             	sete   %dl
8010629a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010629d:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801062a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062a3:	83 e0 01             	and    $0x1,%eax
801062a6:	84 c0                	test   %al,%al
801062a8:	75 0a                	jne    801062b4 <sys_open+0x181>
801062aa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062ad:	83 e0 02             	and    $0x2,%eax
801062b0:	85 c0                	test   %eax,%eax
801062b2:	74 07                	je     801062bb <sys_open+0x188>
801062b4:	b8 01 00 00 00       	mov    $0x1,%eax
801062b9:	eb 05                	jmp    801062c0 <sys_open+0x18d>
801062bb:	b8 00 00 00 00       	mov    $0x0,%eax
801062c0:	89 c2                	mov    %eax,%edx
801062c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c5:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
801062c8:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
801062cb:	c9                   	leave  
801062cc:	c3                   	ret    
...
801062d0:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801062d3:	e8 e5 d1 ff ff       	call   801034bd <begin_op>
...
801062e6:	e8 3b f5 ff ff       	call   80105826 <argstr>
801062eb:	85 c0                	test   %eax,%eax
801062ed:	78 2c                	js     8010631b <sys_mkdir+0x4e>
801062ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062f2:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801062f9:	00 
801062fa:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106301:	00 
80106302:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106309:	00 
8010630a:	89 04 24             	mov    %eax,(%esp)
8010630d:	e8 61 fc ff ff       	call   80105f73 <create>
80106312:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106315:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106319:	75 0c                	jne    80106327 <sys_mkdir+0x5a>
    end_op();
8010631b:	e8 1e d2 ff ff       	call   8010353e <end_op>
    return -1;
80106320:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106325:	eb 15                	jmp    8010633c <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106327:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010632a:	89 04 24             	mov    %eax,(%esp)
8010632d:	e8 22 b8 ff ff       	call   80101b54 <iunlockput>
  end_op();
80106332:	e8 07 d2 ff ff       	call   8010353e <end_op>
  return 0;
...
80106341:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106344:	e8 74 d1 ff ff       	call   801034bd <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106349:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010634c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106350:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106357:	e8 ca f4 ff ff       	call   80105826 <argstr>
8010635c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010635f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106363:	78 5e                	js     801063c3 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106365:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106368:	89 44 24 04          	mov    %eax,0x4(%esp)
8010636c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106373:	e8 1e f4 ff ff       	call   80105796 <argint>
  char *path;
  int len;
  int major, minor;
...
8010637a:	78 47                	js     801063c3 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010637c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010637f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106383:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010638a:	e8 07 f4 ff ff       	call   80105796 <argint>
  int len;
  int major, minor;
...
80106391:	78 30                	js     801063c3 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106393:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106396:	0f bf c8             	movswl %ax,%ecx
80106399:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010639c:	0f bf d0             	movswl %ax,%edx
8010639f:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801063a2:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801063a6:	89 54 24 08          	mov    %edx,0x8(%esp)
801063aa:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801063b1:	00 
801063b2:	89 04 24             	mov    %eax,(%esp)
801063b5:	e8 b9 fb ff ff       	call   80105f73 <create>
801063ba:	89 45 f0             	mov    %eax,-0x10(%ebp)
801063bd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801063c1:	75 0c                	jne    801063cf <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801063c3:	e8 76 d1 ff ff       	call   8010353e <end_op>
    return -1;
801063c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063cd:	eb 15                	jmp    801063e4 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801063cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063d2:	89 04 24             	mov    %eax,(%esp)
801063d5:	e8 7a b7 ff ff       	call   80101b54 <iunlockput>
  end_op();
801063da:	e8 5f d1 ff ff       	call   8010353e <end_op>
  return 0;
...
801063e9:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
801063ec:	e8 cc d0 ff ff       	call   801034bd <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801063f1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801063f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801063f8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063ff:	e8 22 f4 ff ff       	call   80105826 <argstr>
80106404:	85 c0                	test   %eax,%eax
80106406:	78 14                	js     8010641c <sys_chdir+0x36>
80106408:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010640b:	89 04 24             	mov    %eax,(%esp)
8010640e:	e8 5f c0 ff ff       	call   80102472 <namei>
80106413:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106416:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010641a:	75 0c                	jne    80106428 <sys_chdir+0x42>
    end_op();
8010641c:	e8 1d d1 ff ff       	call   8010353e <end_op>
    return -1;
80106421:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106426:	eb 61                	jmp    80106489 <sys_chdir+0xa3>
  }
  ilock(ip);
...
8010643e:	74 17                	je     80106457 <sys_chdir+0x71>
    iunlockput(ip);
80106440:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106443:	89 04 24             	mov    %eax,(%esp)
80106446:	e8 09 b7 ff ff       	call   80101b54 <iunlockput>
    end_op();
8010644b:	e8 ee d0 ff ff       	call   8010353e <end_op>
    return -1;
80106450:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106455:	eb 32                	jmp    80106489 <sys_chdir+0xa3>
  }
  iunlock(ip);
80106457:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010645a:	89 04 24             	mov    %eax,(%esp)
8010645d:	e8 bc b5 ff ff       	call   80101a1e <iunlock>
  iput(proc->cwd);
80106462:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106468:	8b 40 6c             	mov    0x6c(%eax),%eax
8010646b:	89 04 24             	mov    %eax,(%esp)
8010646e:	e8 10 b6 ff ff       	call   80101a83 <iput>
  end_op();
80106473:	e8 c6 d0 ff ff       	call   8010353e <end_op>
  proc->cwd = ip;
80106478:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010647e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106481:	89 50 6c             	mov    %edx,0x6c(%eax)
  return 0;
...
8010648e:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801064a2:	e8 7f f3 ff ff       	call   80105826 <argstr>
801064a7:	85 c0                	test   %eax,%eax
801064a9:	78 1a                	js     801064c5 <sys_exec+0x3a>
801064ab:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801064b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801064b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801064bc:	e8 d5 f2 ff ff       	call   80105796 <argint>
801064c1:	85 c0                	test   %eax,%eax
801064c3:	79 0a                	jns    801064cf <sys_exec+0x44>
    return -1;
801064c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ca:	e9 cc 00 00 00       	jmp    8010659b <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
801064cf:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801064d6:	00 
801064d7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801064de:	00 
801064df:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801064e5:	89 04 24             	mov    %eax,(%esp)
801064e8:	e8 4d ef ff ff       	call   8010543a <memset>
  for(i=0;; i++){
801064ed:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801064f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f7:	83 f8 1f             	cmp    $0x1f,%eax
801064fa:	76 0a                	jbe    80106506 <sys_exec+0x7b>
      return -1;
801064fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106501:	e9 95 00 00 00       	jmp    8010659b <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106506:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106509:	c1 e0 02             	shl    $0x2,%eax
8010650c:	89 c2                	mov    %eax,%edx
8010650e:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106514:	01 c2                	add    %eax,%edx
80106516:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010651c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106520:	89 14 24             	mov    %edx,(%esp)
80106523:	e8 d0 f1 ff ff       	call   801056f8 <fetchint>
80106528:	85 c0                	test   %eax,%eax
8010652a:	79 07                	jns    80106533 <sys_exec+0xa8>
      return -1;
8010652c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106531:	eb 68                	jmp    8010659b <sys_exec+0x110>
    if(uarg == 0){
80106533:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106539:	85 c0                	test   %eax,%eax
8010653b:	75 26                	jne    80106563 <sys_exec+0xd8>
      argv[i] = 0;
8010653d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106540:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106547:	00 00 00 00 
      break;
8010654b:	90                   	nop
    }
...
8010654f:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106555:	89 54 24 04          	mov    %edx,0x4(%esp)
80106559:	89 04 24             	mov    %eax,(%esp)
8010655c:	e8 9b a5 ff ff       	call   80100afc <exec>
80106561:	eb 38                	jmp    8010659b <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106566:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010656d:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106573:	01 c2                	add    %eax,%edx
80106575:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010657b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010657f:	89 04 24             	mov    %eax,(%esp)
80106582:	e8 ab f1 ff ff       	call   80105732 <fetchstr>
80106587:	85 c0                	test   %eax,%eax
80106589:	79 07                	jns    80106592 <sys_exec+0x107>
      return -1;
8010658b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106590:	eb 09                	jmp    8010659b <sys_exec+0x110>
...
80106596:	e9 59 ff ff ff       	jmp    801064f4 <sys_exec+0x69>
  return exec(path, argv);
}
8010659b:	c9                   	leave  
8010659c:	c3                   	ret    
...
801065a0:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801065a3:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801065aa:	00 
801065ab:	8d 45 ec             	lea    -0x14(%ebp),%eax
801065ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801065b2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065b9:	e8 06 f2 ff ff       	call   801057c4 <argptr>
801065be:	85 c0                	test   %eax,%eax
801065c0:	79 0a                	jns    801065cc <sys_pipe+0x2f>
    return -1;
801065c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065c7:	e9 9b 00 00 00       	jmp    80106667 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801065cc:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801065cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801065d3:	8d 45 e8             	lea    -0x18(%ebp),%eax
801065d6:	89 04 24             	mov    %eax,(%esp)
801065d9:	e8 0e da ff ff       	call   80103fec <pipealloc>
801065de:	85 c0                	test   %eax,%eax
801065e0:	79 07                	jns    801065e9 <sys_pipe+0x4c>
    return -1;
801065e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065e7:	eb 7e                	jmp    80106667 <sys_pipe+0xca>
  fd0 = -1;
801065e9:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801065f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801065f3:	89 04 24             	mov    %eax,(%esp)
801065f6:	e8 66 f3 ff ff       	call   80105961 <fdalloc>
801065fb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106602:	78 14                	js     80106618 <sys_pipe+0x7b>
80106604:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106607:	89 04 24             	mov    %eax,(%esp)
8010660a:	e8 52 f3 ff ff       	call   80105961 <fdalloc>
8010660f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106612:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106616:	79 37                	jns    8010664f <sys_pipe+0xb2>
    if(fd0 >= 0)
80106618:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010661c:	78 14                	js     80106632 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010661e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106624:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106627:	83 c2 08             	add    $0x8,%edx
8010662a:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80106631:	00 
    fileclose(rf);
80106632:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106635:	89 04 24             	mov    %eax,(%esp)
80106638:	e8 ef a9 ff ff       	call   8010102c <fileclose>
    fileclose(wf);
8010663d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106640:	89 04 24             	mov    %eax,(%esp)
80106643:	e8 e4 a9 ff ff       	call   8010102c <fileclose>
    return -1;
80106648:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010664d:	eb 18                	jmp    80106667 <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
80106655:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106657:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010665a:	8d 50 04             	lea    0x4(%eax),%edx
8010665d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106660:	89 02                	mov    %eax,(%edx)
  return 0;
80106662:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106667:	c9                   	leave  
80106668:	c3                   	ret    
80106669:	00 00                	add    %al,(%eax)
	...
...
8010666f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106672:	e8 3b e0 ff ff       	call   801046b2 <fork>
}
80106677:	c9                   	leave  
80106678:	c3                   	ret    
...
8010668d:	e8 04 f1 ff ff       	call   80105796 <argint>
80106692:	85 c0                	test   %eax,%eax
80106694:	79 07                	jns    8010669d <sys_exit+0x24>
	    return -1;
80106696:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010669b:	eb 10                	jmp    801066ad <sys_exit+0x34>

	exit(status);
8010669d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a0:	89 04 24             	mov    %eax,(%esp)
801066a3:	e8 b0 e1 ff ff       	call   80104858 <exit>
...
801066eb:	83 ec 28             	sub    $0x28,%esp
	...
	if (	(argint(0, &pid) < 0) ||
801066ee:	8d 45 f4             	lea    -0xc(%ebp),%eax
801066f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801066f5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066fc:	e8 95 f0 ff ff       	call   80105796 <argint>
80106701:	85 c0                	test   %eax,%eax
80106703:	78 36                	js     8010673b <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
80106705:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010670c:	00 
8010670d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106710:	89 44 24 04          	mov    %eax,0x4(%esp)
80106714:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010671b:	e8 a4 f0 ff ff       	call   801057c4 <argptr>
{
	int pid;
	int *status;
	int options;
...
80106722:	78 17                	js     8010673b <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
			(argint(2, &options) < 0) ){
80106724:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106727:	89 44 24 04          	mov    %eax,0x4(%esp)
8010672b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106732:	e8 5f f0 ff ff       	call   80105796 <argint>
	int pid;
	int *status;
	int options;
...
80106739:	79 07                	jns    80106742 <sys_waitpid+0x5a>
			(argint(2, &options) < 0) ){

		return -1;
8010673b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106740:	eb 19                	jmp    8010675b <sys_waitpid+0x73>
	}

	return waitpid(pid, status, options);
80106742:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106745:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106748:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010674b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010674f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106753:	89 04 24             	mov    %eax,(%esp)
80106756:	e8 6d e3 ff ff       	call   80104ac8 <waitpid>
}
8010675b:	c9                   	leave  
8010675c:	c3                   	ret    

8010675d <sys_wait_stat>:
...
80106760:	83 ec 28             	sub    $0x28,%esp
	int *wtime, *rtime, *iotime;

	if (	(argptr(0,(char**)&wtime, sizeof(int)) < 0) ||
80106763:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010676a:	00 
8010676b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010676e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106772:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106779:	e8 46 f0 ff ff       	call   801057c4 <argptr>
8010677e:	85 c0                	test   %eax,%eax
80106780:	78 3e                	js     801067c0 <sys_wait_stat+0x63>
			(argptr(1,(char**)&rtime, sizeof(int)) < 0) ||
80106782:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106789:	00 
8010678a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010678d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106791:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106798:	e8 27 f0 ff ff       	call   801057c4 <argptr>
int
sys_wait_stat(void)
{
	int *wtime, *rtime, *iotime;
...
8010679f:	78 1f                	js     801067c0 <sys_wait_stat+0x63>
			(argptr(1,(char**)&rtime, sizeof(int)) < 0) ||
...
801067b7:	e8 08 f0 ff ff       	call   801057c4 <argptr>
sys_wait_stat(void)
{
	int *wtime, *rtime, *iotime;
...
801067be:	79 07                	jns    801067c7 <sys_wait_stat+0x6a>
			(argptr(2,(char**)&iotime, sizeof(int)) < 0) ){

		return -1;
801067c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067c5:	eb 19                	jmp    801067e0 <sys_wait_stat+0x83>
	}
...
801067db:	e8 6b e4 ff ff       	call   80104c4b <wait_stat>
}
801067e0:	c9                   	leave  
801067e1:	c3                   	ret    

801067e2 <sys_list_pgroup>:
...
801067e5:	83 ec 28             	sub    $0x28,%esp
	...
	if (	(argint(0, &gid) < 0) ||
801067e8:	8d 45 f4             	lea    -0xc(%ebp),%eax
801067eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801067ef:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067f6:	e8 9b ef ff ff       	call   80105796 <argint>
801067fb:	85 c0                	test   %eax,%eax
801067fd:	78 3e                	js     8010683d <sys_list_pgroup+0x5b>
			(argptr(1,(char**)&arr, sizeof(process_info_entry)) < 0) ||
801067ff:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80106806:	00 
80106807:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010680a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010680e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106815:	e8 aa ef ff ff       	call   801057c4 <argptr>
{
	int gid;
	process_info_entry* arr;
	int* size;
...
8010681c:	78 1f                	js     8010683d <sys_list_pgroup+0x5b>
			(argptr(1,(char**)&arr, sizeof(process_info_entry)) < 0) ||
			(argptr(2,(char**)&size, sizeof(int)) < 0)){
8010681e:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106825:	00 
80106826:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106829:	89 44 24 04          	mov    %eax,0x4(%esp)
8010682d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106834:	e8 8b ef ff ff       	call   801057c4 <argptr>
	int gid;
	process_info_entry* arr;
	int* size;
...
8010683b:	79 07                	jns    80106844 <sys_list_pgroup+0x62>
			(argptr(2,(char**)&size, sizeof(int)) < 0)){

		return -1;
8010683d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106842:	eb 19                	jmp    8010685d <sys_list_pgroup+0x7b>
	}

	return list_pgroup(gid, arr, size);
80106844:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106847:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80106858:	e8 35 e4 ff ff       	call   80104c92 <list_pgroup>
}
8010685d:	c9                   	leave  
8010685e:	c3                   	ret    
...
80106862:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80106873:	e8 1e ef ff ff       	call   80105796 <argint>
80106878:	85 c0                	test   %eax,%eax
8010687a:	79 07                	jns    80106883 <sys_kill+0x24>
    return -1;
8010687c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106881:	eb 0b                	jmp    8010688e <sys_kill+0x2f>
  return kill(pid);
80106883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106886:	89 04 24             	mov    %eax,(%esp)
80106889:	e8 7d e7 ff ff       	call   8010500b <kill>
}
8010688e:	c9                   	leave  
8010688f:	c3                   	ret    
...
801068b2:	e8 df ee ff ff       	call   80105796 <argint>
801068b7:	85 c0                	test   %eax,%eax
801068b9:	79 07                	jns    801068c2 <sys_sbrk+0x24>
    return -1;
801068bb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068c0:	eb 24                	jmp    801068e6 <sys_sbrk+0x48>
  addr = proc->sz;
...
801068d3:	e8 35 dd ff ff       	call   8010460d <growproc>
801068d8:	85 c0                	test   %eax,%eax
801068da:	79 07                	jns    801068e3 <sys_sbrk+0x45>
    return -1;
801068dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068e1:	eb 03                	jmp    801068e6 <sys_sbrk+0x48>
  return addr;
...
801068eb:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801068ee:	8d 45 f0             	lea    -0x10(%ebp),%eax
801068f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801068f5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068fc:	e8 95 ee ff ff       	call   80105796 <argint>
80106901:	85 c0                	test   %eax,%eax
80106903:	79 07                	jns    8010690c <sys_sleep+0x24>
    return -1;
80106905:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010690a:	eb 6c                	jmp    80106978 <sys_sleep+0x90>
  acquire(&tickslock);
8010690c:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106913:	e8 d3 e8 ff ff       	call   801051eb <acquire>
  ticks0 = ticks;
80106918:	a1 00 68 11 80       	mov    0x80116800,%eax
8010691d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106920:	eb 34                	jmp    80106956 <sys_sleep+0x6e>
    if(proc->killed){
80106922:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106928:	8b 40 28             	mov    0x28(%eax),%eax
8010692b:	85 c0                	test   %eax,%eax
8010692d:	74 13                	je     80106942 <sys_sleep+0x5a>
      release(&tickslock);
8010692f:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106936:	e8 12 e9 ff ff       	call   8010524d <release>
      return -1;
8010693b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106940:	eb 36                	jmp    80106978 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106942:	c7 44 24 04 c0 5f 11 	movl   $0x80115fc0,0x4(%esp)
80106949:	80 
8010694a:	c7 04 24 00 68 11 80 	movl   $0x80116800,(%esp)
80106951:	e8 ae e5 ff ff       	call   80104f04 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106956:	a1 00 68 11 80       	mov    0x80116800,%eax
8010695b:	89 c2                	mov    %eax,%edx
8010695d:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106960:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106963:	39 c2                	cmp    %eax,%edx
80106965:	72 bb                	jb     80106922 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106967:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
8010696e:	e8 da e8 ff ff       	call   8010524d <release>
  return 0;
...
8010697d:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80106980:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106987:	e8 5f e8 ff ff       	call   801051eb <acquire>
  xticks = ticks;
8010698c:	a1 00 68 11 80       	mov    0x80116800,%eax
80106991:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106994:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
8010699b:	e8 ad e8 ff ff       	call   8010524d <release>
  return xticks;
801069a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
801069a3:	c9                   	leave  
801069a4:	c3                   	ret    
801069a5:	00 00                	add    %al,(%eax)
	...
...
801069b4:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801069b8:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801069bb:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801069bf:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801069c3:	ee                   	out    %al,(%dx)
}
801069c4:	c9                   	leave  
801069c5:	c3                   	ret    
...
801069cc:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801069d3:	00 
801069d4:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801069db:	e8 c8 ff ff ff       	call   801069a8 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801069e0:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801069e7:	00 
801069e8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801069ef:	e8 b4 ff ff ff       	call   801069a8 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801069f4:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801069fb:	00 
801069fc:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a03:	e8 a0 ff ff ff       	call   801069a8 <outb>
  picenable(IRQ_TIMER);
80106a08:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a0f:	e8 61 d4 ff ff       	call   80103e75 <picenable>
}
80106a14:	c9                   	leave  
80106a15:	c3                   	ret    
	...
...
80106a19:	06                   	push   %es
  pushl %fs
80106a1a:	0f a0                	push   %fs
  pushl %gs
80106a1c:	0f a8                	push   %gs
  pushal
80106a1e:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106a1f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106a23:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106a25:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106a27:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106a2b:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106a2d:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106a2f:	54                   	push   %esp
  call trap
80106a30:	e8 5a 02 00 00       	call   80106c8f <trap>
  addl $4, %esp
...
80106a38:	61                   	popa   
  popl %gs
80106a39:	0f a9                	pop    %gs
  popl %fs
80106a3b:	0f a1                	pop    %fs
  popl %es
80106a3d:	07                   	pop    %es
  popl %ds
80106a3e:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80106a3f:	83 c4 08             	add    $0x8,%esp
  iret
80106a42:	cf                   	iret   
	...
...
80106a47:	83 ec 10             	sub    $0x10,%esp
  ...
  pd[0] = size-1;
80106a4a:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a4d:	83 e8 01             	sub    $0x1,%eax
80106a50:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106a54:	8b 45 08             	mov    0x8(%ebp),%eax
80106a57:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106a5b:	8b 45 08             	mov    0x8(%ebp),%eax
80106a5e:	c1 e8 10             	shr    $0x10,%eax
80106a61:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106a65:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106a68:	0f 01 18             	lidtl  (%eax)
}
80106a6b:	c9                   	leave  
80106a6c:	c3                   	ret    
...
80106a74:	0f 20 d3             	mov    %cr2,%ebx
80106a77:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106a7a:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106a86:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106a89:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a90:	e9 c3 00 00 00       	jmp    80106b58 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106a95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a98:	8b 04 85 a4 c0 10 80 	mov    -0x7fef3f5c(,%eax,4),%eax
80106a9f:	89 c2                	mov    %eax,%edx
80106aa1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aa4:	66 89 14 c5 00 60 11 	mov    %dx,-0x7feea000(,%eax,8)
80106aab:	80 
80106aac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aaf:	66 c7 04 c5 02 60 11 	movw   $0x8,-0x7fee9ffe(,%eax,8)
80106ab6:	80 08 00 
80106ab9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106abc:	0f b6 14 c5 04 60 11 	movzbl -0x7fee9ffc(,%eax,8),%edx
80106ac3:	80 
80106ac4:	83 e2 e0             	and    $0xffffffe0,%edx
80106ac7:	88 14 c5 04 60 11 80 	mov    %dl,-0x7fee9ffc(,%eax,8)
80106ace:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad1:	0f b6 14 c5 04 60 11 	movzbl -0x7fee9ffc(,%eax,8),%edx
80106ad8:	80 
80106ad9:	83 e2 1f             	and    $0x1f,%edx
80106adc:	88 14 c5 04 60 11 80 	mov    %dl,-0x7fee9ffc(,%eax,8)
80106ae3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ae6:	0f b6 14 c5 05 60 11 	movzbl -0x7fee9ffb(,%eax,8),%edx
80106aed:	80 
80106aee:	83 e2 f0             	and    $0xfffffff0,%edx
80106af1:	83 ca 0e             	or     $0xe,%edx
80106af4:	88 14 c5 05 60 11 80 	mov    %dl,-0x7fee9ffb(,%eax,8)
80106afb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106afe:	0f b6 14 c5 05 60 11 	movzbl -0x7fee9ffb(,%eax,8),%edx
80106b05:	80 
80106b06:	83 e2 ef             	and    $0xffffffef,%edx
80106b09:	88 14 c5 05 60 11 80 	mov    %dl,-0x7fee9ffb(,%eax,8)
80106b10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b13:	0f b6 14 c5 05 60 11 	movzbl -0x7fee9ffb(,%eax,8),%edx
80106b1a:	80 
80106b1b:	83 e2 9f             	and    $0xffffff9f,%edx
80106b1e:	88 14 c5 05 60 11 80 	mov    %dl,-0x7fee9ffb(,%eax,8)
80106b25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b28:	0f b6 14 c5 05 60 11 	movzbl -0x7fee9ffb(,%eax,8),%edx
80106b2f:	80 
80106b30:	83 ca 80             	or     $0xffffff80,%edx
80106b33:	88 14 c5 05 60 11 80 	mov    %dl,-0x7fee9ffb(,%eax,8)
80106b3a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b3d:	8b 04 85 a4 c0 10 80 	mov    -0x7fef3f5c(,%eax,4),%eax
80106b44:	c1 e8 10             	shr    $0x10,%eax
80106b47:	89 c2                	mov    %eax,%edx
80106b49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b4c:	66 89 14 c5 06 60 11 	mov    %dx,-0x7fee9ffa(,%eax,8)
80106b53:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106b54:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106b58:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106b5f:	0f 8e 30 ff ff ff    	jle    80106a95 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106b65:	a1 a4 c1 10 80       	mov    0x8010c1a4,%eax
80106b6a:	66 a3 00 62 11 80    	mov    %ax,0x80116200
80106b70:	66 c7 05 02 62 11 80 	movw   $0x8,0x80116202
80106b77:	08 00 
80106b79:	0f b6 05 04 62 11 80 	movzbl 0x80116204,%eax
80106b80:	83 e0 e0             	and    $0xffffffe0,%eax
80106b83:	a2 04 62 11 80       	mov    %al,0x80116204
80106b88:	0f b6 05 04 62 11 80 	movzbl 0x80116204,%eax
80106b8f:	83 e0 1f             	and    $0x1f,%eax
80106b92:	a2 04 62 11 80       	mov    %al,0x80116204
80106b97:	0f b6 05 05 62 11 80 	movzbl 0x80116205,%eax
80106b9e:	83 c8 0f             	or     $0xf,%eax
80106ba1:	a2 05 62 11 80       	mov    %al,0x80116205
80106ba6:	0f b6 05 05 62 11 80 	movzbl 0x80116205,%eax
80106bad:	83 e0 ef             	and    $0xffffffef,%eax
80106bb0:	a2 05 62 11 80       	mov    %al,0x80116205
80106bb5:	0f b6 05 05 62 11 80 	movzbl 0x80116205,%eax
80106bbc:	83 c8 60             	or     $0x60,%eax
80106bbf:	a2 05 62 11 80       	mov    %al,0x80116205
80106bc4:	0f b6 05 05 62 11 80 	movzbl 0x80116205,%eax
80106bcb:	83 c8 80             	or     $0xffffff80,%eax
80106bce:	a2 05 62 11 80       	mov    %al,0x80116205
80106bd3:	a1 a4 c1 10 80       	mov    0x8010c1a4,%eax
80106bd8:	c1 e8 10             	shr    $0x10,%eax
80106bdb:	66 a3 06 62 11 80    	mov    %ax,0x80116206
  
  initlock(&tickslock, "time");
80106be1:	c7 44 24 04 a8 8e 10 	movl   $0x80108ea8,0x4(%esp)
80106be8:	80 
80106be9:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106bf0:	e8 d5 e5 ff ff       	call   801051ca <initlock>
}
80106bf5:	c9                   	leave  
80106bf6:	c3                   	ret    
...
80106bfa:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106bfd:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106c04:	00 
80106c05:	c7 04 24 00 60 11 80 	movl   $0x80116000,(%esp)
80106c0c:	e8 33 fe ff ff       	call   80106a44 <lidt>
}
80106c11:	c9                   	leave  
80106c12:	c3                   	ret    

80106c13 <updateStats>:
...
80106c16:	83 ec 10             	sub    $0x10,%esp
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80106c19:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80106c20:	eb 62                	jmp    80106c84 <updateStats+0x71>
		switch (p->state) {
80106c22:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c25:	8b 40 0c             	mov    0xc(%eax),%eax
80106c28:	83 f8 03             	cmp    $0x3,%eax
80106c2b:	74 21                	je     80106c4e <updateStats+0x3b>
80106c2d:	83 f8 04             	cmp    $0x4,%eax
80106c30:	74 33                	je     80106c65 <updateStats+0x52>
80106c32:	83 f8 02             	cmp    $0x2,%eax
80106c35:	75 45                	jne    80106c7c <updateStats+0x69>
			case SLEEPING:
				p->stime++;
80106c37:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c3a:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80106c40:	8d 50 01             	lea    0x1(%eax),%edx
80106c43:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c46:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
				break;
80106c4c:	eb 2f                	jmp    80106c7d <updateStats+0x6a>
			case RUNNABLE:
				p->retime++;
80106c4e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c51:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
80106c57:	8d 50 01             	lea    0x1(%eax),%edx
80106c5a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c5d:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
				break;
80106c63:	eb 18                	jmp    80106c7d <updateStats+0x6a>
			case RUNNING:
				p->rutime++;
80106c65:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c68:	8b 80 94 00 00 00    	mov    0x94(%eax),%eax
80106c6e:	8d 50 01             	lea    0x1(%eax),%edx
80106c71:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106c74:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
				break;
80106c7a:	eb 01                	jmp    80106c7d <updateStats+0x6a>
			default:
				break;
80106c7c:	90                   	nop
} ptable;
...
void updateStats()
{
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80106c7d:	81 45 fc 98 00 00 00 	addl   $0x98,-0x4(%ebp)
80106c84:	81 7d fc b4 5f 11 80 	cmpl   $0x80115fb4,-0x4(%ebp)
80106c8b:	72 95                	jb     80106c22 <updateStats+0xf>
				break;
			default:
				break;
		}
...
80106c92:	57                   	push   %edi
80106c93:	56                   	push   %esi
80106c94:	53                   	push   %ebx
80106c95:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106c98:	8b 45 08             	mov    0x8(%ebp),%eax
80106c9b:	8b 40 30             	mov    0x30(%eax),%eax
80106c9e:	83 f8 40             	cmp    $0x40,%eax
80106ca1:	75 4c                	jne    80106cef <trap+0x60>
    if(proc->killed)
80106ca3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ca9:	8b 40 28             	mov    0x28(%eax),%eax
80106cac:	85 c0                	test   %eax,%eax
80106cae:	74 0c                	je     80106cbc <trap+0x2d>
      exit(EXIT_STATUS_DEFAULT);
80106cb0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106cb7:	e8 9c db ff ff       	call   80104858 <exit>
    proc->tf = tf;
80106cbc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cc2:	8b 55 08             	mov    0x8(%ebp),%edx
80106cc5:	89 50 1c             	mov    %edx,0x1c(%eax)
    syscall();
80106cc8:	e8 90 eb ff ff       	call   8010585d <syscall>
    if(proc->killed)
80106ccd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cd3:	8b 40 28             	mov    0x28(%eax),%eax
80106cd6:	85 c0                	test   %eax,%eax
80106cd8:	0f 84 4e 02 00 00    	je     80106f2c <trap+0x29d>
      exit(EXIT_STATUS_DEFAULT);
80106cde:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106ce5:	e8 6e db ff ff       	call   80104858 <exit>
    return;
80106cea:	e9 3d 02 00 00       	jmp    80106f2c <trap+0x29d>
  }

  switch(tf->trapno){
80106cef:	8b 45 08             	mov    0x8(%ebp),%eax
80106cf2:	8b 40 30             	mov    0x30(%eax),%eax
80106cf5:	83 e8 20             	sub    $0x20,%eax
80106cf8:	83 f8 1f             	cmp    $0x1f,%eax
80106cfb:	0f 87 c1 00 00 00    	ja     80106dc2 <trap+0x133>
80106d01:	8b 04 85 50 8f 10 80 	mov    -0x7fef70b0(,%eax,4),%eax
80106d08:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106d0a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d10:	0f b6 00             	movzbl (%eax),%eax
80106d13:	84 c0                	test   %al,%al
80106d15:	75 36                	jne    80106d4d <trap+0xbe>
      acquire(&tickslock);
80106d17:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106d1e:	e8 c8 e4 ff ff       	call   801051eb <acquire>
      ticks++;
80106d23:	a1 00 68 11 80       	mov    0x80116800,%eax
80106d28:	83 c0 01             	add    $0x1,%eax
80106d2b:	a3 00 68 11 80       	mov    %eax,0x80116800
      wakeup(&ticks);
80106d30:	c7 04 24 00 68 11 80 	movl   $0x80116800,(%esp)
80106d37:	e8 a4 e2 ff ff       	call   80104fe0 <wakeup>
      release(&tickslock);
80106d3c:	c7 04 24 c0 5f 11 80 	movl   $0x80115fc0,(%esp)
80106d43:	e8 05 e5 ff ff       	call   8010524d <release>

      updateStats();
80106d48:	e8 c6 fe ff ff       	call   80106c13 <updateStats>


    }
    lapiceoi();
80106d4d:	e8 29 c2 ff ff       	call   80102f7b <lapiceoi>
    break;
80106d52:	e9 41 01 00 00       	jmp    80106e98 <trap+0x209>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106d57:	e8 fd b9 ff ff       	call   80102759 <ideintr>
    lapiceoi();
80106d5c:	e8 1a c2 ff ff       	call   80102f7b <lapiceoi>
    break;
80106d61:	e9 32 01 00 00       	jmp    80106e98 <trap+0x209>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106d66:	e8 c4 bf ff ff       	call   80102d2f <kbdintr>
    lapiceoi();
80106d6b:	e8 0b c2 ff ff       	call   80102f7b <lapiceoi>
    break;
80106d70:	e9 23 01 00 00       	jmp    80106e98 <trap+0x209>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106d75:	e8 ba 03 00 00       	call   80107134 <uartintr>
    lapiceoi();
80106d7a:	e8 fc c1 ff ff       	call   80102f7b <lapiceoi>
    break;
80106d7f:	e9 14 01 00 00       	jmp    80106e98 <trap+0x209>
  case T_IRQ0 + 7:
...
80106d84:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d87:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106d8a:	8b 45 08             	mov    0x8(%ebp),%eax
80106d8d:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d91:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106da0:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106da4:	89 54 24 08          	mov    %edx,0x8(%esp)
80106da8:	89 44 24 04          	mov    %eax,0x4(%esp)
80106dac:	c7 04 24 b0 8e 10 80 	movl   $0x80108eb0,(%esp)
80106db3:	e8 e9 95 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106db8:	e8 be c1 ff ff       	call   80102f7b <lapiceoi>
    break;
80106dbd:	e9 d6 00 00 00       	jmp    80106e98 <trap+0x209>
...
80106dca:	74 11                	je     80106ddd <trap+0x14e>
...
80106ddb:	75 46                	jne    80106e23 <trap+0x194>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106ddd:	e8 8b fc ff ff       	call   80106a6d <rcr2>
...
80106de2:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106de5:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106de8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106def:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106df2:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106df5:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106df8:	8b 52 30             	mov    0x30(%edx),%edx
80106dfb:	89 44 24 10          	mov    %eax,0x10(%esp)
80106dff:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e03:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106e07:	89 54 24 04          	mov    %edx,0x4(%esp)
80106e0b:	c7 04 24 d4 8e 10 80 	movl   $0x80108ed4,(%esp)
80106e12:	e8 8a 95 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106e17:	c7 04 24 06 8f 10 80 	movl   $0x80108f06,(%esp)
80106e1e:	e8 1a 97 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e23:	e8 45 fc ff ff       	call   80106a6d <rcr2>
80106e28:	89 c2                	mov    %eax,%edx
...
80106e2a:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e2d:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e30:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106e36:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e39:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e3c:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e3f:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e42:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e45:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e48:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e4e:	83 c0 70             	add    $0x70,%eax
...
80106e5d:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106e61:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106e65:	89 74 24 14          	mov    %esi,0x14(%esp)
80106e69:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106e6d:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106e71:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106e74:	89 54 24 08          	mov    %edx,0x8(%esp)
80106e78:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e7c:	c7 04 24 0c 8f 10 80 	movl   $0x80108f0c,(%esp)
80106e83:	e8 19 95 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106e88:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e8e:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
80106e95:	eb 01                	jmp    80106e98 <trap+0x209>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106ea0:	74 2b                	je     80106ecd <trap+0x23e>
80106ea2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ea8:	8b 40 28             	mov    0x28(%eax),%eax
80106eab:	85 c0                	test   %eax,%eax
80106ead:	74 1e                	je     80106ecd <trap+0x23e>
80106eaf:	8b 45 08             	mov    0x8(%ebp),%eax
80106eb2:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106eb6:	0f b7 c0             	movzwl %ax,%eax
80106eb9:	83 e0 03             	and    $0x3,%eax
80106ebc:	83 f8 03             	cmp    $0x3,%eax
80106ebf:	75 0c                	jne    80106ecd <trap+0x23e>
    exit(EXIT_STATUS_DEFAULT);
80106ec1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106ec8:	e8 8b d9 ff ff       	call   80104858 <exit>
...
80106f1c:	75 0f                	jne    80106f2d <trap+0x29e>
    exit(EXIT_STATUS_DEFAULT);
80106f1e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106f25:	e8 2e d9 ff ff       	call   80104858 <exit>
80106f2a:	eb 01                	jmp    80106f2d <trap+0x29e>
      exit(EXIT_STATUS_DEFAULT);
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106f2d:	83 c4 3c             	add    $0x3c,%esp
80106f30:	5b                   	pop    %ebx
80106f31:	5e                   	pop    %esi
80106f32:	5f                   	pop    %edi
80106f33:	5d                   	pop    %ebp
80106f34:	c3                   	ret    
80106f35:	00 00                	add    %al,(%eax)
	...
...
80106f3b:	53                   	push   %ebx
80106f3c:	83 ec 14             	sub    $0x14,%esp
80106f3f:	8b 45 08             	mov    0x8(%ebp),%eax
80106f42:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f46:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106f4a:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106f4e:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106f52:	ec                   	in     (%dx),%al
80106f53:	89 c3                	mov    %eax,%ebx
80106f55:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106f58:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
...
80106f6e:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
80106f83:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
80106f86:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f8d:	00 
80106f8e:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106f95:	e8 c8 ff ff ff       	call   80106f62 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106f9a:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106fa1:	00 
80106fa2:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fa9:	e8 b4 ff ff ff       	call   80106f62 <outb>
  outb(COM1+0, 115200/9600);
80106fae:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106fb5:	00 
80106fb6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106fbd:	e8 a0 ff ff ff       	call   80106f62 <outb>
  outb(COM1+1, 0);
80106fc2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106fc9:	00 
80106fca:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106fd1:	e8 8c ff ff ff       	call   80106f62 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106fd6:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106fdd:	00 
80106fde:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fe5:	e8 78 ff ff ff       	call   80106f62 <outb>
  outb(COM1+4, 0);
80106fea:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ff1:	00 
80106ff2:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106ff9:	e8 64 ff ff ff       	call   80106f62 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106ffe:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107005:	00 
80107006:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010700d:	e8 50 ff ff ff       	call   80106f62 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107012:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107019:	e8 1a ff ff ff       	call   80106f38 <inb>
8010701e:	3c ff                	cmp    $0xff,%al
80107020:	74 6c                	je     8010708e <uartinit+0x10e>
    return;
  uart = 1;
...
80107029:	00 00 00 
  ...
  // enable interrupts.
  inb(COM1+2);
8010702c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107033:	e8 00 ff ff ff       	call   80106f38 <inb>
  inb(COM1+0);
80107038:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010703f:	e8 f4 fe ff ff       	call   80106f38 <inb>
  picenable(IRQ_COM1);
80107044:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010704b:	e8 25 ce ff ff       	call   80103e75 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107050:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107057:	00 
80107058:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010705f:	e8 7a b9 ff ff       	call   801029de <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107064:	c7 45 f4 d0 8f 10 80 	movl   $0x80108fd0,-0xc(%ebp)
8010706b:	eb 15                	jmp    80107082 <uartinit+0x102>
    uartputc(*p);
8010706d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107070:	0f b6 00             	movzbl (%eax),%eax
80107073:	0f be c0             	movsbl %al,%eax
80107076:	89 04 24             	mov    %eax,(%esp)
80107079:	e8 13 00 00 00       	call   80107091 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010707e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107082:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107085:	0f b6 00             	movzbl (%eax),%eax
80107088:	84 c0                	test   %al,%al
8010708a:	75 e1                	jne    8010706d <uartinit+0xed>
8010708c:	eb 01                	jmp    8010708f <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
8010709e:	74 4d                	je     801070ed <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801070a0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801070a7:	eb 10                	jmp    801070b9 <uartputc+0x28>
    microdelay(10);
801070a9:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801070b0:	e8 eb be ff ff       	call   80102fa0 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801070b5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801070b9:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801070bd:	7f 16                	jg     801070d5 <uartputc+0x44>
801070bf:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070c6:	e8 6d fe ff ff       	call   80106f38 <inb>
801070cb:	0f b6 c0             	movzbl %al,%eax
801070ce:	83 e0 20             	and    $0x20,%eax
801070d1:	85 c0                	test   %eax,%eax
801070d3:	74 d4                	je     801070a9 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801070d5:	8b 45 08             	mov    0x8(%ebp),%eax
801070d8:	0f b6 c0             	movzbl %al,%eax
801070db:	89 44 24 04          	mov    %eax,0x4(%esp)
801070df:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070e6:	e8 77 fe ff ff       	call   80106f62 <outb>
801070eb:	eb 01                	jmp    801070ee <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
801070f3:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801070f6:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
...
8010710d:	e8 26 fe ff ff       	call   80106f38 <inb>
...
8010712a:	e8 09 fe ff ff       	call   80106f38 <inb>
...
80107141:	e8 67 96 ff ff       	call   801007ad <consoleintr>
}
80107146:	c9                   	leave  
80107147:	c3                   	ret    
...
8010714a:	6a 00                	push   $0x0
  jmp alltraps
8010714c:	e9 c7 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107153:	6a 01                	push   $0x1
  jmp alltraps
80107155:	e9 be f8 ff ff       	jmp    80106a18 <alltraps>
...
8010715c:	6a 02                	push   $0x2
  jmp alltraps
8010715e:	e9 b5 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107165:	6a 03                	push   $0x3
  jmp alltraps
80107167:	e9 ac f8 ff ff       	jmp    80106a18 <alltraps>
...
8010716e:	6a 04                	push   $0x4
  jmp alltraps
80107170:	e9 a3 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107177:	6a 05                	push   $0x5
  jmp alltraps
80107179:	e9 9a f8 ff ff       	jmp    80106a18 <alltraps>
...
80107180:	6a 06                	push   $0x6
  jmp alltraps
80107182:	e9 91 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107189:	6a 07                	push   $0x7
  jmp alltraps
8010718b:	e9 88 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107190:	6a 08                	push   $0x8
  jmp alltraps
80107192:	e9 81 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107199:	6a 09                	push   $0x9
  jmp alltraps
8010719b:	e9 78 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071a0:	6a 0a                	push   $0xa
  jmp alltraps
801071a2:	e9 71 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071a7:	6a 0b                	push   $0xb
  jmp alltraps
801071a9:	e9 6a f8 ff ff       	jmp    80106a18 <alltraps>
...
801071ae:	6a 0c                	push   $0xc
  jmp alltraps
801071b0:	e9 63 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071b5:	6a 0d                	push   $0xd
  jmp alltraps
801071b7:	e9 5c f8 ff ff       	jmp    80106a18 <alltraps>
...
801071bc:	6a 0e                	push   $0xe
  jmp alltraps
801071be:	e9 55 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071c5:	6a 0f                	push   $0xf
  jmp alltraps
801071c7:	e9 4c f8 ff ff       	jmp    80106a18 <alltraps>
...
801071ce:	6a 10                	push   $0x10
  jmp alltraps
801071d0:	e9 43 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071d5:	6a 11                	push   $0x11
  jmp alltraps
801071d7:	e9 3c f8 ff ff       	jmp    80106a18 <alltraps>
...
801071de:	6a 12                	push   $0x12
  jmp alltraps
801071e0:	e9 33 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071e7:	6a 13                	push   $0x13
  jmp alltraps
801071e9:	e9 2a f8 ff ff       	jmp    80106a18 <alltraps>
...
801071f0:	6a 14                	push   $0x14
  jmp alltraps
801071f2:	e9 21 f8 ff ff       	jmp    80106a18 <alltraps>
...
801071f9:	6a 15                	push   $0x15
  jmp alltraps
801071fb:	e9 18 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107202:	6a 16                	push   $0x16
  jmp alltraps
80107204:	e9 0f f8 ff ff       	jmp    80106a18 <alltraps>
...
8010720b:	6a 17                	push   $0x17
  jmp alltraps
8010720d:	e9 06 f8 ff ff       	jmp    80106a18 <alltraps>
...
80107214:	6a 18                	push   $0x18
  jmp alltraps
80107216:	e9 fd f7 ff ff       	jmp    80106a18 <alltraps>
...
8010721d:	6a 19                	push   $0x19
  jmp alltraps
8010721f:	e9 f4 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107226:	6a 1a                	push   $0x1a
  jmp alltraps
80107228:	e9 eb f7 ff ff       	jmp    80106a18 <alltraps>
...
8010722f:	6a 1b                	push   $0x1b
  jmp alltraps
80107231:	e9 e2 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107238:	6a 1c                	push   $0x1c
  jmp alltraps
8010723a:	e9 d9 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107241:	6a 1d                	push   $0x1d
  jmp alltraps
80107243:	e9 d0 f7 ff ff       	jmp    80106a18 <alltraps>
...
8010724a:	6a 1e                	push   $0x1e
  jmp alltraps
8010724c:	e9 c7 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107253:	6a 1f                	push   $0x1f
  jmp alltraps
80107255:	e9 be f7 ff ff       	jmp    80106a18 <alltraps>
...
8010725c:	6a 20                	push   $0x20
  jmp alltraps
8010725e:	e9 b5 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107265:	6a 21                	push   $0x21
  jmp alltraps
80107267:	e9 ac f7 ff ff       	jmp    80106a18 <alltraps>
...
8010726e:	6a 22                	push   $0x22
  jmp alltraps
80107270:	e9 a3 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107277:	6a 23                	push   $0x23
  jmp alltraps
80107279:	e9 9a f7 ff ff       	jmp    80106a18 <alltraps>
...
80107280:	6a 24                	push   $0x24
  jmp alltraps
80107282:	e9 91 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107289:	6a 25                	push   $0x25
  jmp alltraps
8010728b:	e9 88 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107292:	6a 26                	push   $0x26
  jmp alltraps
80107294:	e9 7f f7 ff ff       	jmp    80106a18 <alltraps>
...
8010729b:	6a 27                	push   $0x27
  jmp alltraps
8010729d:	e9 76 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072a4:	6a 28                	push   $0x28
  jmp alltraps
801072a6:	e9 6d f7 ff ff       	jmp    80106a18 <alltraps>
...
801072ad:	6a 29                	push   $0x29
  jmp alltraps
801072af:	e9 64 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072b6:	6a 2a                	push   $0x2a
  jmp alltraps
801072b8:	e9 5b f7 ff ff       	jmp    80106a18 <alltraps>
...
801072bf:	6a 2b                	push   $0x2b
  jmp alltraps
801072c1:	e9 52 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072c8:	6a 2c                	push   $0x2c
  jmp alltraps
801072ca:	e9 49 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072d1:	6a 2d                	push   $0x2d
  jmp alltraps
801072d3:	e9 40 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072da:	6a 2e                	push   $0x2e
  jmp alltraps
801072dc:	e9 37 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072e3:	6a 2f                	push   $0x2f
  jmp alltraps
801072e5:	e9 2e f7 ff ff       	jmp    80106a18 <alltraps>
...
801072ec:	6a 30                	push   $0x30
  jmp alltraps
801072ee:	e9 25 f7 ff ff       	jmp    80106a18 <alltraps>
...
801072f5:	6a 31                	push   $0x31
  jmp alltraps
801072f7:	e9 1c f7 ff ff       	jmp    80106a18 <alltraps>
...
801072fe:	6a 32                	push   $0x32
  jmp alltraps
80107300:	e9 13 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107307:	6a 33                	push   $0x33
  jmp alltraps
80107309:	e9 0a f7 ff ff       	jmp    80106a18 <alltraps>
...
80107310:	6a 34                	push   $0x34
  jmp alltraps
80107312:	e9 01 f7 ff ff       	jmp    80106a18 <alltraps>
...
80107319:	6a 35                	push   $0x35
  jmp alltraps
8010731b:	e9 f8 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107322:	6a 36                	push   $0x36
  jmp alltraps
80107324:	e9 ef f6 ff ff       	jmp    80106a18 <alltraps>
...
8010732b:	6a 37                	push   $0x37
  jmp alltraps
8010732d:	e9 e6 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107334:	6a 38                	push   $0x38
  jmp alltraps
80107336:	e9 dd f6 ff ff       	jmp    80106a18 <alltraps>
...
8010733d:	6a 39                	push   $0x39
  jmp alltraps
8010733f:	e9 d4 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107346:	6a 3a                	push   $0x3a
  jmp alltraps
80107348:	e9 cb f6 ff ff       	jmp    80106a18 <alltraps>
...
8010734f:	6a 3b                	push   $0x3b
  jmp alltraps
80107351:	e9 c2 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107358:	6a 3c                	push   $0x3c
  jmp alltraps
8010735a:	e9 b9 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107361:	6a 3d                	push   $0x3d
  jmp alltraps
80107363:	e9 b0 f6 ff ff       	jmp    80106a18 <alltraps>
...
8010736a:	6a 3e                	push   $0x3e
  jmp alltraps
8010736c:	e9 a7 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107373:	6a 3f                	push   $0x3f
  jmp alltraps
80107375:	e9 9e f6 ff ff       	jmp    80106a18 <alltraps>
...
8010737c:	6a 40                	push   $0x40
  jmp alltraps
8010737e:	e9 95 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107385:	6a 41                	push   $0x41
  jmp alltraps
80107387:	e9 8c f6 ff ff       	jmp    80106a18 <alltraps>
...
8010738e:	6a 42                	push   $0x42
  jmp alltraps
80107390:	e9 83 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107397:	6a 43                	push   $0x43
  jmp alltraps
80107399:	e9 7a f6 ff ff       	jmp    80106a18 <alltraps>
...
801073a0:	6a 44                	push   $0x44
  jmp alltraps
801073a2:	e9 71 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073a9:	6a 45                	push   $0x45
  jmp alltraps
801073ab:	e9 68 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073b2:	6a 46                	push   $0x46
  jmp alltraps
801073b4:	e9 5f f6 ff ff       	jmp    80106a18 <alltraps>
...
801073bb:	6a 47                	push   $0x47
  jmp alltraps
801073bd:	e9 56 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073c4:	6a 48                	push   $0x48
  jmp alltraps
801073c6:	e9 4d f6 ff ff       	jmp    80106a18 <alltraps>
...
801073cd:	6a 49                	push   $0x49
  jmp alltraps
801073cf:	e9 44 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073d6:	6a 4a                	push   $0x4a
  jmp alltraps
801073d8:	e9 3b f6 ff ff       	jmp    80106a18 <alltraps>
...
801073df:	6a 4b                	push   $0x4b
  jmp alltraps
801073e1:	e9 32 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073e8:	6a 4c                	push   $0x4c
  jmp alltraps
801073ea:	e9 29 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073f1:	6a 4d                	push   $0x4d
  jmp alltraps
801073f3:	e9 20 f6 ff ff       	jmp    80106a18 <alltraps>
...
801073fa:	6a 4e                	push   $0x4e
  jmp alltraps
801073fc:	e9 17 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107403:	6a 4f                	push   $0x4f
  jmp alltraps
80107405:	e9 0e f6 ff ff       	jmp    80106a18 <alltraps>
...
8010740c:	6a 50                	push   $0x50
  jmp alltraps
8010740e:	e9 05 f6 ff ff       	jmp    80106a18 <alltraps>
...
80107415:	6a 51                	push   $0x51
  jmp alltraps
80107417:	e9 fc f5 ff ff       	jmp    80106a18 <alltraps>
...
8010741e:	6a 52                	push   $0x52
  jmp alltraps
80107420:	e9 f3 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107427:	6a 53                	push   $0x53
  jmp alltraps
80107429:	e9 ea f5 ff ff       	jmp    80106a18 <alltraps>
...
80107430:	6a 54                	push   $0x54
  jmp alltraps
80107432:	e9 e1 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107439:	6a 55                	push   $0x55
  jmp alltraps
8010743b:	e9 d8 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107442:	6a 56                	push   $0x56
  jmp alltraps
80107444:	e9 cf f5 ff ff       	jmp    80106a18 <alltraps>
...
8010744b:	6a 57                	push   $0x57
  jmp alltraps
8010744d:	e9 c6 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107454:	6a 58                	push   $0x58
  jmp alltraps
80107456:	e9 bd f5 ff ff       	jmp    80106a18 <alltraps>
...
8010745d:	6a 59                	push   $0x59
  jmp alltraps
8010745f:	e9 b4 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107466:	6a 5a                	push   $0x5a
  jmp alltraps
80107468:	e9 ab f5 ff ff       	jmp    80106a18 <alltraps>
...
8010746f:	6a 5b                	push   $0x5b
  jmp alltraps
80107471:	e9 a2 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107478:	6a 5c                	push   $0x5c
  jmp alltraps
8010747a:	e9 99 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107481:	6a 5d                	push   $0x5d
  jmp alltraps
80107483:	e9 90 f5 ff ff       	jmp    80106a18 <alltraps>
...
8010748a:	6a 5e                	push   $0x5e
  jmp alltraps
8010748c:	e9 87 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107493:	6a 5f                	push   $0x5f
  jmp alltraps
80107495:	e9 7e f5 ff ff       	jmp    80106a18 <alltraps>
...
8010749c:	6a 60                	push   $0x60
  jmp alltraps
8010749e:	e9 75 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074a5:	6a 61                	push   $0x61
  jmp alltraps
801074a7:	e9 6c f5 ff ff       	jmp    80106a18 <alltraps>
...
801074ae:	6a 62                	push   $0x62
  jmp alltraps
801074b0:	e9 63 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074b7:	6a 63                	push   $0x63
  jmp alltraps
801074b9:	e9 5a f5 ff ff       	jmp    80106a18 <alltraps>
...
801074c0:	6a 64                	push   $0x64
  jmp alltraps
801074c2:	e9 51 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074c9:	6a 65                	push   $0x65
  jmp alltraps
801074cb:	e9 48 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074d2:	6a 66                	push   $0x66
  jmp alltraps
801074d4:	e9 3f f5 ff ff       	jmp    80106a18 <alltraps>
...
801074db:	6a 67                	push   $0x67
  jmp alltraps
801074dd:	e9 36 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074e4:	6a 68                	push   $0x68
  jmp alltraps
801074e6:	e9 2d f5 ff ff       	jmp    80106a18 <alltraps>
...
801074ed:	6a 69                	push   $0x69
  jmp alltraps
801074ef:	e9 24 f5 ff ff       	jmp    80106a18 <alltraps>
...
801074f6:	6a 6a                	push   $0x6a
  jmp alltraps
801074f8:	e9 1b f5 ff ff       	jmp    80106a18 <alltraps>
...
801074ff:	6a 6b                	push   $0x6b
  jmp alltraps
80107501:	e9 12 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107508:	6a 6c                	push   $0x6c
  jmp alltraps
8010750a:	e9 09 f5 ff ff       	jmp    80106a18 <alltraps>
...
80107511:	6a 6d                	push   $0x6d
  jmp alltraps
80107513:	e9 00 f5 ff ff       	jmp    80106a18 <alltraps>
...
8010751a:	6a 6e                	push   $0x6e
  jmp alltraps
8010751c:	e9 f7 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107523:	6a 6f                	push   $0x6f
  jmp alltraps
80107525:	e9 ee f4 ff ff       	jmp    80106a18 <alltraps>
...
8010752c:	6a 70                	push   $0x70
  jmp alltraps
8010752e:	e9 e5 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107535:	6a 71                	push   $0x71
  jmp alltraps
80107537:	e9 dc f4 ff ff       	jmp    80106a18 <alltraps>
...
8010753e:	6a 72                	push   $0x72
  jmp alltraps
80107540:	e9 d3 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107547:	6a 73                	push   $0x73
  jmp alltraps
80107549:	e9 ca f4 ff ff       	jmp    80106a18 <alltraps>
...
80107550:	6a 74                	push   $0x74
  jmp alltraps
80107552:	e9 c1 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107559:	6a 75                	push   $0x75
  jmp alltraps
8010755b:	e9 b8 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107562:	6a 76                	push   $0x76
  jmp alltraps
80107564:	e9 af f4 ff ff       	jmp    80106a18 <alltraps>
...
8010756b:	6a 77                	push   $0x77
  jmp alltraps
8010756d:	e9 a6 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107574:	6a 78                	push   $0x78
  jmp alltraps
80107576:	e9 9d f4 ff ff       	jmp    80106a18 <alltraps>
...
8010757d:	6a 79                	push   $0x79
  jmp alltraps
8010757f:	e9 94 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107586:	6a 7a                	push   $0x7a
  jmp alltraps
80107588:	e9 8b f4 ff ff       	jmp    80106a18 <alltraps>
...
8010758f:	6a 7b                	push   $0x7b
  jmp alltraps
80107591:	e9 82 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107598:	6a 7c                	push   $0x7c
  jmp alltraps
8010759a:	e9 79 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075a1:	6a 7d                	push   $0x7d
  jmp alltraps
801075a3:	e9 70 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075aa:	6a 7e                	push   $0x7e
  jmp alltraps
801075ac:	e9 67 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075b3:	6a 7f                	push   $0x7f
  jmp alltraps
801075b5:	e9 5e f4 ff ff       	jmp    80106a18 <alltraps>
...
801075bc:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801075c1:	e9 52 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075c8:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801075cd:	e9 46 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075d4:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801075d9:	e9 3a f4 ff ff       	jmp    80106a18 <alltraps>
...
801075e0:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801075e5:	e9 2e f4 ff ff       	jmp    80106a18 <alltraps>
...
801075ec:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801075f1:	e9 22 f4 ff ff       	jmp    80106a18 <alltraps>
...
801075f8:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801075fd:	e9 16 f4 ff ff       	jmp    80106a18 <alltraps>
...
80107604:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107609:	e9 0a f4 ff ff       	jmp    80106a18 <alltraps>
...
80107610:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107615:	e9 fe f3 ff ff       	jmp    80106a18 <alltraps>
...
8010761c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107621:	e9 f2 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107628:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010762d:	e9 e6 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107634:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107639:	e9 da f3 ff ff       	jmp    80106a18 <alltraps>
...
80107640:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107645:	e9 ce f3 ff ff       	jmp    80106a18 <alltraps>
...
8010764c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107651:	e9 c2 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107658:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010765d:	e9 b6 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107664:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107669:	e9 aa f3 ff ff       	jmp    80106a18 <alltraps>
...
80107670:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107675:	e9 9e f3 ff ff       	jmp    80106a18 <alltraps>
...
8010767c:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107681:	e9 92 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107688:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010768d:	e9 86 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107694:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107699:	e9 7a f3 ff ff       	jmp    80106a18 <alltraps>
...
801076a0:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801076a5:	e9 6e f3 ff ff       	jmp    80106a18 <alltraps>
...
801076ac:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801076b1:	e9 62 f3 ff ff       	jmp    80106a18 <alltraps>
...
801076b8:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801076bd:	e9 56 f3 ff ff       	jmp    80106a18 <alltraps>
...
801076c4:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801076c9:	e9 4a f3 ff ff       	jmp    80106a18 <alltraps>
...
801076d0:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801076d5:	e9 3e f3 ff ff       	jmp    80106a18 <alltraps>
...
801076dc:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801076e1:	e9 32 f3 ff ff       	jmp    80106a18 <alltraps>
...
801076e8:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801076ed:	e9 26 f3 ff ff       	jmp    80106a18 <alltraps>
...
801076f4:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801076f9:	e9 1a f3 ff ff       	jmp    80106a18 <alltraps>
...
80107700:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107705:	e9 0e f3 ff ff       	jmp    80106a18 <alltraps>
...
8010770c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107711:	e9 02 f3 ff ff       	jmp    80106a18 <alltraps>
...
80107718:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010771d:	e9 f6 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107724:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107729:	e9 ea f2 ff ff       	jmp    80106a18 <alltraps>
...
80107730:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107735:	e9 de f2 ff ff       	jmp    80106a18 <alltraps>
...
8010773c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107741:	e9 d2 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107748:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010774d:	e9 c6 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107754:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107759:	e9 ba f2 ff ff       	jmp    80106a18 <alltraps>
...
80107760:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107765:	e9 ae f2 ff ff       	jmp    80106a18 <alltraps>
...
8010776c:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107771:	e9 a2 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107778:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010777d:	e9 96 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107784:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107789:	e9 8a f2 ff ff       	jmp    80106a18 <alltraps>
...
80107790:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107795:	e9 7e f2 ff ff       	jmp    80106a18 <alltraps>
...
8010779c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801077a1:	e9 72 f2 ff ff       	jmp    80106a18 <alltraps>
...
801077a8:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801077ad:	e9 66 f2 ff ff       	jmp    80106a18 <alltraps>
...
801077b4:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801077b9:	e9 5a f2 ff ff       	jmp    80106a18 <alltraps>
...
801077c0:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801077c5:	e9 4e f2 ff ff       	jmp    80106a18 <alltraps>
...
801077cc:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801077d1:	e9 42 f2 ff ff       	jmp    80106a18 <alltraps>
...
801077d8:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801077dd:	e9 36 f2 ff ff       	jmp    80106a18 <alltraps>
...
801077e4:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801077e9:	e9 2a f2 ff ff       	jmp    80106a18 <alltraps>
...
801077f0:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801077f5:	e9 1e f2 ff ff       	jmp    80106a18 <alltraps>
...
801077fc:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107801:	e9 12 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107808:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010780d:	e9 06 f2 ff ff       	jmp    80106a18 <alltraps>
...
80107814:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107819:	e9 fa f1 ff ff       	jmp    80106a18 <alltraps>
...
80107820:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107825:	e9 ee f1 ff ff       	jmp    80106a18 <alltraps>
...
8010782c:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107831:	e9 e2 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107838:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010783d:	e9 d6 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107844:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107849:	e9 ca f1 ff ff       	jmp    80106a18 <alltraps>
...
80107850:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107855:	e9 be f1 ff ff       	jmp    80106a18 <alltraps>
...
8010785c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107861:	e9 b2 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107868:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010786d:	e9 a6 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107874:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107879:	e9 9a f1 ff ff       	jmp    80106a18 <alltraps>
...
80107880:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107885:	e9 8e f1 ff ff       	jmp    80106a18 <alltraps>
...
8010788c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107891:	e9 82 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107898:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010789d:	e9 76 f1 ff ff       	jmp    80106a18 <alltraps>
...
801078a4:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801078a9:	e9 6a f1 ff ff       	jmp    80106a18 <alltraps>
...
801078b0:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801078b5:	e9 5e f1 ff ff       	jmp    80106a18 <alltraps>
...
801078bc:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801078c1:	e9 52 f1 ff ff       	jmp    80106a18 <alltraps>
...
801078c8:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801078cd:	e9 46 f1 ff ff       	jmp    80106a18 <alltraps>
...
801078d4:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801078d9:	e9 3a f1 ff ff       	jmp    80106a18 <alltraps>
...
801078e0:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801078e5:	e9 2e f1 ff ff       	jmp    80106a18 <alltraps>
...
801078ec:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801078f1:	e9 22 f1 ff ff       	jmp    80106a18 <alltraps>
...
801078f8:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801078fd:	e9 16 f1 ff ff       	jmp    80106a18 <alltraps>
...
80107904:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107909:	e9 0a f1 ff ff       	jmp    80106a18 <alltraps>
...
80107910:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107915:	e9 fe f0 ff ff       	jmp    80106a18 <alltraps>
...
8010791c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107921:	e9 f2 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107928:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010792d:	e9 e6 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107934:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107939:	e9 da f0 ff ff       	jmp    80106a18 <alltraps>
...
80107940:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107945:	e9 ce f0 ff ff       	jmp    80106a18 <alltraps>
...
8010794c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107951:	e9 c2 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107958:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010795d:	e9 b6 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107964:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107969:	e9 aa f0 ff ff       	jmp    80106a18 <alltraps>
...
80107970:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107975:	e9 9e f0 ff ff       	jmp    80106a18 <alltraps>
...
8010797c:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107981:	e9 92 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107988:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010798d:	e9 86 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107994:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107999:	e9 7a f0 ff ff       	jmp    80106a18 <alltraps>
...
801079a0:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801079a5:	e9 6e f0 ff ff       	jmp    80106a18 <alltraps>
...
801079ac:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801079b1:	e9 62 f0 ff ff       	jmp    80106a18 <alltraps>
...
801079b8:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801079bd:	e9 56 f0 ff ff       	jmp    80106a18 <alltraps>
...
801079c4:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801079c9:	e9 4a f0 ff ff       	jmp    80106a18 <alltraps>
...
801079d0:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801079d5:	e9 3e f0 ff ff       	jmp    80106a18 <alltraps>
...
801079dc:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801079e1:	e9 32 f0 ff ff       	jmp    80106a18 <alltraps>
...
801079e8:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801079ed:	e9 26 f0 ff ff       	jmp    80106a18 <alltraps>
...
801079f4:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801079f9:	e9 1a f0 ff ff       	jmp    80106a18 <alltraps>
...
80107a00:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107a05:	e9 0e f0 ff ff       	jmp    80106a18 <alltraps>
...
80107a0c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107a11:	e9 02 f0 ff ff       	jmp    80106a18 <alltraps>
...
80107a18:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107a1d:	e9 f6 ef ff ff       	jmp    80106a18 <alltraps>
...
80107a24:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107a29:	e9 ea ef ff ff       	jmp    80106a18 <alltraps>
...
80107a30:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107a35:	e9 de ef ff ff       	jmp    80106a18 <alltraps>
...
80107a3c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107a41:	e9 d2 ef ff ff       	jmp    80106a18 <alltraps>
...
80107a48:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107a4d:	e9 c6 ef ff ff       	jmp    80106a18 <alltraps>
...
80107a54:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107a59:	e9 ba ef ff ff       	jmp    80106a18 <alltraps>
...
80107a60:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107a65:	e9 ae ef ff ff       	jmp    80106a18 <alltraps>
...
80107a6c:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107a71:	e9 a2 ef ff ff       	jmp    80106a18 <alltraps>
...
80107a78:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107a7d:	e9 96 ef ff ff       	jmp    80106a18 <alltraps>
...
80107a84:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107a89:	e9 8a ef ff ff       	jmp    80106a18 <alltraps>
...
80107a90:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107a95:	e9 7e ef ff ff       	jmp    80106a18 <alltraps>
...
80107a9c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107aa1:	e9 72 ef ff ff       	jmp    80106a18 <alltraps>
...
80107aa8:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107aad:	e9 66 ef ff ff       	jmp    80106a18 <alltraps>
...
80107ab4:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107ab9:	e9 5a ef ff ff       	jmp    80106a18 <alltraps>
...
80107ac0:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107ac5:	e9 4e ef ff ff       	jmp    80106a18 <alltraps>
...
80107acc:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107ad1:	e9 42 ef ff ff       	jmp    80106a18 <alltraps>
...
80107ad8:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107add:	e9 36 ef ff ff       	jmp    80106a18 <alltraps>
...
80107ae4:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107ae9:	e9 2a ef ff ff       	jmp    80106a18 <alltraps>
...
80107af0:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107af5:	e9 1e ef ff ff       	jmp    80106a18 <alltraps>
...
80107afc:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107b01:	e9 12 ef ff ff       	jmp    80106a18 <alltraps>
...
80107b08:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107b0d:	e9 06 ef ff ff       	jmp    80106a18 <alltraps>
...
80107b14:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107b19:	e9 fa ee ff ff       	jmp    80106a18 <alltraps>
...
80107b20:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107b25:	e9 ee ee ff ff       	jmp    80106a18 <alltraps>
...
80107b2c:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107b31:	e9 e2 ee ff ff       	jmp    80106a18 <alltraps>
...
80107b38:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107b3d:	e9 d6 ee ff ff       	jmp    80106a18 <alltraps>
...
80107b44:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107b49:	e9 ca ee ff ff       	jmp    80106a18 <alltraps>
...
80107b50:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107b55:	e9 be ee ff ff       	jmp    80106a18 <alltraps>
...
80107b5c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107b61:	e9 b2 ee ff ff       	jmp    80106a18 <alltraps>
...
80107b68:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107b6d:	e9 a6 ee ff ff       	jmp    80106a18 <alltraps>
...
80107b74:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107b79:	e9 9a ee ff ff       	jmp    80106a18 <alltraps>
...
80107b80:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107b85:	e9 8e ee ff ff       	jmp    80106a18 <alltraps>
...
80107b8c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107b91:	e9 82 ee ff ff       	jmp    80106a18 <alltraps>
...
80107b98:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107b9d:	e9 76 ee ff ff       	jmp    80106a18 <alltraps>
...
80107ba4:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ba9:	e9 6a ee ff ff       	jmp    80106a18 <alltraps>
...
80107bb0:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107bb5:	e9 5e ee ff ff       	jmp    80106a18 <alltraps>
	...
...
80107bbf:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107bc2:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bc5:	83 e8 01             	sub    $0x1,%eax
80107bc8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107bcc:	8b 45 08             	mov    0x8(%ebp),%eax
80107bcf:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107bd3:	8b 45 08             	mov    0x8(%ebp),%eax
80107bd6:	c1 e8 10             	shr    $0x10,%eax
80107bd9:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107bdd:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107be0:	0f 01 10             	lgdtl  (%eax)
}
80107be3:	c9                   	leave  
80107be4:	c3                   	ret    
...
80107bee:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107bf2:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107bf6:	0f 00 d8             	ltr    %ax
}
80107bf9:	c9                   	leave  
80107bfa:	c3                   	ret    
...
80107c39:	83 ec 24             	sub    $0x24,%esp
...
80107c9c:	88 50 7d             	mov    %dl,0x7d(%eax)
...
80107cb3:	83 e2 ef             	and    $0xffffffef,%edx
...
80107ce3:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107ce7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cea:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107cf1:	ff ff 
80107cf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf6:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107cfd:	00 00 
80107cff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d02:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107d09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d0c:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
...
80107d3c:	83 e2 9f             	and    $0xffffff9f,%edx
80107d3f:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d48:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d4f:	83 ca 80             	or     $0xffffff80,%edx
80107d52:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80107da7:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107dae:	83 ca 80             	or     $0xffffff80,%edx
80107db1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107db7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dba:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107dc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc4:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107dcb:	ff ff 
80107dcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dd0:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107dd7:	00 00 
80107dd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ddc:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107de3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de6:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107ded:	83 e2 f0             	and    $0xfffffff0,%edx
80107df0:	83 ca 0a             	or     $0xa,%edx
80107df3:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107df9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dfc:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e03:	83 ca 10             	or     $0x10,%edx
80107e06:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e0f:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e16:	83 ca 60             	or     $0x60,%edx
80107e19:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e22:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e29:	83 ca 80             	or     $0xffffff80,%edx
80107e2c:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e35:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e3c:	83 ca 0f             	or     $0xf,%edx
80107e3f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e48:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e4f:	83 e2 ef             	and    $0xffffffef,%edx
80107e52:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e5b:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e62:	83 e2 df             	and    $0xffffffdf,%edx
80107e65:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e6e:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e75:	83 ca 40             	or     $0x40,%edx
80107e78:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e81:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e88:	83 ca 80             	or     $0xffffff80,%edx
80107e8b:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e94:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107e9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e9e:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107ea5:	ff ff 
80107ea7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eaa:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107eb1:	00 00 
80107eb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb6:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107ebd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec0:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ec7:	83 e2 f0             	and    $0xfffffff0,%edx
80107eca:	83 ca 02             	or     $0x2,%edx
80107ecd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ed3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed6:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107edd:	83 ca 10             	or     $0x10,%edx
80107ee0:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ee6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee9:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107ef0:	83 ca 60             	or     $0x60,%edx
80107ef3:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107ef9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107efc:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107f03:	83 ca 80             	or     $0xffffff80,%edx
80107f06:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107f0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0f:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f16:	83 ca 0f             	or     $0xf,%edx
80107f19:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f22:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f29:	83 e2 ef             	and    $0xffffffef,%edx
80107f2c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f35:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f3c:	83 e2 df             	and    $0xffffffdf,%edx
80107f3f:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f48:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f4f:	83 ca 40             	or     $0x40,%edx
80107f52:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f62:	83 ca 80             	or     $0xffffff80,%edx
80107f65:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f6e:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107f75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f78:	05 b4 00 00 00       	add    $0xb4,%eax
80107f7d:	89 c3                	mov    %eax,%ebx
80107f7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f82:	05 b4 00 00 00       	add    $0xb4,%eax
80107f87:	c1 e8 10             	shr    $0x10,%eax
80107f8a:	89 c1                	mov    %eax,%ecx
80107f8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8f:	05 b4 00 00 00       	add    $0xb4,%eax
80107f94:	c1 e8 18             	shr    $0x18,%eax
80107f97:	89 c2                	mov    %eax,%edx
80107f99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9c:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107fa3:	00 00 
80107fa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa8:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107faf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb2:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107fb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fbb:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fc2:	83 e1 f0             	and    $0xfffffff0,%ecx
80107fc5:	83 c9 02             	or     $0x2,%ecx
80107fc8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd1:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fd8:	83 c9 10             	or     $0x10,%ecx
80107fdb:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fe1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe4:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107feb:	83 e1 9f             	and    $0xffffff9f,%ecx
80107fee:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107ff4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107ffe:	83 c9 80             	or     $0xffffff80,%ecx
80108001:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108007:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108011:	83 e1 f0             	and    $0xfffffff0,%ecx
80108014:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010801a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010801d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108024:	83 e1 ef             	and    $0xffffffef,%ecx
80108027:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010802d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108030:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108037:	83 e1 df             	and    $0xffffffdf,%ecx
8010803a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108040:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108043:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010804a:	83 c9 40             	or     $0x40,%ecx
8010804d:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108053:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108056:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010805d:	83 c9 80             	or     $0xffffff80,%ecx
80108060:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108066:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108069:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
8010806f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108072:	83 c0 70             	add    $0x70,%eax
80108075:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
8010807c:	00 
8010807d:	89 04 24             	mov    %eax,(%esp)
80108080:	e8 37 fb ff ff       	call   80107bbc <lgdt>
  loadgs(SEG_KCPU << 3);
80108085:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
8010808c:	e8 6a fb ff ff       	call   80107bfb <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108091:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108094:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
8010809a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801080a1:	00 00 00 00 
}
801080a5:	83 c4 24             	add    $0x24,%esp
801080a8:	5b                   	pop    %ebx
801080a9:	5d                   	pop    %ebp
801080aa:	c3                   	ret    
...
801080ae:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801080b1:	8b 45 0c             	mov    0xc(%ebp),%eax
801080b4:	c1 e8 16             	shr    $0x16,%eax
801080b7:	c1 e0 02             	shl    $0x2,%eax
801080ba:	03 45 08             	add    0x8(%ebp),%eax
801080bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801080c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080c3:	8b 00                	mov    (%eax),%eax
801080c5:	83 e0 01             	and    $0x1,%eax
801080c8:	84 c0                	test   %al,%al
801080ca:	74 17                	je     801080e3 <walkpgdir+0x38>
...
801080d9:	e8 4a fb ff ff       	call   80107c28 <p2v>
801080de:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080e1:	eb 4b                	jmp    8010812e <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801080e3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801080e7:	74 0e                	je     801080f7 <walkpgdir+0x4c>
801080e9:	e8 79 aa ff ff       	call   80102b67 <kalloc>
801080ee:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080f1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801080f5:	75 07                	jne    801080fe <walkpgdir+0x53>
      return 0;
801080f7:	b8 00 00 00 00       	mov    $0x0,%eax
801080fc:	eb 41                	jmp    8010813f <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801080fe:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108105:	00 
80108106:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010810d:	00 
8010810e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108111:	89 04 24             	mov    %eax,(%esp)
80108114:	e8 21 d3 ff ff       	call   8010543a <memset>
...
8010811f:	e8 f7 fa ff ff       	call   80107c1b <v2p>
80108124:	89 c2                	mov    %eax,%edx
80108126:	83 ca 07             	or     $0x7,%edx
80108129:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010812c:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
8010812e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108131:	c1 e8 0c             	shr    $0xc,%eax
80108134:	25 ff 03 00 00       	and    $0x3ff,%eax
80108139:	c1 e0 02             	shl    $0x2,%eax
8010813c:	03 45 f4             	add    -0xc(%ebp),%eax
}
8010813f:	c9                   	leave  
80108140:	c3                   	ret    
...
80108144:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80108155:	03 45 10             	add    0x10(%ebp),%eax
80108158:	83 e8 01             	sub    $0x1,%eax
8010815b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108160:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108163:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010816a:	00 
...
80108178:	e8 2e ff ff ff       	call   801080ab <walkpgdir>
8010817d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108180:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108184:	75 07                	jne    8010818d <mappages+0x4c>
      return -1;
80108186:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010818b:	eb 46                	jmp    801081d3 <mappages+0x92>
    if(*pte & PTE_P)
8010818d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108190:	8b 00                	mov    (%eax),%eax
80108192:	83 e0 01             	and    $0x1,%eax
80108195:	84 c0                	test   %al,%al
80108197:	74 0c                	je     801081a5 <mappages+0x64>
      panic("remap");
80108199:	c7 04 24 d8 8f 10 80 	movl   $0x80108fd8,(%esp)
801081a0:	e8 98 83 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801081a5:	8b 45 18             	mov    0x18(%ebp),%eax
801081a8:	0b 45 14             	or     0x14(%ebp),%eax
801081ab:	89 c2                	mov    %eax,%edx
801081ad:	83 ca 01             	or     $0x1,%edx
801081b0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081b3:	89 10                	mov    %edx,(%eax)
    if(a == last)
801081b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801081bb:	74 10                	je     801081cd <mappages+0x8c>
      break;
    a += PGSIZE;
801081bd:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801081c4:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801081cb:	eb 96                	jmp    80108163 <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801081d9:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801081dc:	e8 86 a9 ff ff       	call   80102b67 <kalloc>
801081e1:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081e4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081e8:	75 0a                	jne    801081f4 <setupkvm+0x1f>
    return 0;
801081ea:	b8 00 00 00 00       	mov    $0x0,%eax
801081ef:	e9 98 00 00 00       	jmp    8010828c <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801081f4:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081fb:	00 
801081fc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108203:	00 
80108204:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108207:	89 04 24             	mov    %eax,(%esp)
8010820a:	e8 2b d2 ff ff       	call   8010543a <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010820f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108216:	e8 0d fa ff ff       	call   80107c28 <p2v>
8010821b:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108220:	76 0c                	jbe    8010822e <setupkvm+0x59>
    panic("PHYSTOP too high");
80108222:	c7 04 24 de 8f 10 80 	movl   $0x80108fde,(%esp)
80108229:	e8 0f 83 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010822e:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108235:	eb 49                	jmp    80108280 <setupkvm+0xab>
...
80108237:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010823a:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
8010823d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108240:	8b 50 04             	mov    0x4(%eax),%edx
80108243:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108246:	8b 58 08             	mov    0x8(%eax),%ebx
80108249:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010824c:	8b 40 04             	mov    0x4(%eax),%eax
8010824f:	29 c3                	sub    %eax,%ebx
80108251:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108254:	8b 00                	mov    (%eax),%eax
80108256:	89 4c 24 10          	mov    %ecx,0x10(%esp)
8010825a:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010825e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108262:	89 44 24 04          	mov    %eax,0x4(%esp)
80108266:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108269:	89 04 24             	mov    %eax,(%esp)
8010826c:	e8 d0 fe ff ff       	call   80108141 <mappages>
80108271:	85 c0                	test   %eax,%eax
80108273:	79 07                	jns    8010827c <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108275:	b8 00 00 00 00       	mov    $0x0,%eax
8010827a:	eb 10                	jmp    8010828c <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010827c:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108280:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108287:	72 ae                	jb     80108237 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
8010828c:	83 c4 34             	add    $0x34,%esp
8010828f:	5b                   	pop    %ebx
80108290:	5d                   	pop    %ebp
80108291:	c3                   	ret    
...
80108295:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108298:	e8 38 ff ff ff       	call   801081d5 <setupkvm>
8010829d:	a3 58 68 11 80       	mov    %eax,0x80116858
  switchkvm();
801082a2:	e8 02 00 00 00       	call   801082a9 <switchkvm>
}
801082a7:	c9                   	leave  
801082a8:	c3                   	ret    
...
801082af:	a1 58 68 11 80       	mov    0x80116858,%eax
801082b4:	89 04 24             	mov    %eax,(%esp)
801082b7:	e8 5f f9 ff ff       	call   80107c1b <v2p>
801082bc:	89 04 24             	mov    %eax,(%esp)
801082bf:	e8 4c f9 ff ff       	call   80107c10 <lcr3>
}
801082c4:	c9                   	leave  
801082c5:	c3                   	ret    
...
801082ca:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801082cd:	e8 61 d0 ff ff       	call   80105333 <pushcli>
...
80108300:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108307:	67 00 
80108309:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108310:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108316:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010831d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108320:	83 c9 09             	or     $0x9,%ecx
80108323:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108329:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108330:	83 c9 10             	or     $0x10,%ecx
80108333:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108339:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108340:	83 e1 9f             	and    $0xffffff9f,%ecx
80108343:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108349:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108350:	83 c9 80             	or     $0xffffff80,%ecx
80108353:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108359:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108360:	83 e1 f0             	and    $0xfffffff0,%ecx
80108363:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108369:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108370:	83 e1 ef             	and    $0xffffffef,%ecx
80108373:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108379:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108380:	83 e1 df             	and    $0xffffffdf,%ecx
80108383:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108389:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108390:	83 c9 40             	or     $0x40,%ecx
80108393:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108399:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801083a0:	83 e1 7f             	and    $0x7f,%ecx
801083a3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083a9:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801083af:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083b5:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801083bc:	83 e2 ef             	and    $0xffffffef,%edx
801083bf:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801083c5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083cb:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801083d1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083d7:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801083de:	8b 52 08             	mov    0x8(%edx),%edx
801083e1:	81 c2 00 10 00 00    	add    $0x1000,%edx
801083e7:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
801083ea:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801083f1:	e8 ef f7 ff ff       	call   80107be5 <ltr>
  if(p->pgdir == 0)
801083f6:	8b 45 08             	mov    0x8(%ebp),%eax
801083f9:	8b 40 04             	mov    0x4(%eax),%eax
801083fc:	85 c0                	test   %eax,%eax
801083fe:	75 0c                	jne    8010840c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80108400:	c7 04 24 ef 8f 10 80 	movl   $0x80108fef,(%esp)
80108407:	e8 31 81 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010840c:	8b 45 08             	mov    0x8(%ebp),%eax
8010840f:	8b 40 04             	mov    0x4(%eax),%eax
80108412:	89 04 24             	mov    %eax,(%esp)
80108415:	e8 01 f8 ff ff       	call   80107c1b <v2p>
8010841a:	89 04 24             	mov    %eax,(%esp)
8010841d:	e8 ee f7 ff ff       	call   80107c10 <lcr3>
  popcli();
80108422:	e8 54 cf ff ff       	call   8010537b <popcli>
}
80108427:	83 c4 14             	add    $0x14,%esp
8010842a:	5b                   	pop    %ebx
8010842b:	5d                   	pop    %ebp
8010842c:	c3                   	ret    
...
80108430:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108433:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010843a:	76 0c                	jbe    80108448 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010843c:	c7 04 24 03 90 10 80 	movl   $0x80109003,(%esp)
80108443:	e8 f5 80 ff ff       	call   8010053d <panic>
  mem = kalloc();
80108448:	e8 1a a7 ff ff       	call   80102b67 <kalloc>
8010844d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108450:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108457:	00 
80108458:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010845f:	00 
80108460:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108463:	89 04 24             	mov    %eax,(%esp)
80108466:	e8 cf cf ff ff       	call   8010543a <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010846b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010846e:	89 04 24             	mov    %eax,(%esp)
80108471:	e8 a5 f7 ff ff       	call   80107c1b <v2p>
80108476:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010847d:	00 
8010847e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108482:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108489:	00 
8010848a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108491:	00 
80108492:	8b 45 08             	mov    0x8(%ebp),%eax
80108495:	89 04 24             	mov    %eax,(%esp)
80108498:	e8 a4 fc ff ff       	call   80108141 <mappages>
  memmove(mem, init, sz);
8010849d:	8b 45 10             	mov    0x10(%ebp),%eax
...
801084b1:	e8 57 d0 ff ff       	call   8010550d <memmove>
}
801084b6:	c9                   	leave  
801084b7:	c3                   	ret    
...
801084bc:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
801084c9:	74 0c                	je     801084d7 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801084cb:	c7 04 24 20 90 10 80 	movl   $0x80109020,(%esp)
801084d2:	e8 66 80 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
801084d7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801084de:	e9 ad 00 00 00       	jmp    80108590 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801084e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084e6:	8b 55 0c             	mov    0xc(%ebp),%edx
...
801084fd:	e8 a9 fb ff ff       	call   801080ab <walkpgdir>
80108502:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108505:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108509:	75 0c                	jne    80108517 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010850b:	c7 04 24 43 90 10 80 	movl   $0x80109043,(%esp)
...
80108521:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108524:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108527:	8b 55 18             	mov    0x18(%ebp),%edx
8010852a:	89 d1                	mov    %edx,%ecx
8010852c:	29 c1                	sub    %eax,%ecx
8010852e:	89 c8                	mov    %ecx,%eax
80108530:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108535:	77 11                	ja     80108548 <loaduvm+0x90>
      n = sz - i;
80108537:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010853a:	8b 55 18             	mov    0x18(%ebp),%edx
8010853d:	89 d1                	mov    %edx,%ecx
8010853f:	29 c1                	sub    %eax,%ecx
80108541:	89 c8                	mov    %ecx,%eax
80108543:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108546:	eb 07                	jmp    8010854f <loaduvm+0x97>
    else
      n = PGSIZE;
80108548:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010854f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108552:	8b 55 14             	mov    0x14(%ebp),%edx
80108555:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108558:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010855b:	89 04 24             	mov    %eax,(%esp)
8010855e:	e8 c5 f6 ff ff       	call   80107c28 <p2v>
80108563:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108566:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010856a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010856e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108572:	8b 45 10             	mov    0x10(%ebp),%eax
80108575:	89 04 24             	mov    %eax,(%esp)
80108578:	e8 49 98 ff ff       	call   80101dc6 <readi>
8010857d:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108580:	74 07                	je     80108589 <loaduvm+0xd1>
      return -1;
80108582:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108587:	eb 18                	jmp    801085a1 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
80108596:	0f 82 47 ff ff ff    	jb     801084e3 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801085a1:	83 c4 24             	add    $0x24,%esp
801085a4:	5b                   	pop    %ebx
801085a5:	5d                   	pop    %ebp
801085a6:	c3                   	ret    
...
801085aa:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801085b2:	79 0a                	jns    801085be <allocuvm+0x17>
    return 0;
801085b4:	b8 00 00 00 00       	mov    $0x0,%eax
801085b9:	e9 c1 00 00 00       	jmp    8010867f <allocuvm+0xd8>
  if(newsz < oldsz)
801085be:	8b 45 10             	mov    0x10(%ebp),%eax
801085c1:	3b 45 0c             	cmp    0xc(%ebp),%eax
801085c4:	73 08                	jae    801085ce <allocuvm+0x27>
    return oldsz;
801085c6:	8b 45 0c             	mov    0xc(%ebp),%eax
801085c9:	e9 b1 00 00 00       	jmp    8010867f <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801085ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801085d1:	05 ff 0f 00 00       	add    $0xfff,%eax
801085d6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801085db:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
801085de:	e9 8d 00 00 00       	jmp    80108670 <allocuvm+0xc9>
    mem = kalloc();
801085e3:	e8 7f a5 ff ff       	call   80102b67 <kalloc>
801085e8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801085eb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801085ef:	75 2c                	jne    8010861d <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801085f1:	c7 04 24 61 90 10 80 	movl   $0x80109061,(%esp)
801085f8:	e8 a4 7d ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801085fd:	8b 45 0c             	mov    0xc(%ebp),%eax
80108600:	89 44 24 08          	mov    %eax,0x8(%esp)
80108604:	8b 45 10             	mov    0x10(%ebp),%eax
80108607:	89 44 24 04          	mov    %eax,0x4(%esp)
8010860b:	8b 45 08             	mov    0x8(%ebp),%eax
8010860e:	89 04 24             	mov    %eax,(%esp)
80108611:	e8 6b 00 00 00       	call   80108681 <deallocuvm>
      return 0;
80108616:	b8 00 00 00 00       	mov    $0x0,%eax
8010861b:	eb 62                	jmp    8010867f <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010861d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108624:	00 
80108625:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010862c:	00 
8010862d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108630:	89 04 24             	mov    %eax,(%esp)
80108633:	e8 02 ce ff ff       	call   8010543a <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108638:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010863b:	89 04 24             	mov    %eax,(%esp)
8010863e:	e8 d8 f5 ff ff       	call   80107c1b <v2p>
80108643:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108646:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010864d:	00 
8010864e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108652:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108659:	00 
8010865a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010865e:	8b 45 08             	mov    0x8(%ebp),%eax
80108661:	89 04 24             	mov    %eax,(%esp)
80108664:	e8 d8 fa ff ff       	call   80108141 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80108669:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108670:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108673:	3b 45 10             	cmp    0x10(%ebp),%eax
80108676:	0f 82 67 ff ff ff    	jb     801085e3 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108684:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
8010868d:	72 08                	jb     80108697 <deallocuvm+0x16>
    return oldsz;
8010868f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108692:	e9 a4 00 00 00       	jmp    8010873b <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108697:	8b 45 10             	mov    0x10(%ebp),%eax
8010869a:	05 ff 0f 00 00       	add    $0xfff,%eax
8010869f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801086a7:	e9 80 00 00 00       	jmp    8010872c <deallocuvm+0xab>
...
801086c1:	e8 e5 f9 ff ff       	call   801080ab <walkpgdir>
801086c6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801086c9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801086cd:	75 09                	jne    801086d8 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801086cf:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801086d6:	eb 4d                	jmp    80108725 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801086d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801086db:	8b 00                	mov    (%eax),%eax
801086dd:	83 e0 01             	and    $0x1,%eax
801086e0:	84 c0                	test   %al,%al
801086e2:	74 41                	je     80108725 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
801086f5:	75 0c                	jne    80108703 <deallocuvm+0x82>
        panic("kfree");
801086f7:	c7 04 24 79 90 10 80 	movl   $0x80109079,(%esp)
801086fe:	e8 3a 7e ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108703:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108706:	89 04 24             	mov    %eax,(%esp)
80108709:	e8 1a f5 ff ff       	call   80107c28 <p2v>
8010870e:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108711:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108714:	89 04 24             	mov    %eax,(%esp)
80108717:	e8 b2 a3 ff ff       	call   80102ace <kfree>
      *pte = 0;
...
80108732:	0f 82 74 ff ff ff    	jb     801086ac <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108740:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108743:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108747:	75 0c                	jne    80108755 <freevm+0x18>
    panic("freevm: no pgdir");
80108749:	c7 04 24 7f 90 10 80 	movl   $0x8010907f,(%esp)
80108750:	e8 e8 7d ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108755:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010875c:	00 
8010875d:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108764:	80 
80108765:	8b 45 08             	mov    0x8(%ebp),%eax
80108768:	89 04 24             	mov    %eax,(%esp)
8010876b:	e8 11 ff ff ff       	call   80108681 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108770:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108777:	eb 3c                	jmp    801087b5 <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108779:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010877c:	c1 e0 02             	shl    $0x2,%eax
8010877f:	03 45 08             	add    0x8(%ebp),%eax
80108782:	8b 00                	mov    (%eax),%eax
80108784:	83 e0 01             	and    $0x1,%eax
80108787:	84 c0                	test   %al,%al
80108789:	74 26                	je     801087b1 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010878b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010878e:	c1 e0 02             	shl    $0x2,%eax
80108791:	03 45 08             	add    0x8(%ebp),%eax
80108794:	8b 00                	mov    (%eax),%eax
80108796:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010879b:	89 04 24             	mov    %eax,(%esp)
8010879e:	e8 85 f4 ff ff       	call   80107c28 <p2v>
801087a3:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801087a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087a9:	89 04 24             	mov    %eax,(%esp)
801087ac:	e8 1d a3 ff ff       	call   80102ace <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801087b1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801087b5:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801087bc:	76 bb                	jbe    80108779 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801087c4:	e8 05 a3 ff ff       	call   80102ace <kfree>
}
801087c9:	c9                   	leave  
801087ca:	c3                   	ret    
...
801087ce:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801087d1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801087d8:	00 
...
801087e6:	e8 c0 f8 ff ff       	call   801080ab <walkpgdir>
801087eb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801087ee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801087f2:	75 0c                	jne    80108800 <clearpteu+0x35>
    panic("clearpteu");
801087f4:	c7 04 24 90 90 10 80 	movl   $0x80109090,(%esp)
801087fb:	e8 3d 7d ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108800:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108803:	8b 00                	mov    (%eax),%eax
80108805:	89 c2                	mov    %eax,%edx
80108807:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108815:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108818:	e8 b8 f9 ff ff       	call   801081d5 <setupkvm>
8010881d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108820:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108824:	75 0a                	jne    80108830 <copyuvm+0x1f>
    return 0;
80108826:	b8 00 00 00 00       	mov    $0x0,%eax
8010882b:	e9 fd 00 00 00       	jmp    8010892d <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108830:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108837:	e9 cc 00 00 00       	jmp    80108908 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010883c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010883f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108846:	00 
80108847:	89 44 24 04          	mov    %eax,0x4(%esp)
8010884b:	8b 45 08             	mov    0x8(%ebp),%eax
8010884e:	89 04 24             	mov    %eax,(%esp)
80108851:	e8 55 f8 ff ff       	call   801080ab <walkpgdir>
80108856:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108859:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010885d:	75 0c                	jne    8010886b <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
8010885f:	c7 04 24 9a 90 10 80 	movl   $0x8010909a,(%esp)
80108866:	e8 d2 7c ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
8010886b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010886e:	8b 00                	mov    (%eax),%eax
80108870:	83 e0 01             	and    $0x1,%eax
80108873:	85 c0                	test   %eax,%eax
80108875:	75 0c                	jne    80108883 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108877:	c7 04 24 b4 90 10 80 	movl   $0x801090b4,(%esp)
8010887e:	e8 ba 7c ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
8010889a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010889d:	e8 c5 a2 ff ff       	call   80102b67 <kalloc>
801088a2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801088a5:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801088a9:	74 6e                	je     80108919 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801088ab:	8b 45 e8             	mov    -0x18(%ebp),%eax
801088ae:	89 04 24             	mov    %eax,(%esp)
801088b1:	e8 72 f3 ff ff       	call   80107c28 <p2v>
801088b6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088bd:	00 
801088be:	89 44 24 04          	mov    %eax,0x4(%esp)
801088c2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801088c5:	89 04 24             	mov    %eax,(%esp)
801088c8:	e8 40 cc ff ff       	call   8010550d <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801088cd:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801088d0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801088d3:	89 04 24             	mov    %eax,(%esp)
801088d6:	e8 40 f3 ff ff       	call   80107c1b <v2p>
801088db:	8b 55 f4             	mov    -0xc(%ebp),%edx
801088de:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801088e2:	89 44 24 0c          	mov    %eax,0xc(%esp)
801088e6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088ed:	00 
801088ee:	89 54 24 04          	mov    %edx,0x4(%esp)
801088f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088f5:	89 04 24             	mov    %eax,(%esp)
801088f8:	e8 44 f8 ff ff       	call   80108141 <mappages>
801088fd:	85 c0                	test   %eax,%eax
801088ff:	78 1b                	js     8010891c <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
8010890e:	0f 82 28 ff ff ff    	jb     8010883c <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108917:	eb 14                	jmp    8010892d <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108919:	90                   	nop
8010891a:	eb 01                	jmp    8010891d <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
8010891c:	90                   	nop
...
80108923:	e8 15 fe ff ff       	call   8010873d <freevm>
  return 0;
80108928:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010892d:	83 c4 44             	add    $0x44,%esp
80108930:	5b                   	pop    %ebx
80108931:	5d                   	pop    %ebp
80108932:	c3                   	ret    
...
80108936:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108939:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108940:	00 
...
8010894e:	e8 58 f7 ff ff       	call   801080ab <walkpgdir>
80108953:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108956:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108959:	8b 00                	mov    (%eax),%eax
8010895b:	83 e0 01             	and    $0x1,%eax
8010895e:	85 c0                	test   %eax,%eax
80108960:	75 07                	jne    80108969 <uva2ka+0x36>
    return 0;
80108962:	b8 00 00 00 00       	mov    $0x0,%eax
80108967:	eb 25                	jmp    8010898e <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108969:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010896c:	8b 00                	mov    (%eax),%eax
8010896e:	83 e0 04             	and    $0x4,%eax
80108971:	85 c0                	test   %eax,%eax
80108973:	75 07                	jne    8010897c <uva2ka+0x49>
    return 0;
80108975:	b8 00 00 00 00       	mov    $0x0,%eax
8010897a:	eb 12                	jmp    8010898e <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
8010897c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010897f:	8b 00                	mov    (%eax),%eax
80108981:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108986:	89 04 24             	mov    %eax,(%esp)
80108989:	e8 9a f2 ff ff       	call   80107c28 <p2v>
}
8010898e:	c9                   	leave  
8010898f:	c3                   	ret    
...
80108993:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108996:	8b 45 10             	mov    0x10(%ebp),%eax
80108999:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010899c:	e9 8b 00 00 00       	jmp    80108a2c <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801089a1:	8b 45 0c             	mov    0xc(%ebp),%eax
...
801089b9:	e8 75 ff ff ff       	call   80108933 <uva2ka>
801089be:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801089c1:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801089c5:	75 07                	jne    801089ce <copyout+0x3e>
      return -1;
801089c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801089cc:	eb 6d                	jmp    80108a3b <copyout+0xab>
    n = PGSIZE - (va - va0);
801089ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801089d1:	8b 55 ec             	mov    -0x14(%ebp),%edx
801089d4:	89 d1                	mov    %edx,%ecx
801089d6:	29 c1                	sub    %eax,%ecx
801089d8:	89 c8                	mov    %ecx,%eax
801089da:	05 00 10 00 00       	add    $0x1000,%eax
801089df:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801089e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089e5:	3b 45 14             	cmp    0x14(%ebp),%eax
801089e8:	76 06                	jbe    801089f0 <copyout+0x60>
      n = len;
801089ea:	8b 45 14             	mov    0x14(%ebp),%eax
801089ed:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801089f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089f3:	8b 55 0c             	mov    0xc(%ebp),%edx
801089f6:	89 d1                	mov    %edx,%ecx
801089f8:	29 c1                	sub    %eax,%ecx
801089fa:	89 c8                	mov    %ecx,%eax
801089fc:	03 45 e8             	add    -0x18(%ebp),%eax
801089ff:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108a02:	89 54 24 08          	mov    %edx,0x8(%esp)
80108a06:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a09:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a0d:	89 04 24             	mov    %eax,(%esp)
80108a10:	e8 f8 ca ff ff       	call   8010550d <memmove>
    len -= n;
80108a15:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a18:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108a1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a1e:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108a21:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a24:	05 00 10 00 00       	add    $0x1000,%eax
80108a29:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108a2c:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108a30:	0f 85 6b ff ff ff    	jne    801089a1 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
...
80108a3b:	c9                   	leave  
80108a3c:	c3                   	ret    
80108a3d:	00 00                	add    %al,(%eax)
	...

80108a40 <implicit_exit>:
.code32
.globl implicit_exit
...
80108a41:	6a ff                	push   $0xffffffff

	movl $2, %eax;
80108a43:	b8 02 00 00 00       	mov    $0x2,%eax
	int $64;
80108a48:	cd 40                	int    $0x40
