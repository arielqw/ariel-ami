...
8010003a:	c7 44 24 04 48 91 10 	movl   $0x80109148,0x4(%esp)
80100041:	80 
...
8010011f:	e8 e9 4f 00 00       	call   8010510d <sleep>
      goto loop;
...
80100198:	c7 04 24 4f 91 10 80 	movl   $0x8010914f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 60 91 10 80 	movl   $0x80109160,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 67 91 10 80 	movl   $0x80109167,(%esp)
...
8010029d:	e8 67 4f 00 00       	call   80105209 <wakeup>
...
801003bc:	e8 72 50 00 00       	call   80105433 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 6e 91 10 80 	movl   $0x8010916e,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 77 91 10 80 	movl   $0x80109177,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 5a 4f 00 00       	call   80105495 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 7e 91 10 80 	movl   $0x8010917e,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 8d 91 10 80 	movl   $0x8010918d,(%esp)
...
80100592:	e8 4d 4f 00 00       	call   801054e4 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 8f 91 10 80 	movl   $0x8010918f,(%esp)
...
801006b2:	e8 9e 50 00 00       	call   80105755 <memmove>
    pos -= 80;
...
801006e1:	e8 9c 4f 00 00       	call   80105682 <memset>
  }
...
80100776:	e8 96 6b 00 00       	call   80107311 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 8a 6b 00 00       	call   80107311 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 7e 6b 00 00       	call   80107311 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 71 6b 00 00       	call   80107311 <uartputc>
  cgaputc(c);
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 e0 4a 00 00       	call   801052cf <procdump>
      break;
...
801008f7:	e8 0d 49 00 00       	call   80105209 <wakeup>
        }
      }
      break;
...
8010091e:	e8 72 4b 00 00       	call   80105495 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 eb 4a 00 00       	call   80105433 <acquire>
  while(n > 0){
...
80100961:	e8 2f 4b 00 00       	call   80105495 <release>
        ilock(ip);
...
8010098a:	e8 7e 47 00 00       	call   8010510d <sleep>
...
80100a08:	e8 88 4a 00 00       	call   80105495 <release>
  ilock(ip);
...
80100a3e:	e8 f0 49 00 00       	call   80105433 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 18 4a 00 00       	call   80105495 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 93 91 10 	movl   $0x80109193,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 6b 49 00 00       	call   80105412 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 9b 91 10 	movl   $0x8010919b,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 00 1e 11 80 	movl   $0x80111e00,(%esp)
80100ab6:	e8 57 49 00 00       	call   80105412 <initlock>
...
80100b78:	0f 85 9a 03 00 00    	jne    80100f18 <exec+0x41c>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 d2 78 00 00       	call   80108455 <setupkvm>
...
80100c17:	e8 0b 7c 00 00       	call   80108827 <allocuvm>
...
80100c54:	e8 df 7a 00 00       	call   80108738 <loaduvm>
...
80100c9b:	ba ca 8c 10 80       	mov    $0x80108cca,%edx
80100ca0:	b8 c0 8c 10 80       	mov    $0x80108cc0,%eax
...
80100cda:	e8 48 7b 00 00       	call   80108827 <allocuvm>
...
80100d07:	e8 3f 7d 00 00       	call   80108a4b <clearpteu>
...
80100d22:	c7 44 24 08 c0 8c 10 	movl   $0x80108cc0,0x8(%esp)
80100d29:	80 
...
80100d37:	e8 d4 7e 00 00       	call   80108c10 <copyout>
...
80100d6e:	e8 8d 4b 00 00       	call   80105900 <strlen>
...
80100d8c:	e8 6f 4b 00 00       	call   80105900 <strlen>
...
80100db6:	e8 55 7e 00 00       	call   80108c10 <copyout>
...
80100e55:	e8 b6 7d 00 00       	call   80108c10 <copyout>
...
80100eac:	e8 01 4a 00 00       	call   801058b2 <safestrcpy>
//  cprintf("\n[debug] [%s] executing '%s' \n", TAG, last);
...
80100efe:	e8 43 76 00 00       	call   80108546 <switchuvm>
  freevm(oldpgdir);
80100f03:	8b 45 c8             	mov    -0x38(%ebp),%eax
80100f06:	89 04 24             	mov    %eax,(%esp)
80100f09:	e8 af 7a 00 00       	call   801089bd <freevm>
  return 0;
...
80100f43:	e8 75 7a 00 00       	call   801089bd <freevm>
  if(ip){
...
80100f6e:	c7 44 24 04 a1 91 10 	movl   $0x801091a1,0x4(%esp)
80100f75:	80 
80100f76:	c7 04 24 c0 1e 11 80 	movl   $0x80111ec0,(%esp)
80100f7d:	e8 90 44 00 00       	call   80105412 <initlock>
}
80100f82:	c9                   	leave  
80100f83:	c3                   	ret    
...
80100f91:	e8 9d 44 00 00       	call   80105433 <acquire>
...
80100fba:	e8 d6 44 00 00       	call   80105495 <release>
      return f;
...
80100fd8:	e8 b8 44 00 00       	call   80105495 <release>
  return 0;
...
80100ff1:	e8 3d 44 00 00       	call   80105433 <acquire>
  if(f->ref < 1)
...
80100ffe:	7f 0c                	jg     8010100c <filedup+0x28>
    panic("filedup");
80101000:	c7 04 24 a8 91 10 80 	movl   $0x801091a8,(%esp)
...
80101022:	e8 6e 44 00 00       	call   80105495 <release>
  return f;
...
80101039:	e8 f5 43 00 00       	call   80105433 <acquire>
  if(f->ref < 1)
...
80101046:	7f 0c                	jg     80101054 <fileclose+0x28>
    panic("fileclose");
80101048:	c7 04 24 b0 91 10 80 	movl   $0x801091b0,(%esp)
...
80101074:	e8 1c 44 00 00       	call   80105495 <release>
    return;
...
801010be:	e8 d2 43 00 00       	call   80105495 <release>
...
801011fd:	eb 0c                	jmp    8010120b <fileread+0xba>
  ...
  panic("fileread");
801011ff:	c7 04 24 ba 91 10 80 	movl   $0x801091ba,(%esp)
...
8010130b:	c7 04 24 c3 91 10 80 	movl   $0x801091c3,(%esp)
...
8010133e:	eb 0c                	jmp    8010134c <filewrite+0x13f>
  ...
  panic("filewrite");
80101340:	c7 04 24 d3 91 10 80 	movl   $0x801091d3,(%esp)
...
80101388:	e8 c8 43 00 00       	call   80105755 <memmove>
  brelse(bp);
...
801013ce:	e8 af 42 00 00       	call   80105682 <memset>
  log_write(bp);
...
80101530:	0f 82 e1 fe ff ff    	jb     80101417 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
80101536:	c7 04 24 dd 91 10 80 	movl   $0x801091dd,(%esp)
...
801015cd:	c7 04 24 f3 91 10 80 	movl   $0x801091f3,(%esp)
...
80101621:	c7 44 24 04 06 92 10 	movl   $0x80109206,0x4(%esp)
80101628:	80 
80101629:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101630:	e8 dd 3d 00 00       	call   80105412 <initlock>
}
80101635:	c9                   	leave  
80101636:	c3                   	ret    
...
801016b2:	e8 cb 3f 00 00       	call   80105682 <memset>
      dip->type = type;
...
80101702:	0f 82 5a ff ff ff    	jb     80101662 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101708:	c7 04 24 0d 92 10 80 	movl   $0x8010920d,(%esp)
...
801017af:	e8 a1 3f 00 00       	call   80105755 <memmove>
  log_write(bp);
...
801017d9:	e8 55 3c 00 00       	call   80105433 <acquire>
...
80101823:	e8 6d 3c 00 00       	call   80105495 <release>
      return ip;
...
80101856:	c7 04 24 1f 92 10 80 	movl   $0x8010921f,(%esp)
...
80101894:	e8 fc 3b 00 00       	call   80105495 <release>
...
801018ab:	e8 83 3b 00 00       	call   80105433 <acquire>
  ip->ref++;
...
801018c6:	e8 ca 3b 00 00       	call   80105495 <release>
  return ip;
...
801018e4:	7f 0c                	jg     801018f2 <ilock+0x22>
    panic("ilock");
801018e6:	c7 04 24 2f 92 10 80 	movl   $0x8010922f,(%esp)
801018ed:	e8 4b ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801018f2:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
801018f9:	e8 35 3b 00 00       	call   80105433 <acquire>
...
8010190e:	e8 fa 37 00 00       	call   8010510d <sleep>
...
80101938:	e8 58 3b 00 00       	call   80105495 <release>
...
801019e3:	e8 6d 3d 00 00       	call   80105755 <memmove>
    brelse(bp);
...
80101a0e:	75 0c                	jne    80101a1c <ilock+0x14c>
      panic("ilock: no type");
80101a10:	c7 04 24 35 92 10 80 	movl   $0x80109235,(%esp)
...
80101a3f:	7f 0c                	jg     80101a4d <iunlock+0x2f>
    panic("iunlock");
80101a41:	c7 04 24 44 92 10 80 	movl   $0x80109244,(%esp)
80101a48:	e8 f0 ea ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101a4d:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101a54:	e8 da 39 00 00       	call   80105433 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a70:	e8 94 37 00 00       	call   80105209 <wakeup>
  release(&icache.lock);
80101a75:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80101a7c:	e8 14 3a 00 00       	call   80105495 <release>
}
80101a81:	c9                   	leave  
80101a82:	c3                   	ret    
...
80101a90:	e8 9e 39 00 00       	call   80105433 <acquire>
...
80101acc:	74 0c                	je     80101ada <iput+0x57>
      panic("iput busy");
80101ace:	c7 04 24 4c 92 10 80 	movl   $0x8010924c,(%esp)
...
80101af2:	e8 9e 39 00 00       	call   80105495 <release>
    itrunc(ip);
...
80101b1d:	e8 11 39 00 00       	call   80105433 <acquire>
    ip->flags = 0;
...
80101b32:	e8 d2 36 00 00       	call   80105209 <wakeup>
  }
  ip->ref--;
...
80101b4d:	e8 43 39 00 00       	call   80105495 <release>
}
80101b52:	c9                   	leave  
80101b53:	c3                   	ret    
...
80101c62:	c7 04 24 56 92 10 80 	movl   $0x80109256,(%esp)
...
80101efa:	e8 56 38 00 00       	call   80105755 <memmove>
    brelse(bp);
...
80102060:	e8 f0 36 00 00       	call   80105755 <memmove>
    log_write(bp);
...
801020e2:	e8 12 37 00 00       	call   801057f9 <strncmp>
}
801020e7:	c9                   	leave  
801020e8:	c3                   	ret    
...
801020fc:	c7 04 24 69 92 10 80 	movl   $0x80109269,(%esp)
...
80102138:	74 0c                	je     80102146 <dirlookup+0x5d>
      panic("dirlink read");
8010213a:	c7 04 24 7b 92 10 80 	movl   $0x8010927b,(%esp)
...
8010221c:	74 0c                	je     8010222a <dirlink+0x79>
      panic("dirlink read");
8010221e:	c7 04 24 7b 92 10 80 	movl   $0x8010927b,(%esp)
...
80102264:	e8 e8 35 00 00       	call   80105851 <strncpy>
  de.inum = inum;
...
80102294:	74 0c                	je     801022a2 <dirlink+0xf1>
    panic("dirlink");
80102296:	c7 04 24 88 92 10 80 	movl   $0x80109288,(%esp)
...
8010231d:	e8 33 34 00 00       	call   80105755 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102338:	e8 18 34 00 00       	call   80105755 <memmove>
    name[len] = 0;
...
80102594:	c7 44 24 04 90 92 10 	movl   $0x80109290,0x4(%esp)
8010259b:	80 
8010259c:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
801025a3:	e8 6a 2e 00 00       	call   80105412 <initlock>
  picenable(IRQ_IDE);
...
8010263e:	75 0c                	jne    8010264c <idestart+0x18>
    panic("idestart");
80102640:	c7 04 24 94 92 10 80 	movl   $0x80109294,(%esp)
...
80102766:	e8 c8 2c 00 00       	call   80105433 <acquire>
  if((b = idequeue) == 0){
...
80102780:	e8 10 2d 00 00       	call   80105495 <release>
...
801027f3:	e8 11 2a 00 00       	call   80105209 <wakeup>
...
80102815:	e8 7b 2c 00 00       	call   80105495 <release>
}
8010281a:	c9                   	leave  
8010281b:	c3                   	ret    
...
8010282e:	c7 04 24 9d 92 10 80 	movl   $0x8010929d,(%esp)
...
80102847:	c7 04 24 b1 92 10 80 	movl   $0x801092b1,(%esp)
...
801028d2:	e8 36 28 00 00       	call   8010510d <sleep>
...
801028ee:	e8 a2 2b 00 00       	call   80105495 <release>
}
801028f3:	c9                   	leave  
801028f4:	c3                   	ret    
...
8010297e:	c7 04 24 e4 92 10 80 	movl   $0x801092e4,(%esp)
...
80102a3f:	c7 44 24 04 16 93 10 	movl   $0x80109316,0x4(%esp)
80102a46:	80 
80102a47:	c7 04 24 a0 38 11 80 	movl   $0x801138a0,(%esp)
80102a4e:	e8 bf 29 00 00       	call   80105412 <initlock>
  kmem.use_lock = 0;
...
80102af9:	76 0c                	jbe    80102b07 <kfree+0x39>
    panic("kfree");
80102afb:	c7 04 24 1b 93 10 80 	movl   $0x8010931b,(%esp)
...
80102b1d:	e8 60 2b 00 00       	call   80105682 <memset>
...
80102b32:	e8 fc 28 00 00       	call   80105433 <acquire>
  r = (struct run*)v;
...
80102b60:	e8 30 29 00 00       	call   80105495 <release>
}
80102b65:	c9                   	leave  
80102b66:	c3                   	ret    
...
80102b7d:	e8 b1 28 00 00       	call   80105433 <acquire>
  r = kmem.freelist;
...
80102baa:	e8 e6 28 00 00       	call   80105495 <release>
  return (char*)r;
...
80102f50:	c7 04 24 24 93 10 80 	movl   $0x80109324,(%esp)
...
801031b4:	e8 40 25 00 00       	call   801056f9 <memcmp>
...
801032b6:	c7 44 24 04 50 93 10 	movl   $0x80109350,0x4(%esp)
801032bd:	80 
801032be:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
801032c5:	e8 48 21 00 00       	call   80105412 <initlock>
  readsb(ROOTDEV, &sb);
...
80103378:	e8 d8 23 00 00       	call   80105755 <memmove>
...
801034ca:	e8 64 1f 00 00       	call   80105433 <acquire>
  while(1){
    if(log.committing){
...
801034e7:	e8 21 1c 00 00       	call   8010510d <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
8010351b:	e8 ed 1b 00 00       	call   8010510d <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
80103536:	e8 5a 1f 00 00       	call   80105495 <release>
      break;
8010353b:	90                   	nop
    }
  }
...
80103552:	e8 dc 1e 00 00       	call   80105433 <acquire>
  log.outstanding -= 1;
...
8010356d:	c7 04 24 54 93 10 80 	movl   $0x80109354,(%esp)
...
8010359c:	e8 68 1c 00 00       	call   80105209 <wakeup>
  }
  release(&log.lock);
801035a1:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
801035a8:	e8 e8 1e 00 00       	call   80105495 <release>
...
80103659:	e8 f7 20 00 00       	call   80105755 <memmove>
...
801036e4:	c7 04 24 63 93 10 80 	movl   $0x80109363,(%esp)
...
801036f9:	c7 04 24 79 93 10 80 	movl   $0x80109379,(%esp)
80103700:	e8 38 ce ff ff       	call   8010053d <panic>

  acquire(&log.lock);
80103705:	c7 04 24 e0 38 11 80 	movl   $0x801138e0,(%esp)
8010370c:	e8 22 1d 00 00       	call   80105433 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103784:	e8 0c 1d 00 00       	call   80105495 <release>
}
80103789:	c9                   	leave  
8010378a:	c3                   	ret    
	...
...
8010380c:	c7 04 24 94 93 10 80 	movl   $0x80109394,(%esp)
...
80103827:	e8 d4 39 00 00       	call   80107200 <uartinit>
  pinit();         // process table
8010382c:	e8 8e 0b 00 00       	call   801043bf <pinit>
  tvinit();        // trap vectors
80103831:	e8 f5 34 00 00       	call   80106d2b <tvinit>
  binit();         // buffer cache
...
80103853:	e8 16 34 00 00       	call   80106c6e <timerinit>
...
8010387e:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103881:	e8 a3 4c 00 00       	call   80108529 <switchkvm>
  seginit();
80103886:	e8 2a 46 00 00       	call   80107eb5 <seginit>
  lapicinit();
...
801038ab:	c7 04 24 ab 93 10 80 	movl   $0x801093ab,(%esp)
801038b2:	e8 ea ca ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801038b7:	e8 e3 35 00 00       	call   80106e9f <idtinit>
...
801038d7:	e8 d3 16 00 00       	call   80104faf <scheduler>
...
80103909:	e8 47 1e 00 00       	call   80105755 <memmove>
...
80103a97:	00 
80103a98:	c7 44 24 04 bc 93 10 	movl   $0x801093bc,0x4(%esp)
80103a9f:	80 
80103aa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103aa3:	89 04 24             	mov    %eax,(%esp)
80103aa6:	e8 4e 1c 00 00       	call   801056f9 <memcmp>
...
80103bd8:	00 
80103bd9:	c7 44 24 04 c1 93 10 	movl   $0x801093c1,0x4(%esp)
80103be0:	80 
80103be1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103be4:	89 04 24             	mov    %eax,(%esp)
80103be7:	e8 0d 1b 00 00       	call   801056f9 <memcmp>
...
80103cb2:	8b 04 85 04 94 10 80 	mov    -0x7fef6bfc(,%eax,4),%eax
...
80103ceb:	c7 04 24 c6 93 10 80 	movl   $0x801093c6,(%esp)
...
80103d7e:	c7 04 24 e4 93 10 80 	movl   $0x801093e4,(%esp)
...
80104083:	c7 44 24 04 18 94 10 	movl   $0x80109418,0x4(%esp)
8010408a:	80 
8010408b:	89 04 24             	mov    %eax,(%esp)
8010408e:	e8 7f 13 00 00       	call   80105412 <initlock>
  (*f0)->type = FD_PIPE;
...
8010413b:	e8 f3 12 00 00       	call   80105433 <acquire>
  if(writable){
...
8010415e:	e8 a6 10 00 00       	call   80105209 <wakeup>
...
8010417d:	e8 87 10 00 00       	call   80105209 <wakeup>
  }
...
801041a2:	e8 ee 12 00 00       	call   80105495 <release>
    kfree((char*)p);
...
801041ba:	e8 d6 12 00 00       	call   80105495 <release>
}
801041bf:	c9                   	leave  
801041c0:	c3                   	ret    
...
801041ce:	e8 60 12 00 00       	call   80105433 <acquire>
  for(i = 0; i < n; i++){
...
801041ff:	e8 91 12 00 00       	call   80105495 <release>
        return -1;
...
80104219:	e8 eb 0f 00 00       	call   80105209 <wakeup>
...
80104231:	e8 d7 0e 00 00       	call   8010510d <sleep>
...
80104298:	e8 6c 0f 00 00       	call   80105209 <wakeup>
  release(&p->lock);
8010429d:	8b 45 08             	mov    0x8(%ebp),%eax
801042a0:	89 04 24             	mov    %eax,(%esp)
801042a3:	e8 ed 11 00 00       	call   80105495 <release>
  return n;
...
801042be:	e8 70 11 00 00       	call   80105433 <acquire>
...
801042d8:	e8 b8 11 00 00       	call   80105495 <release>
      return -1;
...
801042fa:	e8 0e 0e 00 00       	call   8010510d <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
8010438a:	e8 7a 0e 00 00       	call   80105209 <wakeup>
  release(&p->lock);
8010438f:	8b 45 08             	mov    0x8(%ebp),%eax
80104392:	89 04 24             	mov    %eax,(%esp)
80104395:	e8 fb 10 00 00       	call   80105495 <release>
  return i;
...
801043c5:	c7 44 24 04 20 94 10 	movl   $0x80109420,0x4(%esp)
801043cc:	80 
801043cd:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801043d4:	e8 39 10 00 00       	call   80105412 <initlock>
...
801043e8:	e8 c9 4a 00 00       	call   80108eb6 <init_linkedList>
}
801043ed:	c9                   	leave  
801043ee:	c3                   	ret    
...
801043fc:	e8 32 10 00 00       	call   80105433 <acquire>
...
8010442b:	e8 65 10 00 00       	call   80105495 <release>
  return 0;
...
8010446f:	e8 21 10 00 00       	call   80105495 <release>
...
801044b9:	ba e0 6c 10 80       	mov    $0x80106ce0,%edx
...
801044e9:	e8 94 11 00 00       	call   80105682 <memset>
  p->context->eip = (uint)forkret;
801044ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f1:	8b 40 20             	mov    0x20(%eax),%eax
801044f4:	ba e1 50 10 80       	mov    $0x801050e1,%edx
...
80104517:	e8 39 3f 00 00       	call   80108455 <setupkvm>
...
8010452c:	c7 04 24 27 94 10 80 	movl   $0x80109427,(%esp)
...
80104552:	e8 56 41 00 00       	call   801086ad <inituvm>
  p->sz = PGSIZE;
...
80104579:	e8 04 11 00 00       	call   80105682 <memset>
...
801045f2:	00 
801045f3:	c7 44 24 04 40 94 10 	movl   $0x80109440,0x4(%esp)
801045fa:	80 
801045fb:	89 04 24             	mov    %eax,(%esp)
801045fe:	e8 af 12 00 00       	call   801058b2 <safestrcpy>
  p->cwd = namei("/");
80104603:	c7 04 24 49 94 10 80 	movl   $0x80109449,(%esp)
...
8010461f:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104626:	e8 08 0e 00 00       	call   80105433 <acquire>
  plist.add(&plist, p->pid, p);
8010462b:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
80104631:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104634:	8b 40 10             	mov    0x10(%eax),%eax
80104637:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010463a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010463e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104642:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80104649:	ff d1                	call   *%ecx
  release(&ptable.lock);
8010464b:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104652:	e8 3e 0e 00 00       	call   80105495 <release>
...
8010468f:	e8 93 41 00 00       	call   80108827 <allocuvm>
80104694:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104697:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010469b:	75 41                	jne    801046de <growproc+0x85>
      return -1;
8010469d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046a2:	eb 58                	jmp    801046fc <growproc+0xa3>
  } else if(n < 0){
801046a4:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801046a8:	79 34                	jns    801046de <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
801046aa:	8b 45 08             	mov    0x8(%ebp),%eax
801046ad:	89 c2                	mov    %eax,%edx
801046af:	03 55 f4             	add    -0xc(%ebp),%edx
801046b2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046b8:	8b 40 04             	mov    0x4(%eax),%eax
801046bb:	89 54 24 08          	mov    %edx,0x8(%esp)
801046bf:	8b 55 f4             	mov    -0xc(%ebp),%edx
801046c2:	89 54 24 04          	mov    %edx,0x4(%esp)
801046c6:	89 04 24             	mov    %eax,(%esp)
801046c9:	e8 33 42 00 00       	call   80108901 <deallocuvm>
801046ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
801046d1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801046d5:	75 07                	jne    801046de <growproc+0x85>
      return -1;
801046d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046dc:	eb 1e                	jmp    801046fc <growproc+0xa3>
  }
  proc->sz = sz;
...
801046f2:	e8 4f 3e 00 00       	call   80108546 <switchuvm>
  return 0;
...
//  char* TAG = "fork";
  ...
  // Allocate process.
  if((np = allocproc()) == 0)
80104707:	e8 e3 fc ff ff       	call   801043ef <allocproc>
8010470c:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010470f:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
80104713:	75 0a                	jne    8010471f <fork+0x21>
    return -1;
80104715:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010471a:	e9 9a 01 00 00       	jmp    801048b9 <fork+0x1bb>
...
80104737:	e8 55 43 00 00       	call   80108a91 <copyuvm>
8010473c:	8b 55 dc             	mov    -0x24(%ebp),%edx
...
80104755:	e8 74 e3 ff ff       	call   80102ace <kfree>
    np->kstack = 0;
...
80104773:	e9 41 01 00 00       	jmp    801048b9 <fork+0x1bb>
  }
  np->sz = proc->sz;
...
8010478f:	89 50 18             	mov    %edx,0x18(%eax)
  *np->tf = *proc->tf;
80104792:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104795:	8b 50 1c             	mov    0x1c(%eax),%edx
80104798:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010479e:	8b 40 1c             	mov    0x1c(%eax),%eax
801047a1:	89 c3                	mov    %eax,%ebx
801047a3:	b8 13 00 00 00       	mov    $0x13,%eax
801047a8:	89 d7                	mov    %edx,%edi
801047aa:	89 de                	mov    %ebx,%esi
801047ac:	89 c1                	mov    %eax,%ecx
801047ae:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801047b0:	8b 45 dc             	mov    -0x24(%ebp),%eax
801047b3:	8b 40 1c             	mov    0x1c(%eax),%eax
801047b6:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801047bd:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801047c4:	eb 3d                	jmp    80104803 <fork+0x105>
    if(proc->ofile[i])
801047c6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047cc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801047cf:	83 c2 08             	add    $0x8,%edx
801047d2:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
801047d6:	85 c0                	test   %eax,%eax
801047d8:	74 25                	je     801047ff <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
801047da:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047e0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801047e3:	83 c2 08             	add    $0x8,%edx
801047e6:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
801047ea:	89 04 24             	mov    %eax,(%esp)
801047ed:	e8 f2 c7 ff ff       	call   80100fe4 <filedup>
801047f2:	8b 55 dc             	mov    -0x24(%ebp),%edx
801047f5:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801047f8:	83 c1 08             	add    $0x8,%ecx
801047fb:	89 44 8a 0c          	mov    %eax,0xc(%edx,%ecx,4)
  *np->tf = *proc->tf;
...
80104807:	7e bd                	jle    801047c6 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104809:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010480f:	8b 40 6c             	mov    0x6c(%eax),%eax
80104812:	89 04 24             	mov    %eax,(%esp)
80104815:	e8 84 d0 ff ff       	call   8010189e <idup>
8010481a:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010481d:	89 42 6c             	mov    %eax,0x6c(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104820:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104826:	8d 50 70             	lea    0x70(%eax),%edx
80104829:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010482c:	83 c0 70             	add    $0x70,%eax
8010482f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104836:	00 
80104837:	89 54 24 04          	mov    %edx,0x4(%esp)
8010483b:	89 04 24             	mov    %eax,(%esp)
8010483e:	e8 6f 10 00 00       	call   801058b2 <safestrcpy>
 
  pid = np->pid;
80104843:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104846:	8b 40 10             	mov    0x10(%eax),%eax
80104849:	89 45 d8             	mov    %eax,-0x28(%ebp)
...
80104855:	83 f8 02             	cmp    $0x2,%eax
80104858:	75 08                	jne    80104862 <fork+0x164>
	  gid = pid;
8010485a:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010485d:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104860:	eb 0c                	jmp    8010486e <fork+0x170>
  }
  //else, take father gid
  else{
	  gid = proc->gid;
80104862:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104868:	8b 40 14             	mov    0x14(%eax),%eax
8010486b:	89 45 e0             	mov    %eax,-0x20(%ebp)
  }

  np->gid = gid;
8010486e:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
80104874:	89 50 14             	mov    %edx,0x14(%eax)
  ...
  acquire(&ptable.lock);
80104877:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
8010487e:	e8 b0 0b 00 00       	call   80105433 <acquire>
  np->state = RUNNABLE;
80104883:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104886:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  
  plist.add(&plist, pid, np); //todo ifdef
8010488d:	8b 15 b4 cc 10 80    	mov    0x8010ccb4,%edx
80104893:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104896:	89 44 24 08          	mov    %eax,0x8(%esp)
8010489a:	8b 45 d8             	mov    -0x28(%ebp),%eax
8010489d:	89 44 24 04          	mov    %eax,0x4(%esp)
801048a1:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801048a8:	ff d2                	call   *%edx
  //plist.print(&plist);
  release(&ptable.lock);
801048aa:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801048b1:	e8 df 0b 00 00       	call   80105495 <release>



  return pid;
801048b6:	8b 45 d8             	mov    -0x28(%ebp),%eax
}
801048b9:	83 c4 2c             	add    $0x2c,%esp
801048bc:	5b                   	pop    %ebx
801048bd:	5e                   	pop    %esi
801048be:	5f                   	pop    %edi
801048bf:	5d                   	pop    %ebp
...
801048ce:	a1 80 c6 10 80       	mov    0x8010c680,%eax
801048d3:	39 c2                	cmp    %eax,%edx
801048d5:	75 0c                	jne    801048e3 <exit+0x22>
    panic("init exiting");
801048d7:	c7 04 24 4b 94 10 80 	movl   $0x8010944b,(%esp)
801048de:	e8 5a bc ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801048e3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801048ea:	eb 44                	jmp    80104930 <exit+0x6f>
    if(proc->ofile[fd]){
801048ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048f2:	8b 55 f0             	mov    -0x10(%ebp),%edx
801048f5:	83 c2 08             	add    $0x8,%edx
801048f8:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
801048fc:	85 c0                	test   %eax,%eax
801048fe:	74 2c                	je     8010492c <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104900:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104906:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104909:	83 c2 08             	add    $0x8,%edx
8010490c:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80104910:	89 04 24             	mov    %eax,(%esp)
80104913:	e8 14 c7 ff ff       	call   8010102c <fileclose>
      proc->ofile[fd] = 0;
80104918:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010491e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104921:	83 c2 08             	add    $0x8,%edx
80104924:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
8010492b:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010492c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104930:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104934:	7e b6                	jle    801048ec <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104936:	e8 82 eb ff ff       	call   801034bd <begin_op>
  iput(proc->cwd);
8010493b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104941:	8b 40 6c             	mov    0x6c(%eax),%eax
80104944:	89 04 24             	mov    %eax,(%esp)
80104947:	e8 37 d1 ff ff       	call   80101a83 <iput>
  end_op();
8010494c:	e8 ed eb ff ff       	call   8010353e <end_op>
  proc->cwd = 0;
80104951:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104957:	c7 40 6c 00 00 00 00 	movl   $0x0,0x6c(%eax)


  acquire(&ptable.lock);
8010495e:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104965:	e8 c9 0a 00 00       	call   80105433 <acquire>

  proc->status = status;
8010496a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104970:	8b 55 08             	mov    0x8(%ebp),%edx
80104973:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  proc->ttime = ticks;
80104979:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010497f:	8b 15 60 6f 11 80    	mov    0x80116f60,%edx
80104985:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
8010498b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104991:	8b 40 18             	mov    0x18(%eax),%eax
80104994:	89 04 24             	mov    %eax,(%esp)
80104997:	e8 0c 08 00 00       	call   801051a8 <wakeup1>
//  cprintf("\n This is your captin speaking, here is : %s \n", ptable.proc[SHELL_PID].name);


  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010499c:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
801049a3:	eb 3b                	jmp    801049e0 <exit+0x11f>
    if(p->parent == proc){
801049a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a8:	8b 50 18             	mov    0x18(%eax),%edx
801049ab:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049b1:	39 c2                	cmp    %eax,%edx
801049b3:	75 24                	jne    801049d9 <exit+0x118>
      p->parent = initproc;
801049b5:	8b 15 80 c6 10 80    	mov    0x8010c680,%edx
801049bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049be:	89 50 18             	mov    %edx,0x18(%eax)
      if(p->state == ZOMBIE)
801049c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049c4:	8b 40 0c             	mov    0xc(%eax),%eax
801049c7:	83 f8 05             	cmp    $0x5,%eax
801049ca:	75 0d                	jne    801049d9 <exit+0x118>
        wakeup1(initproc);
801049cc:	a1 80 c6 10 80       	mov    0x8010c680,%eax
801049d1:	89 04 24             	mov    %eax,(%esp)
801049d4:	e8 cf 07 00 00       	call   801051a8 <wakeup1>
  wakeup1(proc->parent);
//  cprintf("\n This is your captin speaking, here is : %s \n", ptable.proc[SHELL_PID].name);
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049d9:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
801049e0:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
801049e7:	72 bc                	jb     801049a5 <exit+0xe4>
        wakeup1(initproc);
    }
  }
...
801049ef:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
801049f6:	e8 cd 05 00 00       	call   80104fc8 <sched>
  panic("zombie exit");
801049fb:	c7 04 24 58 94 10 80 	movl   $0x80109458,(%esp)
80104a02:	e8 36 bb ff ff       	call   8010053d <panic>

80104a07 <clean_proc_entry>:
...
80104a19:	8b 40 08             	mov    0x8(%eax),%eax
80104a1c:	89 04 24             	mov    %eax,(%esp)
80104a1f:	e8 aa e0 ff ff       	call   80102ace <kfree>
    p->kstack = 0;
...
80104a37:	e8 81 3f 00 00       	call   801089bd <freevm>
    p->state = UNUSED;
80104a3c:	8b 45 08             	mov    0x8(%ebp),%eax
80104a3f:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    p->pid = 0;
80104a46:	8b 45 08             	mov    0x8(%ebp),%eax
80104a49:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
    p->parent = 0;
80104a50:	8b 45 08             	mov    0x8(%ebp),%eax
80104a53:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)
    p->name[0] = 0;
80104a5a:	8b 45 08             	mov    0x8(%ebp),%eax
80104a5d:	c6 40 70 00          	movb   $0x0,0x70(%eax)
    p->killed = 0;
80104a61:	8b 45 08             	mov    0x8(%ebp),%eax
80104a64:	c7 40 28 00 00 00 00 	movl   $0x0,0x28(%eax)
    p->retime = 0;
80104a6b:	8b 45 08             	mov    0x8(%ebp),%eax
80104a6e:	c7 80 90 00 00 00 00 	movl   $0x0,0x90(%eax)
80104a75:	00 00 00 
    p->rutime = 0;
80104a78:	8b 45 08             	mov    0x8(%ebp),%eax
80104a7b:	c7 80 94 00 00 00 00 	movl   $0x0,0x94(%eax)
80104a82:	00 00 00 
    p->stime = 0;
80104a85:	8b 45 08             	mov    0x8(%ebp),%eax
80104a88:	c7 80 8c 00 00 00 00 	movl   $0x0,0x8c(%eax)
80104a8f:	00 00 00 
    p->ttime = 0;
80104a92:	8b 45 08             	mov    0x8(%ebp),%eax
80104a95:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
80104a9c:	00 00 00 
    p->ctime = 0;
80104a9f:	8b 45 08             	mov    0x8(%ebp),%eax
80104aa2:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
80104aa9:	00 00 00 
...
80104ab4:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104ab7:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104abe:	e8 70 09 00 00       	call   80105433 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104ac3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104aca:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104ad1:	eb 5d                	jmp    80104b30 <wait+0x7f>
      if(p->parent != proc)
80104ad3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ad6:	8b 50 18             	mov    0x18(%eax),%edx
80104ad9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104adf:	39 c2                	cmp    %eax,%edx
80104ae1:	75 45                	jne    80104b28 <wait+0x77>
        continue;
      havekids = 1;
...
80104af3:	75 34                	jne    80104b29 <wait+0x78>
        // Found one.
        pid = clean_proc_entry(p);
80104af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af8:	89 04 24             	mov    %eax,(%esp)
80104afb:	e8 07 ff ff ff       	call   80104a07 <clean_proc_entry>
80104b00:	89 45 ec             	mov    %eax,-0x14(%ebp)

        if(status){ // if user did not send status=0 (do not care)
80104b03:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104b07:	74 0e                	je     80104b17 <wait+0x66>
            *status = p->status; //return status to caller
80104b09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b0c:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104b12:	8b 45 08             	mov    0x8(%ebp),%eax
80104b15:	89 10                	mov    %edx,(%eax)
        }

        release(&ptable.lock);
80104b17:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104b1e:	e8 72 09 00 00       	call   80105495 <release>

        return pid;
80104b23:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b26:	eb 52                	jmp    80104b7a <wait+0xc9>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b28:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b29:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
80104b30:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80104b37:	72 9a                	jb     80104ad3 <wait+0x22>
        return pid;
      }
    }
...
80104b39:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104b3d:	74 0d                	je     80104b4c <wait+0x9b>
80104b3f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b45:	8b 40 28             	mov    0x28(%eax),%eax
80104b48:	85 c0                	test   %eax,%eax
80104b4a:	74 13                	je     80104b5f <wait+0xae>
      release(&ptable.lock);
80104b4c:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104b53:	e8 3d 09 00 00       	call   80105495 <release>
      return -1;
80104b58:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b5d:	eb 1b                	jmp    80104b7a <wait+0xc9>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104b5f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b65:	c7 44 24 04 e0 3f 11 	movl   $0x80113fe0,0x4(%esp)
80104b6c:	80 
80104b6d:	89 04 24             	mov    %eax,(%esp)
80104b70:	e8 98 05 00 00       	call   8010510d <sleep>
  }
80104b75:	e9 49 ff ff ff       	jmp    80104ac3 <wait+0x12>
}
80104b7a:	c9                   	leave  
80104b7b:	c3                   	ret    
...
80104b7f:	83 ec 28             	sub    $0x28,%esp
  for(;;){
   ...
   // isMyChild = 0;
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b82:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104b89:	eb 4d                	jmp    80104bd8 <shellWait+0x5c>
      if(p->parent != proc)
80104b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b8e:	8b 50 18             	mov    0x18(%eax),%edx
80104b91:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b97:	39 c2                	cmp    %eax,%edx
80104b99:	75 35                	jne    80104bd0 <shellWait+0x54>
        continue;
    //  havekids = 1;
      if( p->pid == childPid ){
80104b9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b9e:	8b 40 10             	mov    0x10(%eax),%eax
80104ba1:	3b 45 08             	cmp    0x8(%ebp),%eax
80104ba4:	75 2b                	jne    80104bd1 <shellWait+0x55>
    	 //isMyChild = 1;
		 if(p->state == ZOMBIE ){
80104ba6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ba9:	8b 40 0c             	mov    0xc(%eax),%eax
80104bac:	83 f8 05             	cmp    $0x5,%eax
80104baf:	75 20                	jne    80104bd1 <shellWait+0x55>
			pid = clean_proc_entry(p);
80104bb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bb4:	89 04 24             	mov    %eax,(%esp)
80104bb7:	e8 4b fe ff ff       	call   80104a07 <clean_proc_entry>
80104bbc:	89 45 f0             	mov    %eax,-0x10(%ebp)
			release(&ptable.lock);
80104bbf:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104bc6:	e8 ca 08 00 00       	call   80105495 <release>
...
80104bd0:	90                   	nop
  for(;;){
   ...
   // isMyChild = 0;
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bd1:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
80104bd8:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80104bdf:	72 aa                	jb     80104b8b <shellWait+0xf>
			return pid;
		  }
      }
...
80104be7:	c7 44 24 04 e0 3f 11 	movl   $0x80113fe0,0x4(%esp)
80104bee:	80 
80104bef:	89 04 24             	mov    %eax,(%esp)
80104bf2:	e8 16 05 00 00       	call   8010510d <sleep>
  }
80104bf7:	eb 89                	jmp    80104b82 <shellWait+0x6>
...
80104bfc:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid, isMyChild;

  acquire(&ptable.lock);
80104bff:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104c06:	e8 28 08 00 00       	call   80105433 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104c0b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    isMyChild = 0;
80104c12:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c19:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104c20:	eb 72                	jmp    80104c94 <waitpid+0x9b>
      if(p->parent != proc)
80104c22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c25:	8b 50 18             	mov    0x18(%eax),%edx
80104c28:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104c2e:	39 c2                	cmp    %eax,%edx
80104c30:	75 5a                	jne    80104c8c <waitpid+0x93>
        continue;
      havekids = 1;
80104c32:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if( p->pid == childPid ){
80104c39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c3c:	8b 40 10             	mov    0x10(%eax),%eax
80104c3f:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c42:	75 49                	jne    80104c8d <waitpid+0x94>
    	 isMyChild = 1;
80104c44:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
		 if(p->state == ZOMBIE ){
80104c4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c4e:	8b 40 0c             	mov    0xc(%eax),%eax
80104c51:	83 f8 05             	cmp    $0x5,%eax
80104c54:	75 37                	jne    80104c8d <waitpid+0x94>
			pid = clean_proc_entry(p);
80104c56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c59:	89 04 24             	mov    %eax,(%esp)
80104c5c:	e8 a6 fd ff ff       	call   80104a07 <clean_proc_entry>
80104c61:	89 45 e8             	mov    %eax,-0x18(%ebp)

			if(status){ // if user did not send status=0 (do not care)
80104c64:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104c68:	74 0e                	je     80104c78 <waitpid+0x7f>
				*status = p->status; //return status to caller
80104c6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c6d:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104c73:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c76:	89 10                	mov    %edx,(%eax)
			}

			release(&ptable.lock);
80104c78:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104c7f:	e8 11 08 00 00       	call   80105495 <release>

			return pid;
80104c84:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104c87:	e9 8b 00 00 00       	jmp    80104d17 <waitpid+0x11e>
    havekids = 0;
    isMyChild = 0;
...
80104c8c:	90                   	nop
  for(;;){
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c8d:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
80104c94:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80104c9b:	72 85                	jb     80104c22 <waitpid+0x29>
      }
...
80104c9d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104ca1:	74 13                	je     80104cb6 <waitpid+0xbd>
80104ca3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104ca7:	74 0d                	je     80104cb6 <waitpid+0xbd>
80104ca9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104caf:	8b 40 28             	mov    0x28(%eax),%eax
80104cb2:	85 c0                	test   %eax,%eax
80104cb4:	74 13                	je     80104cc9 <waitpid+0xd0>
      release(&ptable.lock);
80104cb6:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104cbd:	e8 d3 07 00 00       	call   80105495 <release>
      return -1;
80104cc2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cc7:	eb 4e                	jmp    80104d17 <waitpid+0x11e>
    }

    switch (options) {
80104cc9:	8b 45 10             	mov    0x10(%ebp),%eax
80104ccc:	85 c0                	test   %eax,%eax
80104cce:	74 07                	je     80104cd7 <waitpid+0xde>
80104cd0:	83 f8 01             	cmp    $0x1,%eax
80104cd3:	74 1e                	je     80104cf3 <waitpid+0xfa>
80104cd5:	eb 2f                	jmp    80104d06 <waitpid+0x10d>
		case BLOCKING:
			sleep(proc, &ptable.lock);
80104cd7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cdd:	c7 44 24 04 e0 3f 11 	movl   $0x80113fe0,0x4(%esp)
80104ce4:	80 
80104ce5:	89 04 24             	mov    %eax,(%esp)
80104ce8:	e8 20 04 00 00       	call   8010510d <sleep>
			break;
80104ced:	90                   	nop
			release(&ptable.lock);
			return -1;
...
80104cee:	e9 18 ff ff ff       	jmp    80104c0b <waitpid+0x12>
    switch (options) {
		case BLOCKING:
			sleep(proc, &ptable.lock);
			break;
		case NONBLOCKING:
			release(&ptable.lock);
80104cf3:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104cfa:	e8 96 07 00 00       	call   80105495 <release>
			return -1;
80104cff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d04:	eb 11                	jmp    80104d17 <waitpid+0x11e>
			break;
		default:
			release(&ptable.lock);
80104d06:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104d0d:	e8 83 07 00 00       	call   80105495 <release>
			return -1;
...
80104d63:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct proc* p;
	int pids[64];
	int counter = 0;
80104d69:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
//	int i, status;
	int i;
	int retVal = -1;
80104d70:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)

	//cprintf("called fg with gid: %d \n", gid);
	acquire(&ptable.lock);
80104d77:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104d7e:	e8 b0 06 00 00       	call   80105433 <acquire>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d83:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
80104d8a:	eb 60                	jmp    80104dec <foreground+0x8c>
			if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104d8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d8f:	8b 40 0c             	mov    0xc(%eax),%eax
80104d92:	83 f8 04             	cmp    $0x4,%eax
80104d95:	74 16                	je     80104dad <foreground+0x4d>
80104d97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d9a:	8b 40 0c             	mov    0xc(%eax),%eax
80104d9d:	83 f8 03             	cmp    $0x3,%eax
80104da0:	74 0b                	je     80104dad <foreground+0x4d>
80104da2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da5:	8b 40 0c             	mov    0xc(%eax),%eax
80104da8:	83 f8 02             	cmp    $0x2,%eax
80104dab:	75 38                	jne    80104de5 <foreground+0x85>
				(p->parent == initproc) &&
80104dad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104db0:	8b 50 18             	mov    0x18(%eax),%edx
80104db3:	a1 80 c6 10 80       	mov    0x8010c680,%eax
	int retVal = -1;
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
			if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104db8:	39 c2                	cmp    %eax,%edx
80104dba:	75 29                	jne    80104de5 <foreground+0x85>
				(p->parent == initproc) &&
				(p->gid == gid) )
80104dbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dbf:	8b 40 14             	mov    0x14(%eax),%eax
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
			if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
				(p->parent == initproc) &&
80104dc2:	3b 45 08             	cmp    0x8(%ebp),%eax
80104dc5:	75 1e                	jne    80104de5 <foreground+0x85>
				(p->gid == gid) )
			{
				p->parent = &ptable.proc[1]; //parent = shell
80104dc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dca:	c7 40 18 b0 40 11 80 	movl   $0x801140b0,0x18(%eax)
				pids[counter] = p->pid;
80104dd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dd4:	8b 50 10             	mov    0x10(%eax),%edx
80104dd7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dda:	89 94 85 e8 fe ff ff 	mov    %edx,-0x118(%ebp,%eax,4)
				counter++;
80104de1:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
	int i;
	int retVal = -1;
	...
	acquire(&ptable.lock);
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104de5:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
80104dec:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80104df3:	72 97                	jb     80104d8c <foreground+0x2c>
				p->parent = &ptable.proc[1]; //parent = shell
				pids[counter] = p->pid;
				counter++;
			}
	...
	for(i=0; i < counter; i++){
80104df5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80104dfc:	eb 22                	jmp    80104e20 <foreground+0xc0>
		//cprintf("**waiting for: %d \n ",pids[i]);
		if (shellWait(pids[i]) != -1)	retVal = 1;
80104dfe:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e01:	8b 84 85 e8 fe ff ff 	mov    -0x118(%ebp,%eax,4),%eax
80104e08:	89 04 24             	mov    %eax,(%esp)
80104e0b:	e8 6c fd ff ff       	call   80104b7c <shellWait>
80104e10:	83 f8 ff             	cmp    $0xffffffff,%eax
80104e13:	74 07                	je     80104e1c <foreground+0xbc>
80104e15:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%ebp)
				p->parent = &ptable.proc[1]; //parent = shell
				pids[counter] = p->pid;
				counter++;
			}
	...
	for(i=0; i < counter; i++){
80104e1c:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
80104e20:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104e23:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80104e26:	7c d6                	jl     80104dfe <foreground+0x9e>
		//cprintf("**waiting for: %d \n ",pids[i]);
		if (shellWait(pids[i]) != -1)	retVal = 1;
	}
	release(&ptable.lock);
80104e28:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104e2f:	e8 61 06 00 00       	call   80105495 <release>
		cprintf("**waiting for: %d \n ",pids[i]);
	...
	*/
	...
	return retVal;
80104e34:	8b 45 e8             	mov    -0x18(%ebp),%eax
}
80104e37:	c9                   	leave  
80104e38:	c3                   	ret    

80104e39 <set_priority>:
...
80104e46:	83 ec 28             	sub    $0x28,%esp
	struct proc* p;
	int i = 0;
80104e49:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
//	  head->id = 18;
//	  head->data = 0;
//
//	  add_last(&plist,head);
...
80104e57:	e8 d7 05 00 00       	call   80105433 <acquire>
//		j++;
//	}
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
		if( ( p->state == RUNNING ||  p->state == RUNNABLE ||  p->state == SLEEPING) &&
80104e8c:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e8f:	75 49                	jne    80104eda <list_pgroup+0x97>
			p->gid == gid ){

			arr[i].pid = p->pid;
80104e91:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e94:	89 d0                	mov    %edx,%eax
80104e96:	c1 e0 02             	shl    $0x2,%eax
80104e99:	01 d0                	add    %edx,%eax
80104e9b:	c1 e0 02             	shl    $0x2,%eax
80104e9e:	03 45 0c             	add    0xc(%ebp),%eax
80104ea1:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ea4:	8b 52 10             	mov    0x10(%edx),%edx
80104ea7:	89 10                	mov    %edx,(%eax)
			safestrcpy(arr[i].name, p->name, sizeof(arr[i].name));
80104ea9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eac:	8d 48 70             	lea    0x70(%eax),%ecx
80104eaf:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104eb2:	89 d0                	mov    %edx,%eax
80104eb4:	c1 e0 02             	shl    $0x2,%eax
80104eb7:	01 d0                	add    %edx,%eax
80104eb9:	c1 e0 02             	shl    $0x2,%eax
80104ebc:	03 45 0c             	add    0xc(%ebp),%eax
80104ebf:	83 c0 04             	add    $0x4,%eax
80104ec2:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104ec9:	00 
80104eca:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104ece:	89 04 24             	mov    %eax,(%esp)
80104ed1:	e8 dc 09 00 00       	call   801058b2 <safestrcpy>
			i++;
80104ed6:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
//		j++;
//	}
...
//	cprintf("requested listing of processes with group id %d \n", gid);
	...
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104eda:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
80104ee1:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80104ee8:	0f 82 77 ff ff ff    	jb     80104e65 <list_pgroup+0x22>
		}
	}
...
80104ef1:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104ef4:	89 10                	mov    %edx,(%eax)
	release(&ptable.lock);
80104ef6:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104efd:	e8 93 05 00 00       	call   80105495 <release>
...
80104f0c:	83 ec 28             	sub    $0x28,%esp
	  struct proc *p;

	  for(;;){
	    // Enable interrupts on this processor.
	    sti();
80104f0f:	e8 a5 f4 ff ff       	call   801043b9 <sti>

	    acquire(&ptable.lock);
80104f14:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
...
80104f2e:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80104f35:	ff d0                	call   *%eax
...
80104f54:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
			  switchuvm(p);
80104f5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f5d:	89 04 24             	mov    %eax,(%esp)
80104f60:	e8 e1 35 00 00       	call   80108546 <switchuvm>
			  p->state = RUNNING;
80104f65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f68:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
...
80104f7f:	83 c2 04             	add    $0x4,%edx
80104f82:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f86:	89 14 24             	mov    %edx,(%esp)
80104f89:	e8 9a 09 00 00       	call   80105928 <swtch>
			  switchkvm();
80104f8e:	e8 96 35 00 00       	call   80108529 <switchkvm>

			  // Process is done running for now.
			  // It should have changed its p->state before coming back.
			  proc = 0;
80104f93:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104f9a:	00 00 00 00 
	    }
	    release(&ptable.lock);
80104f9e:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
...
80104fc6:	eb fe                	jmp    80104fc6 <scheduler+0x17>
...
80104fcb:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104fce:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80104fd5:	e8 77 05 00 00       	call   80105551 <holding>
...
80105026:	25 00 02 00 00       	and    $0x200,%eax
...
80105041:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105047:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
8010504a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105050:	8b 40 04             	mov    0x4(%eax),%eax
80105053:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010505a:	83 c2 20             	add    $0x20,%edx
8010505d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105061:	89 14 24             	mov    %edx,(%esp)
80105064:	e8 bf 08 00 00       	call   80105928 <swtch>
  cpu->intena = intena;
80105069:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010506f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105072:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105078:	c9                   	leave  
80105079:	c3                   	ret    
...
8010507d:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
80105080:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105087:	e8 a7 03 00 00       	call   80105433 <acquire>
...
80105095:	83 f8 03             	cmp    $0x3,%eax
80105098:	74 27                	je     801050c1 <yield+0x47>
8010509a:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
801050a0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801050a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050ad:	8b 40 10             	mov    0x10(%eax),%eax
801050b0:	89 54 24 08          	mov    %edx,0x8(%esp)
801050b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801050b8:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801050bf:	ff d1                	call   *%ecx
  proc->state = RUNNABLE;
801050c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050c7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)

  sched();
801050ce:	e8 f5 fe ff ff       	call   80104fc8 <sched>
  release(&ptable.lock);
801050d3:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801050da:	e8 b6 03 00 00       	call   80105495 <release>
}
801050df:	c9                   	leave  
801050e0:	c3                   	ret    
...
801050e4:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801050e7:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801050ee:	e8 a2 03 00 00       	call   80105495 <release>

  if (first) {
801050f3:	a1 20 c0 10 80       	mov    0x8010c020,%eax
801050f8:	85 c0                	test   %eax,%eax
801050fa:	74 0f                	je     8010510b <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801050fc:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80105103:	00 00 00 
    initlog();
80105106:	e8 a5 e1 ff ff       	call   801032b0 <initlog>
  }
...
8010513b:	81 7d 0c e0 3f 11 80 	cmpl   $0x80113fe0,0xc(%ebp)
80105142:	74 17                	je     8010515b <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105144:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
8010514b:	e8 e3 02 00 00       	call   80105433 <acquire>
    release(lk);
80105150:	8b 45 0c             	mov    0xc(%ebp),%eax
80105153:	89 04 24             	mov    %eax,(%esp)
80105156:	e8 3a 03 00 00       	call   80105495 <release>
  }

  // Go to sleep.
  proc->chan = chan;
8010515b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105161:	8b 55 08             	mov    0x8(%ebp),%edx
80105164:	89 50 24             	mov    %edx,0x24(%eax)
  proc->state = SLEEPING;
80105167:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010516d:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80105174:	e8 4f fe ff ff       	call   80104fc8 <sched>

  // Tidy up.
  proc->chan = 0;
80105179:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010517f:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80105186:	81 7d 0c e0 3f 11 80 	cmpl   $0x80113fe0,0xc(%ebp)
8010518d:	74 17                	je     801051a6 <sleep+0x99>
    release(&ptable.lock);
8010518f:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105196:	e8 fa 02 00 00       	call   80105495 <release>
    acquire(lk);
8010519b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010519e:	89 04 24             	mov    %eax,(%esp)
801051a1:	e8 8d 02 00 00       	call   80105433 <acquire>
  }
}
801051a6:	c9                   	leave  
801051a7:	c3                   	ret    
...
801051ab:	83 ec 28             	sub    $0x28,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801051ae:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
801051b5:	eb 47                	jmp    801051fe <wakeup1+0x56>
    if(p->state == SLEEPING && p->chan == chan){
801051b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051ba:	8b 40 0c             	mov    0xc(%eax),%eax
801051bd:	83 f8 02             	cmp    $0x2,%eax
801051c0:	75 35                	jne    801051f7 <wakeup1+0x4f>
801051c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051c5:	8b 40 24             	mov    0x24(%eax),%eax
801051c8:	3b 45 08             	cmp    0x8(%ebp),%eax
801051cb:	75 2a                	jne    801051f7 <wakeup1+0x4f>
        p->state = RUNNABLE;
801051cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051d0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
        plist.add(&plist,p->pid, p); //todo ifdef
801051d7:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
801051dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051e0:	8b 40 10             	mov    0x10(%eax),%eax
801051e3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801051e6:	89 54 24 08          	mov    %edx,0x8(%esp)
801051ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801051ee:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801051f5:	ff d1                	call   *%ecx
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801051f7:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
801051fe:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
80105205:	72 b0                	jb     801051b7 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan){
        p->state = RUNNABLE;
        plist.add(&plist,p->pid, p); //todo ifdef
    }
...
8010520c:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
8010520f:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105216:	e8 18 02 00 00       	call   80105433 <acquire>
  wakeup1(chan);
8010521b:	8b 45 08             	mov    0x8(%ebp),%eax
8010521e:	89 04 24             	mov    %eax,(%esp)
80105221:	e8 82 ff ff ff       	call   801051a8 <wakeup1>
  release(&ptable.lock);
80105226:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
8010522d:	e8 63 02 00 00       	call   80105495 <release>
}
80105232:	c9                   	leave  
80105233:	c3                   	ret    
...
80105237:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
8010523a:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
80105241:	e8 ed 01 00 00       	call   80105433 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105246:	c7 45 f4 14 40 11 80 	movl   $0x80114014,-0xc(%ebp)
8010524d:	eb 64                	jmp    801052b3 <kill+0x7f>
    if(p->pid == pid){
8010524f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105252:	8b 40 10             	mov    0x10(%eax),%eax
80105255:	3b 45 08             	cmp    0x8(%ebp),%eax
80105258:	75 52                	jne    801052ac <kill+0x78>
      p->killed = 1;
8010525a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010525d:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING){
80105264:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105267:	8b 40 0c             	mov    0xc(%eax),%eax
8010526a:	83 f8 02             	cmp    $0x2,%eax
8010526d:	75 2a                	jne    80105299 <kill+0x65>
        p->state = RUNNABLE;
8010526f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105272:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
        plist.add(&plist,p->pid,p); //todo ifdef
80105279:	8b 0d b4 cc 10 80    	mov    0x8010ccb4,%ecx
...
80105290:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80105297:	ff d1                	call   *%ecx
      }
      release(&ptable.lock);
80105299:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801052a0:	e8 f0 01 00 00       	call   80105495 <release>
      return 0;
801052a5:	b8 00 00 00 00       	mov    $0x0,%eax
801052aa:	eb 21                	jmp    801052cd <kill+0x99>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801052ac:	81 45 f4 9c 00 00 00 	addl   $0x9c,-0xc(%ebp)
801052b3:	81 7d f4 14 67 11 80 	cmpl   $0x80116714,-0xc(%ebp)
801052ba:	72 93                	jb     8010524f <kill+0x1b>
      }
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801052bc:	c7 04 24 e0 3f 11 80 	movl   $0x80113fe0,(%esp)
801052c3:	e8 cd 01 00 00       	call   80105495 <release>
  return -1;
...
801052d2:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801052d5:	c7 45 f0 14 40 11 80 	movl   $0x80114014,-0x10(%ebp)
801052dc:	e9 db 00 00 00       	jmp    801053bc <procdump+0xed>
    if(p->state == UNUSED)
801052e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052e4:	8b 40 0c             	mov    0xc(%eax),%eax
801052e7:	85 c0                	test   %eax,%eax
801052e9:	0f 84 c5 00 00 00    	je     801053b4 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801052ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052f2:	8b 40 0c             	mov    0xc(%eax),%eax
801052f5:	83 f8 05             	cmp    $0x5,%eax
801052f8:	77 23                	ja     8010531d <procdump+0x4e>
801052fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052fd:	8b 40 0c             	mov    0xc(%eax),%eax
80105300:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105307:	85 c0                	test   %eax,%eax
80105309:	74 12                	je     8010531d <procdump+0x4e>
      state = states[p->state];
8010530b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010530e:	8b 40 0c             	mov    0xc(%eax),%eax
80105311:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105318:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
80105330:	89 54 24 0c          	mov    %edx,0xc(%esp)
...
80105351:	83 f8 02             	cmp    $0x2,%eax
80105354:	75 50                	jne    801053a6 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105356:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105359:	8b 40 20             	mov    0x20(%eax),%eax
8010535c:	8b 40 0c             	mov    0xc(%eax),%eax
8010535f:	83 c0 08             	add    $0x8,%eax
80105362:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80105365:	89 54 24 04          	mov    %edx,0x4(%esp)
80105369:	89 04 24             	mov    %eax,(%esp)
8010536c:	e8 73 01 00 00       	call   801054e4 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105371:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105378:	eb 1b                	jmp    80105395 <procdump+0xc6>
        cprintf(" %p", pc[i]);
...
8010538c:	e8 10 b0 ff ff       	call   801003a1 <cprintf>
    ...
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80105391:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105395:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105399:	7f 0b                	jg     801053a6 <procdump+0xd7>
8010539b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010539e:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
801053a2:	85 c0                	test   %eax,%eax
801053a4:	75 d4                	jne    8010537a <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
801053b4:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801053b5:	81 45 f0 9c 00 00 00 	addl   $0x9c,-0x10(%ebp)
801053bc:	81 7d f0 14 67 11 80 	cmpl   $0x80116714,-0x10(%ebp)
801053c3:	0f 82 18 ff ff ff    	jb     801052e1 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
801053d3:	9c                   	pushf  
801053d4:	5b                   	pop    %ebx
801053d5:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
801053f7:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
801053fa:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80105401:	f0 87 02             	lock xchg %eax,(%edx)
80105404:	89 c3                	mov    %eax,%ebx
...
80105439:	e8 3d 01 00 00       	call   8010557b <pushcli>
  if(holding(lk))
8010543e:	8b 45 08             	mov    0x8(%ebp),%eax
80105441:	89 04 24             	mov    %eax,(%esp)
80105444:	e8 08 01 00 00       	call   80105551 <holding>
...
80105468:	e8 80 ff ff ff       	call   801053ed <xchg>
...
801054a1:	e8 ab 00 00 00       	call   80105551 <holding>
...
801054d8:	e8 10 ff ff ff       	call   801053ed <xchg>

  popcli();
801054dd:	e8 e1 00 00 00       	call   801055c3 <popcli>
}
801054e2:	c9                   	leave  
801054e3:	c3                   	ret    
...
801054fa:	eb 32                	jmp    8010552e <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801054fc:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105500:	74 47                	je     80105549 <getcallerpcs+0x65>
80105502:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105509:	76 3e                	jbe    80105549 <getcallerpcs+0x65>
8010550b:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010550f:	74 38                	je     80105549 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105511:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105514:	c1 e0 02             	shl    $0x2,%eax
80105517:	03 45 0c             	add    0xc(%ebp),%eax
8010551a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010551d:	8b 52 04             	mov    0x4(%edx),%edx
...
80105527:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
8010552a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010552e:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105532:	7e c8                	jle    801054fc <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105534:	eb 13                	jmp    80105549 <getcallerpcs+0x65>
    pcs[i] = 0;
80105536:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105539:	c1 e0 02             	shl    $0x2,%eax
8010553c:	03 45 0c             	add    0xc(%ebp),%eax
8010553f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80105549:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010554d:	7e e7                	jle    80105536 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010554f:	c9                   	leave  
80105550:	c3                   	ret    
...
8010555b:	74 17                	je     80105574 <holding+0x23>
8010555d:	8b 45 08             	mov    0x8(%ebp),%eax
80105560:	8b 50 08             	mov    0x8(%eax),%edx
80105563:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105569:	39 c2                	cmp    %eax,%edx
8010556b:	75 07                	jne    80105574 <holding+0x23>
8010556d:	b8 01 00 00 00       	mov    $0x1,%eax
80105572:	eb 05                	jmp    80105579 <holding+0x28>
...
8010557e:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105581:	e8 46 fe ff ff       	call   801053cc <readeflags>
80105586:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105589:	e8 53 fe ff ff       	call   801053e1 <cli>
  if(cpu->ncli++ == 0)
8010558e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105594:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010559a:	85 d2                	test   %edx,%edx
8010559c:	0f 94 c1             	sete   %cl
8010559f:	83 c2 01             	add    $0x1,%edx
801055a2:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801055a8:	84 c9                	test   %cl,%cl
801055aa:	74 15                	je     801055c1 <pushcli+0x46>
...
801055c6:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801055c9:	e8 fe fd ff ff       	call   801053cc <readeflags>
801055ce:	25 00 02 00 00       	and    $0x200,%eax
...
801055e9:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801055ef:	83 ea 01             	sub    $0x1,%edx
801055f2:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801055f8:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
...
80105614:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010561a:	85 c0                	test   %eax,%eax
8010561c:	75 15                	jne    80105633 <popcli+0x70>
8010561e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105624:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010562a:	85 c0                	test   %eax,%eax
8010562c:	74 05                	je     80105633 <popcli+0x70>
    sti();
8010562e:	e8 b4 fd ff ff       	call   801053e7 <sti>
}
80105633:	c9                   	leave  
80105634:	c3                   	ret    
80105635:	00 00                	add    %al,(%eax)
	...
...
8010563d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105640:	8b 55 10             	mov    0x10(%ebp),%edx
80105643:	8b 45 0c             	mov    0xc(%ebp),%eax
80105646:	89 cb                	mov    %ecx,%ebx
80105648:	89 df                	mov    %ebx,%edi
8010564a:	89 d1                	mov    %edx,%ecx
8010564c:	fc                   	cld    
8010564d:	f3 aa                	rep stos %al,%es:(%edi)
8010564f:	89 ca                	mov    %ecx,%edx
80105651:	89 fb                	mov    %edi,%ebx
80105653:	89 5d 08             	mov    %ebx,0x8(%ebp)
80105656:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105662:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105665:	8b 55 10             	mov    0x10(%ebp),%edx
80105668:	8b 45 0c             	mov    0xc(%ebp),%eax
8010566b:	89 cb                	mov    %ecx,%ebx
8010566d:	89 df                	mov    %ebx,%edi
8010566f:	89 d1                	mov    %edx,%ecx
80105671:	fc                   	cld    
80105672:	f3 ab                	rep stos %eax,%es:(%edi)
80105674:	89 ca                	mov    %ecx,%edx
80105676:	89 fb                	mov    %edi,%ebx
80105678:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105708:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010570b:	eb 32                	jmp    8010573f <memcmp+0x46>
    if(*s1 != *s2)
...
8010571b:	74 1a                	je     80105737 <memcmp+0x3e>
      return *s1 - *s2;
...
8010572f:	89 d1                	mov    %edx,%ecx
80105731:	29 c1                	sub    %eax,%ecx
80105733:	89 c8                	mov    %ecx,%eax
80105735:	eb 1c                	jmp    80105753 <memcmp+0x5a>
    s1++, s2++;
80105737:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010573b:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
8010573f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105743:	0f 95 c0             	setne  %al
80105746:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010574a:	84 c0                	test   %al,%al
8010574c:	75 bf                	jne    8010570d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
8010576a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010576d:	73 54                	jae    801057c3 <memmove+0x6e>
8010576f:	8b 45 10             	mov    0x10(%ebp),%eax
80105772:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105775:	01 d0                	add    %edx,%eax
80105777:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010577a:	76 47                	jbe    801057c3 <memmove+0x6e>
    s += n;
8010577c:	8b 45 10             	mov    0x10(%ebp),%eax
8010577f:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105782:	8b 45 10             	mov    0x10(%ebp),%eax
80105785:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105788:	eb 13                	jmp    8010579d <memmove+0x48>
      *--d = *--s;
8010578a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010578e:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105792:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105795:	0f b6 10             	movzbl (%eax),%edx
80105798:	8b 45 f8             	mov    -0x8(%ebp),%eax
...
801057a1:	0f 95 c0             	setne  %al
801057a4:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057a8:	84 c0                	test   %al,%al
801057aa:	75 de                	jne    8010578a <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801057ac:	eb 25                	jmp    801057d3 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
801057b1:	0f b6 10             	movzbl (%eax),%edx
801057b4:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057b7:	88 10                	mov    %dl,(%eax)
801057b9:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801057bd:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057c1:	eb 01                	jmp    801057c4 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
801057c8:	0f 95 c0             	setne  %al
801057cb:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057cf:	84 c0                	test   %al,%al
801057d1:	75 db                	jne    801057ae <memmove+0x59>
      *d++ = *s++;
...
801057f2:	e8 5e ff ff ff       	call   80105755 <memmove>
}
801057f7:	c9                   	leave  
801057f8:	c3                   	ret    
...
80105835:	eb 18                	jmp    8010584f <strncmp+0x56>
...
80105849:	89 d1                	mov    %edx,%ecx
8010584b:	29 c1                	sub    %eax,%ecx
8010584d:	89 c8                	mov    %ecx,%eax
}
8010584f:	5d                   	pop    %ebp
80105850:	c3                   	ret    
...
8010586b:	74 30                	je     8010589d <strncpy+0x4c>
8010586d:	8b 45 0c             	mov    0xc(%ebp),%eax
80105870:	0f b6 10             	movzbl (%eax),%edx
80105873:	8b 45 08             	mov    0x8(%ebp),%eax
80105876:	88 10                	mov    %dl,(%eax)
80105878:	8b 45 08             	mov    0x8(%ebp),%eax
8010587b:	0f b6 00             	movzbl (%eax),%eax
8010587e:	84 c0                	test   %al,%al
80105880:	0f 95 c0             	setne  %al
80105883:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105887:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010588b:	84 c0                	test   %al,%al
8010588d:	75 cf                	jne    8010585e <strncpy+0xd>
    ;
  while(n-- > 0)
8010588f:	eb 0c                	jmp    8010589d <strncpy+0x4c>
    *s++ = 0;
80105891:	8b 45 08             	mov    0x8(%ebp),%eax
80105894:	c6 00 00             	movb   $0x0,(%eax)
80105897:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010589b:	eb 01                	jmp    8010589e <strncpy+0x4d>
  char *os;
...
801058ab:	75 e4                	jne    80105891 <strncpy+0x40>
    *s++ = 0;
  return os;
...
801058bb:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801058be:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058c2:	7f 05                	jg     801058c9 <safestrcpy+0x17>
    return os;
801058c4:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058c7:	eb 35                	jmp    801058fe <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
801058c9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801058cd:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801058d1:	7e 22                	jle    801058f5 <safestrcpy+0x43>
801058d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801058d6:	0f b6 10             	movzbl (%eax),%edx
801058d9:	8b 45 08             	mov    0x8(%ebp),%eax
801058dc:	88 10                	mov    %dl,(%eax)
801058de:	8b 45 08             	mov    0x8(%ebp),%eax
801058e1:	0f b6 00             	movzbl (%eax),%eax
801058e4:	84 c0                	test   %al,%al
801058e6:	0f 95 c0             	setne  %al
801058e9:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801058ed:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801058f1:	84 c0                	test   %al,%al
801058f3:	75 d4                	jne    801058c9 <safestrcpy+0x17>
    ;
  *s = 0;
...
80105903:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
80105906:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010590d:	eb 04                	jmp    80105913 <strlen+0x13>
8010590f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105913:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105916:	03 45 08             	add    0x8(%ebp),%eax
80105919:	0f b6 00             	movzbl (%eax),%eax
8010591c:	84 c0                	test   %al,%al
8010591e:	75 ef                	jne    8010590f <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105928:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
8010592c:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105933:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105934:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105936:	89 d4                	mov    %edx,%esp
...
8010594b:	3b 45 08             	cmp    0x8(%ebp),%eax
8010594e:	76 12                	jbe    80105962 <fetchint+0x22>
80105950:	8b 45 08             	mov    0x8(%ebp),%eax
80105953:	8d 50 04             	lea    0x4(%eax),%edx
80105956:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010595c:	8b 00                	mov    (%eax),%eax
8010595e:	39 c2                	cmp    %eax,%edx
80105960:	76 07                	jbe    80105969 <fetchint+0x29>
    return -1;
80105962:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105967:	eb 0f                	jmp    80105978 <fetchint+0x38>
  *ip = *(int*)(addr);
80105969:	8b 45 08             	mov    0x8(%ebp),%eax
8010596c:	8b 10                	mov    (%eax),%edx
8010596e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105971:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105988:	3b 45 08             	cmp    0x8(%ebp),%eax
8010598b:	77 07                	ja     80105994 <fetchstr+0x1a>
    return -1;
8010598d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105992:	eb 48                	jmp    801059dc <fetchstr+0x62>
  *pp = (char*)addr;
80105994:	8b 55 08             	mov    0x8(%ebp),%edx
...
801059a4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801059a7:	8b 45 0c             	mov    0xc(%ebp),%eax
801059aa:	8b 00                	mov    (%eax),%eax
801059ac:	89 45 fc             	mov    %eax,-0x4(%ebp)
801059af:	eb 1e                	jmp    801059cf <fetchstr+0x55>
    if(*s == 0)
801059b1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059b4:	0f b6 00             	movzbl (%eax),%eax
801059b7:	84 c0                	test   %al,%al
801059b9:	75 10                	jne    801059cb <fetchstr+0x51>
      return s - *pp;
801059bb:	8b 55 fc             	mov    -0x4(%ebp),%edx
801059be:	8b 45 0c             	mov    0xc(%ebp),%eax
801059c1:	8b 00                	mov    (%eax),%eax
801059c3:	89 d1                	mov    %edx,%ecx
801059c5:	29 c1                	sub    %eax,%ecx
801059c7:	89 c8                	mov    %ecx,%eax
801059c9:	eb 11                	jmp    801059dc <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
801059cb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801059cf:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059d2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801059d5:	72 da                	jb     801059b1 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801059ea:	8b 40 1c             	mov    0x1c(%eax),%eax
801059ed:	8b 50 44             	mov    0x44(%eax),%edx
801059f0:	8b 45 08             	mov    0x8(%ebp),%eax
801059f3:	c1 e0 02             	shl    $0x2,%eax
801059f6:	01 d0                	add    %edx,%eax
801059f8:	8d 50 04             	lea    0x4(%eax),%edx
801059fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801059fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a02:	89 14 24             	mov    %edx,(%esp)
80105a05:	e8 36 ff ff ff       	call   80105940 <fetchint>
}
80105a0a:	c9                   	leave  
80105a0b:	c3                   	ret    
...
80105a81:	e8 58 ff ff ff       	call   801059de <argint>
80105a86:	85 c0                	test   %eax,%eax
80105a88:	79 07                	jns    80105a91 <argstr+0x23>
    return -1;
80105a8a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a8f:	eb 12                	jmp    80105aa3 <argstr+0x35>
  return fetchstr(addr, pp);
80105a91:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a94:	8b 55 0c             	mov    0xc(%ebp),%edx
80105a97:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a9b:	89 04 24             	mov    %eax,(%esp)
80105a9e:	e8 d7 fe ff ff       	call   8010597a <fetchstr>
}
80105aa3:	c9                   	leave  
80105aa4:	c3                   	ret    
...
80105abb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105abf:	7e 30                	jle    80105af1 <syscall+0x4c>
80105ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ac4:	83 f8 1a             	cmp    $0x1a,%eax
80105ac7:	77 28                	ja     80105af1 <syscall+0x4c>
80105ac9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105acc:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105ad3:	85 c0                	test   %eax,%eax
80105ad5:	74 1a                	je     80105af1 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105ad7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105add:	8b 58 1c             	mov    0x1c(%eax),%ebx
80105ae0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ae3:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105aea:	ff d0                	call   *%eax
80105aec:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105aef:	eb 3d                	jmp    80105b2e <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105af1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105af7:	8d 48 70             	lea    0x70(%eax),%ecx
80105afa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105b00:	8b 40 10             	mov    0x10(%eax),%eax
80105b03:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
80105b24:	8b 40 1c             	mov    0x1c(%eax),%eax
80105b27:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105b2e:	83 c4 24             	add    $0x24,%esp
80105b31:	5b                   	pop    %ebx
80105b32:	5d                   	pop    %ebp
80105b33:	c3                   	ret    
...
80105b47:	e8 92 fe ff ff       	call   801059de <argint>
...
80105b72:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
...
80105bc4:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
...
80105bdb:	89 54 88 0c          	mov    %edx,0xc(%eax,%ecx,4)
      return fd;
...
80105c42:	e8 9d b3 ff ff       	call   80100fe4 <filedup>
  return fd;
...
80105c7f:	e8 5a fd ff ff       	call   801059de <argint>
...
80105c9d:	e8 6a fd ff ff       	call   80105a0c <argptr>
...
80105cc1:	e8 8b b4 ff ff       	call   80101151 <fileread>
}
80105cc6:	c9                   	leave  
80105cc7:	c3                   	ret    
...
80105cfb:	e8 de fc ff ff       	call   801059de <argint>
...
80105d19:	e8 ee fc ff ff       	call   80105a0c <argptr>
...
80105d3d:	e8 cb b4 ff ff       	call   8010120d <filewrite>
}
80105d42:	c9                   	leave  
80105d43:	c3                   	ret    
...
80105d7b:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80105d82:	00 
  fileclose(f);
80105d83:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d86:	89 04 24             	mov    %eax,(%esp)
80105d89:	e8 9e b2 ff ff       	call   8010102c <fileclose>
  return 0;
...
80105dd0:	e8 37 fc ff ff       	call   80105a0c <argptr>
...
80105ded:	e8 10 b3 ff ff       	call   80101102 <filestat>
}
80105df2:	c9                   	leave  
80105df3:	c3                   	ret    
...
80105e08:	e8 61 fc ff ff       	call   80105a6e <argstr>
...
80105ea3:	e8 6c b8 ff ff       	call   80101714 <iupdate>
  iunlock(ip);
80105ea8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eab:	89 04 24             	mov    %eax,(%esp)
80105eae:	e8 6b bb ff ff       	call   80101a1e <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105eb3:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105eb6:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105eb9:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ebd:	89 04 24             	mov    %eax,(%esp)
80105ec0:	e8 cf c5 ff ff       	call   80102494 <nameiparent>
80105ec5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ec8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ecc:	74 68                	je     80105f36 <sys_link+0x142>
    goto bad;
  ilock(dp);
80105ece:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed1:	89 04 24             	mov    %eax,(%esp)
80105ed4:	e8 f7 b9 ff ff       	call   801018d0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105ed9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105edc:	8b 10                	mov    (%eax),%edx
80105ede:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee1:	8b 00                	mov    (%eax),%eax
80105ee3:	39 c2                	cmp    %eax,%edx
80105ee5:	75 20                	jne    80105f07 <sys_link+0x113>
80105ee7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eea:	8b 40 04             	mov    0x4(%eax),%eax
80105eed:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ef1:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105ef4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ef8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105efb:	89 04 24             	mov    %eax,(%esp)
80105efe:	e8 ae c2 ff ff       	call   801021b1 <dirlink>
80105f03:	85 c0                	test   %eax,%eax
80105f05:	79 0d                	jns    80105f14 <sys_link+0x120>
    iunlockput(dp);
80105f07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f0a:	89 04 24             	mov    %eax,(%esp)
80105f0d:	e8 42 bc ff ff       	call   80101b54 <iunlockput>
    goto bad;
80105f12:	eb 23                	jmp    80105f37 <sys_link+0x143>
  }
  iunlockput(dp);
80105f14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f17:	89 04 24             	mov    %eax,(%esp)
80105f1a:	e8 35 bc ff ff       	call   80101b54 <iunlockput>
  iput(ip);
80105f1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f22:	89 04 24             	mov    %eax,(%esp)
80105f25:	e8 59 bb ff ff       	call   80101a83 <iput>

  end_op();
80105f2a:	e8 0f d6 ff ff       	call   8010353e <end_op>

  return 0;
80105f2f:	b8 00 00 00 00       	mov    $0x0,%eax
80105f34:	eb 3d                	jmp    80105f73 <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105f3d:	e8 8e b9 ff ff       	call   801018d0 <ilock>
  ip->nlink--;
80105f42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f45:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f49:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105f59:	e8 b6 b7 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
80105f5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f61:	89 04 24             	mov    %eax,(%esp)
80105f64:	e8 eb bb ff ff       	call   80101b54 <iunlockput>
  end_op();
80105f69:	e8 d0 d5 ff ff       	call   8010353e <end_op>
  return -1;
...
80105f78:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105f7b:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105f82:	eb 4b                	jmp    80105fcf <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105f84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f87:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105f8e:	00 
...
80105fa0:	e8 21 be ff ff       	call   80101dc6 <readi>
...
80105fba:	66 85 c0             	test   %ax,%ax
80105fbd:	74 07                	je     80105fc6 <isdirempty+0x51>
      return 0;
80105fbf:	b8 00 00 00 00       	mov    $0x0,%eax
80105fc4:	eb 1b                	jmp    80105fe1 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105fda:	72 a8                	jb     80105f84 <isdirempty+0xf>
  ...
  return 1;
80105fdc:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105fe1:	c9                   	leave  
80105fe2:	c3                   	ret    
...
80105fe6:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105fe9:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105fec:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ff0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ff7:	e8 72 fa ff ff       	call   80105a6e <argstr>
80105ffc:	85 c0                	test   %eax,%eax
80105ffe:	79 0a                	jns    8010600a <sys_unlink+0x27>
    return -1;
80106000:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106005:	e9 af 01 00 00       	jmp    801061b9 <sys_unlink+0x1d6>

  begin_op();
8010600a:	e8 ae d4 ff ff       	call   801034bd <begin_op>
  if((dp = nameiparent(path, name)) == 0){
8010600f:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106012:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106015:	89 54 24 04          	mov    %edx,0x4(%esp)
80106019:	89 04 24             	mov    %eax,(%esp)
8010601c:	e8 73 c4 ff ff       	call   80102494 <nameiparent>
80106021:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106024:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106028:	75 0f                	jne    80106039 <sys_unlink+0x56>
    end_op();
8010602a:	e8 0f d5 ff ff       	call   8010353e <end_op>
    return -1;
8010602f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106034:	e9 80 01 00 00       	jmp    801061b9 <sys_unlink+0x1d6>
  }

  ilock(dp);
80106039:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010603c:	89 04 24             	mov    %eax,(%esp)
8010603f:	e8 8c b8 ff ff       	call   801018d0 <ilock>
...
8010606d:	e8 55 c0 ff ff       	call   801020c7 <namecmp>
80106072:	85 c0                	test   %eax,%eax
80106074:	0f 84 2a 01 00 00    	je     801061a4 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
8010607a:	8d 45 c8             	lea    -0x38(%ebp),%eax
8010607d:	89 44 24 08          	mov    %eax,0x8(%esp)
80106081:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106084:	89 44 24 04          	mov    %eax,0x4(%esp)
80106088:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010608b:	89 04 24             	mov    %eax,(%esp)
8010608e:	e8 56 c0 ff ff       	call   801020e9 <dirlookup>
80106093:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106096:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010609a:	0f 84 03 01 00 00    	je     801061a3 <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
801060a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060a3:	89 04 24             	mov    %eax,(%esp)
801060a6:	e8 25 b8 ff ff       	call   801018d0 <ilock>
...
801060c6:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801060ca:	66 83 f8 01          	cmp    $0x1,%ax
801060ce:	75 1f                	jne    801060ef <sys_unlink+0x10c>
801060d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060d3:	89 04 24             	mov    %eax,(%esp)
801060d6:	e8 9a fe ff ff       	call   80105f75 <isdirempty>
801060db:	85 c0                	test   %eax,%eax
801060dd:	75 10                	jne    801060ef <sys_unlink+0x10c>
    iunlockput(ip);
801060df:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060e2:	89 04 24             	mov    %eax,(%esp)
801060e5:	e8 6a ba ff ff       	call   80101b54 <iunlockput>
    goto bad;
801060ea:	e9 b5 00 00 00       	jmp    801061a4 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
801060ef:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801060f6:	00 
801060f7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801060fe:	00 
801060ff:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106102:	89 04 24             	mov    %eax,(%esp)
80106105:	e8 78 f5 ff ff       	call   80105682 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010610a:	8b 45 c8             	mov    -0x38(%ebp),%eax
8010610d:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106114:	00 
...
80106126:	e8 06 be ff ff       	call   80101f31 <writei>
...
80106147:	75 1c                	jne    80106165 <sys_unlink+0x182>
    dp->nlink--;
80106149:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010614c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106150:	8d 50 ff             	lea    -0x1(%eax),%edx
80106153:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106156:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010615a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010615d:	89 04 24             	mov    %eax,(%esp)
80106160:	e8 af b5 ff ff       	call   80101714 <iupdate>
  }
  iunlockput(dp);
80106165:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106168:	89 04 24             	mov    %eax,(%esp)
8010616b:	e8 e4 b9 ff ff       	call   80101b54 <iunlockput>

  ip->nlink--;
80106170:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106173:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106177:	8d 50 ff             	lea    -0x1(%eax),%edx
8010617a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010617d:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106181:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106184:	89 04 24             	mov    %eax,(%esp)
80106187:	e8 88 b5 ff ff       	call   80101714 <iupdate>
  iunlockput(ip);
8010618c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618f:	89 04 24             	mov    %eax,(%esp)
80106192:	e8 bd b9 ff ff       	call   80101b54 <iunlockput>

  end_op();
80106197:	e8 a2 d3 ff ff       	call   8010353e <end_op>

  return 0;
8010619c:	b8 00 00 00 00       	mov    $0x0,%eax
801061a1:	eb 16                	jmp    801061b9 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
801061aa:	e8 a5 b9 ff ff       	call   80101b54 <iunlockput>
  end_op();
801061af:	e8 8a d3 ff ff       	call   8010353e <end_op>
  return -1;
...
801061be:	83 ec 48             	sub    $0x48,%esp
801061c1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801061c4:	8b 55 10             	mov    0x10(%ebp),%edx
801061c7:	8b 45 14             	mov    0x14(%ebp),%eax
801061ca:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
801061ce:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
801061d2:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
801061e3:	e8 ac c2 ff ff       	call   80102494 <nameiparent>
801061e8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061eb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061ef:	75 0a                	jne    801061fb <create+0x40>
    return 0;
801061f1:	b8 00 00 00 00       	mov    $0x0,%eax
801061f6:	e9 7e 01 00 00       	jmp    80106379 <create+0x1be>
  ilock(dp);
801061fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061fe:	89 04 24             	mov    %eax,(%esp)
80106201:	e8 ca b6 ff ff       	call   801018d0 <ilock>
...
8010621a:	e8 ca be ff ff       	call   801020e9 <dirlookup>
8010621f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106222:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106226:	74 47                	je     8010626f <create+0xb4>
    iunlockput(dp);
80106228:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010622b:	89 04 24             	mov    %eax,(%esp)
8010622e:	e8 21 b9 ff ff       	call   80101b54 <iunlockput>
    ilock(ip);
80106233:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106236:	89 04 24             	mov    %eax,(%esp)
80106239:	e8 92 b6 ff ff       	call   801018d0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010623e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106243:	75 15                	jne    8010625a <create+0x9f>
80106245:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106248:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010624c:	66 83 f8 02          	cmp    $0x2,%ax
80106250:	75 08                	jne    8010625a <create+0x9f>
      return ip;
80106252:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106255:	e9 1f 01 00 00       	jmp    80106379 <create+0x1be>
    iunlockput(ip);
8010625a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010625d:	89 04 24             	mov    %eax,(%esp)
80106260:	e8 ef b8 ff ff       	call   80101b54 <iunlockput>
    return 0;
80106265:	b8 00 00 00 00       	mov    $0x0,%eax
8010626a:	e9 0a 01 00 00       	jmp    80106379 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
8010626f:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
8010627f:	e8 b3 b3 ff ff       	call   80101637 <ialloc>
80106284:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
8010629f:	e8 2c b6 ff ff       	call   801018d0 <ilock>
  ip->major = major;
801062a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062a7:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
801062ab:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
801062af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062b2:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
801062b6:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
801062ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062bd:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
801062c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c6:	89 04 24             	mov    %eax,(%esp)
801062c9:	e8 46 b4 ff ff       	call   80101714 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801062ce:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801062d3:	75 6a                	jne    8010633f <create+0x184>
    dp->nlink++;  // for ".."
...
801062ec:	e8 23 b4 ff ff       	call   80101714 <iupdate>
...
80106309:	e8 a3 be ff ff       	call   801021b1 <dirlink>
8010630e:	85 c0                	test   %eax,%eax
80106310:	78 21                	js     80106333 <create+0x178>
...
8010632a:	e8 82 be ff ff       	call   801021b1 <dirlink>
...
80106371:	e8 de b7 ff ff       	call   80101b54 <iunlockput>
...
8010637e:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106381:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106384:	89 44 24 04          	mov    %eax,0x4(%esp)
80106388:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010638f:	e8 da f6 ff ff       	call   80105a6e <argstr>
80106394:	85 c0                	test   %eax,%eax
80106396:	78 17                	js     801063af <sys_open+0x34>
80106398:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010639b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010639f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801063a6:	e8 33 f6 ff ff       	call   801059de <argint>
801063ab:	85 c0                	test   %eax,%eax
801063ad:	79 0a                	jns    801063b9 <sys_open+0x3e>
    return -1;
801063af:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063b4:	e9 5a 01 00 00       	jmp    80106513 <sys_open+0x198>

  begin_op();
801063b9:	e8 ff d0 ff ff       	call   801034bd <begin_op>

  if(omode & O_CREATE){
801063be:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063c1:	25 00 02 00 00       	and    $0x200,%eax
801063c6:	85 c0                	test   %eax,%eax
801063c8:	74 3b                	je     80106405 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
801063ca:	8b 45 e8             	mov    -0x18(%ebp),%eax
801063cd:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801063d4:	00 
801063d5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801063dc:	00 
801063dd:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801063e4:	00 
801063e5:	89 04 24             	mov    %eax,(%esp)
801063e8:	e8 ce fd ff ff       	call   801061bb <create>
801063ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
801063f0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063f4:	75 6b                	jne    80106461 <sys_open+0xe6>
      end_op();
801063f6:	e8 43 d1 ff ff       	call   8010353e <end_op>
      return -1;
801063fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106400:	e9 0e 01 00 00       	jmp    80106513 <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
80106405:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106408:	89 04 24             	mov    %eax,(%esp)
8010640b:	e8 62 c0 ff ff       	call   80102472 <namei>
80106410:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106413:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106417:	75 0f                	jne    80106428 <sys_open+0xad>
      end_op();
80106419:	e8 20 d1 ff ff       	call   8010353e <end_op>
      return -1;
8010641e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106423:	e9 eb 00 00 00       	jmp    80106513 <sys_open+0x198>
    }
    ilock(ip);
80106428:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010642b:	89 04 24             	mov    %eax,(%esp)
8010642e:	e8 9d b4 ff ff       	call   801018d0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106433:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106436:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010643a:	66 83 f8 01          	cmp    $0x1,%ax
8010643e:	75 21                	jne    80106461 <sys_open+0xe6>
80106440:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106443:	85 c0                	test   %eax,%eax
80106445:	74 1a                	je     80106461 <sys_open+0xe6>
      iunlockput(ip);
80106447:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010644a:	89 04 24             	mov    %eax,(%esp)
8010644d:	e8 02 b7 ff ff       	call   80101b54 <iunlockput>
      end_op();
80106452:	e8 e7 d0 ff ff       	call   8010353e <end_op>
      return -1;
80106457:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010645c:	e9 b2 00 00 00       	jmp    80106513 <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106461:	e8 1e ab ff ff       	call   80100f84 <filealloc>
80106466:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106469:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010646d:	74 14                	je     80106483 <sys_open+0x108>
8010646f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106472:	89 04 24             	mov    %eax,(%esp)
80106475:	e8 2f f7 ff ff       	call   80105ba9 <fdalloc>
8010647a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010647d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106481:	79 28                	jns    801064ab <sys_open+0x130>
    if(f)
80106483:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106487:	74 0b                	je     80106494 <sys_open+0x119>
      fileclose(f);
80106489:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010648c:	89 04 24             	mov    %eax,(%esp)
8010648f:	e8 98 ab ff ff       	call   8010102c <fileclose>
    iunlockput(ip);
80106494:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106497:	89 04 24             	mov    %eax,(%esp)
8010649a:	e8 b5 b6 ff ff       	call   80101b54 <iunlockput>
    end_op();
8010649f:	e8 9a d0 ff ff       	call   8010353e <end_op>
    return -1;
801064a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a9:	eb 68                	jmp    80106513 <sys_open+0x198>
  }
  iunlock(ip);
801064ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ae:	89 04 24             	mov    %eax,(%esp)
801064b1:	e8 68 b5 ff ff       	call   80101a1e <iunlock>
  end_op();
801064b6:	e8 83 d0 ff ff       	call   8010353e <end_op>
...
801064df:	0f 94 c2             	sete   %dl
801064e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064e5:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801064e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064eb:	83 e0 01             	and    $0x1,%eax
801064ee:	84 c0                	test   %al,%al
801064f0:	75 0a                	jne    801064fc <sys_open+0x181>
801064f2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801064f5:	83 e0 02             	and    $0x2,%eax
801064f8:	85 c0                	test   %eax,%eax
801064fa:	74 07                	je     80106503 <sys_open+0x188>
801064fc:	b8 01 00 00 00       	mov    $0x1,%eax
80106501:	eb 05                	jmp    80106508 <sys_open+0x18d>
80106503:	b8 00 00 00 00       	mov    $0x0,%eax
80106508:	89 c2                	mov    %eax,%edx
8010650a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010650d:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80106518:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
8010651b:	e8 9d cf ff ff       	call   801034bd <begin_op>
...
8010652e:	e8 3b f5 ff ff       	call   80105a6e <argstr>
80106533:	85 c0                	test   %eax,%eax
80106535:	78 2c                	js     80106563 <sys_mkdir+0x4e>
80106537:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010653a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106541:	00 
80106542:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106549:	00 
8010654a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106551:	00 
80106552:	89 04 24             	mov    %eax,(%esp)
80106555:	e8 61 fc ff ff       	call   801061bb <create>
8010655a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010655d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106561:	75 0c                	jne    8010656f <sys_mkdir+0x5a>
    end_op();
80106563:	e8 d6 cf ff ff       	call   8010353e <end_op>
    return -1;
80106568:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010656d:	eb 15                	jmp    80106584 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010656f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106572:	89 04 24             	mov    %eax,(%esp)
80106575:	e8 da b5 ff ff       	call   80101b54 <iunlockput>
  end_op();
8010657a:	e8 bf cf ff ff       	call   8010353e <end_op>
  return 0;
...
80106589:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
8010658c:	e8 2c cf ff ff       	call   801034bd <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106591:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106594:	89 44 24 04          	mov    %eax,0x4(%esp)
80106598:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010659f:	e8 ca f4 ff ff       	call   80105a6e <argstr>
801065a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065a7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801065ab:	78 5e                	js     8010660b <sys_mknod+0x85>
     argint(1, &major) < 0 ||
801065ad:	8d 45 e8             	lea    -0x18(%ebp),%eax
801065b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801065b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065bb:	e8 1e f4 ff ff       	call   801059de <argint>
  char *path;
  int len;
  int major, minor;
...
801065c2:	78 47                	js     8010660b <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801065c4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801065c7:	89 44 24 04          	mov    %eax,0x4(%esp)
801065cb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801065d2:	e8 07 f4 ff ff       	call   801059de <argint>
  int len;
  int major, minor;
...
801065d9:	78 30                	js     8010660b <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801065db:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801065de:	0f bf c8             	movswl %ax,%ecx
801065e1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801065e4:	0f bf d0             	movswl %ax,%edx
801065e7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801065ea:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801065ee:	89 54 24 08          	mov    %edx,0x8(%esp)
801065f2:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801065f9:	00 
801065fa:	89 04 24             	mov    %eax,(%esp)
801065fd:	e8 b9 fb ff ff       	call   801061bb <create>
80106602:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106605:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106609:	75 0c                	jne    80106617 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
8010660b:	e8 2e cf ff ff       	call   8010353e <end_op>
    return -1;
80106610:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106615:	eb 15                	jmp    8010662c <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106617:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010661a:	89 04 24             	mov    %eax,(%esp)
8010661d:	e8 32 b5 ff ff       	call   80101b54 <iunlockput>
  end_op();
80106622:	e8 17 cf ff ff       	call   8010353e <end_op>
  return 0;
...
80106631:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106634:	e8 84 ce ff ff       	call   801034bd <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106639:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010663c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106640:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106647:	e8 22 f4 ff ff       	call   80105a6e <argstr>
8010664c:	85 c0                	test   %eax,%eax
8010664e:	78 14                	js     80106664 <sys_chdir+0x36>
80106650:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106653:	89 04 24             	mov    %eax,(%esp)
80106656:	e8 17 be ff ff       	call   80102472 <namei>
8010665b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010665e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106662:	75 0c                	jne    80106670 <sys_chdir+0x42>
    end_op();
80106664:	e8 d5 ce ff ff       	call   8010353e <end_op>
    return -1;
80106669:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010666e:	eb 61                	jmp    801066d1 <sys_chdir+0xa3>
  }
  ilock(ip);
80106670:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106673:	89 04 24             	mov    %eax,(%esp)
80106676:	e8 55 b2 ff ff       	call   801018d0 <ilock>
  if(ip->type != T_DIR){
8010667b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010667e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106682:	66 83 f8 01          	cmp    $0x1,%ax
80106686:	74 17                	je     8010669f <sys_chdir+0x71>
    iunlockput(ip);
80106688:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010668b:	89 04 24             	mov    %eax,(%esp)
8010668e:	e8 c1 b4 ff ff       	call   80101b54 <iunlockput>
    end_op();
80106693:	e8 a6 ce ff ff       	call   8010353e <end_op>
    return -1;
80106698:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010669d:	eb 32                	jmp    801066d1 <sys_chdir+0xa3>
  }
  iunlock(ip);
8010669f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a2:	89 04 24             	mov    %eax,(%esp)
801066a5:	e8 74 b3 ff ff       	call   80101a1e <iunlock>
  iput(proc->cwd);
801066aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066b0:	8b 40 6c             	mov    0x6c(%eax),%eax
801066b3:	89 04 24             	mov    %eax,(%esp)
801066b6:	e8 c8 b3 ff ff       	call   80101a83 <iput>
  end_op();
801066bb:	e8 7e ce ff ff       	call   8010353e <end_op>
  proc->cwd = ip;
801066c0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066c6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066c9:	89 50 6c             	mov    %edx,0x6c(%eax)
  return 0;
...
801066d6:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801066ea:	e8 7f f3 ff ff       	call   80105a6e <argstr>
801066ef:	85 c0                	test   %eax,%eax
801066f1:	78 1a                	js     8010670d <sys_exec+0x3a>
801066f3:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801066f9:	89 44 24 04          	mov    %eax,0x4(%esp)
801066fd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106704:	e8 d5 f2 ff ff       	call   801059de <argint>
80106709:	85 c0                	test   %eax,%eax
8010670b:	79 0a                	jns    80106717 <sys_exec+0x44>
    return -1;
8010670d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106712:	e9 cc 00 00 00       	jmp    801067e3 <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
80106717:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010671e:	00 
8010671f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106726:	00 
80106727:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010672d:	89 04 24             	mov    %eax,(%esp)
80106730:	e8 4d ef ff ff       	call   80105682 <memset>
  for(i=0;; i++){
80106735:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010673c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010673f:	83 f8 1f             	cmp    $0x1f,%eax
80106742:	76 0a                	jbe    8010674e <sys_exec+0x7b>
      return -1;
80106744:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106749:	e9 95 00 00 00       	jmp    801067e3 <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
8010674e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106751:	c1 e0 02             	shl    $0x2,%eax
80106754:	89 c2                	mov    %eax,%edx
80106756:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010675c:	01 c2                	add    %eax,%edx
8010675e:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106764:	89 44 24 04          	mov    %eax,0x4(%esp)
80106768:	89 14 24             	mov    %edx,(%esp)
8010676b:	e8 d0 f1 ff ff       	call   80105940 <fetchint>
80106770:	85 c0                	test   %eax,%eax
80106772:	79 07                	jns    8010677b <sys_exec+0xa8>
      return -1;
80106774:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106779:	eb 68                	jmp    801067e3 <sys_exec+0x110>
    if(uarg == 0){
8010677b:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106781:	85 c0                	test   %eax,%eax
80106783:	75 26                	jne    801067ab <sys_exec+0xd8>
      argv[i] = 0;
80106785:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106788:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010678f:	00 00 00 00 
      break;
80106793:	90                   	nop
    }
...
80106797:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010679d:	89 54 24 04          	mov    %edx,0x4(%esp)
801067a1:	89 04 24             	mov    %eax,(%esp)
801067a4:	e8 53 a3 ff ff       	call   80100afc <exec>
801067a9:	eb 38                	jmp    801067e3 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
801067ae:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801067b5:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801067bb:	01 c2                	add    %eax,%edx
801067bd:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801067c3:	89 54 24 04          	mov    %edx,0x4(%esp)
801067c7:	89 04 24             	mov    %eax,(%esp)
801067ca:	e8 ab f1 ff ff       	call   8010597a <fetchstr>
801067cf:	85 c0                	test   %eax,%eax
801067d1:	79 07                	jns    801067da <sys_exec+0x107>
      return -1;
801067d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067d8:	eb 09                	jmp    801067e3 <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801067da:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
801067de:	e9 59 ff ff ff       	jmp    8010673c <sys_exec+0x69>
  return exec(path, argv);
}
801067e3:	c9                   	leave  
801067e4:	c3                   	ret    
...
801067e8:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801067eb:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801067f2:	00 
801067f3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801067f6:	89 44 24 04          	mov    %eax,0x4(%esp)
801067fa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106801:	e8 06 f2 ff ff       	call   80105a0c <argptr>
80106806:	85 c0                	test   %eax,%eax
80106808:	79 0a                	jns    80106814 <sys_pipe+0x2f>
    return -1;
8010680a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010680f:	e9 9b 00 00 00       	jmp    801068af <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106814:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106817:	89 44 24 04          	mov    %eax,0x4(%esp)
8010681b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010681e:	89 04 24             	mov    %eax,(%esp)
80106821:	e8 c6 d7 ff ff       	call   80103fec <pipealloc>
80106826:	85 c0                	test   %eax,%eax
80106828:	79 07                	jns    80106831 <sys_pipe+0x4c>
    return -1;
8010682a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010682f:	eb 7e                	jmp    801068af <sys_pipe+0xca>
  fd0 = -1;
80106831:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106838:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010683b:	89 04 24             	mov    %eax,(%esp)
8010683e:	e8 66 f3 ff ff       	call   80105ba9 <fdalloc>
80106843:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106846:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010684a:	78 14                	js     80106860 <sys_pipe+0x7b>
8010684c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010684f:	89 04 24             	mov    %eax,(%esp)
80106852:	e8 52 f3 ff ff       	call   80105ba9 <fdalloc>
80106857:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010685a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010685e:	79 37                	jns    80106897 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106860:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106864:	78 14                	js     8010687a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106866:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010686c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010686f:	83 c2 08             	add    $0x8,%edx
80106872:	c7 44 90 0c 00 00 00 	movl   $0x0,0xc(%eax,%edx,4)
80106879:	00 
    fileclose(rf);
8010687a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010687d:	89 04 24             	mov    %eax,(%esp)
80106880:	e8 a7 a7 ff ff       	call   8010102c <fileclose>
    fileclose(wf);
80106885:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106888:	89 04 24             	mov    %eax,(%esp)
8010688b:	e8 9c a7 ff ff       	call   8010102c <fileclose>
    return -1;
80106890:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106895:	eb 18                	jmp    801068af <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106897:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010689a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010689d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010689f:	8b 45 ec             	mov    -0x14(%ebp),%eax
801068a2:	8d 50 04             	lea    0x4(%eax),%edx
801068a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068a8:	89 02                	mov    %eax,(%edx)
  return 0;
...
801068b7:	83 ec 08             	sub    $0x8,%esp
  return fork();
801068ba:	e8 3f de ff ff       	call   801046fe <fork>
}
801068bf:	c9                   	leave  
801068c0:	c3                   	ret    
...
801068c4:	83 ec 28             	sub    $0x28,%esp
	int status;
	if(argint(0, &status) < 0)
801068c7:	8d 45 f4             	lea    -0xc(%ebp),%eax
801068ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801068ce:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068d5:	e8 04 f1 ff ff       	call   801059de <argint>
801068da:	85 c0                	test   %eax,%eax
801068dc:	79 07                	jns    801068e5 <sys_exit+0x24>
	    return -1;
801068de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068e3:	eb 10                	jmp    801068f5 <sys_exit+0x34>

	exit(status);
801068e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068e8:	89 04 24             	mov    %eax,(%esp)
801068eb:	e8 d1 df ff ff       	call   801048c1 <exit>
...
80106913:	e8 f4 f0 ff ff       	call   80105a0c <argptr>
80106918:	85 c0                	test   %eax,%eax
8010691a:	79 07                	jns    80106923 <sys_wait+0x2c>
		return -1;
8010691c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106921:	eb 0b                	jmp    8010692e <sys_wait+0x37>
	}
	return wait(status);
80106923:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106926:	89 04 24             	mov    %eax,(%esp)
80106929:	e8 83 e1 ff ff       	call   80104ab1 <wait>
}
8010692e:	c9                   	leave  
8010692f:	c3                   	ret    

80106930 <sys_waitpid>:
...
80106944:	e8 95 f0 ff ff       	call   801059de <argint>
80106949:	85 c0                	test   %eax,%eax
8010694b:	78 36                	js     80106983 <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
8010694d:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106954:	00 
80106955:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106958:	89 44 24 04          	mov    %eax,0x4(%esp)
8010695c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106963:	e8 a4 f0 ff ff       	call   80105a0c <argptr>
{
	int pid;
	int *status;
	int options;
...
8010696a:	78 17                	js     80106983 <sys_waitpid+0x53>
			(argptr(1,(char**)&status, sizeof(int)) < 0) ||
			(argint(2, &options) < 0) ){
8010696c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010696f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106973:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010697a:	e8 5f f0 ff ff       	call   801059de <argint>
	int pid;
	int *status;
	int options;
...
80106981:	79 07                	jns    8010698a <sys_waitpid+0x5a>
			(argint(2, &options) < 0) ){

		return -1;
80106983:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106988:	eb 19                	jmp    801069a3 <sys_waitpid+0x73>
	}

	return waitpid(pid, status, options);
8010698a:	8b 4d ec             	mov    -0x14(%ebp),%ecx
8010698d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106990:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106993:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106997:	89 54 24 04          	mov    %edx,0x4(%esp)
8010699b:	89 04 24             	mov    %eax,(%esp)
8010699e:	e8 56 e2 ff ff       	call   80104bf9 <waitpid>
}
801069a3:	c9                   	leave  
801069a4:	c3                   	ret    

801069a5 <sys_wait_stat>:
...
801069e7:	78 1f                	js     80106a08 <sys_wait_stat+0x63>
			(argptr(1,(char**)&rtime, sizeof(int)) < 0) ||
			(argptr(2,(char**)&iotime, sizeof(int)) < 0) ){
801069e9:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801069f0:	00 
801069f1:	8d 45 ec             	lea    -0x14(%ebp),%eax
801069f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801069ff:	e8 08 f0 ff ff       	call   80105a0c <argptr>
sys_wait_stat(void)
{
	int *wtime, *rtime, *iotime;
...
80106a06:	79 07                	jns    80106a0f <sys_wait_stat+0x6a>
			(argptr(2,(char**)&iotime, sizeof(int)) < 0) ){

		return -1;
80106a08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a0d:	eb 19                	jmp    80106a28 <sys_wait_stat+0x83>
	}

	return wait_stat(wtime, rtime, iotime);
80106a0f:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106a12:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106a15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a18:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a1c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a20:	89 04 24             	mov    %eax,(%esp)
80106a23:	e8 f1 e2 ff ff       	call   80104d19 <wait_stat>
}
80106a28:	c9                   	leave  
80106a29:	c3                   	ret    

80106a2a <sys_list_pgroup>:
...
80106a2d:	83 ec 28             	sub    $0x28,%esp
	int gid;
	process_info_entry* arr;
	int* size;

	if (	(argint(0, &gid) < 0) ||
80106a30:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106a33:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a37:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a3e:	e8 9b ef ff ff       	call   801059de <argint>
80106a43:	85 c0                	test   %eax,%eax
80106a45:	78 3e                	js     80106a85 <sys_list_pgroup+0x5b>
			(argptr(1,(char**)&arr, sizeof(process_info_entry)) < 0) ||
80106a47:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80106a4e:	00 
80106a4f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a52:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a5d:	e8 aa ef ff ff       	call   80105a0c <argptr>
{
	int gid;
	process_info_entry* arr;
	int* size;
...
80106a64:	78 1f                	js     80106a85 <sys_list_pgroup+0x5b>
			(argptr(1,(char**)&arr, sizeof(process_info_entry)) < 0) ||
			(argptr(2,(char**)&size, sizeof(int)) < 0)){
80106a66:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a6d:	00 
80106a6e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a71:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a75:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106a7c:	e8 8b ef ff ff       	call   80105a0c <argptr>
	int gid;
	process_info_entry* arr;
	int* size;
...
80106a83:	79 07                	jns    80106a8c <sys_list_pgroup+0x62>
			(argptr(2,(char**)&size, sizeof(int)) < 0)){

		return -1;
80106a85:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a8a:	eb 19                	jmp    80106aa5 <sys_list_pgroup+0x7b>
	}

	return list_pgroup(gid, arr, size);
80106a8c:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106a8f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106a92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a95:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a99:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a9d:	89 04 24             	mov    %eax,(%esp)
80106aa0:	e8 9e e3 ff ff       	call   80104e43 <list_pgroup>
}
80106aa5:	c9                   	leave  
80106aa6:	c3                   	ret    

80106aa7 <sys_foreground>:
...
80106aaa:	83 ec 28             	sub    $0x28,%esp
	int gid;

	if (argint(0, &gid) < 0){
80106aad:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106ab0:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ab4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106abb:	e8 1e ef ff ff       	call   801059de <argint>
80106ac0:	85 c0                	test   %eax,%eax
80106ac2:	79 07                	jns    80106acb <sys_foreground+0x24>
		return -1;
80106ac4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ac9:	eb 0b                	jmp    80106ad6 <sys_foreground+0x2f>
	}

	return foreground(gid);
80106acb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ace:	89 04 24             	mov    %eax,(%esp)
80106ad1:	e8 8a e2 ff ff       	call   80104d60 <foreground>
}
80106ad6:	c9                   	leave  
80106ad7:	c3                   	ret    

80106ad8 <sys_set_priority>:
...
80106aec:	e8 ed ee ff ff       	call   801059de <argint>
80106af1:	85 c0                	test   %eax,%eax
80106af3:	79 07                	jns    80106afc <sys_set_priority+0x24>
	return -1;
80106af5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106afa:	eb 0b                	jmp    80106b07 <sys_set_priority+0x2f>
	return set_priority(priority);
80106afc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aff:	89 04 24             	mov    %eax,(%esp)
80106b02:	e8 32 e3 ff ff       	call   80104e39 <set_priority>
}
80106b07:	c9                   	leave  
80106b08:	c3                   	ret    
...
80106b0c:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80106b1d:	e8 bc ee ff ff       	call   801059de <argint>
80106b22:	85 c0                	test   %eax,%eax
80106b24:	79 07                	jns    80106b2d <sys_kill+0x24>
    return -1;
80106b26:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b2b:	eb 0b                	jmp    80106b38 <sys_kill+0x2f>
  return kill(pid);
80106b2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b30:	89 04 24             	mov    %eax,(%esp)
80106b33:	e8 fc e6 ff ff       	call   80105234 <kill>
}
80106b38:	c9                   	leave  
80106b39:	c3                   	ret    
...
80106b43:	8b 40 10             	mov    0x10(%eax),%eax
}
80106b46:	5d                   	pop    %ebp
80106b47:	c3                   	ret    
...
80106b4b:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106b4e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b51:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b55:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b5c:	e8 7d ee ff ff       	call   801059de <argint>
80106b61:	85 c0                	test   %eax,%eax
80106b63:	79 07                	jns    80106b6c <sys_sbrk+0x24>
    return -1;
80106b65:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b6a:	eb 24                	jmp    80106b90 <sys_sbrk+0x48>
  addr = proc->sz;
...
80106b7d:	e8 d7 da ff ff       	call   80104659 <growproc>
80106b82:	85 c0                	test   %eax,%eax
80106b84:	79 07                	jns    80106b8d <sys_sbrk+0x45>
    return -1;
80106b86:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b8b:	eb 03                	jmp    80106b90 <sys_sbrk+0x48>
  return addr;
...
80106b95:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
  
  if(argint(0, &n) < 0)
80106b98:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b9b:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b9f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ba6:	e8 33 ee ff ff       	call   801059de <argint>
80106bab:	85 c0                	test   %eax,%eax
80106bad:	79 07                	jns    80106bb6 <sys_sleep+0x24>
    return -1;
80106baf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bb4:	eb 6c                	jmp    80106c22 <sys_sleep+0x90>
  acquire(&tickslock);
80106bb6:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106bbd:	e8 71 e8 ff ff       	call   80105433 <acquire>
  ticks0 = ticks;
80106bc2:	a1 60 6f 11 80       	mov    0x80116f60,%eax
80106bc7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106bca:	eb 34                	jmp    80106c00 <sys_sleep+0x6e>
    if(proc->killed){
80106bcc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bd2:	8b 40 28             	mov    0x28(%eax),%eax
80106bd5:	85 c0                	test   %eax,%eax
80106bd7:	74 13                	je     80106bec <sys_sleep+0x5a>
      release(&tickslock);
80106bd9:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106be0:	e8 b0 e8 ff ff       	call   80105495 <release>
      return -1;
80106be5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bea:	eb 36                	jmp    80106c22 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106bec:	c7 44 24 04 20 67 11 	movl   $0x80116720,0x4(%esp)
80106bf3:	80 
80106bf4:	c7 04 24 60 6f 11 80 	movl   $0x80116f60,(%esp)
80106bfb:	e8 0d e5 ff ff       	call   8010510d <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106c00:	a1 60 6f 11 80       	mov    0x80116f60,%eax
80106c05:	89 c2                	mov    %eax,%edx
80106c07:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106c0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c0d:	39 c2                	cmp    %eax,%edx
80106c0f:	72 bb                	jb     80106bcc <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106c11:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106c18:	e8 78 e8 ff ff       	call   80105495 <release>
  return 0;
...
80106c27:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106c2a:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106c31:	e8 fd e7 ff ff       	call   80105433 <acquire>
  xticks = ticks;
80106c36:	a1 60 6f 11 80       	mov    0x80116f60,%eax
80106c3b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106c3e:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106c45:	e8 4b e8 ff ff       	call   80105495 <release>
  return xticks;
...
80106c5c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106c60:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106c63:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106c67:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106c6b:	ee                   	out    %al,(%dx)
}
80106c6c:	c9                   	leave  
80106c6d:	c3                   	ret    
...
80106c71:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106c74:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106c7b:	00 
80106c7c:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106c83:	e8 c8 ff ff ff       	call   80106c50 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106c88:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106c8f:	00 
80106c90:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106c97:	e8 b4 ff ff ff       	call   80106c50 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106c9c:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106ca3:	00 
80106ca4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106cab:	e8 a0 ff ff ff       	call   80106c50 <outb>
  picenable(IRQ_TIMER);
80106cb0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106cb7:	e8 b9 d1 ff ff       	call   80103e75 <picenable>
}
80106cbc:	c9                   	leave  
80106cbd:	c3                   	ret    
	...
...
80106cc1:	06                   	push   %es
  pushl %fs
80106cc2:	0f a0                	push   %fs
  pushl %gs
80106cc4:	0f a8                	push   %gs
  pushal
80106cc6:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106cc7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106ccb:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106ccd:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106ccf:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106cd3:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106cd5:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106cd7:	54                   	push   %esp
  call trap
80106cd8:	e8 5a 02 00 00       	call   80106f37 <trap>
  addl $4, %esp
...
80106ce0:	61                   	popa   
  popl %gs
80106ce1:	0f a9                	pop    %gs
  popl %fs
80106ce3:	0f a1                	pop    %fs
  popl %es
80106ce5:	07                   	pop    %es
  popl %ds
80106ce6:	1f                   	pop    %ds
...
80106cef:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106cf2:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cf5:	83 e8 01             	sub    $0x1,%eax
80106cf8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106cfc:	8b 45 08             	mov    0x8(%ebp),%eax
80106cff:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106d03:	8b 45 08             	mov    0x8(%ebp),%eax
80106d06:	c1 e8 10             	shr    $0x10,%eax
80106d09:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106d0d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106d10:	0f 01 18             	lidtl  (%eax)
}
80106d13:	c9                   	leave  
80106d14:	c3                   	ret    
...
80106d19:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106d1c:	0f 20 d3             	mov    %cr2,%ebx
80106d1f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106d22:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106d2e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106d31:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106d38:	e9 c3 00 00 00       	jmp    80106e00 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106d3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d40:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106d47:	89 c2                	mov    %eax,%edx
80106d49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d4c:	66 89 14 c5 60 67 11 	mov    %dx,-0x7fee98a0(,%eax,8)
80106d53:	80 
80106d54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d57:	66 c7 04 c5 62 67 11 	movw   $0x8,-0x7fee989e(,%eax,8)
80106d5e:	80 08 00 
80106d61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d64:	0f b6 14 c5 64 67 11 	movzbl -0x7fee989c(,%eax,8),%edx
80106d6b:	80 
80106d6c:	83 e2 e0             	and    $0xffffffe0,%edx
80106d6f:	88 14 c5 64 67 11 80 	mov    %dl,-0x7fee989c(,%eax,8)
80106d76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d79:	0f b6 14 c5 64 67 11 	movzbl -0x7fee989c(,%eax,8),%edx
80106d80:	80 
80106d81:	83 e2 1f             	and    $0x1f,%edx
80106d84:	88 14 c5 64 67 11 80 	mov    %dl,-0x7fee989c(,%eax,8)
80106d8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d8e:	0f b6 14 c5 65 67 11 	movzbl -0x7fee989b(,%eax,8),%edx
80106d95:	80 
80106d96:	83 e2 f0             	and    $0xfffffff0,%edx
80106d99:	83 ca 0e             	or     $0xe,%edx
80106d9c:	88 14 c5 65 67 11 80 	mov    %dl,-0x7fee989b(,%eax,8)
80106da3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106da6:	0f b6 14 c5 65 67 11 	movzbl -0x7fee989b(,%eax,8),%edx
80106dad:	80 
80106dae:	83 e2 ef             	and    $0xffffffef,%edx
80106db1:	88 14 c5 65 67 11 80 	mov    %dl,-0x7fee989b(,%eax,8)
80106db8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dbb:	0f b6 14 c5 65 67 11 	movzbl -0x7fee989b(,%eax,8),%edx
80106dc2:	80 
80106dc3:	83 e2 9f             	and    $0xffffff9f,%edx
80106dc6:	88 14 c5 65 67 11 80 	mov    %dl,-0x7fee989b(,%eax,8)
80106dcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dd0:	0f b6 14 c5 65 67 11 	movzbl -0x7fee989b(,%eax,8),%edx
80106dd7:	80 
80106dd8:	83 ca 80             	or     $0xffffff80,%edx
80106ddb:	88 14 c5 65 67 11 80 	mov    %dl,-0x7fee989b(,%eax,8)
80106de2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106de5:	8b 04 85 ac c0 10 80 	mov    -0x7fef3f54(,%eax,4),%eax
80106dec:	c1 e8 10             	shr    $0x10,%eax
80106def:	89 c2                	mov    %eax,%edx
80106df1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106df4:	66 89 14 c5 66 67 11 	mov    %dx,-0x7fee989a(,%eax,8)
80106dfb:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106dfc:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106e00:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106e07:	0f 8e 30 ff ff ff    	jle    80106d3d <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106e0d:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106e12:	66 a3 60 69 11 80    	mov    %ax,0x80116960
80106e18:	66 c7 05 62 69 11 80 	movw   $0x8,0x80116962
80106e1f:	08 00 
80106e21:	0f b6 05 64 69 11 80 	movzbl 0x80116964,%eax
80106e28:	83 e0 e0             	and    $0xffffffe0,%eax
80106e2b:	a2 64 69 11 80       	mov    %al,0x80116964
80106e30:	0f b6 05 64 69 11 80 	movzbl 0x80116964,%eax
80106e37:	83 e0 1f             	and    $0x1f,%eax
80106e3a:	a2 64 69 11 80       	mov    %al,0x80116964
80106e3f:	0f b6 05 65 69 11 80 	movzbl 0x80116965,%eax
80106e46:	83 c8 0f             	or     $0xf,%eax
80106e49:	a2 65 69 11 80       	mov    %al,0x80116965
80106e4e:	0f b6 05 65 69 11 80 	movzbl 0x80116965,%eax
80106e55:	83 e0 ef             	and    $0xffffffef,%eax
80106e58:	a2 65 69 11 80       	mov    %al,0x80116965
80106e5d:	0f b6 05 65 69 11 80 	movzbl 0x80116965,%eax
80106e64:	83 c8 60             	or     $0x60,%eax
80106e67:	a2 65 69 11 80       	mov    %al,0x80116965
80106e6c:	0f b6 05 65 69 11 80 	movzbl 0x80116965,%eax
80106e73:	83 c8 80             	or     $0xffffff80,%eax
80106e76:	a2 65 69 11 80       	mov    %al,0x80116965
80106e7b:	a1 ac c1 10 80       	mov    0x8010c1ac,%eax
80106e80:	c1 e8 10             	shr    $0x10,%eax
80106e83:	66 a3 66 69 11 80    	mov    %ax,0x80116966
  
  initlock(&tickslock, "time");
80106e89:	c7 44 24 04 f0 95 10 	movl   $0x801095f0,0x4(%esp)
80106e90:	80 
80106e91:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106e98:	e8 75 e5 ff ff       	call   80105412 <initlock>
}
80106e9d:	c9                   	leave  
80106e9e:	c3                   	ret    
...
80106ea2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106ea5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106eac:	00 
80106ead:	c7 04 24 60 67 11 80 	movl   $0x80116760,(%esp)
80106eb4:	e8 33 fe ff ff       	call   80106cec <lidt>
}
80106eb9:	c9                   	leave  
80106eba:	c3                   	ret    

80106ebb <updateStats>:
...
80106ebe:	83 ec 10             	sub    $0x10,%esp
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80106ec1:	c7 45 fc 14 40 11 80 	movl   $0x80114014,-0x4(%ebp)
80106ec8:	eb 62                	jmp    80106f2c <updateStats+0x71>
		switch (p->state) {
80106eca:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106ecd:	8b 40 0c             	mov    0xc(%eax),%eax
80106ed0:	83 f8 03             	cmp    $0x3,%eax
80106ed3:	74 21                	je     80106ef6 <updateStats+0x3b>
80106ed5:	83 f8 04             	cmp    $0x4,%eax
80106ed8:	74 33                	je     80106f0d <updateStats+0x52>
80106eda:	83 f8 02             	cmp    $0x2,%eax
80106edd:	75 45                	jne    80106f24 <updateStats+0x69>
			case SLEEPING:
				p->stime++;
80106edf:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106ee2:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80106ee8:	8d 50 01             	lea    0x1(%eax),%edx
80106eeb:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106eee:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
				break;
80106ef4:	eb 2f                	jmp    80106f25 <updateStats+0x6a>
			case RUNNABLE:
				p->retime++;
80106ef6:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106ef9:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
80106eff:	8d 50 01             	lea    0x1(%eax),%edx
80106f02:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106f05:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
				break;
80106f0b:	eb 18                	jmp    80106f25 <updateStats+0x6a>
			case RUNNING:
				p->rutime++;
80106f0d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106f10:	8b 80 94 00 00 00    	mov    0x94(%eax),%eax
80106f16:	8d 50 01             	lea    0x1(%eax),%edx
80106f19:	8b 45 fc             	mov    -0x4(%ebp),%eax
80106f1c:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
				break;
80106f22:	eb 01                	jmp    80106f25 <updateStats+0x6a>
			default:
				break;
80106f24:	90                   	nop
} ptable;
...
void updateStats()
{
	struct proc* p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80106f25:	81 45 fc 9c 00 00 00 	addl   $0x9c,-0x4(%ebp)
80106f2c:	81 7d fc 14 67 11 80 	cmpl   $0x80116714,-0x4(%ebp)
80106f33:	72 95                	jb     80106eca <updateStats+0xf>
				break;
			default:
				break;
		}
...
80106f3d:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106f40:	8b 45 08             	mov    0x8(%ebp),%eax
80106f43:	8b 40 30             	mov    0x30(%eax),%eax
80106f46:	83 f8 40             	cmp    $0x40,%eax
80106f49:	75 4c                	jne    80106f97 <trap+0x60>
    if(proc->killed)
80106f4b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f51:	8b 40 28             	mov    0x28(%eax),%eax
80106f54:	85 c0                	test   %eax,%eax
80106f56:	74 0c                	je     80106f64 <trap+0x2d>
      exit(EXIT_STATUS_DEFAULT);
80106f58:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106f5f:	e8 5d d9 ff ff       	call   801048c1 <exit>
    proc->tf = tf;
80106f64:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f6a:	8b 55 08             	mov    0x8(%ebp),%edx
80106f6d:	89 50 1c             	mov    %edx,0x1c(%eax)
    syscall();
80106f70:	e8 30 eb ff ff       	call   80105aa5 <syscall>
    if(proc->killed)
80106f75:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f7b:	8b 40 28             	mov    0x28(%eax),%eax
80106f7e:	85 c0                	test   %eax,%eax
80106f80:	0f 84 26 02 00 00    	je     801071ac <trap+0x275>
      exit(EXIT_STATUS_DEFAULT);
80106f86:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106f8d:	e8 2f d9 ff ff       	call   801048c1 <exit>
    return;
80106f92:	e9 15 02 00 00       	jmp    801071ac <trap+0x275>
  }

  switch(tf->trapno){
80106f97:	8b 45 08             	mov    0x8(%ebp),%eax
80106f9a:	8b 40 30             	mov    0x30(%eax),%eax
80106f9d:	83 e8 20             	sub    $0x20,%eax
80106fa0:	83 f8 1f             	cmp    $0x1f,%eax
80106fa3:	0f 87 c1 00 00 00    	ja     8010706a <trap+0x133>
80106fa9:	8b 04 85 98 96 10 80 	mov    -0x7fef6968(,%eax,4),%eax
80106fb0:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106fb2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106fb8:	0f b6 00             	movzbl (%eax),%eax
80106fbb:	84 c0                	test   %al,%al
80106fbd:	75 36                	jne    80106ff5 <trap+0xbe>
      acquire(&tickslock);
80106fbf:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106fc6:	e8 68 e4 ff ff       	call   80105433 <acquire>
      ticks++;
80106fcb:	a1 60 6f 11 80       	mov    0x80116f60,%eax
80106fd0:	83 c0 01             	add    $0x1,%eax
80106fd3:	a3 60 6f 11 80       	mov    %eax,0x80116f60
      wakeup(&ticks);
80106fd8:	c7 04 24 60 6f 11 80 	movl   $0x80116f60,(%esp)
80106fdf:	e8 25 e2 ff ff       	call   80105209 <wakeup>
      release(&tickslock);
80106fe4:	c7 04 24 20 67 11 80 	movl   $0x80116720,(%esp)
80106feb:	e8 a5 e4 ff ff       	call   80105495 <release>

      updateStats();
80106ff0:	e8 c6 fe ff ff       	call   80106ebb <updateStats>
    }
    lapiceoi();
80106ff5:	e8 81 bf ff ff       	call   80102f7b <lapiceoi>
    break;
80106ffa:	e9 41 01 00 00       	jmp    80107140 <trap+0x209>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106fff:	e8 55 b7 ff ff       	call   80102759 <ideintr>
    lapiceoi();
80107004:	e8 72 bf ff ff       	call   80102f7b <lapiceoi>
    break;
80107009:	e9 32 01 00 00       	jmp    80107140 <trap+0x209>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010700e:	e8 1c bd ff ff       	call   80102d2f <kbdintr>
    lapiceoi();
80107013:	e8 63 bf ff ff       	call   80102f7b <lapiceoi>
    break;
80107018:	e9 23 01 00 00       	jmp    80107140 <trap+0x209>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010701d:	e8 92 03 00 00       	call   801073b4 <uartintr>
    lapiceoi();
80107022:	e8 54 bf ff ff       	call   80102f7b <lapiceoi>
    break;
80107027:	e9 14 01 00 00       	jmp    80107140 <trap+0x209>
  case T_IRQ0 + 7:
...
8010702c:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010702f:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80107035:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107039:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80107048:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010704c:	89 54 24 08          	mov    %edx,0x8(%esp)
80107050:	89 44 24 04          	mov    %eax,0x4(%esp)
80107054:	c7 04 24 f8 95 10 80 	movl   $0x801095f8,(%esp)
8010705b:	e8 41 93 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107060:	e8 16 bf ff ff       	call   80102f7b <lapiceoi>
    break;
80107065:	e9 d6 00 00 00       	jmp    80107140 <trap+0x209>
...
80107072:	74 11                	je     80107085 <trap+0x14e>
80107074:	8b 45 08             	mov    0x8(%ebp),%eax
80107077:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010707b:	0f b7 c0             	movzwl %ax,%eax
8010707e:	83 e0 03             	and    $0x3,%eax
80107081:	85 c0                	test   %eax,%eax
80107083:	75 46                	jne    801070cb <trap+0x194>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107085:	e8 8b fc ff ff       	call   80106d15 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
8010708a:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010708d:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107090:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107097:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010709a:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010709d:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801070a0:	8b 52 30             	mov    0x30(%edx),%edx
801070a3:	89 44 24 10          	mov    %eax,0x10(%esp)
801070a7:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801070ab:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801070af:	89 54 24 04          	mov    %edx,0x4(%esp)
801070b3:	c7 04 24 1c 96 10 80 	movl   $0x8010961c,(%esp)
801070ba:	e8 e2 92 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801070bf:	c7 04 24 4e 96 10 80 	movl   $0x8010964e,(%esp)
801070c6:	e8 72 94 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070cb:	e8 45 fc ff ff       	call   80106d15 <rcr2>
...
801070d2:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070d5:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
801070de:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070e1:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801070e4:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070e7:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801070ea:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801070ed:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801070f0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070f6:	83 c0 70             	add    $0x70,%eax
...
80107105:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80107109:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010710d:	89 74 24 14          	mov    %esi,0x14(%esp)
80107111:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107115:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107119:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010711c:	89 54 24 08          	mov    %edx,0x8(%esp)
80107120:	89 44 24 04          	mov    %eax,0x4(%esp)
80107124:	c7 04 24 54 96 10 80 	movl   $0x80109654,(%esp)
8010712b:	e8 71 92 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107130:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107136:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
8010713d:	eb 01                	jmp    80107140 <trap+0x209>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107148:	74 2b                	je     80107175 <trap+0x23e>
8010714a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107150:	8b 40 28             	mov    0x28(%eax),%eax
80107153:	85 c0                	test   %eax,%eax
80107155:	74 1e                	je     80107175 <trap+0x23e>
...
80107167:	75 0c                	jne    80107175 <trap+0x23e>
    exit(EXIT_STATUS_DEFAULT);
80107169:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80107170:	e8 4c d7 ff ff       	call   801048c1 <exit>
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107175:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010717b:	85 c0                	test   %eax,%eax
8010717d:	74 2e                	je     801071ad <trap+0x276>
8010717f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107185:	8b 40 28             	mov    0x28(%eax),%eax
80107188:	85 c0                	test   %eax,%eax
8010718a:	74 21                	je     801071ad <trap+0x276>
8010718c:	8b 45 08             	mov    0x8(%ebp),%eax
8010718f:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107193:	0f b7 c0             	movzwl %ax,%eax
80107196:	83 e0 03             	and    $0x3,%eax
80107199:	83 f8 03             	cmp    $0x3,%eax
8010719c:	75 0f                	jne    801071ad <trap+0x276>
    exit(EXIT_STATUS_DEFAULT);
8010719e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801071a5:	e8 17 d7 ff ff       	call   801048c1 <exit>
801071aa:	eb 01                	jmp    801071ad <trap+0x276>
      exit(EXIT_STATUS_DEFAULT);
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
801071ad:	83 c4 3c             	add    $0x3c,%esp
801071b0:	5b                   	pop    %ebx
801071b1:	5e                   	pop    %esi
801071b2:	5f                   	pop    %edi
801071b3:	5d                   	pop    %ebp
801071b4:	c3                   	ret    
801071b5:	00 00                	add    %al,(%eax)
	...
...
801071bc:	83 ec 14             	sub    $0x14,%esp
801071bf:	8b 45 08             	mov    0x8(%ebp),%eax
801071c2:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801071c6:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
801071ca:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801071ce:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
801071d2:	ec                   	in     (%dx),%al
801071d3:	89 c3                	mov    %eax,%ebx
801071d5:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
801071d8:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
801071dc:	83 c4 14             	add    $0x14,%esp
801071df:	5b                   	pop    %ebx
801071e0:	5d                   	pop    %ebp
801071e1:	c3                   	ret    
...
801071e8:	8b 55 08             	mov    0x8(%ebp),%edx
801071eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801071ee:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801071f2:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801071f5:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801071f9:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80107203:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
80107206:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010720d:	00 
8010720e:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107215:	e8 c8 ff ff ff       	call   801071e2 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
8010721a:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107221:	00 
80107222:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107229:	e8 b4 ff ff ff       	call   801071e2 <outb>
  outb(COM1+0, 115200/9600);
8010722e:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80107235:	00 
80107236:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010723d:	e8 a0 ff ff ff       	call   801071e2 <outb>
  outb(COM1+1, 0);
80107242:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107249:	00 
8010724a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107251:	e8 8c ff ff ff       	call   801071e2 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107256:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010725d:	00 
8010725e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107265:	e8 78 ff ff ff       	call   801071e2 <outb>
  outb(COM1+4, 0);
8010726a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107271:	00 
80107272:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107279:	e8 64 ff ff ff       	call   801071e2 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010727e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107285:	00 
80107286:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010728d:	e8 50 ff ff ff       	call   801071e2 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107292:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107299:	e8 1a ff ff ff       	call   801071b8 <inb>
8010729e:	3c ff                	cmp    $0xff,%al
801072a0:	74 6c                	je     8010730e <uartinit+0x10e>
    return;
  uart = 1;
801072a2:	c7 05 cc cc 10 80 01 	movl   $0x1,0x8010cccc
801072a9:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801072ac:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801072b3:	e8 00 ff ff ff       	call   801071b8 <inb>
  inb(COM1+0);
801072b8:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801072bf:	e8 f4 fe ff ff       	call   801071b8 <inb>
  picenable(IRQ_COM1);
801072c4:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801072cb:	e8 a5 cb ff ff       	call   80103e75 <picenable>
  ioapicenable(IRQ_COM1, 0);
801072d0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801072d7:	00 
801072d8:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801072df:	e8 fa b6 ff ff       	call   801029de <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801072e4:	c7 45 f4 18 97 10 80 	movl   $0x80109718,-0xc(%ebp)
801072eb:	eb 15                	jmp    80107302 <uartinit+0x102>
    uartputc(*p);
801072ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072f0:	0f b6 00             	movzbl (%eax),%eax
801072f3:	0f be c0             	movsbl %al,%eax
801072f6:	89 04 24             	mov    %eax,(%esp)
801072f9:	e8 13 00 00 00       	call   80107311 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801072fe:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107302:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107305:	0f b6 00             	movzbl (%eax),%eax
80107308:	84 c0                	test   %al,%al
8010730a:	75 e1                	jne    801072ed <uartinit+0xed>
8010730c:	eb 01                	jmp    8010730f <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80107314:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80107317:	a1 cc cc 10 80       	mov    0x8010cccc,%eax
8010731c:	85 c0                	test   %eax,%eax
8010731e:	74 4d                	je     8010736d <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107320:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107327:	eb 10                	jmp    80107339 <uartputc+0x28>
    microdelay(10);
80107329:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107330:	e8 6b bc ff ff       	call   80102fa0 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107335:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107339:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
8010733d:	7f 16                	jg     80107355 <uartputc+0x44>
8010733f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107346:	e8 6d fe ff ff       	call   801071b8 <inb>
8010734b:	0f b6 c0             	movzbl %al,%eax
8010734e:	83 e0 20             	and    $0x20,%eax
80107351:	85 c0                	test   %eax,%eax
80107353:	74 d4                	je     80107329 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80107355:	8b 45 08             	mov    0x8(%ebp),%eax
80107358:	0f b6 c0             	movzbl %al,%eax
8010735b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010735f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107366:	e8 77 fe ff ff       	call   801071e2 <outb>
8010736b:	eb 01                	jmp    8010736e <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80107373:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107376:	a1 cc cc 10 80       	mov    0x8010cccc,%eax
8010737b:	85 c0                	test   %eax,%eax
8010737d:	75 07                	jne    80107386 <uartgetc+0x16>
    return -1;
8010737f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107384:	eb 2c                	jmp    801073b2 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107386:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010738d:	e8 26 fe ff ff       	call   801071b8 <inb>
80107392:	0f b6 c0             	movzbl %al,%eax
80107395:	83 e0 01             	and    $0x1,%eax
80107398:	85 c0                	test   %eax,%eax
8010739a:	75 07                	jne    801073a3 <uartgetc+0x33>
    return -1;
8010739c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073a1:	eb 0f                	jmp    801073b2 <uartgetc+0x42>
  return inb(COM1+0);
801073a3:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801073aa:	e8 09 fe ff ff       	call   801071b8 <inb>
...
801073b7:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801073ba:	c7 04 24 70 73 10 80 	movl   $0x80107370,(%esp)
801073c1:	e8 e7 93 ff ff       	call   801007ad <consoleintr>
}
801073c6:	c9                   	leave  
801073c7:	c3                   	ret    
...
801073ca:	6a 00                	push   $0x0
  jmp alltraps
801073cc:	e9 ef f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073d3:	6a 01                	push   $0x1
  jmp alltraps
801073d5:	e9 e6 f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073da:	6a 00                	push   $0x0
  pushl $2
801073dc:	6a 02                	push   $0x2
  jmp alltraps
801073de:	e9 dd f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073e3:	6a 00                	push   $0x0
  pushl $3
801073e5:	6a 03                	push   $0x3
  jmp alltraps
801073e7:	e9 d4 f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073ec:	6a 00                	push   $0x0
  pushl $4
801073ee:	6a 04                	push   $0x4
  jmp alltraps
801073f0:	e9 cb f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073f5:	6a 00                	push   $0x0
  pushl $5
801073f7:	6a 05                	push   $0x5
  jmp alltraps
801073f9:	e9 c2 f8 ff ff       	jmp    80106cc0 <alltraps>
...
801073fe:	6a 00                	push   $0x0
  pushl $6
80107400:	6a 06                	push   $0x6
  jmp alltraps
80107402:	e9 b9 f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107407:	6a 00                	push   $0x0
  pushl $7
80107409:	6a 07                	push   $0x7
  jmp alltraps
8010740b:	e9 b0 f8 ff ff       	jmp    80106cc0 <alltraps>

80107410 <vector8>:
.globl vector8
vector8:
  pushl $8
80107410:	6a 08                	push   $0x8
  jmp alltraps
80107412:	e9 a9 f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107417:	6a 00                	push   $0x0
  pushl $9
80107419:	6a 09                	push   $0x9
  jmp alltraps
8010741b:	e9 a0 f8 ff ff       	jmp    80106cc0 <alltraps>

80107420 <vector10>:
.globl vector10
vector10:
  pushl $10
80107420:	6a 0a                	push   $0xa
  jmp alltraps
80107422:	e9 99 f8 ff ff       	jmp    80106cc0 <alltraps>

80107427 <vector11>:
.globl vector11
vector11:
  pushl $11
80107427:	6a 0b                	push   $0xb
  jmp alltraps
80107429:	e9 92 f8 ff ff       	jmp    80106cc0 <alltraps>

8010742e <vector12>:
.globl vector12
vector12:
  pushl $12
8010742e:	6a 0c                	push   $0xc
  jmp alltraps
80107430:	e9 8b f8 ff ff       	jmp    80106cc0 <alltraps>

80107435 <vector13>:
.globl vector13
vector13:
  pushl $13
80107435:	6a 0d                	push   $0xd
  jmp alltraps
80107437:	e9 84 f8 ff ff       	jmp    80106cc0 <alltraps>

8010743c <vector14>:
.globl vector14
vector14:
  pushl $14
8010743c:	6a 0e                	push   $0xe
  jmp alltraps
8010743e:	e9 7d f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107443:	6a 00                	push   $0x0
  pushl $15
80107445:	6a 0f                	push   $0xf
  jmp alltraps
80107447:	e9 74 f8 ff ff       	jmp    80106cc0 <alltraps>
...
8010744c:	6a 00                	push   $0x0
  pushl $16
8010744e:	6a 10                	push   $0x10
  jmp alltraps
80107450:	e9 6b f8 ff ff       	jmp    80106cc0 <alltraps>

80107455 <vector17>:
.globl vector17
vector17:
  pushl $17
80107455:	6a 11                	push   $0x11
  jmp alltraps
80107457:	e9 64 f8 ff ff       	jmp    80106cc0 <alltraps>
...
8010745c:	6a 00                	push   $0x0
  pushl $18
8010745e:	6a 12                	push   $0x12
  jmp alltraps
80107460:	e9 5b f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107465:	6a 00                	push   $0x0
  pushl $19
80107467:	6a 13                	push   $0x13
  jmp alltraps
80107469:	e9 52 f8 ff ff       	jmp    80106cc0 <alltraps>
...
8010746e:	6a 00                	push   $0x0
  pushl $20
80107470:	6a 14                	push   $0x14
  jmp alltraps
80107472:	e9 49 f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107477:	6a 00                	push   $0x0
  pushl $21
80107479:	6a 15                	push   $0x15
  jmp alltraps
8010747b:	e9 40 f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107480:	6a 00                	push   $0x0
  pushl $22
80107482:	6a 16                	push   $0x16
  jmp alltraps
80107484:	e9 37 f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107489:	6a 00                	push   $0x0
  pushl $23
8010748b:	6a 17                	push   $0x17
  jmp alltraps
8010748d:	e9 2e f8 ff ff       	jmp    80106cc0 <alltraps>
...
80107492:	6a 00                	push   $0x0
  pushl $24
80107494:	6a 18                	push   $0x18
  jmp alltraps
80107496:	e9 25 f8 ff ff       	jmp    80106cc0 <alltraps>
...
8010749b:	6a 00                	push   $0x0
  pushl $25
8010749d:	6a 19                	push   $0x19
  jmp alltraps
8010749f:	e9 1c f8 ff ff       	jmp    80106cc0 <alltraps>
...
801074a4:	6a 00                	push   $0x0
  pushl $26
801074a6:	6a 1a                	push   $0x1a
  jmp alltraps
801074a8:	e9 13 f8 ff ff       	jmp    80106cc0 <alltraps>
...
801074ad:	6a 00                	push   $0x0
  pushl $27
801074af:	6a 1b                	push   $0x1b
  jmp alltraps
801074b1:	e9 0a f8 ff ff       	jmp    80106cc0 <alltraps>
...
801074b6:	6a 00                	push   $0x0
  pushl $28
801074b8:	6a 1c                	push   $0x1c
  jmp alltraps
801074ba:	e9 01 f8 ff ff       	jmp    80106cc0 <alltraps>
...
801074bf:	6a 00                	push   $0x0
  pushl $29
801074c1:	6a 1d                	push   $0x1d
  jmp alltraps
801074c3:	e9 f8 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074c8:	6a 00                	push   $0x0
  pushl $30
801074ca:	6a 1e                	push   $0x1e
  jmp alltraps
801074cc:	e9 ef f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074d1:	6a 00                	push   $0x0
  pushl $31
801074d3:	6a 1f                	push   $0x1f
  jmp alltraps
801074d5:	e9 e6 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074da:	6a 00                	push   $0x0
  pushl $32
801074dc:	6a 20                	push   $0x20
  jmp alltraps
801074de:	e9 dd f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074e3:	6a 00                	push   $0x0
  pushl $33
801074e5:	6a 21                	push   $0x21
  jmp alltraps
801074e7:	e9 d4 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074ec:	6a 00                	push   $0x0
  pushl $34
801074ee:	6a 22                	push   $0x22
  jmp alltraps
801074f0:	e9 cb f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074f5:	6a 00                	push   $0x0
  pushl $35
801074f7:	6a 23                	push   $0x23
  jmp alltraps
801074f9:	e9 c2 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801074fe:	6a 00                	push   $0x0
  pushl $36
80107500:	6a 24                	push   $0x24
  jmp alltraps
80107502:	e9 b9 f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107507:	6a 00                	push   $0x0
  pushl $37
80107509:	6a 25                	push   $0x25
  jmp alltraps
8010750b:	e9 b0 f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107510:	6a 00                	push   $0x0
  pushl $38
80107512:	6a 26                	push   $0x26
  jmp alltraps
80107514:	e9 a7 f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107519:	6a 00                	push   $0x0
  pushl $39
8010751b:	6a 27                	push   $0x27
  jmp alltraps
8010751d:	e9 9e f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107522:	6a 00                	push   $0x0
  pushl $40
80107524:	6a 28                	push   $0x28
  jmp alltraps
80107526:	e9 95 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010752b:	6a 00                	push   $0x0
  pushl $41
8010752d:	6a 29                	push   $0x29
  jmp alltraps
8010752f:	e9 8c f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107534:	6a 00                	push   $0x0
  pushl $42
80107536:	6a 2a                	push   $0x2a
  jmp alltraps
80107538:	e9 83 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010753d:	6a 00                	push   $0x0
  pushl $43
8010753f:	6a 2b                	push   $0x2b
  jmp alltraps
80107541:	e9 7a f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107546:	6a 00                	push   $0x0
  pushl $44
80107548:	6a 2c                	push   $0x2c
  jmp alltraps
8010754a:	e9 71 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010754f:	6a 00                	push   $0x0
  pushl $45
80107551:	6a 2d                	push   $0x2d
  jmp alltraps
80107553:	e9 68 f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107558:	6a 00                	push   $0x0
  pushl $46
8010755a:	6a 2e                	push   $0x2e
  jmp alltraps
8010755c:	e9 5f f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107561:	6a 00                	push   $0x0
  pushl $47
80107563:	6a 2f                	push   $0x2f
  jmp alltraps
80107565:	e9 56 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010756a:	6a 00                	push   $0x0
  pushl $48
8010756c:	6a 30                	push   $0x30
  jmp alltraps
8010756e:	e9 4d f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107573:	6a 00                	push   $0x0
  pushl $49
80107575:	6a 31                	push   $0x31
  jmp alltraps
80107577:	e9 44 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010757c:	6a 00                	push   $0x0
  pushl $50
8010757e:	6a 32                	push   $0x32
  jmp alltraps
80107580:	e9 3b f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107585:	6a 00                	push   $0x0
  pushl $51
80107587:	6a 33                	push   $0x33
  jmp alltraps
80107589:	e9 32 f7 ff ff       	jmp    80106cc0 <alltraps>
...
8010758e:	6a 00                	push   $0x0
  pushl $52
80107590:	6a 34                	push   $0x34
  jmp alltraps
80107592:	e9 29 f7 ff ff       	jmp    80106cc0 <alltraps>
...
80107597:	6a 00                	push   $0x0
  pushl $53
80107599:	6a 35                	push   $0x35
  jmp alltraps
8010759b:	e9 20 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801075a0:	6a 00                	push   $0x0
  pushl $54
801075a2:	6a 36                	push   $0x36
  jmp alltraps
801075a4:	e9 17 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801075a9:	6a 00                	push   $0x0
  pushl $55
801075ab:	6a 37                	push   $0x37
  jmp alltraps
801075ad:	e9 0e f7 ff ff       	jmp    80106cc0 <alltraps>
...
801075b2:	6a 00                	push   $0x0
  pushl $56
801075b4:	6a 38                	push   $0x38
  jmp alltraps
801075b6:	e9 05 f7 ff ff       	jmp    80106cc0 <alltraps>
...
801075bb:	6a 00                	push   $0x0
  pushl $57
801075bd:	6a 39                	push   $0x39
  jmp alltraps
801075bf:	e9 fc f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075c4:	6a 00                	push   $0x0
  pushl $58
801075c6:	6a 3a                	push   $0x3a
  jmp alltraps
801075c8:	e9 f3 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075cd:	6a 00                	push   $0x0
  pushl $59
801075cf:	6a 3b                	push   $0x3b
  jmp alltraps
801075d1:	e9 ea f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075d6:	6a 00                	push   $0x0
  pushl $60
801075d8:	6a 3c                	push   $0x3c
  jmp alltraps
801075da:	e9 e1 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075df:	6a 00                	push   $0x0
  pushl $61
801075e1:	6a 3d                	push   $0x3d
  jmp alltraps
801075e3:	e9 d8 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075e8:	6a 00                	push   $0x0
  pushl $62
801075ea:	6a 3e                	push   $0x3e
  jmp alltraps
801075ec:	e9 cf f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075f1:	6a 00                	push   $0x0
  pushl $63
801075f3:	6a 3f                	push   $0x3f
  jmp alltraps
801075f5:	e9 c6 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801075fa:	6a 00                	push   $0x0
  pushl $64
801075fc:	6a 40                	push   $0x40
  jmp alltraps
801075fe:	e9 bd f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107603:	6a 00                	push   $0x0
  pushl $65
80107605:	6a 41                	push   $0x41
  jmp alltraps
80107607:	e9 b4 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010760c:	6a 00                	push   $0x0
  pushl $66
8010760e:	6a 42                	push   $0x42
  jmp alltraps
80107610:	e9 ab f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107615:	6a 00                	push   $0x0
  pushl $67
80107617:	6a 43                	push   $0x43
  jmp alltraps
80107619:	e9 a2 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010761e:	6a 00                	push   $0x0
  pushl $68
80107620:	6a 44                	push   $0x44
  jmp alltraps
80107622:	e9 99 f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107627:	6a 00                	push   $0x0
  pushl $69
80107629:	6a 45                	push   $0x45
  jmp alltraps
8010762b:	e9 90 f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107630:	6a 00                	push   $0x0
  pushl $70
80107632:	6a 46                	push   $0x46
  jmp alltraps
80107634:	e9 87 f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107639:	6a 00                	push   $0x0
  pushl $71
8010763b:	6a 47                	push   $0x47
  jmp alltraps
8010763d:	e9 7e f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107642:	6a 00                	push   $0x0
  pushl $72
80107644:	6a 48                	push   $0x48
  jmp alltraps
80107646:	e9 75 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010764b:	6a 00                	push   $0x0
  pushl $73
8010764d:	6a 49                	push   $0x49
  jmp alltraps
8010764f:	e9 6c f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107654:	6a 00                	push   $0x0
  pushl $74
80107656:	6a 4a                	push   $0x4a
  jmp alltraps
80107658:	e9 63 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010765d:	6a 00                	push   $0x0
  pushl $75
8010765f:	6a 4b                	push   $0x4b
  jmp alltraps
80107661:	e9 5a f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107666:	6a 00                	push   $0x0
  pushl $76
80107668:	6a 4c                	push   $0x4c
  jmp alltraps
8010766a:	e9 51 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010766f:	6a 00                	push   $0x0
  pushl $77
80107671:	6a 4d                	push   $0x4d
  jmp alltraps
80107673:	e9 48 f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107678:	6a 00                	push   $0x0
  pushl $78
8010767a:	6a 4e                	push   $0x4e
  jmp alltraps
8010767c:	e9 3f f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107681:	6a 00                	push   $0x0
  pushl $79
80107683:	6a 4f                	push   $0x4f
  jmp alltraps
80107685:	e9 36 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010768a:	6a 00                	push   $0x0
  pushl $80
8010768c:	6a 50                	push   $0x50
  jmp alltraps
8010768e:	e9 2d f6 ff ff       	jmp    80106cc0 <alltraps>
...
80107693:	6a 00                	push   $0x0
  pushl $81
80107695:	6a 51                	push   $0x51
  jmp alltraps
80107697:	e9 24 f6 ff ff       	jmp    80106cc0 <alltraps>
...
8010769c:	6a 00                	push   $0x0
  pushl $82
8010769e:	6a 52                	push   $0x52
  jmp alltraps
801076a0:	e9 1b f6 ff ff       	jmp    80106cc0 <alltraps>
...
801076a5:	6a 00                	push   $0x0
  pushl $83
801076a7:	6a 53                	push   $0x53
  jmp alltraps
801076a9:	e9 12 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801076ae:	6a 00                	push   $0x0
  pushl $84
801076b0:	6a 54                	push   $0x54
  jmp alltraps
801076b2:	e9 09 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801076b7:	6a 00                	push   $0x0
  pushl $85
801076b9:	6a 55                	push   $0x55
  jmp alltraps
801076bb:	e9 00 f6 ff ff       	jmp    80106cc0 <alltraps>
...
801076c0:	6a 00                	push   $0x0
  pushl $86
801076c2:	6a 56                	push   $0x56
  jmp alltraps
801076c4:	e9 f7 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076c9:	6a 00                	push   $0x0
  pushl $87
801076cb:	6a 57                	push   $0x57
  jmp alltraps
801076cd:	e9 ee f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076d2:	6a 00                	push   $0x0
  pushl $88
801076d4:	6a 58                	push   $0x58
  jmp alltraps
801076d6:	e9 e5 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076db:	6a 00                	push   $0x0
  pushl $89
801076dd:	6a 59                	push   $0x59
  jmp alltraps
801076df:	e9 dc f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076e4:	6a 00                	push   $0x0
  pushl $90
801076e6:	6a 5a                	push   $0x5a
  jmp alltraps
801076e8:	e9 d3 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076ed:	6a 00                	push   $0x0
  pushl $91
801076ef:	6a 5b                	push   $0x5b
  jmp alltraps
801076f1:	e9 ca f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076f6:	6a 00                	push   $0x0
  pushl $92
801076f8:	6a 5c                	push   $0x5c
  jmp alltraps
801076fa:	e9 c1 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801076ff:	6a 00                	push   $0x0
  pushl $93
80107701:	6a 5d                	push   $0x5d
  jmp alltraps
80107703:	e9 b8 f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107708:	6a 00                	push   $0x0
  pushl $94
8010770a:	6a 5e                	push   $0x5e
  jmp alltraps
8010770c:	e9 af f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107711:	6a 00                	push   $0x0
  pushl $95
80107713:	6a 5f                	push   $0x5f
  jmp alltraps
80107715:	e9 a6 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010771a:	6a 00                	push   $0x0
  pushl $96
8010771c:	6a 60                	push   $0x60
  jmp alltraps
8010771e:	e9 9d f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107723:	6a 00                	push   $0x0
  pushl $97
80107725:	6a 61                	push   $0x61
  jmp alltraps
80107727:	e9 94 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010772c:	6a 00                	push   $0x0
  pushl $98
8010772e:	6a 62                	push   $0x62
  jmp alltraps
80107730:	e9 8b f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107735:	6a 00                	push   $0x0
  pushl $99
80107737:	6a 63                	push   $0x63
  jmp alltraps
80107739:	e9 82 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010773e:	6a 00                	push   $0x0
  pushl $100
80107740:	6a 64                	push   $0x64
  jmp alltraps
80107742:	e9 79 f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107747:	6a 00                	push   $0x0
  pushl $101
80107749:	6a 65                	push   $0x65
  jmp alltraps
8010774b:	e9 70 f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107750:	6a 00                	push   $0x0
  pushl $102
80107752:	6a 66                	push   $0x66
  jmp alltraps
80107754:	e9 67 f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107759:	6a 00                	push   $0x0
  pushl $103
8010775b:	6a 67                	push   $0x67
  jmp alltraps
8010775d:	e9 5e f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107762:	6a 00                	push   $0x0
  pushl $104
80107764:	6a 68                	push   $0x68
  jmp alltraps
80107766:	e9 55 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010776b:	6a 00                	push   $0x0
  pushl $105
8010776d:	6a 69                	push   $0x69
  jmp alltraps
8010776f:	e9 4c f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107774:	6a 00                	push   $0x0
  pushl $106
80107776:	6a 6a                	push   $0x6a
  jmp alltraps
80107778:	e9 43 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010777d:	6a 00                	push   $0x0
  pushl $107
8010777f:	6a 6b                	push   $0x6b
  jmp alltraps
80107781:	e9 3a f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107786:	6a 00                	push   $0x0
  pushl $108
80107788:	6a 6c                	push   $0x6c
  jmp alltraps
8010778a:	e9 31 f5 ff ff       	jmp    80106cc0 <alltraps>
...
8010778f:	6a 00                	push   $0x0
  pushl $109
80107791:	6a 6d                	push   $0x6d
  jmp alltraps
80107793:	e9 28 f5 ff ff       	jmp    80106cc0 <alltraps>
...
80107798:	6a 00                	push   $0x0
  pushl $110
8010779a:	6a 6e                	push   $0x6e
  jmp alltraps
8010779c:	e9 1f f5 ff ff       	jmp    80106cc0 <alltraps>
...
801077a1:	6a 00                	push   $0x0
  pushl $111
801077a3:	6a 6f                	push   $0x6f
  jmp alltraps
801077a5:	e9 16 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801077aa:	6a 00                	push   $0x0
  pushl $112
801077ac:	6a 70                	push   $0x70
  jmp alltraps
801077ae:	e9 0d f5 ff ff       	jmp    80106cc0 <alltraps>
...
801077b3:	6a 00                	push   $0x0
  pushl $113
801077b5:	6a 71                	push   $0x71
  jmp alltraps
801077b7:	e9 04 f5 ff ff       	jmp    80106cc0 <alltraps>
...
801077bc:	6a 00                	push   $0x0
  pushl $114
801077be:	6a 72                	push   $0x72
  jmp alltraps
801077c0:	e9 fb f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077c5:	6a 00                	push   $0x0
  pushl $115
801077c7:	6a 73                	push   $0x73
  jmp alltraps
801077c9:	e9 f2 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077ce:	6a 00                	push   $0x0
  pushl $116
801077d0:	6a 74                	push   $0x74
  jmp alltraps
801077d2:	e9 e9 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077d7:	6a 00                	push   $0x0
  pushl $117
801077d9:	6a 75                	push   $0x75
  jmp alltraps
801077db:	e9 e0 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077e0:	6a 00                	push   $0x0
  pushl $118
801077e2:	6a 76                	push   $0x76
  jmp alltraps
801077e4:	e9 d7 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077e9:	6a 00                	push   $0x0
  pushl $119
801077eb:	6a 77                	push   $0x77
  jmp alltraps
801077ed:	e9 ce f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077f2:	6a 00                	push   $0x0
  pushl $120
801077f4:	6a 78                	push   $0x78
  jmp alltraps
801077f6:	e9 c5 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801077fb:	6a 00                	push   $0x0
  pushl $121
801077fd:	6a 79                	push   $0x79
  jmp alltraps
801077ff:	e9 bc f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107804:	6a 00                	push   $0x0
  pushl $122
80107806:	6a 7a                	push   $0x7a
  jmp alltraps
80107808:	e9 b3 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010780d:	6a 00                	push   $0x0
  pushl $123
8010780f:	6a 7b                	push   $0x7b
  jmp alltraps
80107811:	e9 aa f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107816:	6a 00                	push   $0x0
  pushl $124
80107818:	6a 7c                	push   $0x7c
  jmp alltraps
8010781a:	e9 a1 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010781f:	6a 00                	push   $0x0
  pushl $125
80107821:	6a 7d                	push   $0x7d
  jmp alltraps
80107823:	e9 98 f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107828:	6a 00                	push   $0x0
  pushl $126
8010782a:	6a 7e                	push   $0x7e
  jmp alltraps
8010782c:	e9 8f f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107831:	6a 00                	push   $0x0
  pushl $127
80107833:	6a 7f                	push   $0x7f
  jmp alltraps
80107835:	e9 86 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010783a:	6a 00                	push   $0x0
  pushl $128
8010783c:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107841:	e9 7a f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107846:	6a 00                	push   $0x0
  pushl $129
80107848:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010784d:	e9 6e f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107852:	6a 00                	push   $0x0
  pushl $130
80107854:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107859:	e9 62 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010785e:	6a 00                	push   $0x0
  pushl $131
80107860:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107865:	e9 56 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010786a:	6a 00                	push   $0x0
  pushl $132
8010786c:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107871:	e9 4a f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107876:	6a 00                	push   $0x0
  pushl $133
80107878:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010787d:	e9 3e f4 ff ff       	jmp    80106cc0 <alltraps>
...
80107882:	6a 00                	push   $0x0
  pushl $134
80107884:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107889:	e9 32 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010788e:	6a 00                	push   $0x0
  pushl $135
80107890:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107895:	e9 26 f4 ff ff       	jmp    80106cc0 <alltraps>
...
8010789a:	6a 00                	push   $0x0
  pushl $136
8010789c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801078a1:	e9 1a f4 ff ff       	jmp    80106cc0 <alltraps>
...
801078a6:	6a 00                	push   $0x0
  pushl $137
801078a8:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801078ad:	e9 0e f4 ff ff       	jmp    80106cc0 <alltraps>
...
801078b2:	6a 00                	push   $0x0
  pushl $138
801078b4:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801078b9:	e9 02 f4 ff ff       	jmp    80106cc0 <alltraps>
...
801078be:	6a 00                	push   $0x0
  pushl $139
801078c0:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801078c5:	e9 f6 f3 ff ff       	jmp    80106cc0 <alltraps>
...
801078ca:	6a 00                	push   $0x0
  pushl $140
801078cc:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801078d1:	e9 ea f3 ff ff       	jmp    80106cc0 <alltraps>
...
801078d6:	6a 00                	push   $0x0
  pushl $141
801078d8:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801078dd:	e9 de f3 ff ff       	jmp    80106cc0 <alltraps>
...
801078e2:	6a 00                	push   $0x0
  pushl $142
801078e4:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801078e9:	e9 d2 f3 ff ff       	jmp    80106cc0 <alltraps>
...
801078ee:	6a 00                	push   $0x0
  pushl $143
801078f0:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801078f5:	e9 c6 f3 ff ff       	jmp    80106cc0 <alltraps>
...
801078fa:	6a 00                	push   $0x0
  pushl $144
801078fc:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107901:	e9 ba f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107906:	6a 00                	push   $0x0
  pushl $145
80107908:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010790d:	e9 ae f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107912:	6a 00                	push   $0x0
  pushl $146
80107914:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107919:	e9 a2 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010791e:	6a 00                	push   $0x0
  pushl $147
80107920:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107925:	e9 96 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010792a:	6a 00                	push   $0x0
  pushl $148
8010792c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107931:	e9 8a f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107936:	6a 00                	push   $0x0
  pushl $149
80107938:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010793d:	e9 7e f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107942:	6a 00                	push   $0x0
  pushl $150
80107944:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107949:	e9 72 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010794e:	6a 00                	push   $0x0
  pushl $151
80107950:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107955:	e9 66 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010795a:	6a 00                	push   $0x0
  pushl $152
8010795c:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107961:	e9 5a f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107966:	6a 00                	push   $0x0
  pushl $153
80107968:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010796d:	e9 4e f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107972:	6a 00                	push   $0x0
  pushl $154
80107974:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107979:	e9 42 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010797e:	6a 00                	push   $0x0
  pushl $155
80107980:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107985:	e9 36 f3 ff ff       	jmp    80106cc0 <alltraps>
...
8010798a:	6a 00                	push   $0x0
  pushl $156
8010798c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107991:	e9 2a f3 ff ff       	jmp    80106cc0 <alltraps>
...
80107996:	6a 00                	push   $0x0
  pushl $157
80107998:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010799d:	e9 1e f3 ff ff       	jmp    80106cc0 <alltraps>
...
801079a2:	6a 00                	push   $0x0
  pushl $158
801079a4:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801079a9:	e9 12 f3 ff ff       	jmp    80106cc0 <alltraps>
...
801079ae:	6a 00                	push   $0x0
  pushl $159
801079b0:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801079b5:	e9 06 f3 ff ff       	jmp    80106cc0 <alltraps>
...
801079ba:	6a 00                	push   $0x0
  pushl $160
801079bc:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801079c1:	e9 fa f2 ff ff       	jmp    80106cc0 <alltraps>
...
801079c6:	6a 00                	push   $0x0
  pushl $161
801079c8:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801079cd:	e9 ee f2 ff ff       	jmp    80106cc0 <alltraps>
...
801079d2:	6a 00                	push   $0x0
  pushl $162
801079d4:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801079d9:	e9 e2 f2 ff ff       	jmp    80106cc0 <alltraps>
...
801079de:	6a 00                	push   $0x0
  pushl $163
801079e0:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801079e5:	e9 d6 f2 ff ff       	jmp    80106cc0 <alltraps>
...
801079ea:	6a 00                	push   $0x0
  pushl $164
801079ec:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801079f1:	e9 ca f2 ff ff       	jmp    80106cc0 <alltraps>
...
801079f6:	6a 00                	push   $0x0
  pushl $165
801079f8:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801079fd:	e9 be f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a02:	6a 00                	push   $0x0
  pushl $166
80107a04:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107a09:	e9 b2 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a0e:	6a 00                	push   $0x0
  pushl $167
80107a10:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107a15:	e9 a6 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a1a:	6a 00                	push   $0x0
  pushl $168
80107a1c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107a21:	e9 9a f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a26:	6a 00                	push   $0x0
  pushl $169
80107a28:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107a2d:	e9 8e f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a32:	6a 00                	push   $0x0
  pushl $170
80107a34:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107a39:	e9 82 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a3e:	6a 00                	push   $0x0
  pushl $171
80107a40:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107a45:	e9 76 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a4a:	6a 00                	push   $0x0
  pushl $172
80107a4c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107a51:	e9 6a f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a56:	6a 00                	push   $0x0
  pushl $173
80107a58:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107a5d:	e9 5e f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a62:	6a 00                	push   $0x0
  pushl $174
80107a64:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107a69:	e9 52 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a6e:	6a 00                	push   $0x0
  pushl $175
80107a70:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107a75:	e9 46 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a7a:	6a 00                	push   $0x0
  pushl $176
80107a7c:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107a81:	e9 3a f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a86:	6a 00                	push   $0x0
  pushl $177
80107a88:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107a8d:	e9 2e f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a92:	6a 00                	push   $0x0
  pushl $178
80107a94:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107a99:	e9 22 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107a9e:	6a 00                	push   $0x0
  pushl $179
80107aa0:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107aa5:	e9 16 f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107aaa:	6a 00                	push   $0x0
  pushl $180
80107aac:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107ab1:	e9 0a f2 ff ff       	jmp    80106cc0 <alltraps>
...
80107ab6:	6a 00                	push   $0x0
  pushl $181
80107ab8:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107abd:	e9 fe f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107ac2:	6a 00                	push   $0x0
  pushl $182
80107ac4:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107ac9:	e9 f2 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107ace:	6a 00                	push   $0x0
  pushl $183
80107ad0:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107ad5:	e9 e6 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107ada:	6a 00                	push   $0x0
  pushl $184
80107adc:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107ae1:	e9 da f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107ae6:	6a 00                	push   $0x0
  pushl $185
80107ae8:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107aed:	e9 ce f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107af2:	6a 00                	push   $0x0
  pushl $186
80107af4:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107af9:	e9 c2 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107afe:	6a 00                	push   $0x0
  pushl $187
80107b00:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107b05:	e9 b6 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b0a:	6a 00                	push   $0x0
  pushl $188
80107b0c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107b11:	e9 aa f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b16:	6a 00                	push   $0x0
  pushl $189
80107b18:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107b1d:	e9 9e f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b22:	6a 00                	push   $0x0
  pushl $190
80107b24:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107b29:	e9 92 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b2e:	6a 00                	push   $0x0
  pushl $191
80107b30:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107b35:	e9 86 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b3a:	6a 00                	push   $0x0
  pushl $192
80107b3c:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107b41:	e9 7a f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b46:	6a 00                	push   $0x0
  pushl $193
80107b48:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107b4d:	e9 6e f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b52:	6a 00                	push   $0x0
  pushl $194
80107b54:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107b59:	e9 62 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b5e:	6a 00                	push   $0x0
  pushl $195
80107b60:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107b65:	e9 56 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b6a:	6a 00                	push   $0x0
  pushl $196
80107b6c:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107b71:	e9 4a f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b76:	6a 00                	push   $0x0
  pushl $197
80107b78:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107b7d:	e9 3e f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b82:	6a 00                	push   $0x0
  pushl $198
80107b84:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107b89:	e9 32 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b8e:	6a 00                	push   $0x0
  pushl $199
80107b90:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107b95:	e9 26 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107b9a:	6a 00                	push   $0x0
  pushl $200
80107b9c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107ba1:	e9 1a f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107ba6:	6a 00                	push   $0x0
  pushl $201
80107ba8:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107bad:	e9 0e f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107bb2:	6a 00                	push   $0x0
  pushl $202
80107bb4:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107bb9:	e9 02 f1 ff ff       	jmp    80106cc0 <alltraps>
...
80107bbe:	6a 00                	push   $0x0
  pushl $203
80107bc0:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107bc5:	e9 f6 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107bca:	6a 00                	push   $0x0
  pushl $204
80107bcc:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107bd1:	e9 ea f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107bd6:	6a 00                	push   $0x0
  pushl $205
80107bd8:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107bdd:	e9 de f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107be2:	6a 00                	push   $0x0
  pushl $206
80107be4:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107be9:	e9 d2 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107bee:	6a 00                	push   $0x0
  pushl $207
80107bf0:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107bf5:	e9 c6 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107bfa:	6a 00                	push   $0x0
  pushl $208
80107bfc:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107c01:	e9 ba f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c06:	6a 00                	push   $0x0
  pushl $209
80107c08:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107c0d:	e9 ae f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c12:	6a 00                	push   $0x0
  pushl $210
80107c14:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107c19:	e9 a2 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c1e:	6a 00                	push   $0x0
  pushl $211
80107c20:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107c25:	e9 96 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c2a:	6a 00                	push   $0x0
  pushl $212
80107c2c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107c31:	e9 8a f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c36:	6a 00                	push   $0x0
  pushl $213
80107c38:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107c3d:	e9 7e f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c42:	6a 00                	push   $0x0
  pushl $214
80107c44:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107c49:	e9 72 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c4e:	6a 00                	push   $0x0
  pushl $215
80107c50:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107c55:	e9 66 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c5a:	6a 00                	push   $0x0
  pushl $216
80107c5c:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107c61:	e9 5a f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c66:	6a 00                	push   $0x0
  pushl $217
80107c68:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107c6d:	e9 4e f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c72:	6a 00                	push   $0x0
  pushl $218
80107c74:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107c79:	e9 42 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c7e:	6a 00                	push   $0x0
  pushl $219
80107c80:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107c85:	e9 36 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c8a:	6a 00                	push   $0x0
  pushl $220
80107c8c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107c91:	e9 2a f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107c96:	6a 00                	push   $0x0
  pushl $221
80107c98:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107c9d:	e9 1e f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107ca2:	6a 00                	push   $0x0
  pushl $222
80107ca4:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107ca9:	e9 12 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107cae:	6a 00                	push   $0x0
  pushl $223
80107cb0:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107cb5:	e9 06 f0 ff ff       	jmp    80106cc0 <alltraps>
...
80107cba:	6a 00                	push   $0x0
  pushl $224
80107cbc:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107cc1:	e9 fa ef ff ff       	jmp    80106cc0 <alltraps>
...
80107cc6:	6a 00                	push   $0x0
  pushl $225
80107cc8:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107ccd:	e9 ee ef ff ff       	jmp    80106cc0 <alltraps>
...
80107cd2:	6a 00                	push   $0x0
  pushl $226
80107cd4:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107cd9:	e9 e2 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107cde:	6a 00                	push   $0x0
  pushl $227
80107ce0:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107ce5:	e9 d6 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107cea:	6a 00                	push   $0x0
  pushl $228
80107cec:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107cf1:	e9 ca ef ff ff       	jmp    80106cc0 <alltraps>
...
80107cf6:	6a 00                	push   $0x0
  pushl $229
80107cf8:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107cfd:	e9 be ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d02:	6a 00                	push   $0x0
  pushl $230
80107d04:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107d09:	e9 b2 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d0e:	6a 00                	push   $0x0
  pushl $231
80107d10:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107d15:	e9 a6 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d1a:	6a 00                	push   $0x0
  pushl $232
80107d1c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107d21:	e9 9a ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d26:	6a 00                	push   $0x0
  pushl $233
80107d28:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107d2d:	e9 8e ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d32:	6a 00                	push   $0x0
  pushl $234
80107d34:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107d39:	e9 82 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d3e:	6a 00                	push   $0x0
  pushl $235
80107d40:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107d45:	e9 76 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d4a:	6a 00                	push   $0x0
  pushl $236
80107d4c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107d51:	e9 6a ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d56:	6a 00                	push   $0x0
  pushl $237
80107d58:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107d5d:	e9 5e ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d62:	6a 00                	push   $0x0
  pushl $238
80107d64:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107d69:	e9 52 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d6e:	6a 00                	push   $0x0
  pushl $239
80107d70:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107d75:	e9 46 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d7a:	6a 00                	push   $0x0
  pushl $240
80107d7c:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107d81:	e9 3a ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d86:	6a 00                	push   $0x0
  pushl $241
80107d88:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107d8d:	e9 2e ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d92:	6a 00                	push   $0x0
  pushl $242
80107d94:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107d99:	e9 22 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107d9e:	6a 00                	push   $0x0
  pushl $243
80107da0:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107da5:	e9 16 ef ff ff       	jmp    80106cc0 <alltraps>
...
80107daa:	6a 00                	push   $0x0
  pushl $244
80107dac:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107db1:	e9 0a ef ff ff       	jmp    80106cc0 <alltraps>
...
80107db6:	6a 00                	push   $0x0
  pushl $245
80107db8:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107dbd:	e9 fe ee ff ff       	jmp    80106cc0 <alltraps>
...
80107dc2:	6a 00                	push   $0x0
  pushl $246
80107dc4:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107dc9:	e9 f2 ee ff ff       	jmp    80106cc0 <alltraps>
...
80107dce:	6a 00                	push   $0x0
  pushl $247
80107dd0:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107dd5:	e9 e6 ee ff ff       	jmp    80106cc0 <alltraps>
...
80107dda:	6a 00                	push   $0x0
  pushl $248
80107ddc:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107de1:	e9 da ee ff ff       	jmp    80106cc0 <alltraps>
...
80107de6:	6a 00                	push   $0x0
  pushl $249
80107de8:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107ded:	e9 ce ee ff ff       	jmp    80106cc0 <alltraps>
...
80107df2:	6a 00                	push   $0x0
  pushl $250
80107df4:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107df9:	e9 c2 ee ff ff       	jmp    80106cc0 <alltraps>
...
80107dfe:	6a 00                	push   $0x0
  pushl $251
80107e00:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107e05:	e9 b6 ee ff ff       	jmp    80106cc0 <alltraps>
...
80107e0a:	6a 00                	push   $0x0
  pushl $252
80107e0c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107e11:	e9 aa ee ff ff       	jmp    80106cc0 <alltraps>
...
80107e16:	6a 00                	push   $0x0
  pushl $253
80107e18:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107e1d:	e9 9e ee ff ff       	jmp    80106cc0 <alltraps>
...
80107e22:	6a 00                	push   $0x0
  pushl $254
80107e24:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107e29:	e9 92 ee ff ff       	jmp    80106cc0 <alltraps>
...
80107e2e:	6a 00                	push   $0x0
  pushl $255
80107e30:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107e35:	e9 86 ee ff ff       	jmp    80106cc0 <alltraps>
	...
...
80107e45:	83 e8 01             	sub    $0x1,%eax
80107e48:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107e4c:	8b 45 08             	mov    0x8(%ebp),%eax
80107e4f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107e53:	8b 45 08             	mov    0x8(%ebp),%eax
80107e56:	c1 e8 10             	shr    $0x10,%eax
80107e59:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107e5d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107e60:	0f 01 10             	lgdtl  (%eax)
}
80107e63:	c9                   	leave  
80107e64:	c3                   	ret    
...
80107e6e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107e72:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107e76:	0f 00 d8             	ltr    %ax
}
80107e79:	c9                   	leave  
80107e7a:	c3                   	ret    
...
80107e7e:	83 ec 04             	sub    $0x4,%esp
80107e81:	8b 45 08             	mov    0x8(%ebp),%eax
80107e84:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107e88:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107e8c:	8e e8                	mov    %eax,%gs
}
80107e8e:	c9                   	leave  
80107e8f:	c3                   	ret    
...
80107eae:	05 00 00 00 80       	add    $0x80000000,%eax
80107eb3:	5d                   	pop    %ebp
80107eb4:	c3                   	ret    
...
80107eb8:	53                   	push   %ebx
80107eb9:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107ebc:	e8 5e b0 ff ff       	call   80102f1f <cpunum>
80107ec1:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107ec7:	05 e0 39 11 80       	add    $0x801139e0,%eax
80107ecc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107ecf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed2:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107ed8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107edb:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107ee1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee4:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107ee8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eeb:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107eef:	83 e2 f0             	and    $0xfffffff0,%edx
80107ef2:	83 ca 0a             	or     $0xa,%edx
80107ef5:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ef8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107efb:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107eff:	83 ca 10             	or     $0x10,%edx
80107f02:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f08:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f0c:	83 e2 9f             	and    $0xffffff9f,%edx
80107f0f:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f15:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107f19:	83 ca 80             	or     $0xffffff80,%edx
80107f1c:	88 50 7d             	mov    %dl,0x7d(%eax)
80107f1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f22:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f26:	83 ca 0f             	or     $0xf,%edx
80107f29:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f2f:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f33:	83 e2 ef             	and    $0xffffffef,%edx
80107f36:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f3c:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f40:	83 e2 df             	and    $0xffffffdf,%edx
80107f43:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f49:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f4d:	83 ca 40             	or     $0x40,%edx
80107f50:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f56:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107f5a:	83 ca 80             	or     $0xffffff80,%edx
80107f5d:	88 50 7e             	mov    %dl,0x7e(%eax)
80107f60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f63:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107f67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f6a:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107f71:	ff ff 
80107f73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f76:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107f7d:	00 00 
80107f7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f82:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107f89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f8c:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107f93:	83 e2 f0             	and    $0xfffffff0,%edx
80107f96:	83 ca 02             	or     $0x2,%edx
80107f99:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107f9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa2:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107fa9:	83 ca 10             	or     $0x10,%edx
80107fac:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107fb2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb5:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107fbc:	83 e2 9f             	and    $0xffffff9f,%edx
80107fbf:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107fc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc8:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107fcf:	83 ca 80             	or     $0xffffff80,%edx
80107fd2:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107fd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fdb:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107fe2:	83 ca 0f             	or     $0xf,%edx
80107fe5:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107feb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fee:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ff5:	83 e2 ef             	and    $0xffffffef,%edx
80107ff8:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107ffe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108001:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108008:	83 e2 df             	and    $0xffffffdf,%edx
8010800b:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108011:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108014:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010801b:	83 ca 40             	or     $0x40,%edx
8010801e:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108024:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108027:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010802e:	83 ca 80             	or     $0xffffff80,%edx
80108031:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108037:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803a:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108041:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108044:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
8010804b:	ff ff 
8010804d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108050:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108057:	00 00 
80108059:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010805c:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80108063:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108066:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010806d:	83 e2 f0             	and    $0xfffffff0,%edx
80108070:	83 ca 0a             	or     $0xa,%edx
80108073:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108079:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010807c:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108083:	83 ca 10             	or     $0x10,%edx
80108086:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010808c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010808f:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108096:	83 ca 60             	or     $0x60,%edx
80108099:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010809f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a2:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
801080a9:	83 ca 80             	or     $0xffffff80,%edx
801080ac:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
801080b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080b5:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801080bc:	83 ca 0f             	or     $0xf,%edx
801080bf:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801080c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080c8:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801080cf:	83 e2 ef             	and    $0xffffffef,%edx
801080d2:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801080d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080db:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801080e2:	83 e2 df             	and    $0xffffffdf,%edx
801080e5:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801080eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080ee:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
801080f5:	83 ca 40             	or     $0x40,%edx
801080f8:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
...
80108114:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010811b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010811e:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80108125:	ff ff 
80108127:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010812a:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108131:	00 00 
80108133:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108136:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
8010813d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108140:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108147:	83 e2 f0             	and    $0xfffffff0,%edx
8010814a:	83 ca 02             	or     $0x2,%edx
8010814d:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108153:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108156:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010815d:	83 ca 10             	or     $0x10,%edx
80108160:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108166:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108169:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108170:	83 ca 60             	or     $0x60,%edx
80108173:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108179:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010817c:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108183:	83 ca 80             	or     $0xffffff80,%edx
80108186:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
8010818c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010818f:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108196:	83 ca 0f             	or     $0xf,%edx
80108199:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010819f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a2:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801081a9:	83 e2 ef             	and    $0xffffffef,%edx
801081ac:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801081b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b5:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801081bc:	83 e2 df             	and    $0xffffffdf,%edx
801081bf:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801081c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c8:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
801081cf:	83 ca 40             	or     $0x40,%edx
801081d2:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
801081ee:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801081f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081f8:	05 b4 00 00 00       	add    $0xb4,%eax
801081fd:	89 c3                	mov    %eax,%ebx
801081ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108202:	05 b4 00 00 00       	add    $0xb4,%eax
80108207:	c1 e8 10             	shr    $0x10,%eax
8010820a:	89 c1                	mov    %eax,%ecx
8010820c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010820f:	05 b4 00 00 00       	add    $0xb4,%eax
80108214:	c1 e8 18             	shr    $0x18,%eax
80108217:	89 c2                	mov    %eax,%edx
80108219:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010821c:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80108223:	00 00 
80108225:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108228:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
8010822f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108232:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108238:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010823b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108242:	83 e1 f0             	and    $0xfffffff0,%ecx
80108245:	83 c9 02             	or     $0x2,%ecx
80108248:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010824e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108251:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108258:	83 c9 10             	or     $0x10,%ecx
8010825b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108261:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108264:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010826b:	83 e1 9f             	and    $0xffffff9f,%ecx
8010826e:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108274:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108277:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010827e:	83 c9 80             	or     $0xffffff80,%ecx
80108281:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108287:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010828a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108291:	83 e1 f0             	and    $0xfffffff0,%ecx
80108294:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010829a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010829d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801082a4:	83 e1 ef             	and    $0xffffffef,%ecx
801082a7:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801082ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082b0:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801082b7:	83 e1 df             	and    $0xffffffdf,%ecx
801082ba:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801082c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082c3:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801082ca:	83 c9 40             	or     $0x40,%ecx
801082cd:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801082d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082d6:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801082dd:	83 c9 80             	or     $0xffffff80,%ecx
801082e0:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801082e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082e9:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801082ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082f2:	83 c0 70             	add    $0x70,%eax
801082f5:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801082fc:	00 
801082fd:	89 04 24             	mov    %eax,(%esp)
80108300:	e8 37 fb ff ff       	call   80107e3c <lgdt>
  loadgs(SEG_KCPU << 3);
80108305:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
8010830c:	e8 6a fb ff ff       	call   80107e7b <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108311:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108314:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
8010831a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108321:	00 00 00 00 
}
80108325:	83 c4 24             	add    $0x24,%esp
80108328:	5b                   	pop    %ebx
80108329:	5d                   	pop    %ebp
8010832a:	c3                   	ret    
...
80108334:	c1 e8 16             	shr    $0x16,%eax
80108337:	c1 e0 02             	shl    $0x2,%eax
8010833a:	03 45 08             	add    0x8(%ebp),%eax
...
8010834a:	74 17                	je     80108363 <walkpgdir+0x38>
...
80108359:	e8 4a fb ff ff       	call   80107ea8 <p2v>
8010835e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108361:	eb 4b                	jmp    801083ae <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108363:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108367:	74 0e                	je     80108377 <walkpgdir+0x4c>
80108369:	e8 f9 a7 ff ff       	call   80102b67 <kalloc>
8010836e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108371:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108375:	75 07                	jne    8010837e <walkpgdir+0x53>
      return 0;
80108377:	b8 00 00 00 00       	mov    $0x0,%eax
8010837c:	eb 41                	jmp    801083bf <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010837e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108385:	00 
80108386:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010838d:	00 
8010838e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108391:	89 04 24             	mov    %eax,(%esp)
80108394:	e8 e9 d2 ff ff       	call   80105682 <memset>
...
8010839f:	e8 f7 fa ff ff       	call   80107e9b <v2p>
801083a4:	89 c2                	mov    %eax,%edx
801083a6:	83 ca 07             	or     $0x7,%edx
801083a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083ac:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
801083ae:	8b 45 0c             	mov    0xc(%ebp),%eax
801083b1:	c1 e8 0c             	shr    $0xc,%eax
801083b4:	25 ff 03 00 00       	and    $0x3ff,%eax
801083b9:	c1 e0 02             	shl    $0x2,%eax
801083bc:	03 45 f4             	add    -0xc(%ebp),%eax
}
801083bf:	c9                   	leave  
801083c0:	c3                   	ret    
...
801083d5:	03 45 10             	add    0x10(%ebp),%eax
801083d8:	83 e8 01             	sub    $0x1,%eax
801083db:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801083e0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801083e3:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
801083ea:	00 
...
801083f8:	e8 2e ff ff ff       	call   8010832b <walkpgdir>
801083fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108400:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108404:	75 07                	jne    8010840d <mappages+0x4c>
      return -1;
80108406:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010840b:	eb 46                	jmp    80108453 <mappages+0x92>
    if(*pte & PTE_P)
8010840d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108410:	8b 00                	mov    (%eax),%eax
80108412:	83 e0 01             	and    $0x1,%eax
80108415:	84 c0                	test   %al,%al
80108417:	74 0c                	je     80108425 <mappages+0x64>
      panic("remap");
80108419:	c7 04 24 20 97 10 80 	movl   $0x80109720,(%esp)
80108420:	e8 18 81 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80108425:	8b 45 18             	mov    0x18(%ebp),%eax
80108428:	0b 45 14             	or     0x14(%ebp),%eax
8010842b:	89 c2                	mov    %eax,%edx
8010842d:	83 ca 01             	or     $0x1,%edx
80108430:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108433:	89 10                	mov    %edx,(%eax)
    if(a == last)
80108435:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108438:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010843b:	74 10                	je     8010844d <mappages+0x8c>
      break;
    a += PGSIZE;
8010843d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80108444:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
8010844b:	eb 96                	jmp    801083e3 <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108459:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
8010845c:	e8 06 a7 ff ff       	call   80102b67 <kalloc>
80108461:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108464:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108468:	75 0a                	jne    80108474 <setupkvm+0x1f>
    return 0;
8010846a:	b8 00 00 00 00       	mov    $0x0,%eax
8010846f:	e9 98 00 00 00       	jmp    8010850c <setupkvm+0xb7>
...
8010848a:	e8 f3 d1 ff ff       	call   80105682 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010848f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108496:	e8 0d fa ff ff       	call   80107ea8 <p2v>
8010849b:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
801084a0:	76 0c                	jbe    801084ae <setupkvm+0x59>
    panic("PHYSTOP too high");
801084a2:	c7 04 24 26 97 10 80 	movl   $0x80109726,(%esp)
801084a9:	e8 8f 80 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801084ae:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
801084b5:	eb 49                	jmp    80108500 <setupkvm+0xab>
...
801084d6:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801084da:	89 54 24 0c          	mov    %edx,0xc(%esp)
801084de:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801084e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801084e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084e9:	89 04 24             	mov    %eax,(%esp)
801084ec:	e8 d0 fe ff ff       	call   801083c1 <mappages>
801084f1:	85 c0                	test   %eax,%eax
801084f3:	79 07                	jns    801084fc <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
801084f5:	b8 00 00 00 00       	mov    $0x0,%eax
801084fa:	eb 10                	jmp    8010850c <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801084fc:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108500:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108507:	72 ae                	jb     801084b7 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
8010850c:	83 c4 34             	add    $0x34,%esp
8010850f:	5b                   	pop    %ebx
80108510:	5d                   	pop    %ebp
80108511:	c3                   	ret    
...
80108515:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108518:	e8 38 ff ff ff       	call   80108455 <setupkvm>
8010851d:	a3 b8 6f 11 80       	mov    %eax,0x80116fb8
  switchkvm();
80108522:	e8 02 00 00 00       	call   80108529 <switchkvm>
}
80108527:	c9                   	leave  
80108528:	c3                   	ret    
...
8010852f:	a1 b8 6f 11 80       	mov    0x80116fb8,%eax
80108534:	89 04 24             	mov    %eax,(%esp)
80108537:	e8 5f f9 ff ff       	call   80107e9b <v2p>
8010853c:	89 04 24             	mov    %eax,(%esp)
8010853f:	e8 4c f9 ff ff       	call   80107e90 <lcr3>
}
80108544:	c9                   	leave  
80108545:	c3                   	ret    
...
8010854a:	83 ec 14             	sub    $0x14,%esp
  pushcli();
8010854d:	e8 29 d0 ff ff       	call   8010557b <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80108552:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108558:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010855f:	83 c2 08             	add    $0x8,%edx
80108562:	89 d3                	mov    %edx,%ebx
80108564:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010856b:	83 c2 08             	add    $0x8,%edx
8010856e:	c1 ea 10             	shr    $0x10,%edx
80108571:	89 d1                	mov    %edx,%ecx
80108573:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010857a:	83 c2 08             	add    $0x8,%edx
8010857d:	c1 ea 18             	shr    $0x18,%edx
80108580:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108587:	67 00 
80108589:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108590:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108596:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010859d:	83 e1 f0             	and    $0xfffffff0,%ecx
801085a0:	83 c9 09             	or     $0x9,%ecx
801085a3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801085a9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801085b0:	83 c9 10             	or     $0x10,%ecx
801085b3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801085b9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801085c0:	83 e1 9f             	and    $0xffffff9f,%ecx
801085c3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801085c9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801085d0:	83 c9 80             	or     $0xffffff80,%ecx
801085d3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801085d9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801085e0:	83 e1 f0             	and    $0xfffffff0,%ecx
801085e3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085e9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801085f0:	83 e1 ef             	and    $0xffffffef,%ecx
801085f3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801085f9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108600:	83 e1 df             	and    $0xffffffdf,%ecx
80108603:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108609:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108610:	83 c9 40             	or     $0x40,%ecx
80108613:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108619:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108620:	83 e1 7f             	and    $0x7f,%ecx
80108623:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108629:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010862f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108635:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
...
8010864b:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80108651:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108657:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010865e:	8b 52 08             	mov    0x8(%edx),%edx
80108661:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108667:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
8010866a:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108671:	e8 ef f7 ff ff       	call   80107e65 <ltr>
  if(p->pgdir == 0)
80108676:	8b 45 08             	mov    0x8(%ebp),%eax
80108679:	8b 40 04             	mov    0x4(%eax),%eax
8010867c:	85 c0                	test   %eax,%eax
8010867e:	75 0c                	jne    8010868c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80108680:	c7 04 24 37 97 10 80 	movl   $0x80109737,(%esp)
80108687:	e8 b1 7e ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010868c:	8b 45 08             	mov    0x8(%ebp),%eax
8010868f:	8b 40 04             	mov    0x4(%eax),%eax
80108692:	89 04 24             	mov    %eax,(%esp)
80108695:	e8 01 f8 ff ff       	call   80107e9b <v2p>
8010869a:	89 04 24             	mov    %eax,(%esp)
8010869d:	e8 ee f7 ff ff       	call   80107e90 <lcr3>
  popcli();
801086a2:	e8 1c cf ff ff       	call   801055c3 <popcli>
}
801086a7:	83 c4 14             	add    $0x14,%esp
801086aa:	5b                   	pop    %ebx
801086ab:	5d                   	pop    %ebp
801086ac:	c3                   	ret    
...
801086b0:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
801086b3:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801086ba:	76 0c                	jbe    801086c8 <inituvm+0x1b>
    panic("inituvm: more than a page");
801086bc:	c7 04 24 4b 97 10 80 	movl   $0x8010974b,(%esp)
801086c3:	e8 75 7e ff ff       	call   8010053d <panic>
  mem = kalloc();
801086c8:	e8 9a a4 ff ff       	call   80102b67 <kalloc>
801086cd:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
801086d0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801086d7:	00 
801086d8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801086df:	00 
801086e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086e3:	89 04 24             	mov    %eax,(%esp)
801086e6:	e8 97 cf ff ff       	call   80105682 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801086eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086ee:	89 04 24             	mov    %eax,(%esp)
801086f1:	e8 a5 f7 ff ff       	call   80107e9b <v2p>
801086f6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801086fd:	00 
801086fe:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108702:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108709:	00 
8010870a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108711:	00 
80108712:	8b 45 08             	mov    0x8(%ebp),%eax
80108715:	89 04 24             	mov    %eax,(%esp)
80108718:	e8 a4 fc ff ff       	call   801083c1 <mappages>
  memmove(mem, init, sz);
8010871d:	8b 45 10             	mov    0x10(%ebp),%eax
80108720:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108731:	e8 1f d0 ff ff       	call   80105755 <memmove>
}
80108736:	c9                   	leave  
80108737:	c3                   	ret    
...
8010873c:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010873f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108742:	25 ff 0f 00 00       	and    $0xfff,%eax
80108747:	85 c0                	test   %eax,%eax
80108749:	74 0c                	je     80108757 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
8010874b:	c7 04 24 68 97 10 80 	movl   $0x80109768,(%esp)
80108752:	e8 e6 7d ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108757:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010875e:	e9 ad 00 00 00       	jmp    80108810 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108763:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108766:	8b 55 0c             	mov    0xc(%ebp),%edx
80108769:	01 d0                	add    %edx,%eax
...
8010877d:	e8 a9 fb ff ff       	call   8010832b <walkpgdir>
80108782:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108785:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108789:	75 0c                	jne    80108797 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010878b:	c7 04 24 8b 97 10 80 	movl   $0x8010978b,(%esp)
80108792:	e8 a6 7d ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
801087a7:	8b 55 18             	mov    0x18(%ebp),%edx
801087aa:	89 d1                	mov    %edx,%ecx
801087ac:	29 c1                	sub    %eax,%ecx
801087ae:	89 c8                	mov    %ecx,%eax
801087b0:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801087b5:	77 11                	ja     801087c8 <loaduvm+0x90>
      n = sz - i;
801087b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087ba:	8b 55 18             	mov    0x18(%ebp),%edx
801087bd:	89 d1                	mov    %edx,%ecx
801087bf:	29 c1                	sub    %eax,%ecx
801087c1:	89 c8                	mov    %ecx,%eax
801087c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
801087c6:	eb 07                	jmp    801087cf <loaduvm+0x97>
    else
      n = PGSIZE;
801087c8:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801087cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087d2:	8b 55 14             	mov    0x14(%ebp),%edx
801087d5:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801087d8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801087db:	89 04 24             	mov    %eax,(%esp)
801087de:	e8 c5 f6 ff ff       	call   80107ea8 <p2v>
801087e3:	8b 55 f0             	mov    -0x10(%ebp),%edx
801087e6:	89 54 24 0c          	mov    %edx,0xc(%esp)
801087ea:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801087ee:	89 44 24 04          	mov    %eax,0x4(%esp)
801087f2:	8b 45 10             	mov    0x10(%ebp),%eax
801087f5:	89 04 24             	mov    %eax,(%esp)
801087f8:	e8 c9 95 ff ff       	call   80101dc6 <readi>
801087fd:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108800:	74 07                	je     80108809 <loaduvm+0xd1>
      return -1;
80108802:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108807:	eb 18                	jmp    80108821 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80108809:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108810:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108813:	3b 45 18             	cmp    0x18(%ebp),%eax
80108816:	0f 82 47 ff ff ff    	jb     80108763 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108821:	83 c4 24             	add    $0x24,%esp
80108824:	5b                   	pop    %ebx
80108825:	5d                   	pop    %ebp
80108826:	c3                   	ret    
...
8010882a:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108832:	79 0a                	jns    8010883e <allocuvm+0x17>
    return 0;
80108834:	b8 00 00 00 00       	mov    $0x0,%eax
80108839:	e9 c1 00 00 00       	jmp    801088ff <allocuvm+0xd8>
  if(newsz < oldsz)
8010883e:	8b 45 10             	mov    0x10(%ebp),%eax
80108841:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108844:	73 08                	jae    8010884e <allocuvm+0x27>
    return oldsz;
80108846:	8b 45 0c             	mov    0xc(%ebp),%eax
80108849:	e9 b1 00 00 00       	jmp    801088ff <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
8010884e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108851:	05 ff 0f 00 00       	add    $0xfff,%eax
80108856:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010885b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010885e:	e9 8d 00 00 00       	jmp    801088f0 <allocuvm+0xc9>
    mem = kalloc();
80108863:	e8 ff a2 ff ff       	call   80102b67 <kalloc>
80108868:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
8010886b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010886f:	75 2c                	jne    8010889d <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108871:	c7 04 24 a9 97 10 80 	movl   $0x801097a9,(%esp)
80108878:	e8 24 7b ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010887d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108880:	89 44 24 08          	mov    %eax,0x8(%esp)
80108884:	8b 45 10             	mov    0x10(%ebp),%eax
80108887:	89 44 24 04          	mov    %eax,0x4(%esp)
8010888b:	8b 45 08             	mov    0x8(%ebp),%eax
8010888e:	89 04 24             	mov    %eax,(%esp)
80108891:	e8 6b 00 00 00       	call   80108901 <deallocuvm>
      return 0;
80108896:	b8 00 00 00 00       	mov    $0x0,%eax
8010889b:	eb 62                	jmp    801088ff <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010889d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088a4:	00 
801088a5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801088ac:	00 
801088ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088b0:	89 04 24             	mov    %eax,(%esp)
801088b3:	e8 ca cd ff ff       	call   80105682 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801088b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088bb:	89 04 24             	mov    %eax,(%esp)
801088be:	e8 d8 f5 ff ff       	call   80107e9b <v2p>
801088c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801088c6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801088cd:	00 
...
801088e4:	e8 d8 fa ff ff       	call   801083c1 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801088f3:	3b 45 10             	cmp    0x10(%ebp),%eax
801088f6:	0f 82 67 ff ff ff    	jb     80108863 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
8010890d:	72 08                	jb     80108917 <deallocuvm+0x16>
    return oldsz;
8010890f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108912:	e9 a4 00 00 00       	jmp    801089bb <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108917:	8b 45 10             	mov    0x10(%ebp),%eax
8010891a:	05 ff 0f 00 00       	add    $0xfff,%eax
8010891f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108924:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108927:	e9 80 00 00 00       	jmp    801089ac <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010892c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010892f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108936:	00 
80108937:	89 44 24 04          	mov    %eax,0x4(%esp)
8010893b:	8b 45 08             	mov    0x8(%ebp),%eax
8010893e:	89 04 24             	mov    %eax,(%esp)
80108941:	e8 e5 f9 ff ff       	call   8010832b <walkpgdir>
80108946:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108949:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010894d:	75 09                	jne    80108958 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010894f:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108956:	eb 4d                	jmp    801089a5 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108958:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010895b:	8b 00                	mov    (%eax),%eax
8010895d:	83 e0 01             	and    $0x1,%eax
80108960:	84 c0                	test   %al,%al
80108962:	74 41                	je     801089a5 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108964:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108967:	8b 00                	mov    (%eax),%eax
80108969:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010896e:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108971:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108975:	75 0c                	jne    80108983 <deallocuvm+0x82>
        panic("kfree");
80108977:	c7 04 24 c1 97 10 80 	movl   $0x801097c1,(%esp)
8010897e:	e8 ba 7b ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108983:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108986:	89 04 24             	mov    %eax,(%esp)
80108989:	e8 1a f5 ff ff       	call   80107ea8 <p2v>
8010898e:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108991:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108994:	89 04 24             	mov    %eax,(%esp)
80108997:	e8 32 a1 ff ff       	call   80102ace <kfree>
      *pte = 0;
8010899c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010899f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801089af:	3b 45 0c             	cmp    0xc(%ebp),%eax
801089b2:	0f 82 74 ff ff ff    	jb     8010892c <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801089c0:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
801089c3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801089c7:	75 0c                	jne    801089d5 <freevm+0x18>
    panic("freevm: no pgdir");
801089c9:	c7 04 24 c7 97 10 80 	movl   $0x801097c7,(%esp)
801089d0:	e8 68 7b ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801089d5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801089dc:	00 
801089dd:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801089e4:	80 
801089e5:	8b 45 08             	mov    0x8(%ebp),%eax
801089e8:	89 04 24             	mov    %eax,(%esp)
801089eb:	e8 11 ff ff ff       	call   80108901 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801089f0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801089f7:	eb 3c                	jmp    80108a35 <freevm+0x78>
    if(pgdir[i] & PTE_P){
801089f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089fc:	c1 e0 02             	shl    $0x2,%eax
801089ff:	03 45 08             	add    0x8(%ebp),%eax
80108a02:	8b 00                	mov    (%eax),%eax
80108a04:	83 e0 01             	and    $0x1,%eax
80108a07:	84 c0                	test   %al,%al
80108a09:	74 26                	je     80108a31 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108a0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a0e:	c1 e0 02             	shl    $0x2,%eax
80108a11:	03 45 08             	add    0x8(%ebp),%eax
80108a14:	8b 00                	mov    (%eax),%eax
80108a16:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108a1b:	89 04 24             	mov    %eax,(%esp)
80108a1e:	e8 85 f4 ff ff       	call   80107ea8 <p2v>
80108a23:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108a26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a29:	89 04 24             	mov    %eax,(%esp)
80108a2c:	e8 9d a0 ff ff       	call   80102ace <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108a31:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108a35:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108a3c:	76 bb                	jbe    801089f9 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108a44:	e8 85 a0 ff ff       	call   80102ace <kfree>
}
80108a49:	c9                   	leave  
80108a4a:	c3                   	ret    
...
80108a51:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a58:	00 
80108a59:	8b 45 0c             	mov    0xc(%ebp),%eax
80108a5c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a60:	8b 45 08             	mov    0x8(%ebp),%eax
80108a63:	89 04 24             	mov    %eax,(%esp)
80108a66:	e8 c0 f8 ff ff       	call   8010832b <walkpgdir>
80108a6b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108a6e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108a72:	75 0c                	jne    80108a80 <clearpteu+0x35>
    panic("clearpteu");
80108a74:	c7 04 24 d8 97 10 80 	movl   $0x801097d8,(%esp)
80108a7b:	e8 bd 7a ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108a80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a83:	8b 00                	mov    (%eax),%eax
80108a85:	89 c2                	mov    %eax,%edx
80108a87:	83 e2 fb             	and    $0xfffffffb,%edx
...
{
80108a91:	55                   	push   %ebp
80108a92:	89 e5                	mov    %esp,%ebp
80108a94:	53                   	push   %ebx
80108a95:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108a98:	e8 b8 f9 ff ff       	call   80108455 <setupkvm>
80108a9d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108aa0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108aa4:	75 0a                	jne    80108ab0 <copyuvm+0x1f>
    return 0;
80108aa6:	b8 00 00 00 00       	mov    $0x0,%eax
80108aab:	e9 fd 00 00 00       	jmp    80108bad <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108ab0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108ab7:	e9 cc 00 00 00       	jmp    80108b88 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108abc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108abf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108ac6:	00 
80108ac7:	89 44 24 04          	mov    %eax,0x4(%esp)
80108acb:	8b 45 08             	mov    0x8(%ebp),%eax
80108ace:	89 04 24             	mov    %eax,(%esp)
80108ad1:	e8 55 f8 ff ff       	call   8010832b <walkpgdir>
80108ad6:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108ad9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108add:	75 0c                	jne    80108aeb <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108adf:	c7 04 24 e2 97 10 80 	movl   $0x801097e2,(%esp)
80108ae6:	e8 52 7a ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108aeb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108aee:	8b 00                	mov    (%eax),%eax
80108af0:	83 e0 01             	and    $0x1,%eax
80108af3:	85 c0                	test   %eax,%eax
80108af5:	75 0c                	jne    80108b03 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108af7:	c7 04 24 fc 97 10 80 	movl   $0x801097fc,(%esp)
80108afe:	e8 3a 7a ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80108b03:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b06:	8b 00                	mov    (%eax),%eax
80108b08:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b0d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
80108b10:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b13:	8b 00                	mov    (%eax),%eax
80108b15:	25 ff 0f 00 00       	and    $0xfff,%eax
80108b1a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108b1d:	e8 45 a0 ff ff       	call   80102b67 <kalloc>
80108b22:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108b25:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108b29:	74 6e                	je     80108b99 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108b2b:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108b2e:	89 04 24             	mov    %eax,(%esp)
80108b31:	e8 72 f3 ff ff       	call   80107ea8 <p2v>
80108b36:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108b3d:	00 
80108b3e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b42:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108b45:	89 04 24             	mov    %eax,(%esp)
80108b48:	e8 08 cc ff ff       	call   80105755 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108b4d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108b50:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108b53:	89 04 24             	mov    %eax,(%esp)
80108b56:	e8 40 f3 ff ff       	call   80107e9b <v2p>
80108b5b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108b5e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108b62:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108b66:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108b6d:	00 
80108b6e:	89 54 24 04          	mov    %edx,0x4(%esp)
80108b72:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b75:	89 04 24             	mov    %eax,(%esp)
80108b78:	e8 44 f8 ff ff       	call   801083c1 <mappages>
80108b7d:	85 c0                	test   %eax,%eax
80108b7f:	78 1b                	js     80108b9c <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
80108b8b:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108b8e:	0f 82 28 ff ff ff    	jb     80108abc <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108b97:	eb 14                	jmp    80108bad <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108b99:	90                   	nop
80108b9a:	eb 01                	jmp    80108b9d <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108b9c:	90                   	nop
...
80108ba3:	e8 15 fe ff ff       	call   801089bd <freevm>
  return 0;
80108ba8:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108bad:	83 c4 44             	add    $0x44,%esp
80108bb0:	5b                   	pop    %ebx
80108bb1:	5d                   	pop    %ebp
80108bb2:	c3                   	ret    
...
80108bc0:	00 
80108bc1:	8b 45 0c             	mov    0xc(%ebp),%eax
80108bc4:	89 44 24 04          	mov    %eax,0x4(%esp)
80108bc8:	8b 45 08             	mov    0x8(%ebp),%eax
80108bcb:	89 04 24             	mov    %eax,(%esp)
80108bce:	e8 58 f7 ff ff       	call   8010832b <walkpgdir>
80108bd3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108bd6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bd9:	8b 00                	mov    (%eax),%eax
80108bdb:	83 e0 01             	and    $0x1,%eax
80108bde:	85 c0                	test   %eax,%eax
80108be0:	75 07                	jne    80108be9 <uva2ka+0x36>
    return 0;
80108be2:	b8 00 00 00 00       	mov    $0x0,%eax
80108be7:	eb 25                	jmp    80108c0e <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108be9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bec:	8b 00                	mov    (%eax),%eax
80108bee:	83 e0 04             	and    $0x4,%eax
80108bf1:	85 c0                	test   %eax,%eax
80108bf3:	75 07                	jne    80108bfc <uva2ka+0x49>
    return 0;
80108bf5:	b8 00 00 00 00       	mov    $0x0,%eax
80108bfa:	eb 12                	jmp    80108c0e <uva2ka+0x5b>
...
80108c09:	e8 9a f2 ff ff       	call   80107ea8 <p2v>
}
80108c0e:	c9                   	leave  
80108c0f:	c3                   	ret    
...
80108c13:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108c16:	8b 45 10             	mov    0x10(%ebp),%eax
80108c19:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108c1c:	e9 8b 00 00 00       	jmp    80108cac <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108c21:	8b 45 0c             	mov    0xc(%ebp),%eax
80108c24:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108c29:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108c2c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108c2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108c33:	8b 45 08             	mov    0x8(%ebp),%eax
80108c36:	89 04 24             	mov    %eax,(%esp)
80108c39:	e8 75 ff ff ff       	call   80108bb3 <uva2ka>
80108c3e:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108c41:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108c45:	75 07                	jne    80108c4e <copyout+0x3e>
      return -1;
80108c47:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108c4c:	eb 6d                	jmp    80108cbb <copyout+0xab>
    n = PGSIZE - (va - va0);
80108c4e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108c51:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108c54:	89 d1                	mov    %edx,%ecx
80108c56:	29 c1                	sub    %eax,%ecx
80108c58:	89 c8                	mov    %ecx,%eax
80108c5a:	05 00 10 00 00       	add    $0x1000,%eax
80108c5f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108c62:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108c65:	3b 45 14             	cmp    0x14(%ebp),%eax
80108c68:	76 06                	jbe    80108c70 <copyout+0x60>
      n = len;
80108c6a:	8b 45 14             	mov    0x14(%ebp),%eax
80108c6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108c70:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108c73:	8b 55 0c             	mov    0xc(%ebp),%edx
80108c76:	89 d1                	mov    %edx,%ecx
80108c78:	29 c1                	sub    %eax,%ecx
80108c7a:	89 c8                	mov    %ecx,%eax
80108c7c:	03 45 e8             	add    -0x18(%ebp),%eax
80108c7f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108c82:	89 54 24 08          	mov    %edx,0x8(%esp)
80108c86:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c89:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c8d:	89 04 24             	mov    %eax,(%esp)
80108c90:	e8 c0 ca ff ff       	call   80105755 <memmove>
    len -= n;
...
80108cb0:	0f 85 6b ff ff ff    	jne    80108c21 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
...
80108cbb:	c9                   	leave  
80108cbc:	c3                   	ret    
80108cbd:	00 00                	add    %al,(%eax)
	...

80108cc0 <implicit_exit>:
.code32
.globl implicit_exit
...
80108cc1:	6a ff                	push   $0xffffffff

	movl $2, %eax;
80108cc3:	b8 02 00 00 00       	mov    $0x2,%eax
	int $64;
80108cc8:	cd 40                	int    $0x40

80108cca <implicit_exit_end>:
	...

80108ccc <create_link>:
...
80108cd9:	eb 4e                	jmp    80108d29 <create_link+0x5d>
		if(!list->nodes[i].used){
80108cdb:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108cde:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108ce1:	89 d0                	mov    %edx,%eax
80108ce3:	01 c0                	add    %eax,%eax
80108ce5:	01 d0                	add    %edx,%eax
80108ce7:	c1 e0 03             	shl    $0x3,%eax
80108cea:	01 c8                	add    %ecx,%eax
80108cec:	83 c0 20             	add    $0x20,%eax
80108cef:	8b 00                	mov    (%eax),%eax
80108cf1:	85 c0                	test   %eax,%eax
80108cf3:	75 30                	jne    80108d25 <create_link+0x59>
			list->nodes[i].used = 1;
80108cf5:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108cf8:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108cfb:	89 d0                	mov    %edx,%eax
80108cfd:	01 c0                	add    %eax,%eax
80108cff:	01 d0                	add    %edx,%eax
80108d01:	c1 e0 03             	shl    $0x3,%eax
80108d04:	01 c8                	add    %ecx,%eax
80108d06:	83 c0 20             	add    $0x20,%eax
80108d09:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
			return &list->nodes[i];
80108d0f:	8b 45 08             	mov    0x8(%ebp),%eax
80108d12:	8d 48 10             	lea    0x10(%eax),%ecx
80108d15:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108d18:	89 d0                	mov    %edx,%eax
80108d1a:	01 c0                	add    %eax,%eax
80108d1c:	01 d0                	add    %edx,%eax
80108d1e:	c1 e0 03             	shl    $0x3,%eax
80108d21:	01 c8                	add    %ecx,%eax
80108d23:	eb 1b                	jmp    80108d40 <create_link+0x74>
#include "types.h"
#include "defs.h"
...
80108d29:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
80108d2d:	7e ac                	jle    80108cdb <create_link+0xf>
			return &list->nodes[i];
		}
	}
...
80108d2f:	c7 04 24 18 98 10 80 	movl   $0x80109818,(%esp)
80108d36:	e8 66 76 ff ff       	call   801003a1 <cprintf>
	return 0;
...
80108d51:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	link->next = 0;
80108d58:	8b 45 08             	mov    0x8(%ebp),%eax
80108d5b:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	link->prev = 0;
80108d62:	8b 45 08             	mov    0x8(%ebp),%eax
80108d65:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	link->used = 0;
80108d6c:	8b 45 08             	mov    0x8(%ebp),%eax
80108d6f:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
}
80108d76:	5d                   	pop    %ebp
80108d77:	c3                   	ret    
...
80108d79:	89 e5                	mov    %esp,%ebp
	if(list->head == 0){
80108d7b:	8b 45 08             	mov    0x8(%ebp),%eax
80108d7e:	8b 00                	mov    (%eax),%eax
80108d80:	85 c0                	test   %eax,%eax
80108d82:	75 22                	jne    80108da6 <add_last+0x2e>
		list->head = link;
80108d84:	8b 45 08             	mov    0x8(%ebp),%eax
...
80108d92:	89 50 04             	mov    %edx,0x4(%eax)
		list->size++;
80108d95:	8b 45 08             	mov    0x8(%ebp),%eax
80108d98:	8b 40 08             	mov    0x8(%eax),%eax
80108d9b:	8d 50 01             	lea    0x1(%eax),%edx
80108d9e:	8b 45 08             	mov    0x8(%ebp),%eax
80108da1:	89 50 08             	mov    %edx,0x8(%eax)
80108da4:	eb 30                	jmp    80108dd6 <add_last+0x5e>
	}
	else{
		link->prev = list->tail;
80108da6:	8b 45 08             	mov    0x8(%ebp),%eax
80108da9:	8b 50 04             	mov    0x4(%eax),%edx
80108dac:	8b 45 0c             	mov    0xc(%ebp),%eax
80108daf:	89 50 0c             	mov    %edx,0xc(%eax)
		list->tail->next = link;
80108db2:	8b 45 08             	mov    0x8(%ebp),%eax
80108db5:	8b 40 04             	mov    0x4(%eax),%eax
80108db8:	8b 55 0c             	mov    0xc(%ebp),%edx
80108dbb:	89 50 08             	mov    %edx,0x8(%eax)
		list->tail = link;
80108dbe:	8b 45 08             	mov    0x8(%ebp),%eax
80108dc1:	8b 55 0c             	mov    0xc(%ebp),%edx
80108dc4:	89 50 04             	mov    %edx,0x4(%eax)
		list->size++;
80108dc7:	8b 45 08             	mov    0x8(%ebp),%eax
80108dca:	8b 40 08             	mov    0x8(%eax),%eax
80108dcd:	8d 50 01             	lea    0x1(%eax),%edx
80108dd0:	8b 45 08             	mov    0x8(%ebp),%eax
80108dd3:	89 50 08             	mov    %edx,0x8(%eax)
	}
}
80108dd6:	5d                   	pop    %ebp
80108dd7:	c3                   	ret    
...
80108dd8:	55                   	push   %ebp
80108dd9:	89 e5                	mov    %esp,%ebp
80108ddb:	83 ec 28             	sub    $0x28,%esp
//	if( search(list,id) != 0 ) return; //add unique
	//cprintf("adding %d to linkedlist\n", id);
	cprintf("(+%d)", id);
80108dde:	8b 45 0c             	mov    0xc(%ebp),%eax
80108de1:	89 44 24 04          	mov    %eax,0x4(%esp)
80108de5:	c7 04 24 59 98 10 80 	movl   $0x80109859,(%esp)
80108dec:	e8 b0 75 ff ff       	call   801003a1 <cprintf>
	node* node;
	node = create_link(list);
80108df1:	8b 45 08             	mov    0x8(%ebp),%eax
80108df4:	89 04 24             	mov    %eax,(%esp)
80108df7:	e8 d0 fe ff ff       	call   80108ccc <create_link>
80108dfc:	89 45 f4             	mov    %eax,-0xc(%ebp)
	node->id = id;
80108dff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e02:	8b 55 0c             	mov    0xc(%ebp),%edx
80108e05:	89 10                	mov    %edx,(%eax)
	node->data = p;
80108e07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e0a:	8b 55 10             	mov    0x10(%ebp),%edx
80108e0d:	89 50 04             	mov    %edx,0x4(%eax)
	list->add_last(list,node);
80108e10:	8b 45 08             	mov    0x8(%ebp),%eax
80108e13:	8b 90 10 06 00 00    	mov    0x610(%eax),%edx
80108e19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e1c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108e20:	8b 45 08             	mov    0x8(%ebp),%eax
80108e23:	89 04 24             	mov    %eax,(%esp)
80108e26:	ff d2                	call   *%edx
	//print(list);
}
80108e28:	c9                   	leave  
80108e29:	c3                   	ret    

80108e2a <remove_first>:
...
80108e33:	8b 00                	mov    (%eax),%eax
80108e35:	85 c0                	test   %eax,%eax
80108e37:	75 13                	jne    80108e4c <remove_first+0x22>
		cprintf("ERROR: list is empty. cant remove 1st link");
80108e39:	c7 04 24 60 98 10 80 	movl   $0x80109860,(%esp)
80108e40:	e8 5c 75 ff ff       	call   801003a1 <cprintf>
		return 0;
80108e45:	b8 00 00 00 00       	mov    $0x0,%eax
80108e4a:	eb 68                	jmp    80108eb4 <remove_first+0x8a>
	}
	tmp = list->head;
...
80108e57:	8b 00                	mov    (%eax),%eax
80108e59:	89 44 24 04          	mov    %eax,0x4(%esp)
80108e5d:	c7 04 24 8b 98 10 80 	movl   $0x8010988b,(%esp)
80108e64:	e8 38 75 ff ff       	call   801003a1 <cprintf>
	p = tmp->data;
80108e69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e6c:	8b 40 04             	mov    0x4(%eax),%eax
80108e6f:	89 45 f0             	mov    %eax,-0x10(%ebp)
	list->head = list->head->next;
80108e72:	8b 45 08             	mov    0x8(%ebp),%eax
80108e75:	8b 00                	mov    (%eax),%eax
80108e77:	8b 50 08             	mov    0x8(%eax),%edx
80108e7a:	8b 45 08             	mov    0x8(%ebp),%eax
80108e7d:	89 10                	mov    %edx,(%eax)
	tmp->clean_up(tmp);
80108e7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e82:	8b 50 14             	mov    0x14(%eax),%edx
80108e85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e88:	89 04 24             	mov    %eax,(%esp)
80108e8b:	ff d2                	call   *%edx
	if(list->head != 0){
80108e8d:	8b 45 08             	mov    0x8(%ebp),%eax
80108e90:	8b 00                	mov    (%eax),%eax
80108e92:	85 c0                	test   %eax,%eax
80108e94:	74 0c                	je     80108ea2 <remove_first+0x78>
		list->head->prev = 0;
80108e96:	8b 45 08             	mov    0x8(%ebp),%eax
80108e99:	8b 00                	mov    (%eax),%eax
80108e9b:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	}
	list->size--;
80108ea2:	8b 45 08             	mov    0x8(%ebp),%eax
80108ea5:	8b 40 08             	mov    0x8(%eax),%eax
80108ea8:	8d 50 ff             	lea    -0x1(%eax),%edx
80108eab:	8b 45 08             	mov    0x8(%ebp),%eax
80108eae:	89 50 08             	mov    %edx,0x8(%eax)
	return p;
...
80108ec9:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	list->size = 0;
80108ed0:	8b 45 08             	mov    0x8(%ebp),%eax
80108ed3:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	list->max_size = fixed_size;
80108eda:	8b 45 08             	mov    0x8(%ebp),%eax
80108edd:	8b 55 0c             	mov    0xc(%ebp),%edx
80108ee0:	89 50 0c             	mov    %edx,0xc(%eax)
	list->add_last = add_last;
80108ee3:	8b 45 08             	mov    0x8(%ebp),%eax
80108ee6:	c7 80 10 06 00 00 78 	movl   $0x80108d78,0x610(%eax)
80108eed:	8d 10 80 
	list->add = add;
80108ef0:	8b 45 08             	mov    0x8(%ebp),%eax
80108ef3:	c7 80 14 06 00 00 d8 	movl   $0x80108dd8,0x614(%eax)
80108efa:	8d 10 80 
	list->remove_first = remove_first;
80108efd:	8b 45 08             	mov    0x8(%ebp),%eax
80108f00:	c7 80 18 06 00 00 2a 	movl   $0x80108e2a,0x618(%eax)
80108f07:	8e 10 80 
	list->print = print;
80108f0a:	8b 45 08             	mov    0x8(%ebp),%eax
80108f0d:	c7 80 1c 06 00 00 c7 	movl   $0x80108fc7,0x61c(%eax)
80108f14:	8f 10 80 
	list->get_link = get_link;
80108f17:	8b 45 08             	mov    0x8(%ebp),%eax
80108f1a:	c7 80 20 06 00 00 2b 	movl   $0x8010902b,0x620(%eax)
80108f21:	90 10 80 
	list->remove_link = remove_link;
80108f24:	8b 45 08             	mov    0x8(%ebp),%eax
80108f27:	c7 80 24 06 00 00 9b 	movl   $0x8010909b,0x624(%eax)
80108f2e:	90 10 80 
	list->search = search;
80108f31:	8b 45 08             	mov    0x8(%ebp),%eax
80108f34:	c7 80 28 06 00 00 66 	movl   $0x80109066,0x628(%eax)
80108f3b:	90 10 80 

	for(i=0; i < fixed_size; i++){
80108f3e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108f45:	eb 4d                	jmp    80108f94 <init_linkedList+0xde>
		list->nodes[i].clean_up = clean_up;
80108f47:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108f4a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108f4d:	89 d0                	mov    %edx,%eax
80108f4f:	01 c0                	add    %eax,%eax
80108f51:	01 d0                	add    %edx,%eax
80108f53:	c1 e0 03             	shl    $0x3,%eax
80108f56:	01 c8                	add    %ecx,%eax
80108f58:	83 c0 24             	add    $0x24,%eax
80108f5b:	c7 00 42 8d 10 80    	movl   $0x80108d42,(%eax)
		list->nodes[i].clean_up(&list->nodes[i]);
80108f61:	8b 4d 08             	mov    0x8(%ebp),%ecx
80108f64:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108f67:	89 d0                	mov    %edx,%eax
80108f69:	01 c0                	add    %eax,%eax
80108f6b:	01 d0                	add    %edx,%eax
80108f6d:	c1 e0 03             	shl    $0x3,%eax
80108f70:	01 c8                	add    %ecx,%eax
80108f72:	83 c0 24             	add    $0x24,%eax
80108f75:	8b 08                	mov    (%eax),%ecx
80108f77:	8b 45 08             	mov    0x8(%ebp),%eax
80108f7a:	8d 58 10             	lea    0x10(%eax),%ebx
80108f7d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108f80:	89 d0                	mov    %edx,%eax
80108f82:	01 c0                	add    %eax,%eax
80108f84:	01 d0                	add    %edx,%eax
80108f86:	c1 e0 03             	shl    $0x3,%eax
80108f89:	01 d8                	add    %ebx,%eax
80108f8b:	89 04 24             	mov    %eax,(%esp)
80108f8e:	ff d1                	call   *%ecx
	list->print = print;
	list->get_link = get_link;
	list->remove_link = remove_link;
	list->search = search;
	...
	for(i=0; i < fixed_size; i++){
80108f90:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108f94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f97:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108f9a:	7c ab                	jl     80108f47 <init_linkedList+0x91>
		list->nodes[i].clean_up = clean_up;
		list->nodes[i].clean_up(&list->nodes[i]);
	}

}
80108f9c:	83 c4 24             	add    $0x24,%esp
80108f9f:	5b                   	pop    %ebx
80108fa0:	5d                   	pop    %ebp
80108fa1:	c3                   	ret    
...
80108fa2:	55                   	push   %ebp
80108fa3:	89 e5                	mov    %esp,%ebp
80108fa5:	83 ec 18             	sub    $0x18,%esp
	while(list->size > 0){
80108fa8:	eb 11                	jmp    80108fbb <clean_list+0x19>
		list->remove_first(list);
80108faa:	8b 45 08             	mov    0x8(%ebp),%eax
80108fad:	8b 90 18 06 00 00    	mov    0x618(%eax),%edx
80108fb3:	8b 45 08             	mov    0x8(%ebp),%eax
80108fb6:	89 04 24             	mov    %eax,(%esp)
80108fb9:	ff d2                	call   *%edx
	}
...
void clean_list(linkedList* list){
	while(list->size > 0){
80108fbb:	8b 45 08             	mov    0x8(%ebp),%eax
80108fbe:	8b 40 08             	mov    0x8(%eax),%eax
80108fc1:	85 c0                	test   %eax,%eax
80108fc3:	7f e5                	jg     80108faa <clean_list+0x8>
		list->remove_first(list);
	}
}
80108fc5:	c9                   	leave  
...
80108fca:	83 ec 28             	sub    $0x28,%esp
	node* link = list->head;
...
80108fd5:	c7 04 24 91 98 10 80 	movl   $0x80109891,(%esp)
80108fdc:	e8 c0 73 ff ff       	call   801003a1 <cprintf>

	cprintf("HEAD");
80108fe1:	c7 04 24 a6 98 10 80 	movl   $0x801098a6,(%esp)
80108fe8:	e8 b4 73 ff ff       	call   801003a1 <cprintf>
	while(link != 0){
80108fed:	eb 28                	jmp    80109017 <print+0x50>
		cprintf(" => [%d ,0x%x] ",link->id,link->data);
80108fef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ff2:	8b 50 04             	mov    0x4(%eax),%edx
80108ff5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ff8:	8b 00                	mov    (%eax),%eax
80108ffa:	89 54 24 08          	mov    %edx,0x8(%esp)
80108ffe:	89 44 24 04          	mov    %eax,0x4(%esp)
80109002:	c7 04 24 ab 98 10 80 	movl   $0x801098ab,(%esp)
80109009:	e8 93 73 ff ff       	call   801003a1 <cprintf>
		link = link->next;
8010900e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109011:	8b 40 08             	mov    0x8(%eax),%eax
80109014:	89 45 f4             	mov    %eax,-0xc(%ebp)
	node* link = list->head;
	...
	cprintf("HEAD");
	while(link != 0){
80109017:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010901b:	75 d2                	jne    80108fef <print+0x28>
		cprintf(" => [%d ,0x%x] ",link->id,link->data);
		link = link->next;
	}
	cprintf("<= TAIL \n");
8010901d:	c7 04 24 bb 98 10 80 	movl   $0x801098bb,(%esp)
80109024:	e8 78 73 ff ff       	call   801003a1 <cprintf>
...
8010902b:	55                   	push   %ebp
8010902c:	89 e5                	mov    %esp,%ebp
8010902e:	83 ec 10             	sub    $0x10,%esp
	node* link = list->head;
80109031:	8b 45 08             	mov    0x8(%ebp),%eax
80109034:	8b 00                	mov    (%eax),%eax
80109036:	89 45 fc             	mov    %eax,-0x4(%ebp)
	while(position > 0 && link != 0){
80109039:	eb 0d                	jmp    80109048 <get_link+0x1d>
		link = link->next;
8010903b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010903e:	8b 40 08             	mov    0x8(%eax),%eax
80109041:	89 45 fc             	mov    %eax,-0x4(%ebp)
		position--;
80109044:	83 6d 0c 01          	subl   $0x1,0xc(%ebp)
...
node* get_link(linkedList* list,int position){
	node* link = list->head;
	while(position > 0 && link != 0){
80109048:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010904c:	7e 06                	jle    80109054 <get_link+0x29>
8010904e:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80109052:	75 e7                	jne    8010903b <get_link+0x10>
		link = link->next;
		position--;
	}
	if(position == 0) return link;
80109054:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80109058:	75 05                	jne    8010905f <get_link+0x34>
8010905a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010905d:	eb 05                	jmp    80109064 <get_link+0x39>

	return 0;
8010905f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80109064:	c9                   	leave  
80109065:	c3                   	ret    
...
80109069:	83 ec 10             	sub    $0x10,%esp
	node* p = list->head;
8010906c:	8b 45 08             	mov    0x8(%ebp),%eax
8010906f:	8b 00                	mov    (%eax),%eax
80109071:	89 45 fc             	mov    %eax,-0x4(%ebp)

	while(p != 0){
80109074:	eb 18                	jmp    8010908e <search+0x28>
		if(p->id == id){
80109076:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109079:	8b 00                	mov    (%eax),%eax
8010907b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010907e:	75 05                	jne    80109085 <search+0x1f>
			return p;
80109080:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109083:	eb 14                	jmp    80109099 <search+0x33>
		}
		p=p->next;
80109085:	8b 45 fc             	mov    -0x4(%ebp),%eax
80109088:	8b 40 08             	mov    0x8(%eax),%eax
8010908b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	return 0;
}
node* search(linkedList* list, int id){
	node* p = list->head;
	...
	while(p != 0){
8010908e:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80109092:	75 e2                	jne    80109076 <search+0x10>
		if(p->id == id){
			return p;
		}
		p=p->next;
...
801090a8:	8b 45 08             	mov    0x8(%ebp),%eax
801090ab:	89 04 24             	mov    %eax,(%esp)
801090ae:	e8 b3 ff ff ff       	call   80109066 <search>
801090b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
	cprintf("requested: %d, deleting, found:(%d) %d\n", id, tmp, tmp->id);
801090b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090b9:	8b 00                	mov    (%eax),%eax
801090bb:	89 44 24 0c          	mov    %eax,0xc(%esp)
801090bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090c2:	89 44 24 08          	mov    %eax,0x8(%esp)
801090c6:	8b 45 0c             	mov    0xc(%ebp),%eax
801090c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801090cd:	c7 04 24 c8 98 10 80 	movl   $0x801098c8,(%esp)
801090d4:	e8 c8 72 ff ff       	call   801003a1 <cprintf>
	if(tmp != 0){
801090d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801090dd:	74 62                	je     80109141 <remove_link+0xa6>
		if(tmp->prev == 0){ /* was head*/
801090df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090e2:	8b 40 0c             	mov    0xc(%eax),%eax
801090e5:	85 c0                	test   %eax,%eax
801090e7:	75 0d                	jne    801090f6 <remove_link+0x5b>
			list->head = tmp->next;
801090e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090ec:	8b 50 08             	mov    0x8(%eax),%edx
801090ef:	8b 45 08             	mov    0x8(%ebp),%eax
801090f2:	89 10                	mov    %edx,(%eax)
801090f4:	eb 36                	jmp    8010912c <remove_link+0x91>
		}
		else{
			tmp->prev->next = tmp->next;
801090f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801090f9:	8b 40 0c             	mov    0xc(%eax),%eax
801090fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801090ff:	8b 52 08             	mov    0x8(%edx),%edx
80109102:	89 50 08             	mov    %edx,0x8(%eax)
			if(tmp->next != 0){
80109105:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109108:	8b 40 08             	mov    0x8(%eax),%eax
8010910b:	85 c0                	test   %eax,%eax
8010910d:	74 11                	je     80109120 <remove_link+0x85>
				tmp->next->prev = tmp->prev;
8010910f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109112:	8b 40 08             	mov    0x8(%eax),%eax
80109115:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109118:	8b 52 0c             	mov    0xc(%edx),%edx
8010911b:	89 50 0c             	mov    %edx,0xc(%eax)
8010911e:	eb 0c                	jmp    8010912c <remove_link+0x91>
			}
			else{
				list->tail = tmp->prev;
80109120:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109123:	8b 50 0c             	mov    0xc(%eax),%edx
80109126:	8b 45 08             	mov    0x8(%ebp),%eax
80109129:	89 50 04             	mov    %edx,0x4(%eax)
			}
...
8010912f:	8b 50 14             	mov    0x14(%eax),%edx
80109132:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109135:	89 04 24             	mov    %eax,(%esp)
80109138:	ff d2                	call   *%edx
		//list->print(list);

		return 1;
8010913a:	b8 01 00 00 00       	mov    $0x1,%eax
8010913f:	eb 05                	jmp    80109146 <remove_link+0xab>
	}
	return 0;
