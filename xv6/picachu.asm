...
int main(int argc, char *argv[]){
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	printf(1, "no exit call here.. \n");
   9:	c7 44 24 04 cb 07 00 	movl   $0x7cb,0x4(%esp)
  10:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39e:	0f b6 90 28 0a 00 00 	movzbl 0xa28(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4fd:	75 27                	jne    526 <printf+0x11f>
          s = "(null)";
 4ff:	c7 45 f4 e1 07 00 00 	movl   $0x7e1,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5cb:	a1 44 0a 00 00       	mov    0xa44,%eax
...
free(void *ap)
{
 ...
 68c:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 691:	c9                   	leave  
 692:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6df:	e8 d8 fe ff ff       	call   5bc <free>
  return freep;
 6e4:	a1 44 0a 00 00       	mov    0xa44,%eax
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 700:	a1 44 0a 00 00       	mov    0xa44,%eax
 705:	89 45 f0             	mov    %eax,-0x10(%ebp)
 708:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 70c:	75 23                	jne    731 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 70e:	c7 45 f0 3c 0a 00 00 	movl   $0xa3c,-0x10(%ebp)
 715:	8b 45 f0             	mov    -0x10(%ebp),%eax
 718:	a3 44 0a 00 00       	mov    %eax,0xa44
 71d:	a1 44 0a 00 00       	mov    0xa44,%eax
 722:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    base.s.size = 0;
 727:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 72e:	00 00 00 
  }
 ...
 784:	a3 44 0a 00 00       	mov    %eax,0xa44
      return (void*)(p + 1);
 ...
 78f:	eb 38                	jmp    7c9 <malloc+0xde>
    ...
    if(p == freep)
 791:	a1 44 0a 00 00       	mov    0xa44,%eax
